...
class Brainbuilder(PythonPackage):
    ...
    depends_on("py-bluepysnap@0.13.0:0", type=("build", "run"), when="@:0.18.3")
    depends_on("py-bluepysnap@1.0.3:", type=("build", "run"), when="@0.18.4:")

    depends_on("py-attrs@:19", type=("build", "run"))
    depends_on("py-entity-management@0.1.11:0", type=("build", "run"))
