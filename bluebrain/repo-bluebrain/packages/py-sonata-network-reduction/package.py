...
class PySonataNetworkReduction(PythonPackage):
    ...
    depends_on("py-h5py@3.0.0:4.99", type=("build", "run"))
    depends_on("py-pandas@0.25:1.99", type=("build", "run"))
    depends_on("py-tqdm@4.34:4.99", type=("build", "run"))
    depends_on("py-dask", type=("build", "run"))
    depends_on("py-dask-mpi", type=("build", "run"))
    depends_on("py-distributed@2.0:2.21", type=("build", "run"))
    depends_on("py-bluepyopt@1.8.68:1.999", type=("build", "run"))
    depends_on("py-bglibpy@4.3:4.999", type=("build", "run"))
    depends_on("py-bluepysnap@0.5.2:0.99", type=("build", "run"))
    depends_on("neuron+python", type=("build", "run"))
    depends_on("py-neuron-reduce@0.0.8:0.99", type=("build", "run"))
    depends_on("py-morphio@3.0.0:3.999", type=("build", "run"))
    depends_on("py-morph-tool@0.2.7:2.99", type=("build", "run"))
    depends_on("py-click@6.7:7.99", type=("build", "run"))
    depends_on("py-aibs-circuit-converter@0.0.3:0.99", type=("build", "run"))
    depends_on("py-pyyaml@5.3:5.99", type=("build", "run"))
