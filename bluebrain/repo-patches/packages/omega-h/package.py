...
class OmegaH(CMakePackage):
    ...
    version(
        "9.33.0.dev1", sha256="984831746222317b9701a58042cb3da1754845a50cb17d865e3e8210beb5dd6b"
    )
    version(
        "9.32.5.dev3", sha256="83381f728688ad9d786f02946fe101bf577c7c3268a40e46264935e7cd1a5d97"
    )
    version(
        "9.31.3.dev2", sha256="8ff448a5185e916068dc41e25a0e7a262d12543426c3888ae145ed90a7afa0de"
    )
    version("9.30.0", sha256="7160045ea12718269f345c7be93a386533ebb76788504df413f22fbcb072f158")
    version(
        "9.29.2.dev1", sha256="d180c8b32768464e6e3e909f06ed9c8dbb21bd6443e88687409434dd307fe150"
    )
    ...
    def patch(self):
        filter_file(r"OUTPUT_QUIET", "OUTPUT_VARIABLE Gmsh_VERSION_STRING", "cmake/FindGmsh.cmake")
