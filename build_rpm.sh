...
nonmpipkgs = {"python@2.7.14": ["^readline@system"],
              ...
              "bwa@0.7.17": [""],
              "r@3.4.1+external-lapack": ["^readline@system ^openblas threads=openmp", "^readline@system ^intel-parallel-studio+mkl"],
              "octave+qt@4.2.1": ["^readline@system ^openblas threads=openmp"],
