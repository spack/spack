...
for pkg in ["intel-parallel-studio@cluster.2015.6+advisor+clck+daal+inspector+ipp+itac+mkl+mpi+tbb+vtune %{} threads=openmp".format(CC),
            "intel-parallel-studio@cluster.2016.4+advisor+clck+daal+inspector+ipp+itac+mkl+mpi+tbb+vtune %{} threads=openmp".format(CC),
...
for pkg in ["intel-parallel-studio@cluster.2015.6+advisor+clck+daal+inspector+ipp+itac+mkl+mpi+tbb+vtune %intel@15.0.6 threads=openmp",
