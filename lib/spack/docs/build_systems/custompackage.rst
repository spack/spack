...
`perl <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/perl/package.py>`_ and
`cmake <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/cmake/package.py>`_
