...
`cbench <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/cbench/package.py>`_
is a good example of a simple package that does this, while
`esmf <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/esmf/package.py>`_
...
`cloverleaf <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/cloverleaf/package.py>`_
...
`stream <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/stream/package.py>`_
...
`elk <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/elk/package.py>`_
...
`hpl <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/hpl/package.py>`_
