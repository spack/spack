...
`kahip <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/kahip/package.py>`_
don't bother overwriting the default SCons help message, so this isn't
very useful, but other packages like
`serf <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/serf/package.py>`_
...
`cantera <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/cantera/package.py>`_
