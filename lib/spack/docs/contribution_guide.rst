...
.. code-block:: console
   ...
   Modified files:
     ...
     var/spack/spack_repo/builtin/packages/hdf5/package.py
     var/spack/spack_repo/builtin/packages/hdf/package.py
     var/spack/spack_repo/builtin/packages/netcdf/package.py
   =======================================================
...
.. code-block:: console
   ...
   var/spack/spack_repo/builtin/packages/netcdf/package.py:26: [F401] 'os' imported but unused
   var/spack/spack_repo/builtin/packages/netcdf/package.py:61: [E303] too many blank lines (2)
   var/spack/spack_repo/builtin/packages/netcdf/package.py:106: [E501] line too long (92 > 79 characters)
   Flake8 found errors.
...
.. warning::
   ...
   Sphinx has `several required dependencies <https://github.com/spack/spack/blob/develop/var/spack/spack_repo/builtin/packages/py-sphinx/package.py>`_.
