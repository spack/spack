...
.. code-block:: console
   ...
   --------------------------------------------------------------- ~/.local/share/spack/modules/linux-ubuntu14-x86_64 ---------------------------------------------------------------
...
+===========+==============+==============================+==============================================+======================+
|  ``tcl``  | No           | ~/.local/share/spack/modules | share/spack/templates/modules/modulefile.tcl | Env. Modules/Lmod    |
+-----------+--------------+------------------------------+----------------------------------------------+----------------------+
|  ``lmod`` | Yes          | ~/.local/share/spack/lmod    | share/spack/templates/modules/modulefile.lua | Lmod                 |
+-----------+--------------+------------------------------+----------------------------------------------+----------------------+
...
As shown in the table above, the default module root for ``lmod`` is ``~/.local/share/spack/lmod`` and the default root for ``tcl`` is ``~/.local/share/spack/modules``.
