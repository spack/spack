...
+==========+===================+================+=========================+==================================================+==================+
| ``Tcl``  | non-hierarchical  | yes            | ``share/spack/modules`` | ``share/spack/templates/modules/modulefile.tcl`` | Environment      |
|          |                   |                |                         |                                                  | Modules, Lmod    |
+----------+-------------------+----------------+-------------------------+--------------------------------------------------+------------------+
...
When using Tcl modules, Spack can optionally generate module files that define the package variants using the Tcl module file ``variant`` command.
This helps users inspect and query the module to understand what has been installed.
...
It allows to express the module requirement with its exact variant configuration.
The variant specification also appears in the output of ``spack module tcl find`` and ``spack module tcl loads`` commands.
