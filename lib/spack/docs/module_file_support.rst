...
programmers on their development machines. To blend in this common practice
...
under the Spack root:
  ...
  |                                |  **Module files root**             |
  +================================+====================================+
  |  **Environment Modules**       |  share/spack/modules               |
  +--------------------------------+------------------------------------+
  |  **Dotkit**                    |   share/spack/dotkit               |
  +--------------------------------+------------------------------------+
  |  **LMod Hierarchical Modules** |   share/spack/lmod                 |
  +--------------------------------+------------------------------------+
