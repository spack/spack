...
class ROCmPackage(PackageBase):
    ...
    depends_on("llvm-amdgpu@5.2.0:", when="amdgpu_target=gfx940:xnack-")
    depends_on("llvm-amdgpu@5.7.0:", when="amdgpu_target=gfx941:xnack-")
    depends_on("llvm-amdgpu@5.7.0:", when="amdgpu_target=gfx942:xnack-")
    depends_on("llvm-amdgpu@5.2.0:", when="amdgpu_target=gfx940:xnack+")
    depends_on("llvm-amdgpu@5.7.0:", when="amdgpu_target=gfx941:xnack+")
    depends_on("llvm-amdgpu@5.7.0:", when="amdgpu_target=gfx942:xnack+")
