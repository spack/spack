...
def shell_init_instructions(cmd, equivalent):
    ...
    msg = [
        ...
        "  . %s/setup-env.sh" % spack.paths_base.locations.share_path,
        "",
        color.colorize("@*c{For csh/tcsh:}"),
        "  source %s/setup-env.csh" % spack.paths_base.locations.share_path,
        "",
        color.colorize("@*c{For fish:}"),
        "  source %s/setup-env.fish" % spack.paths_base.locations.share_path,
        "",
        color.colorize("@*c{For Windows batch:}"),
        "  %s\\spack_cmd.bat" % spack.paths_base.locations.bin_path,
        "",
        color.colorize("@*c{For PowerShell:}"),
        "  %s\\setup-env.ps1" % spack.paths_base.locations.share_path,
        "",
