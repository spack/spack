...
def solve(parser, args):
    ...
    kwargs = {
        ...
        "highlight_version_fn": (spack.spec.non_preferred_version if args.non_defaults else None),
        "highlight_variant_fn": (spack.spec.non_default_variant if args.non_defaults else None),
    }
