...
def class_for_compiler_name(compiler_name):
    ...
    python_file = submodule_name + ".py"
    module_path = os.path.join(spack.paths.compilers_path, python_file)
    module_name = '.'.join(['spack', 'compilers', submodule_name])
    module_obj = llnl.util.lang.load_module_from_file(module_name, module_path)
