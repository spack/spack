...
class PathContext(tengine.Context):
    ...
    def paths(self):
        ...
        Paths = collections.namedtuple("Paths", ["environment", "store", "view"])
        return Paths(
    ...
    def monitor(self):
        ...
        Monitor = collections.namedtuple(
            "Monitor", ["enabled", "host", "prefix", "keep_going", "tags"]
        )
    ...
    def bootstrap(self):
        ...
        if self.bootstrap_image:
            ...
            context = {
                "bootstrap": {"image": self.bootstrap_image, "spack_checkout": command}
            }
    ...
    def render_phase(self):
        ...
        return Render(
            bootstrap=render_bootstrap, build=render_build, final=render_final
        )
