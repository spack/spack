...
class SpackMonitorClient:
    ...
    def issue_request(self, request, retry=True):
        ...
        try:
            ...
            # Handle permanent re-directs!
                ...
                if location:
                    request = self.prepare_request(location, request_data, self.headers)
    ...
    def new_configuration(self, specs):
        ...
        for spec in specs:
            ...
            as_dict = {
                "spec": spec.to_dict(hash=ht.full_hash)["spec"],
    ...
    def failed_concretization(self, specs):
        ...
        for spec in specs:
            ...
            as_dict = {"spec": meta, "spack_version": self.spack_version}
