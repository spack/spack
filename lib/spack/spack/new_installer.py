...
class PackageInstaller:
    ...
    def _drain_child_output(self, child_info: ChildInfo, selector: selectors.BaseSelector) -> None:
        ...
        key = child_info.output_r_conn
        map = selector.get_map()
        while key in map:
            self._handle_child_logs(map[key], child_info, selector)
    ...
    def _drain_child_state(self, child_info: ChildInfo, selector: selectors.BaseSelector) -> None:
        ...
        key = child_info.state_r_conn
        map = selector.get_map()
        while key in map:
            self._handle_child_state(map[key], child_info, selector)
