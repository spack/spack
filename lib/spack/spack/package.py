...
class BundlePackage(with_metaclass(PackageMeta, PackageViewMixin, object)):
    ...
    **Package Lifecycle**
    ...
    A core package's lifecycle over a Spack run looks something like this:
    ...
    @property
    def requires_url(self):
        """Returns False since a URL is not used."""
        return False
...
class PackageBase(BundlePackage):
    ...
    **Package Lifecycle**
    ...
    @property
    def requires_url(self):
        """Returns True since a URL is required."""
        return True
