...
class Dependency:
    ...
    This class differs from :class:`~spack.spec.DependencySpec` because it
    represents metadata at the :class:`~spack.package_base.PackageBase` level.
    :class:`~spack.spec.DependencySpec` is a descriptor for an actual package
    configuration, while this is a descriptor for a package's dependency
    *requirements*.
    ...
    def __init__(
        self, pkg: Type["PackageBase"], spec: spack.spec.Spec, depflag: dt.DepFlag = dt.DEFAULT
    ):
