...
def _compute_default_deprecation_severity(configuration: spack.config.Configuration) -> str:
    ...
    if configuration.get("config:deprecated", False):
        warnings.warn(
...
class SpackSolverSetup:
    ...
    def deprecation_rules(self, pkg):
        ...
        pkg_cfg = self.context.config.get_config("packages").get(pkg.name, {})
    ...
    def setup(
        ...
        *,
        ...
        self._deprecation_default = _compute_default_deprecation_severity(self.context.config)
