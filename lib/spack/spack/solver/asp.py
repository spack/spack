...
class PyclingoDriver:
    ...
    def solve(
        ...
        ui.on_solve_finished(result, timer=timer, statistics=statistics, cached=cached)
...
class SpecBuilder:
    ...
    def __init__(self, specs, *, repo: spack.repo.RepoPath, hash_lookup=None):
        ...
        #: Diagnostics about the answer set, stored on the Result
...
class Solver:
    ...
    def solve_with_stats(
        ...
        setup = SpackSolverSetup(tests=tests, context=self.context, ui=self.ui)
