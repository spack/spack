...
class SpackSolverSetup(object):
    ...
    def __init__(self):
        ...
        # use same strategy as clingo to define function builder
        global fn
        from ..asp import AspFunctionBuilder
        fn = AspFunctionBuilder()

        # default logic programs in root directory
        self.lp = ['concretize.lp', 'display.lp']
