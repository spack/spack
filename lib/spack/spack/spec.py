...
class Spec(object):
    ...
    def concretize(self, tests=False):
        ...
        for s in self.traverse():
            ...
            for cond, patch_list in s.package_class.patches.items():
                if s.satisfies(cond, patch_sense=True):
    ...
    def satisfies(self, other, deps=True, strict=False, strict_deps=False,
        ...
        There is also the exception of patch_sense:
          * when checking whether to patch constraint of @x.y does
            not imply x.y.z should be patched.
