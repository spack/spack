...
class Spec:
    ...
    def to_node_dict(self) -> Dict[str, Any]:
        ...
        like the DAG hash (see :meth:`dag_hash()`). The ``annotations`` entry is serialized, but
        excluded from the hash. Example result of this function for the ``sqlite`` package::
