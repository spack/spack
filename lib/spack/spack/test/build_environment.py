...
# FIXME (compiler as nodes): this test doesn't make much sense anymore. Compiler packages should
# FIXME (compiler as nodes): just define an appropriate "setup_dependent_build_environment"
