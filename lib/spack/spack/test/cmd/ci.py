...
"""
    ...
    for ci_key, ci_obj in yaml_contents.items():
        ...
        assert ci_obj["script"][2].startswith("spack env activate --without-view ")
        ci_obj["script"][2] = "spack env activate --without-view ENV"
...
def test_ci_get_stack_changed(mock_git_repo, monkeypatch, override_path):
