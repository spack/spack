...
def test_load(install_mockery, mock_fetch, mock_archive, mock_packages, capsys):
    ...
    sh_out = load('--sh', '--only', 'package', 'mpileaks', out=capsys)
    csh_out = load('--csh', '--only', 'package', 'mpileaks', out=capsys)
...
def test_load_fails_no_shell(install_mockery, mock_fetch, mock_archive,
    ...
    out = load('mpileaks', fail_on_error=False, out=capsys)
...
def test_unload(install_mockery, mock_fetch, mock_archive, mock_packages,
    ...
    sh_out = unload('--sh', 'mpileaks', out=capsys)
    csh_out = unload('--csh', 'mpileaks', out=capsys)
...
def test_unload_fails_no_shell(install_mockery, mock_fetch, mock_archive,
                               mock_packages, working_env, capsys):
    ...
    out = unload('mpileaks', fail_on_error=False, out=capsys)
    assert "To set up shell support" in out
