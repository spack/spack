...
def test_arm_flags():
    ...
    supported_flag_test(
        "opt_flags", ["-O", "-O0", "-O1", "-O2", "-O3", "-Ofast"], "arm@1.0"
    )
...
def test_gcc_flags():
    ...
    supported_flag_test(
        "debug_flags",
        ["-g", "-gstabs+", "-gstabs", "-gxcoff+", "-gxcoff", "-gvms"],
        "gcc@4.0",
    )
    supported_flag_test(
        "opt_flags",
...
def test_intel_flags():
    ...
    supported_flag_test(
        "debug_flags", ["-debug", "-g", "-g0", "-g1", "-g2", "-g3"], "intel@1.0"
    )
    supported_flag_test(
...
def test_nag_flags():
    ...
    supported_flag_test(
        "opt_flags", ["-O", "-O0", "-O1", "-O2", "-O3", "-O4"], "nag@1.0"
    )
...
def test_nvhpc_flags():
    ...
    supported_flag_test(
        "opt_flags", ["-O", "-O0", "-O1", "-O2", "-O3", "-O4"], "nvhpc@20.9"
    )
...
def test_pgi_flags():
    ...
    supported_flag_test(
        "opt_flags", ["-O", "-O0", "-O1", "-O2", "-O3", "-O4"], "pgi@1.0"
    )
...
def test_xl_flags():
    ...
    supported_flag_test(
        "debug_flags", ["-g", "-g0", "-g1", "-g2", "-g8", "-g9"], "xl@1.0"
    )
    supported_flag_test(
        "opt_flags",
        ["-O", "-O0", "-O1", "-O2", "-O3", "-O4", "-O5", "-Ofast"],
        "xl@1.0",
    )
