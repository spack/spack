...
def test_cce_flags():
    ...
    supported_flag_test("cxx14_flag","-std=c++14","cce@11.0.0")
    supported_flag_test("cxx17_flag","-std=c++17","cce@11.0.0")
...
def test_gcc_flags():
    ...
    supported_flag_test("cxx14_flag",cce"-std=c++14", "gcc@4.9")
