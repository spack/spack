...
datadir = spack_root.joinpath( 'lib', 'spack', 'spack', 'test', 'data')
...
def files_to_be_sourced():
    ...
    return [
        datadir.joinpath( 'sourceme_first.sh'),
        datadir.joinpath( 'sourceme_second.sh'),
        datadir.joinpath( 'sourceme_parameters.sh'),
        datadir.joinpath( 'sourceme_unicode.sh')
    ]
...
@pytest.mark.parametrize('files,expected,deleted', [
    ...
    ((datadir.joinpath( 'sourceme_parameters.sh'),),
     {'FOO': 'default'}, []),
    (([datadir.joinpath( 'sourceme_parameters.sh'), 'intel64'],),
     {'FOO': 'intel64'}, []),
    ...
    ((datadir.joinpath( 'sourceme_unset.sh'),
      datadir.joinpath( 'sourceme_first.sh')),
     {'NEW_VAR': 'new', 'UNSET_ME': 'overridden'}, []),
    ((datadir.joinpath( 'sourceme_first.sh'),
      datadir.joinpath( 'sourceme_unset.sh')),
...
def test_blacklist_lmod_variables():
    ...
    file = datadir.joinpath( 'sourceme_lmod.sh')
