...
def test_plural(arguments, expected):
    assert llnl.util.string.plural(*arguments) == expected
...
def test_quote(arguments, expected):
    assert llnl.util.string.quote(*arguments) == expected
...
def test_comma_and_or(input, expected_and, expected_or):
    assert llnl.util.string.comma_and(input) == expected_and
    assert llnl.util.string.comma_or(input) == expected_or
