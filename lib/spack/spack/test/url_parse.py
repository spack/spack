...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "libpng",
            "1.6.37",
            "http://download.sourceforge.net/libpng/libpng-1.6.37.tar.gz",
        ),
        ...
        (
            "jube2",
            "2.2.2",
            "https://apps.fz-juelich.de/jsc/jube/jube2/download.php?version=2.2.2",
        ),
        (
            "archive",
            "1.0.0",
        ...
        (
            "octopus",
            "6.0",
            "http://octopus-code.org/down.php?file=6.0/octopus-6.0.tar.gz",
        ),
        (
            "cloog",
            "0.18.1",
