...
# This module tests package content hashing itself, so it needs the real thing rather
# than the trivial stand-in the mock_package_hash_for_tests fixture installs.
