...
def spider(root_urls, depth=0, concurrency=None):
    ...
    Args:
        ...
        concurrency (int or None): number of simultaneous requests that can be sent
...
def find_versions_of_archive(
    archive_urls, list_url=None, list_depth=0, concurrency=None, reference_package=None
):
    ...
    Args:
        ...
        list_depth (int): max depth to follow links on list_url pages.
            Defaults to 0.
        concurrency (int or None): maximum number of concurrent requests
