...
_spack_cd() {
    if $list_options
    then
        SPACK_COMPREPLY="-h --help -m --module-dir -r --spack-root -i --install-dir -p --package-dir --repo --packages -P -s --stage-dir -S --stages -E --env-root -I --install-root -c --source-dir -b --build-dir -e --env -v --view --first"
    else
        _all_packages
    fi
}
