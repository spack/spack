...
_spack_solve() {
    if $list_options
    then
        SPACK_COMPREPLY="-h --help --show -l --long -L --very-long -I --install-status -j --json -c --cover -N --namespaces -t --types --timers --stats -U --fresh --reuse"
    else
        _all_packages
    fi
}
...
_spack_spec() {
    if $list_options
    then
        SPACK_COMPREPLY="-h --help -l --long -L --very-long -I --install-status -j --json --format -c --cover -N --namespaces -t --types -U --fresh --reuse"
    else
        _all_packages
    fi
}
