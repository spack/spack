...
complete -c spack -n '__fish_spack_using_command_pos 0 ' -f -a migrate -d 'migrate user config and cache from old to new locations'
...
complete -c spack -n '__fish_spack_using_command bootstrap enable' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap disable' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap root' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap list' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap add' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command buildcache check' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
# spack cd
set -g __fish_spack_optspecs_spack_cd h/help m/module-dir r/spack-root i/install-dir install-root p/package-dir repo= s/stage-dir S/stages c/source-dir b/build-dir e/env= v/view= first
...
complete -c spack -n '__fish_spack_using_command compiler find' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler add' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler remove' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler rm' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler list' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler ls' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler info' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command compilers' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command config' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command_pos 0 debug' -f -a paths -d 'show how each Spack data path was resolved (active layout scheme, config keys, env-var overrides)'
...
# spack debug paths
set -g __fish_spack_optspecs_spack_debug_paths h/help
complete -c spack -n '__fish_spack_using_command debug paths' -s h -l help -f -a help
complete -c spack -n '__fish_spack_using_command debug paths' -s h -l help -d 'show this help message and exit'
...
complete -c spack -n '__fish_spack_using_command external find' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
# spack location
set -g __fish_spack_optspecs_spack_location h/help m/module-dir r/spack-root i/install-dir install-root p/package-dir repo= s/stage-dir S/stages c/source-dir b/build-dir e/env= v/view= first
...
complete -c spack -n '__fish_spack_using_command mirror add' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror remove' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror rm' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set-url' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror list' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror ls' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo list' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo ls' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo add' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo set' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo remove' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo rm' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo update' -l scope -r -f -a '_builtin defaults:base defaults:old defaults system site user spack command_line'
