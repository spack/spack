...
set -g __fish_spack_optspecs_spack_buildcache_push h/help f/force u/unsigned signed k/key= update-index only= with-build-dependencies without-build-dependencies fail-fast allow-missing base-image= t/tag= private only-noncached group= j/jobs=
...
complete -c spack -n '__fish_spack_using_command buildcache push' -l only-noncached -f -a only_noncached
complete -c spack -n '__fish_spack_using_command buildcache push' -l only-noncached -d 'only push packages not present in an existing binary cache'
...
set -g __fish_spack_optspecs_spack_buildcache_create h/help f/force u/unsigned signed k/key= update-index only= with-build-dependencies without-build-dependencies fail-fast allow-missing base-image= t/tag= private only-noncached group= j/jobs=
...
complete -c spack -n '__fish_spack_using_command buildcache create' -l only-noncached -f -a only_noncached
complete -c spack -n '__fish_spack_using_command buildcache create' -l only-noncached -d 'only push packages not present in an existing binary cache'
