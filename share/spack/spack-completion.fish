...
# spack repo update
set -g __fish_spack_optspecs_spack_repo_update h/help r/remote= scope= b/branch= f/force-discard t/tag= c/commit=
...
complete -c spack -n '__fish_spack_using_command repo update' -l force-discard -s f -f -a force_discard
complete -c spack -n '__fish_spack_using_command repo update' -l force-discard -s f -d 'force an update of a divergent branch by discarding local changes'
