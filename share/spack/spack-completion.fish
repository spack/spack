...
# spack cd
set -g __fish_spack_optspecs_spack_cd h/help m/module-dir r/spack-root i/install-dir p/package-dir repo= s/stage-dir S/stages E/env-root I/install-root c/source-dir b/build-dir e/env= v/view= first
...
complete -c spack -n '__fish_spack_using_command cd' -s E -l env-root -f -a env_root
complete -c spack -n '__fish_spack_using_command cd' -s E -l env-root -d 'top level environment directory'
complete -c spack -n '__fish_spack_using_command cd' -s I -l install-root -f -a install_root
complete -c spack -n '__fish_spack_using_command cd' -s I -l install-root -d 'top level installation directory'
...
# spack location
set -g __fish_spack_optspecs_spack_location h/help m/module-dir r/spack-root i/install-dir p/package-dir repo= s/stage-dir S/stages E/env-root I/install-root c/source-dir b/build-dir e/env= v/view= first
...
complete -c spack -n '__fish_spack_using_command location' -s E -l env-root -f -a env_root
complete -c spack -n '__fish_spack_using_command location' -s E -l env-root -d 'top level environment directory'
complete -c spack -n '__fish_spack_using_command location' -s I -l install-root -f -a install_root
complete -c spack -n '__fish_spack_using_command location' -s I -l install-root -d 'top level installation directory'
