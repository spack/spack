...
# spack ci generate
set -g __fish_spack_optspecs_spack_ci_generate h/help output-file= copy-to= optimize dependencies buildcache-destination= prune-dag no-prune-dag prune-externals check-index-only artifacts-root=
...
complete -c spack -n '__fish_spack_using_command ci generate' -l prune-externals -d 'prune external specs from the pipeline'
