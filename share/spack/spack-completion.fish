...
# spack solve
set -g __fish_spack_optspecs_spack_solve h/help show= timers stats l/long L/very-long N/namespaces I/install-status no-install-status y/yaml j/json format= show-non-defaults c/cover= t/types f/force U/fresh reuse fresh-roots deprecated
...
complete -c spack -n '__fish_spack_using_command solve' -l show-non-defaults -f -a show_non_defaults
complete -c spack -n '__fish_spack_using_command solve' -l show-non-defaults -d 'highlight non-default versions or variants'
...
# spack spec
set -g __fish_spack_optspecs_spack_spec h/help l/long L/very-long N/namespaces I/install-status no-install-status y/yaml j/json format= show-non-defaults c/cover= t/types f/force U/fresh reuse fresh-roots deprecated
...
complete -c spack -n '__fish_spack_using_command spec' -l show-non-defaults -f -a show_non_defaults
complete -c spack -n '__fish_spack_using_command spec' -l show-non-defaults -d 'highlight non-default versions or variants'
