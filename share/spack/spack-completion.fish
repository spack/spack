...
complete -c spack -n '__fish_spack_using_command repo migrate' -l dry-run -r -f -a patch
complete -c spack -n '__fish_spack_using_command repo migrate' -l dry-run -r -d 'do not modify the repository, but write a patch file'
