...
complete -c spack -n '__fish_spack_using_command_pos 0 config get' -f -a 'bootstrap bootstrap_resource cdash ci compilers concretizer config definitions develop mirrors modules packages repos upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config blame' -f -a 'bootstrap bootstrap_resource cdash ci compilers concretizer config definitions develop mirrors modules packages repos upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config edit' -f -a 'bootstrap bootstrap_resource cdash ci compilers concretizer config definitions develop mirrors modules packages repos upstreams view'
