...
complete -c spack -n '__fish_spack_using_command bootstrap enable' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap disable' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap root' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap list' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap add' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command build-env' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command buildcache check' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command ci generate' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command compiler find' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler add' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler remove' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler rm' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler list' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler ls' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compiler info' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command compilers' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command concretize' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command concretise' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command config' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config get' -f -a 'bootstrap cdash ci concretizer config definitions develop env_vars include mirrors modules packages repos toolchains upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config blame' -f -a 'bootstrap cdash ci concretizer config definitions develop env_vars include mirrors modules packages repos toolchains upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config edit' -f -a 'bootstrap cdash ci concretizer config definitions develop env_vars include mirrors modules packages repos toolchains upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 config scopes' -f -a 'bootstrap cdash ci concretizer config definitions develop env_vars include mirrors modules packages repos toolchains upstreams view'
...
complete -c spack -n '__fish_spack_using_command_pos 0 env' -f -a depfile -d '(deprecated) generate a depfile to exploit parallel builds across specs'
...
complete -c spack -n '__fish_spack_using_command external find' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
# spack isolate
set -g __fish_spack_optspecs_spack_isolate h/help path= self undo overwrite reuse-old
...
complete -c spack -n '__fish_spack_using_command isolate' -l reuse-old -f -a reuse_old
complete -c spack -n '__fish_spack_using_command isolate' -l reuse-old -d 'reuse an existing isolation target without overwriting its configuration'
...
complete -c spack -n '__fish_spack_using_command mirror create' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command mirror add' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror remove' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror rm' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set-url' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror list' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command mirror ls' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo list' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo ls' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo add' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo set' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo remove' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo rm' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command repo update' -l scope -r -f -a '_builtin defaults:base defaults layout system site user spack:standard_scopes spack command_line'
...
complete -c spack -n '__fish_spack_using_command solve' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command spec' -l deprecated -f -a deprecated
...
complete -c spack -n '__fish_spack_using_command test-env' -l deprecated -f -a deprecated
