...
complete -c spack -n '__fish_spack_using_command install' -l timer-summary-file -r -f -a timer_summary_file
complete -c spack -n '__fish_spack_using_command install' -l timer-summary-file -r -d 'File to record the top level install timer summary'
