...
class Flake8(Package):
    ...
    variant(
        ...
        default=True,
        description="Enable super awesome feature",
    )
    variant(
        "somewhat-awesome-feature",
        default=False,
        description="Enable somewhat awesome feature",
    )
    ...
    extends(
        "python",
        ignore="bin/(why|does|every|package|that|depends|on|numpy|need|to|copy|f2py3?)",
    )
    ...
    def install(self, spec, prefix):
        ...
        if (
            ...
            != "that-goes-over-the-line-length-limit-and-requires-noqa"
        ):  # noqa
            pass
