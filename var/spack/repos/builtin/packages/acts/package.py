...
class Acts(CMakePackage, CudaPackage):
    ...
    variant(
        "benchmarks",
        default=False,
        description="Build the performance benchmarks",
        when="@0.16:",
    )
    variant(
        "examples",
        ...
        when="@0.23: +digitization +fatras +identification +json +tgeo",
    )
    variant(
    ...
    variant(
        "tgeo",
        default=False,
        description="Build the TGeo plugin",
        when="+identification",
    )
    variant(
        "alignment",
        default=False,
        description="Build the alignment package",
        when="@13:",
    )
    ...
    variant(
        "analysis",
        default=False,
        description="Build analysis applications in the examples",
    )
