...
class Amrex(CMakePackage, CudaPackage, ROCmPackage):
    ...
    depends_on("python@2.7:", when="@:20.04", type="build")
    depends_on("cmake@3.5:", when="@:18.10", type="build")
    depends_on("cmake@3.13:", when="@18.11:19.03", type="build")
    depends_on("cmake@3.14:", when="@19.04:22.05", type="build")
    depends_on("cmake@3.17:", when="@22.06:23.01", type="build")
    depends_on("cmake@3.18:", when="@23.02:", type="build")
    # cmake @3.17: is necessary to handle cuda @11: correctly
    depends_on("cmake@3.17:", when="^cuda @11:", type="build")
    depends_on("cmake@3.20:", when="+rocm", type="build")
    depends_on("cmake@3.22:", when="+sycl", type="build")
    depends_on("hdf5@1.10.4: +mpi", when="+hdf5")
    depends_on("rocrand", when="+rocm", type="build")
    depends_on("hiprand", when="+rocm", type="build")
    depends_on("rocprim", when="@21.05: +rocm", type="build")
    depends_on("hypre@2.18.2:", when="@:21.02 +hypre", type="link")
    depends_on("hypre@2.19.0:", when="@21.03: ~cuda +hypre", type="link")
    depends_on("hypre@2.20.0:", when="@21.03: +cuda +hypre", type="link")
    depends_on("petsc", when="+petsc", type="link")
