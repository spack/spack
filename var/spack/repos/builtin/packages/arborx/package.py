...
class Arborx(CMakePackage):
    ...
    # provide them
    depends_on('kokkos@2.7.00:+cuda+enable_lambda cxxstandard=c++14', when='+cuda')
    depends_on('kokkos@2.7.00:+openmp cxxstandard=c++14', when='+openmp')
    depends_on('kokkos@2.7.00:+serial cxxstandard=c++14', when='+serial')
