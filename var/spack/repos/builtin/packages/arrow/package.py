...
class Arrow(CMakePackage, CudaPackage):
    ...
    depends_on("llvm@:11 +clang", type="build", when="+gandiva @:3")
    depends_on("llvm@:12 +clang", type="build", when="+gandiva @:4")
    depends_on("llvm@:13 +clang", type="build", when="+gandiva @:7")
    depends_on("llvm@:14 +clang", type="build", when="+gandiva @8:")
