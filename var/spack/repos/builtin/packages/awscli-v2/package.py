...
class AwscliV2(PythonPackage):
    ...
    depends_on("py-ruamel-yaml-clib@0.2:0.2.7", type=("build", "run"), when="python@:3.9")
    depends_on("py-prompt-toolkit@3.0.24:3.0.38", type=("build", "run"))
    depends_on("py-distro@1.5:1.8", type=("build", "run"))
    depends_on("py-awscrt@0.16.4:0.16.16", type=("build", "run"), when="@2.13")
    depends_on("py-awscrt@0.19.18:0.19.19", type=("build", "run"), when="@2.15")
