...
class Awscli(PythonPackage):
    ...
    version(
        "1.16.308",
        sha256="3632fb1db2538128509a7b5e89f2a2c4ea3426bec139944247bddc4d79bf7603",
    )
    version(
        "1.16.179",
        sha256="6a87114d1325358d000abe22b2103baae7b91f053ff245b9fde33cb0affb5e4f",
    )
    ...
    depends_on(
        "py-pyyaml@3.10:3.13", when="^python@:2.6,3.0:3.3", type=("build", "run")
    )
    depends_on("py-pyyaml@3.10:5.2", when="^python@3.4:", type=("build", "run"))
    depends_on(
        "py-colorama@0.2.5:0.3.9", when="^python@:2.6,3.0:3.3", type=("build", "run")
    )
