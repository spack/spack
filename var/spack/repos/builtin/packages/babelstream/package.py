...
class Babelstream(CMakePackage):
    ...
    variant(
        "model", 
        values=[
            "std-data", "std-indices","std-ranges","ocl",
            "omp","hip","cuda","kokkos", "sycl","sycl2020",
            "acc","raja","tbb","thrust"], 
        default="std-data", 
    ...
    variant(
        ...
        values=str,
        default="none",
        description="Target AMD GPU device being used."
    )
    ...
    variant(
        ...
        values=str,
        default="none",
        description="The CUDA architecture being used."
    )
