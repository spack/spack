...
class Bazel(Package):
    ...
    version('0.21.0', '8c8240b178a35c0f3c1bc03017550270')
    ...
    patch('fix_env_handling-0.17.2.patch', when='@0.14.0:0.17.999')
    patch('fix_env_handling-0.21.0.patch', when='@0.21.0:')
    patch('link.patch', when='@0.17.2:0.17.999')
    ...
    patch('unix_cc_configure-0.17.2.patch', when='@0.15.0:0.17.999')
    patch('unix_cc_configure-0.21.0.patch', when='@0.21.0:')
