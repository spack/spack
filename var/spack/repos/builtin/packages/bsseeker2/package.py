...
class Bsseeker2(Package):
    ...
    def install(self, spec, prefix):
        ...
        install_tree('bs_index', join_path(prefix.bin, 'bs_index'))
        install('bs_seeker2-build.py', prefix.bin)
        install_tree('bs_utils', join_path(prefix.bin, 'bs_utils'))
        install_tree('galaxy', prefix.bin.galaxy)
        install_tree('bs_align', join_path(prefix.bin, 'bs_align'))
