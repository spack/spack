...
class Clfft(CMakePackage):
    ...
    patch(
        "https://github.com/clMathLibraries/clFFT/commit/eea7dbc888367b8dbea602ba539eb1a9cbc118d9.patch",
        sha256="3148d5937077def301b30b913bc2437df869204fca1de4385ccd46e3b98b13aa",
        when="@2.12.2",
    )
