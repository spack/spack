...
class Cmake(Package):
    ...
    version(
        "3.15.6",
        sha256="3fa17992ac97d3fc856ffba5d3b10578744ea5b4736818f01e6067f0253b2db5",
    )
    version(
        "3.15.5",
    ...
    version(
        "3.1.0",
        sha256="8bdc3fa3f2da81bc10c772a6b64cc9052acc2901d42e1e1b2588b40df224aad9",
    )
    version(
        "3.0.2",
    ...
    variant(
        "openssl",
        default=True,
        description="Enable openssl for curl bootstrapped by CMake when using +ownlibs",
    )
    ...
    def bootstrap_args(self):
        spec = self.spec
        args = ["--prefix={0}".format(self.prefix), "--parallel={0}".format(make_jobs)]
