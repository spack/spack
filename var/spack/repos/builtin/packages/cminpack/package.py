...
class Cminpack(CMakePackage):
    ...
    version('develop', branch='master', git='https://github.com/devernay/cminpack.git')
    ...
    # Backport a pull request for correctly linking cblas.
    patch('link_with_cblas_pr_21.patch', when='@:1.3.6')
