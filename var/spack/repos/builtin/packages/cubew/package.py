...
class Cubew(AutotoolsPackage):
    ...
    version(
        "4.6", sha256="99fe58ce7ab13061ebfbc360aedaecc28099a30636c5269a42c0cbaf57149aa8"
    )
    version(
        "4.5", sha256="16bd8fd864197a74ca65f7325761ad75d73d555072326e95e1338cff39f28a5c"
    )
    version(
        "4.4.3",
    ...
    version(
        "4.4", sha256="b1d6fecb546bc645ced430ea3fc166e85835f3b997d4e5f0dece71919fc95a99"
    )
    ...
    def url_for_version(self, version):
        url = (
            "http://apps.fz-juelich.de/scalasca/releases/cube/{0}/dist/cubew-{1}.tar.gz"
        )
