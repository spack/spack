...
class Cudnn(Package):
    ...
    version('7.5.1-10.1-x64', '24017f4a56159d48fd5a31c8a930167b',
    ...
    version('7.5.1-10.0-x64', '703ed4be4d242ff4bc0ca48aaf2029bc',
    ...
    depends_on('cuda@10:', when='@7.5-10.0-ppc64le,7.5-10.0-x64,7.5.1-10.0-ppc64le,7.5.1-10.0-x64')
    depends_on('cuda@10.1:', when='@7.5-10.1-ppc64le,7.5-10.1-x64,7.5.1-10.1-ppc64le,7.5.1-10.1-x64')
