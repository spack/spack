...
class Damask(BundlePackage):
    ...
    depends_on("damask-grid@3.0.0-alpha7", type="run", when="@3.0.0-alpha7")
    depends_on("damask-mesh@3.0.0-alpha7", type="run", when="@3.0.0-alpha7")
    depends_on("py-damask@3.0.0-alpha7", type="run", when="@3.0.0-alpha7")

    depends_on("damask-grid@3.0.0-alpha6", type="run", when="@3.0.0-alpha6")
    depends_on("damask-mesh@3.0.0-alpha6", type="run", when="@3.0.0-alpha6")
    depends_on("py-damask@3.0.0-alpha6", type="run", when="@3.0.0-alpha6")

    depends_on("damask-grid@3.0.0-alpha5", type="run", when="@3.0.0-alpha5")
    depends_on("damask-mesh@3.0.0-alpha5", type="run", when="@3.0.0-alpha5")
    depends_on("py-damask@3.0.0-alpha5", type="run", when="@3.0.0-alpha5")

    depends_on("damask-grid@3.0.0-alpha4", type="run", when="@3.0.0-alpha4")
    depends_on("damask-mesh@3.0.0-alpha4", type="run", when="@3.0.0-alpha4")
    depends_on("py-damask@3.0.0-alpha4", type="run", when="@3.0.0-alpha4")
