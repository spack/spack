...
class DarshanRuntime(AutotoolsPackage):
    ...
    depends_on("autoconf", when="@3.4.0:", type="build")
    depends_on("automake", when="@3.4.0:", type="build")
    depends_on("libtool", when="@3.4.0:", type="build")
    depends_on("m4", when="@3.4.0:", type="build")
