...
class Draco(CMakePackage):
    ...
    depends_on("cmake@3.11:", type="build", when="@7.0.0:7.1")
    depends_on("cmake@3.14:", type="build", when="@7.2.0:7.6")
    depends_on("cmake@3.17:", type="build", when="@7.7:")
    depends_on("cmake@3.18:", type="build", when="@7.9:")
    ...
    depends_on("python@2.7:", type=("build", "run", "test"), when="@:7.6")
    depends_on("python@3.5:", type=("build", "run", "test"), when="@7.7.0:")
    ...
    depends_on("qt", type=("build", "link", "run"), when="+qt")
    depends_on("superlu-dist@:5", when="@:7.6+superlu_dist")
    depends_on("py-matplotlib", type=("run"), when="+pythontools")
