...
class Espresso(Package):
    ...
    variant('qmcpackconv', default=False, description='Build for qmcpack use')
    ...
    depends_on('hdf5~mpi', when='+qmcpackconv~mpi')
    patch('https://raw.githubusercontent.com/QMCPACK/qmcpack/develop/external_codes/quantum_espresso/add_pw2qmcpack_to_espresso-5.3.0.diff',
          when='@5.3.0+qmcpackconv',md5='ae395964e4d124f5eef48a53001513a0')
