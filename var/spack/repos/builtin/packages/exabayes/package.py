...
class Exabayes(AutotoolsPackage):
    ...
    url = (
        "https://sco.h-its.org/exelixis/resource/download/software/exabayes-1.5.tar.gz"
    )
    ...
    version(
        "1.5", sha256="e401f1b4645e67e8879d296807131d0ab79bba81a1cd5afea14d7c3838b095a2"
    )
