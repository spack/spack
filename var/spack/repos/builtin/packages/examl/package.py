...
class Examl(MakefilePackage):
    ...
    version(
        "3.0.21",
        sha256="6c7e6c5d7bf4ab5cfbac5cc0d577885272a803c142e06b531693a6a589102e2e",
    )
    version(
        "3.0.20",
        sha256="023681248bbc7f19821b509948d79301e46bbf275aa90bf12e9f4879639a023b",
    )
    version(
        "3.0.19",
        sha256="3814230bf7578b8396731dc87ce665d0b1a671d8effd571f924c5b7936ae1c9e",
    )
    version(
        "3.0.18",
        sha256="1bacb5124d943d921e7beae52b7062626d0ce3cf2f83e3aa3acf6ea26cf9cd87",
    )
    version(
        "3.0.17",
    ...
    version(
        "3.0.16",
        sha256="abc922994332d40892e30f077e4644db08cd59662da8e2a9197d1bd8bcb9aa5f",
    )
    version(
        "3.0.15",
        sha256="da5e66a63d6fa34b640535c359d8daf67f23bd2fcc958ac604551082567906b0",
    )
    version(
        "3.0.14",
    ...
    version(
        "3.0.13",
        sha256="893aecb5545798235a17975aa07268693d3526d0aee0ed59a2d6e791248791ed",
    )
