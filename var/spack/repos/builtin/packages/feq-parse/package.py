...
class FeqParse(CMakePackage):
    ...
    url = "https://github.com/FluidNumerics/feq-parse/archive/v2.0.0.tar.gz"

    maintainers("fluidnumerics-joe")

    version("2.0.0", sha256="f2dacad7ec8735abf61ee3e3969f105428de6f4fe85b2ac3849c801b077abe60")
