...
class Ffmpeg(AutotoolsPackage):
    ...
    depends_on("pkg-config", when="+X", type="build")
    depends_on("pkg-config", when="+drawtext", type="build")
    depends_on("pkg-config", when="+libaom", type="build")
    depends_on("pkg-config", when="+libopenjpeg", type="build")
    depends_on("pkg-config", when="+libopus", type="build")
    depends_on("pkg-config", when="+libspeex", type="build")
    depends_on("pkg-config", when="+libssh", type="build")
    depends_on("pkg-config", when="+libvorbis", type="build")
    depends_on("pkg-config", when="+libwebp", type="build")
    depends_on("pkg-config", when="+libx264", type="build")
    depends_on("pkg-config", when="+libxml2", type="build")
    depends_on("pkg-config", when="+libzmq", type="build")
    depends_on("pkg-config", when="+openssl", type="build")
