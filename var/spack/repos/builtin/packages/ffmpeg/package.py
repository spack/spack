...
class Ffmpeg(AutotoolsPackage):
    ...
    depends_on("pkgconfig", when="+X", type="build")
    depends_on("pkgconfig", when="+drawtext", type="build")
    depends_on("pkgconfig", when="+libaom", type="build")
    depends_on("pkgconfig", when="+libopenjpeg", type="build")
    depends_on("pkgconfig", when="+libopus", type="build")
    depends_on("pkgconfig", when="+libspeex", type="build")
    depends_on("pkgconfig", when="+libssh", type="build")
    depends_on("pkgconfig", when="+libvorbis", type="build")
    depends_on("pkgconfig", when="+libwebp", type="build")
    depends_on("pkgconfig", when="+libx264", type="build")
    depends_on("pkgconfig", when="+libxml2", type="build")
    depends_on("pkgconfig", when="+libzmq", type="build")
    depends_on("pkgconfig", when="+openssl", type="build")
