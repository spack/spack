...
class Flatbuffers(CMakePackage):
    ...
    patch('https://raw.githubusercontent.com/Flamefire/easybuild-easyconfigs/72ba2a1a0d44fbd96ded9f279373ef804bdf3903' \
          '/easybuild/easyconfigs/f/flatbuffers/flatbuffers-1.12.0_replace-usage-of-memset.patch',
    ...
    # Possibly affects earlier releases but I haven't tried does patch apply there smoothly.
    patch('https://patch-diff.githubusercontent.com/raw/google/flatbuffers/pull/6020.patch'
