...
class G4emlow(Package):
    ...
    version(
        "8.0", sha256="d919a8e5838688257b9248a613910eb2a7633059e030c8b50c0a2c2ad9fd2b3b"
    )
    version(
        "7.13",
    ...
    version(
        "7.9", sha256="4abf9aa6cda91e4612676ce4d2d8a73b91184533aa66f9aad19a53a8c4dc3aff"
    )
    version(
    ...
    def install(self, spec, prefix):
        ...
        install_path = join_path(
            prefix.share, "data", "G4EMLOW{0}".format(self.version)
        )
        install_tree(self.stage.source_path, install_path)

    def setup_dependent_run_environment(self, env, dependent_spec):
        install_path = join_path(
            self.prefix.share, "data", "G4EMLOW{0}".format(self.version)
        )
    ...
    def url_for_version(self, version):
        ...
        return (
            "https://geant4-data.web.cern.ch/geant4-data/datasets/G4EMLOW.%s.tar.gz"
            % version
        )
