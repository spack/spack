...
class G4incl(Package):
    ...
    version(
        "1.0", sha256="716161821ae9f3d0565fbf3c2cf34f4e02e3e519eb419a82236eef22c2c4367d"
    )
    ...
    def setup_dependent_run_environment(self, env, dependent_spec):
        install_path = join_path(
            self.prefix.share, "data", "G4INCL{0}".format(self.version)
        )
    ...
    def url_for_version(self, version):
        ...
        return (
            "http://geant4-data.web.cern.ch/geant4-data/datasets/G4INCL.%s.tar.gz"
            % version
        )
