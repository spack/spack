...
class G4ndl(Package):
    ...
    version(
        "4.6", sha256="9d287cf2ae0fb887a2adce801ee74fb9be21b0d166dab49bcbee9408a5145408"
    )
    version(
    ...
    def setup_dependent_run_environment(self, env, dependent_spec):
        install_path = join_path(
            self.prefix.share, "data", "G4NDL{0}".format(self.version)
        )
    ...
    def url_for_version(self, version):
        ...
        return (
            "http://geant4-data.web.cern.ch/geant4-data/datasets/G4NDL.%s.tar.gz"
            % version
        )
