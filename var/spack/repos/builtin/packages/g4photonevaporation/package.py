...
class G4photonevaporation(Package):
    ...
    version(
        "5.7", sha256="761e42e56ffdde3d9839f9f9d8102607c6b4c0329151ee518206f4ee9e77e7e5"
    )
    version(
        "5.5", sha256="5995dda126c18bd7f68861efde87b4af438c329ecbe849572031ceed8f5e76d7"
    )
    version(
        "5.3", sha256="d47ababc8cbe548065ef644e9bd88266869e75e2f9e577ebc36bc55bf7a92ec8"
    )
    version(
        "5.2", sha256="83607f8d36827b2a7fca19c9c336caffbebf61a359d0ef7cee44a8bcf3fc2d1f"
    )
    version(
        "4.3.2",
    ...
    def install(self, spec, prefix):
        ...
        install_path = join_path(
            prefix.share, "data", "PhotonEvaporation{0}".format(self.version)
        )
