...
class Ga(AutotoolsPackage):
    ...
    variant('bytes', values=('4', '8'), default='8', description='Number of bytes for Integer type')
    ...
    variant('armci', values=('mpi-ts', 'mpi-pr', 'mpi3', 'openib', 'ofi'), default='mpi-ts', description='ARMCI runtime')
