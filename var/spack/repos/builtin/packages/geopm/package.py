...
class Geopm(AutotoolsPackage):
    ...
    depends_on("py-cycler@0.10.0:", type=("build", "run"), when="@1.0.0:")
    depends_on("py-pandas@0.22.0:", type=("build", "run"))
    depends_on("py-tables@3.4.3:", type=("build", "run"), when="@1.0.0:")
    depends_on("py-cffi@1.6.0:", type=("build", "run"), when="@1.1.0:")
    depends_on("py-pyyaml@5.1.0:", type=("build", "run"), when="@1.1.0:")
    depends_on("py-mock@3.0.0:", type=("build", "run"), when="@1.1.0:")
    depends_on("py-future@0.17.1:", type=("build", "run"), when="@1.1.0:")
    depends_on("py-numpy@1.14.3:", type=("build", "run"))
    depends_on("py-setuptools@39.2.0:", type="build", when="@1.0.0:")
    depends_on("py-natsort@5.3.2:", type=("build", "run"))
    depends_on("py-psutil@5.4.8:", type=("build", "run"), when="@1.0.0:")
    depends_on("py-pylint@1.9.5:", type=("build", "run"), when="@1.1.0:")
    depends_on("py-matplotlib@2.2.3", type=("build", "run"), when="@:1.0.0-rc2")
    depends_on("py-matplotlib@2.2.3:", type=("build", "run"), when="@1.1.0:")
