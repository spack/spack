...
class Geos(CMakePackage):
    ...
    version(
        "3.4.3",
        sha256="cfbf68079117c1c2b76411636444ff41d73c31093c4cab9dcc9a8c1bbe7e3897",
    )
    version(
        "3.4.2",
    ...
    version(
        "3.4.1",
        sha256="d07ac375f3edd12425d6ce5a96db9739d5ff358cbdf60c6804f7a9e565af8ff2",
    )
    version(
        "3.4.0",
        sha256="3b2106d9baeede39d70e22672598d40cb63ee901f54436c774b250726d7bbdd5",
    )
    version(
        "3.3.9",
    ...
    version(
        "3.3.7",
        sha256="fd01c21b54a3c48cac3e7885f26d4ca10ea9944238776b8ce03489e5e45c592b",
    )
    version(
        "3.3.6",
        sha256="7ee6c1da9a1b87a3e29209e7cddbf19d36f9689d8e44fec2c9bcf6a1b1be3898",
    )
    version(
        "3.3.5",
        sha256="3b513fbe2d155364d61e76d9c250d6d8e75b5166783a233596c744373cb5874f",
    )
    version(
        "3.3.4",
        sha256="cd5400aa5f3fe32246dfed5d238c5017e1808162c865c016480b3e6c07271904",
    )
    version(
        "3.3.3",
        sha256="dfcf4bd70ab212a5b7bad21d01b84748f101a545092b56dafdc3882ef3bddec9",
    )
    ...
    patch(
        "https://patch-diff.githubusercontent.com/raw/libgeos/geos/pull/461.patch",
