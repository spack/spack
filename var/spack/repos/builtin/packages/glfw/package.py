...
class Glfw(CMakePackage):
    ...
    version(
        "3.3", sha256="81bf5fde487676a8af55cb317830703086bb534c53968d71936e7b48ee5a0f3e"
    )
    version(
        "3.2.1",
    ...
    version(
        "3.2", sha256="cb3aab46757981a39ae108e5207a1ecc4378e68949433a2b040ce2e17d8f6aa6"
    )
    version(
        "3.1.2",
    ...
    version(
        "3.1.1",
        sha256="4de311ec9bf43bfdc8423ddf93b91dc54dc73dcfbedfb0991b6fbb3a9baf245f",
    )
    version(
        "3.1", sha256="2140f4c532e7ce4c84cb7e4c419d0979d5954fa1ce204b7646491bd2cc5bf308"
    )
    version(
        "3.0.4",
        sha256="a4e7c57db2086803de4fc853bd472ff8b6d2639b9aa16e6ac6b19ffb53958caf",
    )
    version(
        "3.0.3",
        sha256="7a182047ba6b1fdcda778b79aac249bb2328b6d141188cb5df29560715d01693",
    )
