...
class Gptune(CMakePackage):
    ...
    depends_on("superlu-dist@develop", type=("build", "run"), when="+superlu")
    depends_on("hypre+gptune@2.19.0", type=("build", "run"), when="+hypre")

    depends_on("openmpi@4:", type=("build", "run"), when="+mpispawn")
