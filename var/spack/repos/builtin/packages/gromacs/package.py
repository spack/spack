...
class Gromacs(CMakePackage):
    ...
    depends_on('plumed@2.7.1~mpi', when='@2020.5+plumed~mpi')
    depends_on('plumed@2.6.2:2.6.99,2.7.0+mpi', when='@2020.4+plumed+mpi')
    depends_on('plumed@2.6.2:2.6.99,2.7.0~mpi', when='@2020.4+plumed~mpi')
    depends_on('plumed@2.6.1+mpi', when='@2020.2+plumed+mpi')
    depends_on('plumed@2.6.1~mpi', when='@2020.2+plumed~mpi')
    depends_on('plumed@2.6.1:2.6.99,2.7.0:2.7.1+mpi', when='@2019.6+plumed+mpi')
    depends_on('plumed@2.6.1:2.6.99,2.7.0:2.7.1~mpi', when='@2019.6+plumed~mpi')
    depends_on('plumed@2.5.3:2.5.99,2.6.0+mpi', when='@2019.4+plumed+mpi')
    depends_on('plumed@2.5.3:2.5.99,2.6.0~mpi', when='@2019.4+plumed~mpi')
    depends_on('plumed@2.5.2+mpi', when='@2019.2+plumed+mpi')
    depends_on('plumed@2.5.2~mpi', when='@2019.2+plumed~mpi')
    depends_on('plumed@2.5.3:2.5.99,2.6.0:2.6.99+mpi', when='@2018.8+plumed+mpi')
    depends_on('plumed@2.5.3:2.5.99,2.6.0:2.6.99~mpi', when='@2018.8+plumed~mpi')
