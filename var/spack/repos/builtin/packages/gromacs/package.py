...
class Gromacs(CMakePackage, CudaPackage):
    ...
    depends_on("cmake@3.4.3:3", when="@2018:", type="build")
    depends_on("cmake@3.9.6:3", when="@2020", type="build")
    depends_on("cmake@3.13.0:3", when="@2021", type="build")
    depends_on("cmake@3.16.3:3", when="@2022:", type="build")
    depends_on("cmake@3.18.4:3", when="@main", type="build")
    depends_on("cmake@3.16.0:3", when="%fj", type="build")
