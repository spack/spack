...
class Guile(AutotoolsPackage, GNUMirrorPackage):
    ...
    version(
        "2.2.5",
        sha256="c3c7a2f6ae0d8321a240c7ebc532a1d47af8c63214157a73789e2b2305b4c927",
    )
    version(
        "2.2.4",
    ...
    version(
        "2.2.1",
        sha256="f004b2a5e98017df80cd419773f12a77cfc7ba6069195f97d6702e3d6e487a14",
    )
    version(
        "2.2.0",
        sha256="ef1e9544631f18029b113911350bffd5064955c208a975bfe0d27a4003d6d86b",
    )
    version(
        "2.0.14",
