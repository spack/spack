...
class Heffte(CMakePackage, CudaPackage, ROCmPackage):
    ...
    version(
        "2.2.0",
        sha256="aff4f5111d3d05b269a1378bb201271c40b39e9c960c05c4ef247a31a039be58",
    )
    version(
        "2.1.0",
        sha256="527a3e21115231715a0342afdfaf6a8878d2dd0f02f03c92b53692340fd940b9",
    )
    version(
        "2.0.0",
    ...
    variant(
        "magma",
        default=False,
        description="Use helper methods from the UTK MAGMA library",
    )
