...
class Heffte(CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant("oneapi", default=False, description="Builds with support for oneAPI backend")
    ...
    depends_on("intel-oneapi-mkl@2023.2.0:", when="+oneapi", type=("build", "run"))
    depends_on("intel-oneapi-mpi@2021.10.0:", when="+oneapi", type=("build", "run"))
    ...
    def cmake_args(self):
        args = [
            ...
            self.define_from_variant("Heffte_ENABLE_ONEAPI", "oneapi"),
