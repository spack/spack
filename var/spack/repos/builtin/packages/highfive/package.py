...
class Highfive(CMakePackage):
    ...
    def url_for_version(self, version):
        if version != Version('1.5'):
            return "https://github.com/BlueBrain/HighFive/archive/v{0}.tar.gz".format(version.dotted)
        else:
            return "https://github.com/BlueBrain/HighFive/archive/{0}.tar.gz".format(version.dotted)
