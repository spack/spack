...
class Hip(CMakePackage):
    ...
    version("5.4.4", sha256="3a1fafeb549fe9a28722ed60ce305391c2ca8decda0848f32d8ca03fda0f30a5")
    ...
    with when("+rocm"):
        ...
        for ver in ["5.4.0", "5.4.3", "5.4.4", "5.5.0", "5.5.1", "5.6.0"]:
    ...
    for d_version, d_shasum in [
        ("5.6.0", "a35b4a557ba8349323434ebfd8c46c5e9ecc0dfe28ec54e8d945f3e7b5c3b648"),
        ...
        ("5.4.4", "c5e591513804a81e8757fd7d193abed50be89a590e0581603e01295f2b7594a2"),
    ...
    for d_version, d_shasum in [
        ...
        ("5.4.4", "a13b77900f9e972d1244404d05af7d0700741910ebe1453db39db123bf6b3dca"),
    ...
    for d_version, d_shasum in [
        ...
        ("5.4.4", "11e094e7df74e730b87811f84ec967c5cb2dddf2643e34cf16c0ac71444244d4"),
