...
class Hiredis(MakefilePackage, CMakePackage):
    ...
    depends_on("cmake@3.18:", when="build_system=cmake", type="build")
    depends_on("openssl@1.1:", when="+ssl", type=("build", "link"))
    depends_on("openssl@1.1:", when="+test_ssl", type=("build", "link"))
