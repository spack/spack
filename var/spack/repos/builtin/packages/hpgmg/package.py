...
class Hpgmg(Package):
    ...
    version(
        "0.4", sha256="abdabfe09453487299500b5bd8da4e6dc3d88477199bcfa38ac41d0b3c780f6f"
    )
    version(
        "a0a5510df23b",
    ...
    version(
        "0.3", sha256="12a65da216fec91daea78594ae4b5a069c8f1a700f1ba21eed9f45a79a68c793"
    )
