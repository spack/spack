...
class Httpie(PythonPackage):
    ...
    depends_on("py-charset-normalizer@2:", type=("build", "run"), when="@2.6:")
    ...
    depends_on("py-multidict@4.7.0:", type=("build", "run"), when="@3.2.1:")
    depends_on("py-setuptools", type=("build", "run"))
    depends_on("py-importlib-metadata@1.4.0:", type=("build", "run"), when="@3: ^python@:3.7")
    depends_on("py-rich@9.10.0:", type=("build", "run"), when="@3.2.1:")
    depends_on("py-colorama@0.2.4:", type=("build", "run"), when="platform=windows")
