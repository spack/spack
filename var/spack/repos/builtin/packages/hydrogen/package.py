...
class Hydrogen(CMakePackage, CudaPackage, ROCmPackage):
    ...
    version(
        "1.5.1",
        sha256="447da564278f98366906d561d9c8bc4d31678c56d761679c2ff3e59ee7a2895c",
    )
    version(
        "1.5.0",
        sha256="03dd487fb23b9fdbc715554a8ea48c3196a1021502e61b0172ef3fdfbee75180",
    )
    version(
        "1.4.0",
        sha256="c13374ff4a6c4d1076e47ba8c8d91a7082588b9958d1ed89cffb12f1d2e1452e",
    )
    version(
        "1.3.4",
        sha256="7979f6656f698f0bbad6798b39d4b569835b3013ff548d98089fce7c283c6741",
    )
    version(
        "1.3.3",
        sha256="a51a1cfd40ac74d10923dfce35c2c04a3082477683f6b35e7b558ea9f4bb6d51",
    )
    version(
        "1.3.2",
        sha256="50bc5e87955f8130003d04dfd9dcad63107e92b82704f8107baf95b0ccf98ed6",
    )
    version(
        "1.3.1",
        sha256="a8b8521458e9e747f2b24af87c4c2749a06e500019c383e0cefb33e5df6aaa1d",
    )
    version(
        "1.3.0",
        sha256="0f3006aa1d8235ecdd621e7344c99f56651c6836c2e1bc0cf006331b70126b36",
    )
    version(
        "1.2.0",
        sha256="8545975139582ee7bfe5d00f8d83a8697afc285bf7026b0761e9943355974806",
    )
    version(
        "1.1.0-1",
        sha256="73ce05e4166853a186469269cb00a454de71e126b2019f95bbae703b65606808",
    )
    version(
        "1.1.0",
        sha256="b4c12913acd01c72d31f4522266bfeb8df1d4d3b4aef02e07ccbc9a477894e71",
    )
    version(
        "1.0.1",
    ...
    def cmake_args(self):
        ...
        if "blas=openblas" in spec:
            ...
            args.extend(["-DHydrogen_USE_ESSL:BOOL=%s" % ("blas=essl" in spec)])
