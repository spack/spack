...
class Icedtea(AutotoolsPackage):
    ...
    depends_on("libx11", type="build", when="~X")
    depends_on("xproto", type="build", when="~X")
    depends_on("libxext", type="build", when="~X")
    depends_on("libxtst", type="build", when="~X")
    depends_on("libxi", type="build", when="~X")
    depends_on("libxt", type="build", when="~X")
    depends_on("libxinerama", type="build", when="~X")
    depends_on("libxrender", type="build", when="~X")
    depends_on("libxcomposite", type="build", when="~X")
    depends_on("libxau", type="build", when="~X")
    depends_on("libxdmcp", type="build", when="~X")
    depends_on("gtkplus", type="build", when="~X")
