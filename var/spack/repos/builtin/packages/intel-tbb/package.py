...
class IntelTbb(Package):
    ...
    patch("tbb_gcc_rtm_key.patch", level=0, when='@2019 %gcc@4.8.0:4.99999 os=rhel6')
    patch("tbb_gcc_rtm_key.patch", level=0, when='@2019 %gcc@4.8.0:4.99999 os=scientific6')
    patch("tbb_gcc_rtm_key.patch", level=0, when='@2019 %gcc@4.8.0:4.99999 os=centos6')
    patch("tbb_gcc_rtm_key.patch", level=0, when='@:2018 %gcc@4.8.0:4.99999 os=rhel6')
    patch("tbb_gcc_rtm_key.patch", level=0, when='@:2018 %gcc@4.8.0:4.99999 os=scientific6')
    patch("tbb_gcc_rtm_key.patch", level=0, when='@:2018 %gcc@4.8.0:4.99999 os=centos6')
