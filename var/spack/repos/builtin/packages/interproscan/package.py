...
class Interproscan(Package):
    ...
    depends_on("python@3:", type=("build", "run"), when="@5:")
    depends_on("perl-cgi", type=("build", "run"), when="@:4.8")
    depends_on("perl-mailtools", type=("build", "run"), when="@:4.8")
    depends_on("perl-xml-quote", type=("build", "run"), when="@:4.8")
    depends_on("perl-xml-parser", type=("build", "run"), when="@:4.8")
    depends_on("perl-io-string", type=("build", "run"), when="@:4.8")
    depends_on("perl-io-stringy", type=("build", "run"), when="@:4.8")
    depends_on("perl-db-file", type=("build", "run"), when="@:4.8")
