...
class Jube(PythonPackage):
    ...
    variant(
        'resource_manager', default='slurm', description='Select resource manager templates',
    ...
    def setup_environment(self, spack_env, run_env):
        run_env.prepend_path(
            'JUBE_INCLUDE_PATH', prefix + "/platform/" + self.spec.variants['resource_manager'].value
        )
