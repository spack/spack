...
class Lbann(CachedCMakePackage, CudaPackage, ROCmPackage):
    ...
    variant("python", default=True, sticky=True, description="Support for Python extensions (e.g. Data Reader)")
    variant("pfe", default=True, sticky=True, description="Python Frontend for generating and launching models")
