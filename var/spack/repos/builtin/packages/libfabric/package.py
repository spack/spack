...
class Libfabric(AutotoolsPackage):
    ...
    version(
        "1.13.1",
        sha256="8e6eed38c4a39aa4cbf7d5d3734f0eecbfc030182f1f9b3be470702f2586d30e",
    )
    version(
        "1.12.1",
    ...
    patch(
        "https://github.com/ofiwg/libfabric/commit/2e95b0efd85fa8a3d814128e34ec57ffd357460e.patch",
