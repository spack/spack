...
class Libfuse(MesonPackage):
    ...
    patch(
        "https://github.com/libfuse/libfuse/commit/6d55007027dfe7b75a74899f497f075046cc5404.patch",
        sha256="d8c54ae932f2e7179dd05081a4a8e7aefd23553a0ef354fa25b1456386d96932",
        when="@:2",
    )
    patch(
        "https://github.com/libfuse/libfuse/commit/5d38afc8a5b4a2a6e27aad7a1840046e99cd826d.patch",
        sha256="7f3e8e54966aca8cb64096bea2cbd4d2679b47f9c1355fe9d442ba8464d74372",
        when="@:2",
    )
    # https://bugs.gentoo.org/803923
    patch(
        "https://github.com/libfuse/libfuse/commit/5a43d0f724c56f8836f3f92411e0de1b5f82db32.patch",
        sha256="1e8b0a1b2bbaa335d92a3c46e31c928dcd53abe011214a0cbbfa7c11a3a68f1a",
        when="@:2",
    )
