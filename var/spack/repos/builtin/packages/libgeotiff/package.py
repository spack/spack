...
class Libgeotiff(AutotoolsPackage):
    ...
    patch(
        "https://github.com/OSGeo/libgeotiff/commit/7cb9b68ea72fb2a6023bb98796fd3ba6dc7b64a1.patch",
        sha256="9485efc0a62a02207d34ac0c4d22e421c975b6ce85397c5e557c0105a232aaa3",
        level=2,
        when="@1.5.0:1.5.1",
    )
    patch(
        "https://github.com/OSGeo/libgeotiff/commit/4b41ca6ce332f0c21504c2da3da850275d9da5ae.patch",
