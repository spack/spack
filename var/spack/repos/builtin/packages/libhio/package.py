...
class Libhio(AutotoolsPackage):
    ...
    url      = "https://github.com/hpc/libhio/releases/download/1.4.1.5/libhio-1.4.1.5.tar.bz2"
    ...
    version('1.4.1.5', sha256='af5cb2a799a8470ed95847c3b07ea3ad61f8f7d5a2b79c52a46ca784846e8962', url="https://github.com/hpc/libhio/releases/download/1.4.1.5/libhio-1.4.1.5.tar.bz2")
