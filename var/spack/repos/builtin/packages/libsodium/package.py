...
class Libsodium(AutotoolsPackage):
    ...
    version('1.0.12', md5='c308e3faa724b630b86cc0aaf887a5d4')
    version('1.0.11', md5='b58928d035064b2a46fb564937b83540')
    version('1.0.10', md5='ea89dcbbda0b2b6ff6a1c476231870dd')
