...
class Libxc(AutotoolsPackage, CudaPackage):
    ...
    version(
        "5.1.7",
        sha256="1a818fdfe5c5f74270bc8ef0c59064e8feebcd66b8f642c08aecc1e7d125be34",
    )
    version(
        "5.1.5",
        sha256="02e4615a22dc3ec87a23efbd3d9be5bfad2445337140bad1720699571c45c3f9",
    )
    version(
        "5.1.3",
        sha256="0350defdd6c1b165e4cf19995f590eee6e0b9db95a6b221d28cecec40f4e85cd",
    )
    version(
        "5.1.2",
        sha256="180d52b5552921d1fac8a10869dd30708c0fb41dc202a3bbee0e36f43872718a",
    )
    version(
        "5.1.0",
        sha256="f67b6e518372871d9eed6e5dba77c3ab5ea030c229ba7a7d44bcf51f3258373f",
    )
    version(
        "5.0.0",
        sha256="1cdc57930f7b57da4eb9b2c55a50ba1c2c385936ddaf5582fee830994461a892",
    )
    version(
        "4.3.4",
    ...
    version(
        "4.3.2",
        sha256="bc159aea2537521998c7fb1199789e1be71e04c4b7758d58282622e347603a6f",
    )
    version(
        "4.2.3",
    ...
    version(
        "2.2.1",
        sha256="ade61c1fa4ed238edd56408fd8ee6c2e305a3d5753e160017e2a71817c98fd00",
    )
