...
class Libxsmm(MakefilePackage):
    ...
    version(
        "1.16.2",
        sha256="bdc7554b56b9e0a380fc9c7b4f4394b41be863344858bc633bc9c25835c4c64e",
    )
    version(
        "1.16.1",
    ...
    version(
        "1.16",
        sha256="4f4f2ad97815413af80821d2e306eb6f00541941ad412662da05c02361a20e07",
    )
    version(
        "1.15",
    ...
    version(
        "1.12.1",
        sha256="3687fb98da00ba92cd50b5f0d18b39912c7886dad3856843573aee0cb34e9791",
    )
    version(
        "1.12",
        sha256="37432fae4404ca12d8c5a205bfec7f9326c2d607d9ec37680f42dae60b52382a",
    )
    version(
        "1.11",
    ...
    version(
        "1.10",
        sha256="2904f7983719fd5c5af081121c1d028d45b10b854aec9a9e67996a0602631abc",
    )
    version(
        "1.9", sha256="cd8532021352b4a0290d209f7f9bfd7c2411e08286a893af3577a43457287bfa"
    )
    version(
        "1.8.3",
        sha256="08ed4a67731d07c739fa83c426a06a5a8fe576bc273da4bab84eb0d1f4405011",
    )
    version(
        "1.8.2",
        sha256="252ab73e437f5fcc87268df1ac130ffe6eb41e4281d9d3a3eaa7d591a85a612f",
    )
    version(
        "1.8.1",
    ...
    version(
        "1.8", sha256="0330201afb5525d0950ec861fec9dd75eb40a03845ebe03d2c635cf8bfc14fea"
    )
    version(
        "1.7.1",
    ...
    version(
        "1.7", sha256="2eea65624a697e74b939511cd2a686b4c957e90c99be168fe134d96771e811ad"
    )
    version(
        "1.6.6",
    ...
    version(
        "1.6.3",
        sha256="afad4f75ec5959bc3b18b741f3f16864f699c8b763598d01faf6af029dded48c",
    )
    version(
        "1.6.2",
    ...
    version(
        "1.6", sha256="c2a56f8cdc2ab03a6477ef98dbaa00917674fda59caa2824a1a29f78d2255ba5"
    )
    version(
        "1.5.2",
        sha256="a037b7335932921960d687ef3d49b50ee38a83e0c8ad237bc20d3f4a0523f7d3",
    )
    version(
        "1.5.1",
        sha256="9e2a400e63b6fb2d4954e53536090eb8eb6f0ca25d0f34dd3a4f166802aa3d54",
    )
    version(
        "1.5", sha256="c52568c5e0e8dc9d8fcf869a716d73598e52f71c3d83af5a4c0b3be81403b423"
    )
    version(
        "1.4.4",
        sha256="bf4a0fff05cf721e11cb6cdb74f3d27dd0fa67ccc024055f2d9dd5dbd928c7c0",
    )
    version(
        "1.4.3",
        sha256="5033c33038ba4a75c675387aeb7c86b629e43ffc0a40df0b78e4ed52e4b5bd90",
    )
    version(
        "1.4.2",
        sha256="9c89391635be96759486a245365793bc4593859e6d7957b37c39a29f9b4f95eb",
    )
    version(
        "1.4.1",
        sha256="c19be118694c9b4e9a61ef4205b1e1a7e0c400c07f9bce65ae430d2dc2be5fe1",
    )
    version(
        "1.4", sha256="cf483a370d802bd8800c06a12d14d2b4406a745c8a0b2c8722ccc992d0cd72dd"
    )
    ...
    variant("header-only", default=False, description="With header-only installation")
    variant("generator", default=False, description="With generator executable(s)")
    conflicts(
        "+header-only", when="@:1.6.2", msg="Header-only is available since v1.6.2!"
    )
    ...
    def libs(self):
        result = find_libraries(
            ["libxsmm", "libxsmmf"], root=self.prefix, recursive=True
        )
        if len(result) == 0:
            result = find_libraries(
