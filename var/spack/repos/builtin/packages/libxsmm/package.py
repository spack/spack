...
class Libxsmm(Package):
    ...
    #variant('shared', default=False,
            #description='Build a shared library rather than an archive.')
    ...
    def manual_install(self, prefix):
        ...
        mkdirp(doc_path)
        for doc_file in glob('documentation/*.md'):  install(doc_file, doc_path)
        for doc_file in glob('documentation/*.pdf'): install(doc_file, doc_path)
