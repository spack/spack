...
class Libzmq(AutotoolsPackage):
    ...
    patch(
        "https://github.com/zeromq/libzmq/commit/92b2c38a2c51a1942a380c7ee08147f7b1ca6845.patch",
        sha256="8ebde83ee148989f9118d36ebaf256532627b8a6e7a486842110623331972edb",
