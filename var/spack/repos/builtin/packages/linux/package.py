...
class Linux(MakefilePackage):
    ...
    # depends_on("gcc@5.1:", when="@6.9:")
    # depends_on("make@3.82:", when="@6.9:")
    # depends_on("bash@4.2:", when="@6.9:")
    # depends_on("binutils@2.25:", when="@6.9:")
    # depends_on("flex@2.5.35:", when="@6.9:")
    # depends_on("bison@2.0:", when="@6.9:")
    # depends_on("pahole@1.16:", when="@6.9:")
    # depends_on("util-linux@2.10o:", when="@6.9:")
    # depends_on("kmod@13:", when="@6.9:")
    # depends_on("e2fsprogs@1.41.4:", when="@6.9:")
    # depends_on("jfsutils@1.1.3:", when="@6.9:")
    # depends_on("reiserfsprogs@3.6.3:", when="@6.9:")
    # depends_on("xfsprogs@2.6.0:", when="@6.9:")
    # depends_on("squashfs-tools@4.0", when="@6.9:")
    # depends_on("btfgs-progs@0.18:", when="@6.9:")
    # depends_on("pcmciautils@004:", when="@6.9:")
    # depends_on("quota-tools@3.09:", when="@6.9:")
    # depends_on("PPP@2.4.0:", when="@6.9:")
    # depends_on("nfs-utils@1.0.5:", when="@6.9:")
    # depends_on("procps@3.2.0:", when="@6.9:")
    # depends_on("udev@081:", when="@6.9:")
    # depends_on("grub@0.93:", when="@6.9:")
    # depends_on("mcelog@0.6:", when="@6.9:")
    # depends_on("iptables@1.4.2:", when="@6.9:")
    # depends_on("openssl@1.0.0:", when="@6.9:")
    # depends_on("bc@1.06.95:", when="@6.9:")
    # depends_on("sphinx@2.4.4:", when="@6.9:")
    # depends_on("cpio")
    # depends_on("tar@1.28:", when="@6.10:")
