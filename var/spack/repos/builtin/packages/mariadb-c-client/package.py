...
class MariadbCClient(CMakePackage):
    ...
    version(
        "3.1.4",
        sha256="7a1a72fee00e4c28060f96c3efbbf38aabcbbab17903e82fce85a85002565316",
    )
    version(
        "3.0.9",
    ...
    version(
        "3.0.5",
        sha256="940017f13a13846153eb9d36290824c4615c8a8be4142b6bbaeb698609f02667",
    )
    version(
        "3.0.4",
    ...
    version(
        "2.3.7",
        sha256="94f9582da738809ae1d9f1813185165ec7c8caf9195bdd04e511f6bdcb883f8e",
    )
    version(
        "2.3.6",
        sha256="6b271d25dddda15f1c2328eee64f646a2e8b116ea21b04ece24b5a70712c3e96",
    )
    version(
        "2.3.5",
        sha256="2f3bf4c326d74284debf7099f30cf3615f7978d1ec22b8c1083676688a76746f",
    )
    version(
        "2.3.4",
        sha256="8beb0513da8a24ed2cb47836564c8b57045c3b36f933362f74b3676567c13abc",
    )
    version(
        "2.3.3",
        sha256="82a5710134e7654b9cad58964d6a25ed91b3dc1804ff51e8be2def0032914089",
    )
    version(
        "2.3.2",
    ...
    version(
        "2.3.0",
        sha256="37faae901ca77bd48d2c6286f2e19e8c1abe7cac6fb1b128bd556617f4335c8a",
    )
    version(
        "2.2.3",
        sha256="cd01ce2c418382f90fd0b21c3c756b89643880efe3447507bf740569b9d08eed",
    )
    version(
        "2.2.2",
    ...
    version(
        "2.2.1",
        sha256="c30ba19be03a6ac8688ef7620aed0eabdf34ca9ee886c017c56b013b5f8ee06a",
    )
    version(
        "2.2.0",
        sha256="3825b068d38bc19d6ad1eaecdd74bcd49d6ddd9d00559fb150e4e851a55bbbd4",
    )
    version(
        "2.1.0",
        sha256="568050b89463af7610d458669fd9eee06dcc9405689aca8a526ac8c013b59167",
    )
