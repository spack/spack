...
class Moab(AutotoolsPackage):
    ...
    depends_on("autoconf", when="@master,5.0.1:", type="build")
    depends_on("automake", when="@master,5.0.1:", type="build")
    depends_on("libtool", when="@master,5.0.1:", type="build")
    depends_on("m4", when="@master,5.0.1:", type="build")
    depends_on("blas")
    depends_on("lapack")
