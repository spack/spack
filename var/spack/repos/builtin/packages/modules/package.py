...
class Modules(Package):
    ...
    environment via modulefiles. This is a copy for the `Environment-Modules`
    package, allowing users to experiment with different versions of `modules`
    without breaking spack."""
