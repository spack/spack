...
class Mpich(AutotoolsPackage):
    ...
    version(
        "3.1.3",
        sha256="afb690aa828467721e9d9ab233fe00c68cae2b7b930d744cb5f7f3eb08c8602c",
    )
    version(
        "3.1.2",
...
'-Wl,-flat_namespace'.""",
    ...
    patch(
        "https://github.com/pmodels/mpich/commit/8a851b317ee57366cd15f4f28842063d8eff4483.patch",
    ...
    patch(
        "https://github.com/pmodels/mpich/commit/b324d2de860a7a2848dc38aefb8c7627a72d2003.patch",
    ...
    def determine_variants(cls, exes, version):
        ...
        for exe in exes:
            ...
            compiler_spec = get_spack_compiler_spec(os.path.dirname(match.group(1)))
            if compiler_spec:
