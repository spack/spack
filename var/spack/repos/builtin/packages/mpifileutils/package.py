...
class Mpifileutils(Package):
    ...
    version('0.8.1', md5='acbd5b5c15919a67392509614bb7871e')
    version('0.8', md5='1082600e7ac4e6b2c13d91bbec40cffb')
    version('0.7', md5='c081f7f72c4521dddccdcf9e087c5a2b')
    version('0.6', md5='620bcc4966907481f1b1a965b28fc9bf')
