...
class Mxnet(CMakePackage, CudaPackage, PythonExtension):
    ...
    depends_on("pkgconfig", type="build", when="@1.6.0")
    depends_on("blas")
    ...
    depends_on("py-numpy@1.17:", type=("build", "run"), when="@2.0.0:+python")
    depends_on("py-numpy@1.16.1:1", type=("build", "run"), when="@1.6:1.8.0+python")
    depends_on("py-numpy@1.8.2:1.15.0", type=("build", "run"), when="@1.3.0+python")
    depends_on("py-requests@2.20.0:2", type=("build", "run"), when="@1.6:+python")
    depends_on("py-requests@2.18.4:2.18", type=("build", "run"), when="@1.3.0+python")
    depends_on("py-graphviz@0.8.1:0.8", type=("build", "run"), when="+python")
