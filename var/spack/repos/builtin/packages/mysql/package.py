...
class Mysql(CMakePackage):
    ...
    depends_on("cmake@3.1.0:", when="@5.7.0:5.7 platform=win32", type="build")
    depends_on("cmake@3.8.0:", when="@8.0.0: platform=win32", type="build")
    depends_on("cmake@3.9.2:", when="@8.0.0: platform=darwin", type="build")
    depends_on("cmake@3.4.0:", when="@8.0.0: platform=solaris", type="build")
    depends_on("cmake@2.6:", when="@:5.6", type="build")
    depends_on("cmake@2.8.9:", when="@5.7.0:5.7", type="build")
    depends_on("cmake@2.8.12:", when="@8.0.0:", type="build")

    depends_on("gmake@3.75:", type="build")
    depends_on("pkgconfig", when="@5.7.0:", type="build")
    depends_on("doxygen", when="@8.0.0:", type="build")

    # Each version of MySQL requires a specific version of boost
    # See BOOST_PACKAGE_NAME in cmake/boost.cmake
    # 8.0.29
    depends_on("boost@1.77.0 cxxstd=98", when="@8.0.29 cxxstd=98", type="build")
    depends_on("boost@1.77.0 cxxstd=11", when="@8.0.29 cxxstd=11", type="build")
    depends_on("boost@1.77.0 cxxstd=14", when="@8.0.29 cxxstd=14", type="build")
    depends_on("boost@1.77.0 cxxstd=17", when="@8.0.29 cxxstd=17", type="build")
    # 8.0.19
    depends_on("boost@1.70.0 cxxstd=98", when="@8.0.19 cxxstd=98", type="build")
    depends_on("boost@1.70.0 cxxstd=11", when="@8.0.19 cxxstd=11", type="build")
    depends_on("boost@1.70.0 cxxstd=14", when="@8.0.19 cxxstd=14", type="build")
    depends_on("boost@1.70.0 cxxstd=17", when="@8.0.19 cxxstd=17", type="build")
    # 8.0.16--8.0.18
    depends_on("boost@1.69.0 cxxstd=98", when="@8.0.16:8.0.18 cxxstd=98", type="build")
    depends_on("boost@1.69.0 cxxstd=11", when="@8.0.16:8.0.18 cxxstd=11", type="build")
    depends_on("boost@1.69.0 cxxstd=14", when="@8.0.16:8.0.18 cxxstd=14", type="build")
    depends_on("boost@1.69.0 cxxstd=17", when="@8.0.16:8.0.18 cxxstd=17", type="build")
    # 8.0.14--8.0.15
    depends_on("boost@1.68.0 cxxstd=98", when="@8.0.14:8.0.15 cxxstd=98", type="build")
    depends_on("boost@1.68.0 cxxstd=11", when="@8.0.14:8.0.15 cxxstd=11", type="build")
    depends_on("boost@1.68.0 cxxstd=14", when="@8.0.14:8.0.15 cxxstd=14", type="build")
    depends_on("boost@1.68.0 cxxstd=17", when="@8.0.14:8.0.15 cxxstd=17", type="build")
    # 8.0.12--8.0.13
    depends_on("boost@1.67.0 cxxstd=98", when="@8.0.12:8.0.13 cxxstd=98", type="build")
    depends_on("boost@1.67.0 cxxstd=11", when="@8.0.12:8.0.13 cxxstd=11", type="build")
    depends_on("boost@1.67.0 cxxstd=14", when="@8.0.12:8.0.13 cxxstd=14", type="build")
    depends_on("boost@1.67.0 cxxstd=17", when="@8.0.12:8.0.13 cxxstd=17", type="build")
    # 8.0.11
    depends_on("boost@1.66.0 cxxstd=98", when="@8.0.11 cxxstd=98", type="build")
    depends_on("boost@1.66.0 cxxstd=11", when="@8.0.11 cxxstd=11", type="build")
    depends_on("boost@1.66.0 cxxstd=14", when="@8.0.11 cxxstd=14", type="build")
    depends_on("boost@1.66.0 cxxstd=17", when="@8.0.11 cxxstd=17", type="build")
    # 5.7.X
    ...
    depends_on("m4", when="@develop platform=solaris", type="build")
