...
class Neovim(CMakePackage):
    ...
    depends_on('libuv@1.28:', type='link', when='@0.4:,master,stable')
    depends_on('jemalloc', type='link')
    depends_on('libtermkey', type='link')
    depends_on('libtermkey@0.18:', type='link', when='@0.3.4:,master,stable')
    depends_on('libvterm@0.0.0', type='link', when='@0.2.0:0.3')
    depends_on('libvterm@0.1:', type='link', when='@0.4:,master,stable')
    depends_on('unibilium', type='link')
    depends_on('unibilium@:1.2.0', type='link', when='@0.2.0')
    depends_on('unibilium@2.0:', type='link', when='@0.4:,master,stable')
    depends_on('msgpack-c', type='link')
    depends_on('msgpack-c@1.0.0:', type='link', when='@0.4:,master,stable')
    depends_on('gperf', type='link')
    depends_on('libluv@1.30.0:', type='link', when='@0.4:,master,stable')
