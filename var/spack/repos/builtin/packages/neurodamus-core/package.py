...
class NeurodamusCore(Package):
    ...
    version('develop', git=git, branch='master', get_full_repo=True)
    version('2.8.0', git=git, tag='2.8.0', get_full_repo=True)
    version('2.7.3', git=git, tag='2.7.3', get_full_repo=True)
    version('2.7.2', git=git, tag='2.7.2', get_full_repo=True)
    version('2.7.0', git=git, tag='2.7.0', get_full_repo=True)
    version('2.6.0', git=git, tag='2.6.0', get_full_repo=True)
    version('2.5.0', git=git, tag='2.5.0', get_full_repo=True)
    version('2.4.3', git=git, tag='2.4.3', get_full_repo=True)
    version('2.4.1', git=git, tag='2.4.1', get_full_repo=True)
    version('2.3.4', git=git, tag='2.3.4', get_full_repo=True)
    version('2.3.3', git=git, tag='2.3.3', get_full_repo=True)
    version('2.2.1', git=git, tag='2.2.1', get_full_repo=True)
