...
class NinjaBase(Package):
    ...
    variant("re2c", default=False, description="Enable buidling Ninja with re2c")
    ...
    def determine_version(cls, exe):
        ...
        if "jobserver" in output:
            if cls.name == "ninja":
                return None
        return output.strip()

    def configure(self, spec, prefix):
        if "+use_spack_interpreter" in spec:
            pre_args = list(sys.argv)
            sys.argv = ["configure.py", "--bootstrap"]
    ...
    def setup_dependent_package(self, module, dspec):
        ...
        module.ninja = MakeExecutable(
            ...
            supports_jobserver=self.spec.version == ver("kitware") or self.name == "ninja_fortran",
        )
