...
class NodeJs(Package):
    ...
    depends_on("python@3.6:3.11", type="build", when="@19.1:")
    depends_on("python@3.6:3.10", type="build", when="@16.11:19.0")
    depends_on("python@3.6:3.9", type="build", when="@16.0:16.10")
    depends_on("python@2.7,3.5:3.8", type="build", when="@15")
    depends_on("python@2.7,3.6:3.10", type="build", when="@14.18.2:14")
    depends_on("python@2.7,3.5:3.8", type="build", when="@13.1:14.18.1")
    depends_on("python@2.7,3.5:3.7", type="build", when="@12:13.0")
