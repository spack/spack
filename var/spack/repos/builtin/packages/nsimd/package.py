...
class Nsimd(CMakePackage):
    ...
    depends_on("cmake@3.0.2:", when="@2:", type="build")
    ...
    depends_on("py-chardet", when="@3:", type="build")
    depends_on("py-requests", when="@3:", type="build")
    depends_on("py-urllib3", when="@3:", type="build")
