...
class NvidiaNsightSystems(Package):
    ...
    if arch == "x86_64":
        ...
        version('2024.1.1', sha256='8c98b511df1747c4c782430504ae6fa4b3fce6fa72623083a828fc0a1e11f1b8', url='https://developer.download.nvidia.com/devtools/repos/rhel8/ppc64le/nsight-systems-cli-2024.1.1-2024.1.1.59_3380207-0.ppc64le.rpm', expand=False)
