...
class Omniperf(CMakePackage):
    ...
    url = "https://github.com/ROCm/omniperf/archive/refs/tags/rocm-6.2.0.tar.gz"
    ...
    depends_on("py-astunparse@1.6.2:")
    depends_on("py-colorlover")
    ...
    depends_on("py-dash-svg")
    depends_on("py-dash")
    depends_on("py-dash-bootstrap-components")
