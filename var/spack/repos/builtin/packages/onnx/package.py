...
class Onnx(CMakePackage):
    ...
    version(
        "1.10.1",
        sha256="cb2fe3e0c9bba128a5790a565d81be30f4b5571eaca5418fb19df8d2d0f11ce2",
    )
    version(
        "1.10.0",
        sha256="705a27ee076713b8c755911913c9ffa8f96b95fc3a8568ed0b8e1dd954d67147",
    )
    version(
        "1.9.0",
    ...
    version(
        "1.6.0_2020-02-16", commit="9fdae4c68960a2d44cd1cc871c74a6a9d469fa1f"
    )  # py-torch@1.5
    version(
        "1.6.0_2019-11-06", commit="fea8568cac61a482ed208748fdc0e1a8e47f62f5"
    )  # py-torch@1.4
    version(
        "1.6.0_2019-09-26", commit="034921bd574cc84906b7996c07873454b7dd4135"
    )  # py-torch@1.3
    version(
        "1.5.0_2019-07-25", commit="28ca699b69b5a31892619defca2391044a9a6052"
    )  # py-torch@1.2
    version(
        "1.5.0_2019-04-25", commit="22662bfd4dcc6baebf29e3b823a051676f991001"
    )  # py-torch@1.1
    version(
        "1.3.0_2018-12-04", commit="42804705bdbf179d1a98394008417e1392013547"
    )  # py-torch@1.0
    version(
