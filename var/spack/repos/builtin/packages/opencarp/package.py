...
class Opencarp(CMakePackage):
    ...
    version("test", commit="6a8e1c09d34ffc1abf418e2148a10e5b12a88213", submodules=False, no_cache=True, preferred=True)
    ...
    for ver in ["test", "15.0", "13.0", "12.0", "11.0", "10.0", "9.0", "8.2", "8.1", "7.0"]:
