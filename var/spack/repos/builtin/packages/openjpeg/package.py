...
class Openjpeg(CMakePackage):
    ...
    version(
        "2.0.1",
        sha256="f184d402a218359184fd162075bb5246a68165b9776678185b6a379c49093816",
    )
    version(
        "2.0.0",
        sha256="5480f801a9f88af1a456145e41f3adede1dfae425bbac66a19c7eeeba94a1249",
    )
    version(
        "1.5.2",
    ...
    version(
        "1.5.1",
        sha256="6a42fcc23cb179f69a1e94429089e5a5926aee1ffe582a0a6bd91299d297e61a",
    )
    ...
    def libs(self):
        return find_libraries(
            "libopenjp{0}".format(self.version.up_to(1)),
            root=self.prefix,
            recursive=True,
        )
