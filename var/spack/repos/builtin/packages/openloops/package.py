...
class Openloops(Package):
    ...
    all_processes = ['tbln', 'tbln_ew', 'tbqq', 'tbw', 'pptttt', 'pptttt_ew', 'pptt', 'pptt_ew', 'ppttbb', 'ppttj',
                     'ppttj_ew', 'ppttjj', 'pptaj', 'pptajj', 'pptllj', 'pptlljj', 'pptln', 'pptw', 'pptwj', 'pptzj',
                     'pptzjj', 'ppthj', 'ppthjj', 'pptj', 'pptjj', 'ppjj', 'ppjj_ew', 'ppjjj', 'ppjjj_ew', 'ppjjj_nf5',
                     'ppjjjj', 'pplllvvv_ew', 'ppatt', 'ppatt_ew', 'ppattj', 'pplltt', 'pplltt_ew', 'ppllttj',
                     'ppllttj_ew', 'pplntt', 'pplnttj', 'ppwtt', 'ppwtt_ew', 'ppwttj', 'ppwttj_ew', 'ppztt', 'ppztt_ew',
                     'ppzttj', 'ppaatt', 'ppwwtt', 'ppzatt', 'ppzztt', 'ppvvvv', 'ppaaaj2', 'ppllaa', 'ppllaaj',
                     'pplllla', 'ppvvv', 'ppvvv2', 'ppvvv_ew', 'ppvvvj', 'ppaajj', 'ppaajj2', 'ppaajjj', 'pplla',
                     'pplla2', 'pplla_ew', 'ppllaj', 'ppllaj2', 'ppllaj_ew', 'ppllaj_nf5', 'ppllajj', 'ppllll',
                     'ppllll2', 'ppllll2_nf5', 'ppllll2_onlyh', 'ppllll_ew', 'ppllllbb', 'ppllllj', 'ppllllj2',
                     'ppllllj2_nf5', 'ppllllj2_nf5_notridr', 'ppllllj2_nf5_sr', 'ppllllj2_onlyh', 'ppllnnjj_ew',
                     'ppllnnjj_vbs', 'pplnaj_ckm', 'pplnajj', 'pplnajj_ckm', 'ppvv', 'ppvv2', 'ppvv_ew', 'ppvvj',
                     'ppvvj2', 'ppvvj_ew', 'ppwajj', 'ppwwjj', 'ppzajj', 'ppzwj_ew', 'ppzwjj', 'ppzzjj', 'ppajj',
                     'ppajj2', 'ppajj_ew', 'ppajjj', 'ppllj', 'ppllj2', 'ppllj_ew', 'ppllj_nf5', 'pplljj', 'pplljj_ew',
                     'pplljjj', 'pplnj_ckm', 'pplnjj', 'pplnjj_ckm', 'pplnjj_ew', 'pplnjjj', 'ppnnjj_ew', 'ppnnjjj',
                     'ppvj', 'ppvj2', 'ppvj_ew', 'ppwj_ckm', 'ppwjj', 'ppwjj_ckm', 'ppwjj_ew', 'ppwjjj', 'ppzjj',
                     'ppzjj_ew', 'ppzjjj', 'pphtt', 'pphtt_ew', 'pphttj', 'pphlltt', 'pphll', 'pphll2', 'pphll_ew',
                     'pphllj', 'pphllj2', 'pphllj_ew', 'pphlljj', 'pphlljj_top', 'pphlnj_ckm', 'pphlnjj', 'pphv',
                     'pphv_ew', 'pphwjj', 'pphz2', 'pphzj2', 'pphzjj', 'pphhtt', 'pphhv', 'pphhh2', 'heftpphh',
                     'heftpphhj', 'heftpphhjj', 'pphh2', 'pphhj2', 'pphhjj2', 'pphhjj_vbf', 'bbhj', 'heftpphj',
                     'heftpphjj', 'heftpphjjj', 'pphbb', 'pphbbj', 'pphj2', 'pphjj2', 'pphjj_vbf', 'pphjj_vbf_ew',
                     'pphjjj2', 'eetttt', 'eettttj', 'eellllbb', 'eett', 'eett_ew', 'eettj', 'eettjj', 'eevtt',
                     'eevttj', 'eevttjj', 'eevvtt', 'eevvttj', 'eellll_ew', 'eevv_ew', 'eevvjj', 'eell_ew', 'eevjj',
                     'eehtt', 'eehttj', 'eehll_ew', 'eehvtt', 'eehhtt', 'heftppllj', 'heftpplljj', 'heftpplljjj']
