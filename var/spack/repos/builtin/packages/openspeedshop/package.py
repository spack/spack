...
class Openspeedshop(CMakePackage):
    ...
    depends_on(
        "cbtf-krell@1.9.3:9999+crayfe",
        when="@2.4.0:9999+crayfe",
        type=("build", "link", "run"),
    )

    depends_on(
        "cbtf-krell@develop+mpich2",
        when="@develop+mpich2",
        type=("build", "link", "run"),
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+mpich2",
        when="@2.4.0:9999+mpich2",
        type=("build", "link", "run"),
    )
    ...
    depends_on(
        "cbtf-krell@develop+mvapich2",
        when="@develop+mvapich2",
        type=("build", "link", "run"),
    )
    depends_on(
    ...
    depends_on(
        "cbtf-krell@develop+openmpi",
        when="@develop+openmpi",
        type=("build", "link", "run"),
    )
    depends_on(
        "cbtf-krell@1.9.3:9999+openmpi",
        when="@2.4.0:9999+openmpi",
        type=("build", "link", "run"),
    )
