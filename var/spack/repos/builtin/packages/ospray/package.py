...
class Ospray(CMakePackage):
    ...
    depends_on("ispc@1.16.0:", type=("build"), when="@2.7.0:")
    depends_on("ispc@1.18.0:", type=("build"), when="@2.10.0:")
    depends_on("ispc@1.19.0:", type=("build"), when="@2.11.0:")
    depends_on("ispc@1.20.0:", type=("build"), when="@2.12.0:")
    depends_on("tbb")
