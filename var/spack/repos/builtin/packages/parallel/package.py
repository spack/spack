...
class Parallel(AutotoolsPackage, GNUMirrorPackage):
    ...
    version("20240622", sha256="37e210c907bd443c7d5b626071e815dc0d691d0652992b67d0c2acc34cbf38d5")
    ...
    def filter_sbang(self):
        ...
        with working_dir("src"):
            ...
            substitute = f"#!{perl}"
            if self.spec.satisfies("@20200422:"):
                files = ["parallel", "niceload", "parcat", "parsort", "sql"]
            else:
