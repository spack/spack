...
class PerlBioperl(PerlPackage):
    ...
    depends_on("perl-error", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-graph", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-http-message", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-io-stringy", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-ipc-run", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-list-moreutils", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-set-scalar", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-test-requiresinternet", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-dom", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-dom-xpath", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-libxml", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-sax", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-sax-base", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-sax-writer", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-twig", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-xml-writer", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-yaml", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-libwww-perl", type=("build", "run"), when="@1.7.6:")
    depends_on("perl-libxml-perl", type=("build", "run"), when="@1.7.6:")
