...
class PerlListMoreutils(PerlPackage):
    ...
    provides("perl-list-moreutils-pp")  # AUTO-CPAN2Spack
    depends_on("perl-exporter-tiny@0.38:", type="run")  # AUTO-CPAN2Spack
    depends_on("perl-extutils-makemaker", type="build")  # AUTO-CPAN2Spack
    depends_on("perl-test-leaktrace", type=("build", "test"))  # AUTO-CPAN2Spack
    depends_on("perl-list-moreutils-xs@0.430:", type="run")  # AUTO-CPAN2Spack
