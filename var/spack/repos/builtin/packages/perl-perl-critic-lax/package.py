...
class PerlPerlCriticLax(PerlPackage):
    ...
    provides("perl-perl-critic-policy-lax-prohibitcomplexmappings-linesnotstatements")  # AUTO-CPAN2Spack
    ...
    provides("perl-perl-critic-policy-lax-requireconstantonleftsideofequality-excepteq")  # AUTO-CPAN2Spack
    provides("perl-perl-critic-policy-lax-requireendwithtrueconst")  # AUTO-CPAN2Spack
    provides("perl-perl-critic-policy-lax-requireexplicitpackage-exceptforpragmata")  # AUTO-CPAN2Spack
    ...
    depends_on("perl-perl-critic-policy-valuesandexpressions-prohibitleadingzeros", type="run")  # AUTO-CPAN2Spack
