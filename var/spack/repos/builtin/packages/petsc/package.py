...
class Petsc(Package, CudaPackage, ROCmPackage):
    ...
    version(
        "3.14.6",
        sha256="4de0c8820419fb15bc683b780127ff57067b62ca18749e864a87c6d7c93f1230",
    )
    version(
        "3.14.5",
    ...
    version(
        "3.10.4",
        sha256="6c836df84caa9ae683ae401d3f94eb9471353156fec6db602bf2e857e4ec339f",
        deprecated=True,
    )
    version(
        "3.10.3",
        sha256="cd106babbae091604fee40c258737c84dec048949be779eaef5a745df3dc8de4",
        deprecated=True,
    )
    version(
        "3.10.2",
        sha256="9d3381bcf9c63abe6521b21a88efc70f8e893293503cff497971d0d9c1ec68cc",
        deprecated=True,
    )
    version(
        "3.10.1",
        sha256="b6e64ce062113ee0e2e2a6cfffb4d33c085ec91d5bc3afeb33781074aa5a22a5",
        deprecated=True,
    )
    version(
        "3.10.0",
        sha256="6ebacc010397ea47649495e8363cd7d7d86b876e6df07c6f6ccfa48b22fa555c",
        deprecated=True,
    )
    version(
        "3.9.4",
        sha256="ecc647c9b1ef565a2c113936454c65632eedc1626e0fc99b5a36accb91195a63",
        deprecated=True,
    )
    version(
        "3.9.3",
        sha256="6c7f2c7a28433385d74d647b4934aaeea3c1b3053b207973c9497639b6ebf7c8",
        deprecated=True,
    )
    version(
        "3.9.2",
        sha256="ab396ae5dbfff808df1b5648f5ce30f3021ec70faec3d5cd63df324d416ac6ac",
        deprecated=True,
    )
    version(
        "3.9.1",
        sha256="742e838a35d278693e956ed1ca4592c1d663451f6beea0694bf334aeb67681e8",
        deprecated=True,
    )
    version(
        "3.9.0",
        sha256="dcbcab1f321667be1c6e5f8e7b4ee8670bb09e372e51f1ea6471464519d54b2d",
        deprecated=True,
    )
    version(
        "3.8.4",
    ...
    version(
        "3.8.3",
        sha256="01f9c3ed937eafac6c9e006510b61c7cd07197115ec40c429fc835f346ca3eac",
        deprecated=True,
    )
    version(
        "3.8.2",
        sha256="42690508d408e31fb98be738ac097bc869be14c5bfe08dda2184243283ceb16a",
        deprecated=True,
    )
    version(
        "3.8.1",
        sha256="9b48a9e72d304046923667d2ab1f201778cc56242928a374ff9e074843a334ff",
        deprecated=True,
    )
    version(
        "3.8.0",
        sha256="1e1b4d90ccbf98dc5759a956ac9a771310a6690f1cbb37b31502b29568262d7e",
        deprecated=True,
    )
    version(
        "3.7.7",
        sha256="40fd3bc76998e056c4097704c08f28eb89bf3b93164dc9e69abab393f43bf6f0",
        deprecated=True,
    )
    version(
        "3.7.6",
        sha256="3c8ee051349587d45baa7910c54ce8e0a571592e3b40f3054a7b7f986919d449",
        deprecated=True,
    )
    version(
        "3.7.5",
        sha256="493ab0b6c1b3fe68e71d990eff87c84f499f680e6d2c0c394e78646a82ed4be3",
        deprecated=True,
    )
    version(
        "3.7.4",
        sha256="54b804f924ea5be3b6718b4d4e98f8ccb9d1bd6bbbd1e9c0f18c4a90ddf5db18",
        deprecated=True,
    )
    version(
        "3.7.2",
        sha256="36681dd0df97e0d5cd182d902e89f527eb8f441f05271159dac5340acb4cf0ec",
        deprecated=True,
    )
    version(
        "3.6.4",
        sha256="eb09925a139b52b4dd5a071b3da4fe2165f1d6e8f71d410479603c9976c940f0",
        deprecated=True,
    )
    version(
        "3.6.3",
        sha256="776e2644e4003653c56a44a6f7c02c41427af26f7c5cd9bec3aa84ed90223245",
        deprecated=True,
    )
    version(
        "3.5.3",
        sha256="68e6a42f5ec75bad87f74d4df8f55ad63f0c4d996f162da6713cb3d6f566830d",
        deprecated=True,
    )
    version(
        "3.5.2",
        sha256="1a8f09af654afab787c732e7b2f5d0c1d856777398148351565389d38d30935e",
        deprecated=True,
    )
    version(
        "3.5.1",
        sha256="199af205f62dcc572728600670c7d4c8cb0d4efc4172c26f02b895d9dd1df245",
        deprecated=True,
    )
    version(
        "3.4.4",
        sha256="fa73b99caf70c416a967234f5476cdb1d2c014610ee0619e48f54d8d309631b7",
        deprecated=True,
    )
    ...
    variant("scalapack", default=False, description="Activates support for Scalapack")
    variant(
        "trilinos",
        default=False,
    ...
    def mpi_dependent_options(self):
        if "~mpi" in self.spec:
            compiler_opts = [
                ...
                "--with-fc=%s"
                % (os.environ["FC"] if self.compiler.fc is not None else "0"),
                "--with-mpi=0",
            ]
        else:
            compiler_opts = [
    ...
    def install(self, spec, prefix):
        ...
        if self.run_tests:
            make(
                'check PETSC_ARCH="" PETSC_DIR={0}'.format(self.prefix), parallel=False
            )
