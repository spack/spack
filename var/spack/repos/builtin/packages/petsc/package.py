...
class Petsc(Package, CudaPackage, ROCmPackage):
    ...
    # Build dependencies
    depends_on("python@2.6:2.8,3.4:3.8", type="build", when="@:3.13")
    depends_on("python@2.6:2.8,3.4:", type="build", when="@3.14:3.17")
    depends_on("python@3.4:", type="build", when="@3.18:")
