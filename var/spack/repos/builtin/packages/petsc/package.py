...
class Petsc(Package):
    ...
    depends_on('superlu-dist@:4.3+int64', when='@3.4.4:3.6.4+superlu-dist+mpi+int64')
    depends_on('superlu-dist@5.0.0:~int64', when='@3.7:3.7.7+superlu-dist+mpi~int64')
    depends_on('superlu-dist@5.0.0:+int64', when='@3.7:3.7.7+superlu-dist+mpi+int64')
    depends_on('superlu-dist@test:~int64', when='@3.8:+superlu-dist+mpi~int64')
    depends_on('superlu-dist@test:+int64', when='@3.7:+superlu-dist+mpi+int64')
