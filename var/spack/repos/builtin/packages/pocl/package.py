...
class Pocl(CMakePackage):
    ...
    version(
        "1.6", sha256="b0a4c0c056371b6f0db726b88fbb76bbee94948fb2abd4dbc8d958f7c42f766c"
    )
    version(
        "1.5", sha256="4fcf4618171727d165fc044d465a66e3119217bb4577a97374f94fcd8aed330e"
    )
    version(
        "1.4", sha256="ec237faa83bb1c803fbdf7c6e83d8a2ad68b6f0ed1879c3aa16c0e1dcc478742"
    )
    version(
        "1.3", sha256="6527e3f47fab7c21e96bc757c4ae3303901f35e23f64642d6da5cc4c4fcc915a"
    )
    version(
        "1.2", sha256="0c43e68f336892f3a64cba19beb99d9212f529bedb77f7879c0331450b982d46"
    )
    version(
        "1.1", sha256="1e8dd0693a88c84937754df947b202871a40545b1b0a97ebefa370b0281c3c53"
    )
    version(
        "1.0", sha256="94bd86a2f9847c03e6c3bf8dca12af3734f8b272ffeacbc3fa8fcca58844b1d4"
    )
    version(
        "0.14",
    ...
    version(
        "0.12",
        sha256="5160d7a59721e6a7d0fc85868381c0afceaa7c07b9956c9be1e3b51e80c29f76",
    )
    version(
        "0.11",
        sha256="24bb801fb87d104b66faaa95d1890776fdeabb37ad1b12fb977281737c7f29bb",
    )
    version(
        "0.10",
    ...
    conflicts(
        "@:1.5", when="target=a64fx", msg="a64fx is supported by pocl v1.6 and above."
    )
