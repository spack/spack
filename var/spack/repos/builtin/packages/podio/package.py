...
class Podio(CMakePackage):
    ...
    depends_on("py-jinja2@2.10.1:", when="@0.12.0:", type=("build", "run"))
    depends_on("sio", when="+sio", type=("build", "link"))
    depends_on("catch2@3.0.1:", when="@0.13:0.16.5", type=("test"))
    depends_on("catch2@3.1:", when="@0.16.6:", type=("test"))
    depends_on("py-tabulate", when="@0.16.6:", type=("run", "test"))
