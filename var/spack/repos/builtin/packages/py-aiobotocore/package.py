...
class PyAiobotocore(PythonPackage):
    ...
    depends_on("py-botocore@1.27.59", type=("build", "run"), when="@2.4.2")
    depends_on("py-botocore@1.19.52", type=("build", "run"), when="@1.2.1")
    depends_on("py-botocore@1.29.76", type=("build", "run"), when="@2.5.0")
