...
class PyAiohttp(PythonPackage):
    ...
    depends_on('py-chardet@2.0:4.0', type=('build', 'run'))
    depends_on('py-multidict@4.5:5.0', type=('build', 'run'))
    depends_on('py-async-timeout@3.0:4.0', type=('build', 'run'))
    depends_on('py-yarl@1.0:2.0', type=('build', 'run'))
    depends_on('py-idna-ssl@1.0:', type=('build', 'run'), when='^python@:3.7')
    depends_on('py-typing-extensions@3.6.5:', type=('build', 'run'), when='^python@:3.7')
