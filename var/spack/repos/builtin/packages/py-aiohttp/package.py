...
class PyAiohttp(PythonPackage):
    ...
    depends_on("py-charset-normalizer@2:3", type=("build", "run"), when="@3.8.4:")
    depends_on("py-charset-normalizer@2", type=("build", "run"), when="@3.8.0:3.8.3")
    depends_on("py-multidict@4.5:6", type=("build", "run"), when="@3.6.3:")
    depends_on("py-multidict@4.5:4", type=("build", "run"), when="@:3.6.2")
    depends_on("py-async-timeout@4", type=("build", "run"), when="@3.8.0:")
    depends_on("py-async-timeout@3", type=("build", "run"), when="@:3.7.4")
