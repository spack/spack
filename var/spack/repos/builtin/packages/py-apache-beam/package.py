...
class PyApacheBeam(PythonPackage):
    ...
    version(
        "2.24.0",
        sha256="55c50b1a964bacc840a5e4cc3b4a42c4ef09d12192d215ba3cad65d4d22e09dd",
    )
    ...
    depends_on(
        "py-avro-python3@1.8.1:1.9.1,1.9.3:1.9",
        type=("build", "run"),
        when="^python@3:",
    )
    ...
    depends_on(
        "py-pyarrow@0.15.1:0.17",
        type=("build", "run"),
        when="platform=windows ^python@3:",
    )
