...
class PyApacheBeam(PythonPackage):
    ...
    depends_on('py-funcsigs@1.0.2:2', type=('build', 'run'), when='+python^python@:2.9')
    depends_on('py-future@0.18.2:1.0.0', type=('build', 'run'))
    depends_on('py-futures@3.2.0:4.0.0', type=('build', 'run'), when='+python^python@:2.9')
    ...
    depends_on('py-pyarrow@0.15.1:0.18.0', type=('build', 'run'), when='+python^python@3.0:')
    ...
    depends_on('py-pyvcf@0.6.8:0.7.0', type=('build', 'run'), when='+python^python@:2.9')
    depends_on('py-requests@2.24.0:3.0.0', type=('build', 'run'))
    depends_on('py-typing@3.7.0:3.8.0', type=('build', 'run'), when='+python^python@:3.5')
