...
class PyArrow(PythonPackage):
    ...
    depends_on("python@3.6:", when="@1.2.1:", type=("build", "run"))
    depends_on("python@2.7:2.8,3.5:", when="@:0.16.0", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-python-dateutil", type=("build", "run"))
    depends_on("py-typing-extensions", when="@1.2.1: ^python@:3.7", type=("build", "run"))
    depends_on("py-python-dateutil@2.7.0:", when="@1.2.1:", type=("build", "run"))
