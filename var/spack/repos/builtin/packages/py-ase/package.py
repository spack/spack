...
class PyAse(PythonPackage):
    ...
    depends_on("python@2.6:", when="@:3.15.0", type=("build", "run"))
    depends_on("python@3.5:", when="@3.18.0:", type=("build", "run"))
    depends_on("python@3.6:", when="@3.20.0:", type=("build", "run"))
    ...
    depends_on("py-flask", when="@:3.18.0", type=("build", "run"))
