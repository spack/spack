...
class PyAstroid(PythonPackage):
    ...
    depends_on("python@3.4:", type=("build", "run"), when="@2.0.0:")
    depends_on("python@3.5:", type=("build", "run"), when="@2.3.3:")
    depends_on("python@3.6:", type=("build", "run"), when="@2.5.6:")
    depends_on("python@3.6.2:", type=("build", "run"), when="@2.11.4:")
    depends_on("python@3.7.2:", type=("build", "run"), when="@2.12.7:")
    ...
    depends_on("py-lazy-object-proxy@1.4.0:1.4", type=("build", "run"), when="@2.3.1:2.7.2")
    depends_on("py-lazy-object-proxy@1.4.0:", type=("build", "run"), when="@2.7.3:")
    depends_on("py-six", type=("build", "run"), when="@:2.7.2")
    depends_on("py-six@1.12:1", type=("build", "run"), when="@2.3.3:2.7.2")
    depends_on("py-wrapt", type=("build", "run"), when="@:2.2")
    depends_on("py-wrapt@1.11:1.12", type=("build", "run"), when="@2.3.3:2.8.2")
    depends_on("py-wrapt@1.11:1.13", type=("build", "run"), when="@2.8.3:2.10")
    depends_on("py-wrapt@1.11:1", type=("build", "run"), when="@2.11")
    depends_on("py-wrapt@1.14:1", type=("build", "run"), when="@2.12.7: ^python@3.11:")
    depends_on("py-wrapt@1.11:1", type=("build", "run"), when="@2.12.7: ^python@:3.10")
    depends_on("py-typed-ast@1.3.0:", when="@2.2.5:2.3.0 ^python@3.7.0:3.7")
    depends_on("py-typed-ast@1.4.0:1.4", type=("build", "run"), when="@2.3.1:2.8.4 ^python@:3.7")
    depends_on("py-typed-ast@1.4.0:1", type=("build", "run"), when="@2.8.5: ^python@:3.7")
    depends_on("py-typing-extensions@3.7.4:", type=("build", "run"), when="@2.7.3: ^python@:3.7")
    depends_on("py-typing-extensions@3.10:", type=("build", "run"), when="@2.8.3: ^python@:3.9")
    depends_on("py-typing-extensions@4.0:", type=("build", "run"), when="@2.14: ^python@:3.10")
    depends_on("py-setuptools@17.1:", type=("build", "run"))
    depends_on("py-setuptools@20:", type=("build", "run"), when="@2.7.3:")
    depends_on("py-setuptools@62.6:62", type=("build", "run"), when="@2.12.7:")
    depends_on("py-wheel@0.37.1:0.37", type="build", when="@2.12.7:")
