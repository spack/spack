...
class PyAstropy(PythonPackage):
    ...
    depends_on('python@3.8:', when='@5.0:', type=('build', 'run'))
    ...
    depends_on('py-setuptools-scm@6.2:', when='@5.0:', type='build')
    depends_on('py-setuptools-scm', when='@4.1:', type='build')
    depends_on('py-cython@0.29.30:', when='@5.1:', type='build')
    depends_on('py-cython@0.29.22:', when='@4.2.1:', type='build')
    depends_on('py-cython@0.29.14:', when='@4.0.2:', type='build')
    depends_on('py-cython@0.29.13:', type='build')
    depends_on('py-jinja2@3.0.3:', when='@5.0.3:5.0.4', type='build')
    depends_on('py-jinja2@2.10.3:', when='@4.0.2:', type='build')
    depends_on('py-numpy@1.18:', when='@5.0:', type=('build', 'run'))
    depends_on('py-numpy@1.17:', when='@4.2:', type=('build', 'run'))
    ...
    depends_on('py-packaging@19.0:', when='@5.0:', type='build')
    depends_on('py-extension-helpers', when='@4.1:', type=('build', 'run'))
    depends_on('py-pyyaml@3.13:', when='@5.0:', type=('build', 'run'))
    depends_on('py-pyerfa@2.0:', when='@5.0:', type='run')
    depends_on('py-pyerfa@1.7.3:', when='@4.3:', type='run')
    depends_on('py-pyerfa', when='@4.2:', type='run')

    # Optional dependencies
    depends_on('py-scipy@1.3:', when='@5.0:+extras', type=('build', 'run'))
    depends_on('py-scipy@1.1:', when='@4.2:+extras', type=('build', 'run'))
    ...
    depends_on('py-pyyaml@3.13:', when='@4.2:4.3+extras', type=('build', 'run'))
    depends_on('py-pyyaml@3.12:', when='@4.0.2:+extras', type=('build', 'run'))
    ...
    depends_on('py-matplotlib@3.1:', when='@5.0:+extras', type=('build', 'run'))
    ...
    depends_on('py-asdf@2.10:', when='@5.1:+extras', type=('build', 'run'))
    depends_on('py-asdf@2.9.2:', when='@5.0.2:+extras', type=('build', 'run'))
    depends_on('py-asdf@2.6:', when='@4.1:+extras', type=('build', 'run'))
    depends_on('py-asdf@2.5:', when='@4.0.1:+extras', type=('build', 'run'))
    depends_on('py-asdf@2.3:', when='+extras', type=('build', 'run'))
    depends_on('py-bottleneck', when='+extras', type=('build', 'run'))
    depends_on('py-pytest@7.0:', when='@5.0.2:+extras', type=('build', 'run'))
    depends_on('py-pytest', when='+extras', type=('build', 'run'))
    depends_on('py-ipython@4.2:', when='@4.3:+extras', type=('build', 'run'))
    depends_on('py-ipython', when='@4.0:+extras', type=('build', 'run'))
    depends_on('py-certifi', when='@4.3:+extras', type=('build', 'run'))
    depends_on('py-arrow', when='@5.0:+extras', type=('build', 'run'))
    depends_on('py-dask +array', when='@4.1:+extras', type=('build', 'run'))
    depends_on('py-typing-extensions', when='@5.0:+extras', type=('build', 'run'))
