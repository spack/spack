...
class PyAstropy(PythonPackage):
    ...
    depends_on("py-numpy@1.18:", type=("build", "run"), when="@5.1:")
    depends_on("py-numpy@1.16:", type=("build", "run"), when="@4.0:")
    depends_on("py-numpy@1.13:", type=("build", "run"), when="@3.1:")
    depends_on("py-numpy@1.10:", type=("build", "run"), when="@3.0:")
    depends_on("py-numpy@1.9:", type=("build", "run"), when="@2.0:")
    depends_on("py-numpy@1.7:", type=("build", "run"), when="@1.2:")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-packaging@19.0:", type=("build", "run"), when="@5.1:")
    depends_on("py-pyyaml@3.13:", type=("build", "run"), when="@5.1:")
    depends_on("py-pyerfa@2.0:", type=("build", "run"), when="@5.1:")
    depends_on("py-setuptools-scm@6.2:", type="build", when="@5.1:")
    depends_on("py-cython@0.29.30", type="build", when="@5.1:")
    depends_on("py-extension-helpers", type="build", when="@5.1:")
    ...
    with when("+all"):
        depends_on("py-scipy@1.3:", type=("build", "run"), when="@5:")
        depends_on("py-scipy@0.18:", type=("build", "run"))
        depends_on("py-matplotlib@3.1:", type=("build", "run"), when="@5:")
        depends_on("py-matplotlib@2.1:", type=("build", "run"), when="@4:")
        depends_on("py-matplotlib@2.0:", type=("build", "run"))
        depends_on("py-certifi", type=("build", "run"), when="@4.3:")
        depends_on("py-dask+array", type=("build", "run"), when="@4.1:")
        depends_on("py-h5py", type=("build", "run"))
        depends_on("py-pyarrow@5:", type=("build", "run"), when="@5:")
        ...
        depends_on("py-asdf@2.10:", type=("build", "run"), when="@5.1:")
        depends_on("py-asdf@2.5:", type=("build", "run"), when="@4.0.1post1:")
        depends_on("py-asdf@2.3:", type=("build", "run"))
        depends_on("py-bottleneck", type=("build", "run"))
        depends_on("py-ipython@4.2:", type=("build", "run"), when="@4.3:")
        depends_on("py-ipython", type=("build", "run"))
        depends_on("py-pytest@7:", type=("build", "run"), when="@5.0.2:")
        depends_on("py-pytest", type=("build", "run"))
        depends_on("py-typing-extensions@3.10.0.1:", type=("build", "run"), when="@5.0.2:")

        # Historical optional dependencies
        depends_on("py-pyyaml", type=("build", "run"), when="@:5")
        depends_on("py-scikit-image", type=("build", "run"), when="@:4.0")
        depends_on("py-bintrees", type=("build", "run"), when="@:3.2.1")
