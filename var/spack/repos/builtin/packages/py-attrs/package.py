...
class PyAttrs(PythonPackage):
    ...
    depends_on("py-hatchling", when="@23.1.0:", type="build")
    depends_on("py-hatch-vcs", when="@23.1.0:", type="build")
    depends_on("py-hatch-fancy-pypi-readme", when="@23.1.0:", type="build")
