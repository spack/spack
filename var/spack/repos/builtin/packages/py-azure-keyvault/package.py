...
class PyAzureKeyvault(PythonPackage):
    ...
    depends_on("py-azure-keyvault-certificates@4.1:4", type=("build", "run"), when="@4:")
    depends_on("py-azure-keyvault-secrets@4.1:4", type=("build", "run"), when="@4:")
    depends_on("py-azure-keyvault-keys@4.1:4", type=("build", "run"), when="@4:")
    depends_on("py-msrest@0.5.0:", type=("build", "run"), when="@:1")
    depends_on("py-msrestazure@0.4.32:1", type=("build", "run"), when="@:1")
    depends_on("py-azure-common@1.1:1", type=("build", "run"), when="@:1")
    depends_on("py-cryptography@2.1.4:", type=("build", "run"), when="@:1")
    depends_on("py-requests@2.18.4:", type=("build", "run"), when="@:1")
