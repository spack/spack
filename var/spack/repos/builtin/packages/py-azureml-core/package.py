    ...
    * Models, images and web services.
    ...
    with default_args(type="run"):
        ...
        depends_on(
            ...
            when="@:1.0.62.0,1.0.65:1.0.76.0,1.0.79:1.0.85.5,1.1:1.1.5.6,1.2:1.2.0.post1,"
            "1.4.0.post:1.9.0.0,1.10:1.10.0.post1,1.11:1.11.0.post1,1.12:1.12.0.post1,"
            "1.13:1.13.0.0,1.14:1.14.0.0",
        )
        ...
        depends_on(
            "py-pyjwt",
            when="@0.1.68:1.13.0.post1,1.14:1.14.0.post1,1.15:1.15.0.0,"
            "1.16:1.16.0.post1,1.17:1.17.0.0,1.22:",
        )
        ...
        depends_on(
            "py-ruamel-yaml@0.15.35:",
            when="@1.11.0.post:1.11," "1.12.0.post:1.25.0.0,1.26:1.26.0.0",
        )
