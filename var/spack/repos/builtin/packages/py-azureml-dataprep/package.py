...
class PyAzuremlDataprep(PythonPackage):
    ...
    depends_on("py-azureml-dataprep-native@30.0.0:30", type=("build", "run"), when="@2.10.0:")
    depends_on("py-azureml-dataprep-native@14.2.1:14", type=("build", "run"), when="@:2.0.2")
    depends_on("py-azureml-dataprep-rslex@1.9.0:1.9", type=("build", "run"), when="@2.11.0:")
    depends_on("py-azureml-dataprep-rslex@1.8.0:1.8", type=("build", "run"), when="@2.10.1")
    depends_on("py-cloudpickle@1.1.0:1", type=("build", "run"))
    depends_on("py-azure-identity@1.2.0:1.4", type=("build", "run"), when="@2.10.0:")
    depends_on("py-azure-identity@1.2.0:1.2", type=("build", "run"), when="@:2.0.2")
    depends_on("py-fusepy@3.0.1:3", type=("build", "run"), when="+fuse")
