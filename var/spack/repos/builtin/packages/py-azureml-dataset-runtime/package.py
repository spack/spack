...
class PyAzuremlDatasetRuntime(PythonPackage):
    ...
    depends_on("py-azureml-dataprep@2.10.0:2.10", type=("build", "run"), when="@1.23.0")
    depends_on("py-azureml-dataprep@2.0.1:2.0", type=("build", "run"), when="@1.11.0.post1")
    depends_on("py-pyarrow@0.17.0:1", type=("build", "run"), when="@1.23.0")
    depends_on("py-pyarrow@0.17.0:0", type=("build", "run"), when="@1.11.0.post1")
    depends_on("py-numpy@:1.19.2,1.19.4:", type=("build", "run"), when="@1.23.0:")
