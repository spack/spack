...
class PyAzuremlTrainAutomlClient(PythonPackage):
    ...
    depends_on("py-azureml-automl-core@1.23.0:1.23", type=("build", "run"), when="@1.23.0")
    depends_on("py-azureml-core@1.23.0:1.23", type=("build", "run"), when="@1.23.0")
    depends_on("py-azureml-dataset-runtime@1.23.0:1.23", type=("build", "run"), when="@1.23.0")
    depends_on("py-azureml-telemetry@1.23.0:1.23", type=("build", "run"), when="@1.23.0")

    depends_on("py-azureml-automl-core@1.11.0:1.11", type=("build", "run"), when="@1.11.0")
    depends_on("py-azureml-core@1.11.0:1.11", type=("build", "run"), when="@1.11.0")
    depends_on("py-azureml-dataset-runtime@1.11.0:1.11", type=("build", "run"), when="@1.11.0")
    depends_on("py-azureml-telemetry@1.11.0:1.11", type=("build", "run"), when="@1.11.0")

    depends_on("py-azureml-dataprep@1.8.0:1.8", type=("build", "run"), when="@1.8.0")
    depends_on("py-azureml-automl-core@1.8.0:1.8", type=("build", "run"), when="@1.8.0")
    depends_on("py-azureml-core@1.8.0:1.8", type=("build", "run"), when="@1.8.0")
    depends_on("py-azureml-telemetry@1.8.0:1.8", type=("build", "run"), when="@1.8.0")
