...
class PyBidscoin(PythonPackage):
    ...
    depends_on("py-setuptools@62.2:", type="build", when="@4.1:")
    depends_on("py-setuptools@61:", type="build", when="@4:")
    depends_on("py-setuptools", type="build")
    depends_on("py-argparse-manpage+setuptools", type="build", when="@4.1:")

    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-matplotlib", type=("build", "run"))
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-pydicom@2:", type=("build", "run"))
    depends_on("py-pyqt6", type=("build", "run"), when="@4.1:")
    depends_on("py-ruamel-yaml@0.15.35:", type=("build", "run"))
    depends_on("py-tomli@1.1:", type=("build", "run"), when="@4.1: ^python@:3.10")
    depends_on("py-coloredlogs", type=("build", "run"))
    depends_on("py-tqdm@4.60:", type=("build", "run"), when="@4:")
    depends_on("py-tqdm", type=("build", "run"))
    depends_on("py-multiecho@0.25:", type=("build", "run"))
    depends_on("py-python-dateutil", type=("build", "run"))
    depends_on("py-nibabel", type=("build", "run"))
    depends_on("py-bids-validator", type=("build", "run"), when="@4:")
    depends_on("dcm2niix", type=("build", "run"))

    # Historical dependencies
    depends_on("py-pytest-runner", type="build", when="@:3")
    depends_on("py-pyqt5@5.12.1:", type=("build", "run"), when="@:4.0")
    depends_on("py-pydeface", type=("build", "run"), when="@4.0")
    depends_on("py-pytest", type=("build", "run"), when="@4.0")
