...
class PyBiomFormat(PythonPackage):
    ...
    depends_on("python@3:", when="@2.1.9:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-cython", type="build")
    depends_on("py-h5py@2.2.0:", type=("build", "run"))
    depends_on("py-click", type=("build", "run"))
    depends_on("py-numpy@1.3.0:", type=("build", "run"))
    depends_on("py-numpy@1.9.2:", when="@2.1.7:", type=("build", "run"))
    depends_on("py-future@0.16.0:", when="@:2.1.10", type=("build", "run"))
    depends_on("py-scipy@0.13.0:", type=("build", "run"))
    depends_on("py-scipy@1.3.1:", when="@2.1.8:", type=("build", "run"))
    depends_on("py-pandas@0.19.2:", type=("build", "run"))
    depends_on("py-pandas@0.20.0:", when="@2.1.7:", type=("build", "run"))
