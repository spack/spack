...
class PyBiopython(PythonPackage):
    ...
    depends_on("python@2.6:2.7,3.3:", when="@1.63:1.68", type=("build", "run"))
    depends_on("python@2.7,3.3:", when="@1.69", type=("build", "run"))
    depends_on("python@2.7,3.4:", when="@1.70:1.74", type=("build", "run"))
    depends_on("python@2.7,3.5:", when="@1.75:1.76", type=("build", "run"))
    depends_on("python@3.6:", when="@1.77:", type=("build", "run"))
