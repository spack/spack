...
class PyBiopython(PythonPackage):
    ...
    depends_on("python@2.6:2.7,3.3:3.10", type=("build", "run"), when="@1.63:1.68")
    depends_on("python@2.7,3.3:3.10", type=("build", "run"), when="@1.69")
    depends_on("python@2.7,3.4:3.10", type=("build", "run"), when="@1.70:1.74")
    depends_on("python@2.7,3.5:3.10", type=("build", "run"), when="@1.75:1.76")
