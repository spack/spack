...
class PyBlessed(PythonPackage):
    ...
    version(
        "1.17.7",
        sha256="0329a3d1db91328986a6dfd36475dbc498c867090f0433cdcc1a45a5eb2067e4",
    )
    version(
        "1.17.6",
    ...
    version(
        "1.17.3",
        sha256="cc38547175ae0a3a3d4e5dcc7e7478a5a6bf0a6b5f4d9c6b2e5eadbe4475cb0e",
    )
    version(
        "1.17.0",
    ...
    version(
        "1.16.0",
        sha256="34b78e9b56c2ba2f6a9a625cc989d6cf4ae8ae87dcc4ed8ad144660ae4cf7784",
    )
    version(
        "1.15.0",
