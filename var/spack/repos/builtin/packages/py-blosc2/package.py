...
class PyBlosc2(PythonPackage):
    ...
    depends_on("python@3.9:3", type=("build", "link", "run"), when="@2.2:")
    depends_on("python@3.8:3", type=("build", "link", "run"), when="@2.0")
    ...
    depends_on("py-ndindex@1.4:", type=("build", "run"), when="@2.2:")
    depends_on("py-msgpack", type=("build", "run"))
    depends_on("py-py-cpuinfo", type=("build", "run"), when="@2.2:")
