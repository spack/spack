...
class PyBoto3(PythonPackage):
    ...
    depends_on("py-s3transfer@0.9", when="@1.34:", type=("build", "run"))
    depends_on("py-s3transfer@0.8.2:0.8", when="@1.33.4:", type=("build", "run"))
    depends_on("py-s3transfer@0.8", when="@1.29.7:", type=("build", "run"))
    depends_on("py-s3transfer@0.7", when="@1.28.55:", type=("build", "run"))
