...
class PyBoto3(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@1.26:")
    depends_on("python@3.6:", type=("build", "run"), when="@1.18:")
    depends_on("python@2.7:2.8,3.6:", type=("build", "run"), when="@1.17:")
    depends_on("python@2.6:", type=("build", "run"), when="@1.9:")
    depends_on("py-setuptools", type="build")

    depends_on("py-botocore@1.29.26:1.29", type=("build", "run"), when="@1.26")
    depends_on("py-botocore@1.28.5:1.28", type=("build", "run"), when="@1.25")
    depends_on("py-botocore@1.27.96:1.27", type=("build", "run"), when="@1.24")
    depends_on("py-botocore@1.26.10:1.26", type=("build", "run"), when="@1.23")
    depends_on("py-botocore@1.25.13:1.25", type=("build", "run"), when="@1.22")
    depends_on("py-botocore@1.24.46:1.24", type=("build", "run"), when="@1.21")
    depends_on("py-botocore@1.23.54:1.23", type=("build", "run"), when="@1.20")
    depends_on("py-botocore@1.22.12:1.22", type=("build", "run"), when="@1.19")
    depends_on("py-botocore@1.21.65:1.21", type=("build", "run"), when="@1.18")
    depends_on("py-botocore@1.20.27:1.20", type=("build", "run"), when="@1.17")
    depends_on("py-botocore@1.13.50:1.13", type=("build", "run"), when="@1.10")
    depends_on("py-botocore@1.12.253:1.12", type=("build", "run"), when="@1.9")

    depends_on("py-jmespath@0.7.1:0", type=("build", "run"), when="@:1.20")
    depends_on("py-jmespath@0.7.1:1", type=("build", "run"))

    depends_on("py-s3transfer@0.6", type=("build", "run"), when="@1.24:")
    depends_on("py-s3transfer@0.5", type=("build", "run"), when="@1.18:1.23")
    depends_on("py-s3transfer@0.3", type=("build", "run"), when="@1.17")
    depends_on("py-s3transfer@0.2", type=("build", "run"), when="@:1.10")
