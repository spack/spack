...
class PyBotocore(PythonPackage):
    ...
    depends_on("py-jmespath@0.7.1:0", when="@:1.23", type=("build", "run"))
    depends_on("py-jmespath@0.7.1:1", type=("build", "run"))
    depends_on("py-docutils@0.10:0.15", when="@:1.17", type=("build", "run"))
    depends_on("py-python-dateutil@2.1:2", type=("build", "run"))
    depends_on("py-urllib3@1.20:1.25", when="@:1.14.11", type=("build", "run"))
    depends_on("py-urllib3@1.20:1.25", when="@1.14.12:1.18", type=("build", "run"))
    depends_on("py-urllib3@1.25.4:1.25", when="@1.19.0:1.19.15", type=("build", "run"))
    depends_on("py-urllib3@1.25.4:1.26", when="@1.19.16:", type=("build", "run"))
