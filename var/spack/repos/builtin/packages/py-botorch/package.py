...
class PyBotorch(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@0.8.3:")
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools@:47", type="build", when="@:0.6.4")
    depends_on("py-setuptools-scm", type="build")
    depends_on("py-setuptools-scm+toml", type="build", when="@0.8.3:")
    depends_on("py-torch@1.12:", type=("build", "run"), when="@0.8.3:")
    depends_on("py-torch@1.9:", type=("build", "run"))
    depends_on("py-gpytorch@1.10:", type=("build", "run"), when="@0.8.4:")
    depends_on("py-gpytorch@1.9.1:", type=("build", "run"), when="@0.8.3:")
    depends_on("py-gpytorch@1.6:", type=("build", "run"))
    depends_on("py-scipy", type=("build", "run"))
    depends_on("py-multipledispatch", type=("build", "run"))
    depends_on("py-pyro-ppl@1.8.4:", type=("build", "run"), when="@0.8.3:")
    depends_on("py-pyro-ppl@1.8.0", type=("build", "run"), when="@:0.6.4")
    depends_on("py-linear-operator@0.4.0:", type=("build", "run"), when="@0.8.4:")
    depends_on("py-linear-operator@0.3.0:", type=("build", "run"), when="@0.8.3:")
