...
class PyCartopy(PythonPackage):
    ...
    depends_on("python@3.9:3.11", type=("build", "link", "run"), when="@0.22:")
    depends_on("python@3.8:3.11", type=("build", "link", "run"), when="@0.21")
    depends_on("python@:3.11", type=("build", "link", "run"), when="@0.20")
    depends_on("python@:3.10", type=("build", "link", "run"), when="@0.19")
    depends_on("python@:3.9", type=("build", "link", "run"), when="@:0.18")

    # Required dependencies
    depends_on("py-setuptools@40.6:", type="build", when="@0.19:")
    depends_on("py-setuptools@0.7.2:", type="build")
    depends_on("py-cython@0.29.24:", type="build", when="@0.22:")
    depends_on("py-cython@0.29.13:", type="build", when="@0.20:")
    depends_on("py-cython@0.29.2:", type="build", when="@0.19:")
    depends_on("py-cython@0.28:", type="build", when="@0.18:")
    depends_on("py-cython@0.15.1:", type="build", when="@0.17:")
    depends_on("py-cython", type="build")
    depends_on("py-setuptools-scm@7:", type="build", when="@0.20.3:")
    depends_on("py-setuptools-scm", type="build", when="@0.19:")
    depends_on("py-numpy@1.21:", type=("build", "link", "run"), when="@0.22:")
    depends_on("py-numpy@1.18:", type=("build", "link", "run"), when="@0.20:")
    depends_on("py-numpy@1.13.3:", type=("build", "link", "run"), when="@0.19:")
    depends_on("py-numpy@1.10:", type=("build", "link", "run"), when="@0.17:")
    depends_on("py-numpy@1.6:", type=("build", "link", "run"))
    depends_on("py-matplotlib@3.4:", type=("build", "run"), when="@0.22:")
    depends_on("py-matplotlib@3.1:", type=("build", "run"), when="@0.21")
    # https://github.com/SciTools/cartopy/issues/2086
    depends_on("py-matplotlib@3.1:3.5", type=("build", "run"), when="@0.20")
    depends_on("py-shapely@1.7:", type=("build", "run"), when="@0.22:")
    depends_on("py-shapely@1.6.4:", type=("build", "run"), when="@0.21.1:0.21")
    depends_on("py-shapely@1.6.4:1", type=("build", "run"), when="@0.20:0.21.0")
    depends_on("py-shapely@1.5.6:1", type=("build", "run"), when="@:0.19")
    depends_on("py-packaging@20:", type=("build", "run"), when="@0.22:")
    depends_on("py-pyshp@2.1:", type=("build", "run"), when="@0.20:")
    depends_on("py-pyshp@2:", type=("build", "run"), when="@0.19:")
    depends_on("py-pyshp@1.1.4:", type=("build", "run"))
    depends_on("py-pyproj@3.1:", type=("build", "run"), when="@0.22:")
    depends_on("py-pyproj@3:", type=("build", "run"), when="@0.20:")

    with when("+ows"):
        depends_on("py-owslib@0.20:", type="run", when="@0.22:")
        depends_on("py-owslib@0.18:", type="run", when="@0.20:")
        depends_on("py-owslib@0.8.11:", type="run")
        depends_on("pil@6.1:", type="run", when="@0.20:")
        depends_on("pil@1.7.8:", type="run")

    with when("+plotting"):
        depends_on("pil@6.1:", type="run", when="@0.20:")
        depends_on("pil@1.7.8:", type="run")
        depends_on("py-scipy@1.3.1:", type="run", when="@0.20:")
        depends_on("py-scipy@0.10:", type="run")

    # Historical dependencies
    depends_on("py-setuptools-scm-git-archive", type="build", when="@0.19:0.20.2")
    depends_on("py-six@1.3:", type=("build", "run"), when="@:0.18")
    ...
    with when("+epsg"):
        ...
        depends_on("py-pyepsg@0.4:", type="run", when="@0.18:")

    with when("+plotting"):
        depends_on("gdal@2.3.2:+python", type="run", when="@0.20:0.21")
        depends_on("gdal@1.10:+python", type="run", when="@:0.19")
        depends_on("py-matplotlib@1.5.1:3.5", type="run", when="@0.17:0.19")
        depends_on("py-matplotlib@1.3:3.5", type="run", when="@0.16")
