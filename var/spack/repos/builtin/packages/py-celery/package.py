...
class PyCelery(PythonPackage):
    ...
    depends_on("py-redis@3.2.0:", type=("build", "run"), when="+redis")
    depends_on("py-redis@3.4.1:3,4.0.2:", type=("build", "run"), when="@5.2.3:+redis")
    depends_on("py-sqlalchemy", type=("build", "run"), when="+sqlalchemy")

    depends_on("py-click@7.0:7", type=("build", "run"), when="@5.0.0:5.0")
    depends_on("py-click@8.0.3:8", type=("build", "run"), when="@5.2.0:")
    depends_on("py-click-didyoumean@0.0.3:", type=("build", "run"), when="@5.0.0:5")
    depends_on("py-click-plugins@1.1.1:", type=("build", "run"), when="@5.0.3:")
    depends_on("py-click-repl@:0.1.6", type=("build", "run"), when="@5.0.0:5.0")
    depends_on("py-click-repl@0.2.0:", type=("build", "run"), when="@5.2.0:")
    ...
    depends_on("py-kombu@4.6.11", type=("build", "run"), when="@4.3.0:4")
    depends_on("py-kombu@5.0.0:", type=("build", "run"), when="@5.0.0:5.0")
    depends_on("py-kombu@5.2.3:5", type=("build", "run"), when="@5.2.0:5.2")
    depends_on("py-vine@1.3.0", type=("build", "run"), when="@4.3.0:4")
    depends_on("py-vine@5.0.0:5", type=("build", "run"), when="@5.0.0:5")
