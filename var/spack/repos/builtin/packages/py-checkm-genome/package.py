...
class PyCheckmGenome(PythonPackage):
    ...
    version(
        "1.0.13",
        sha256="ffb7e4966c0fac07c7e6e7db6f6eb5b48587fa83987f8a68efbaff2afb7da82e",
        deprecated=True,
    )
    version(
        "1.0.11",
        sha256="e475d9817d12fa771dbccc80f47758b742fc67c25261dc8ca0c0dc898c2a5190",
        deprecated=True,
    )
    ...
    depends_on(
        "py-backports-functools-lru-cache", type=("build", "run"), when="^python@:3.2"
    )
