...
class PyChex(PythonPackage):
    ...
    version("0.1.8", sha256="590394fdb48f392019321de568b3ec7f962516f0c660641b790246b9a4142a79")
    ...
    depends_on("py-typing-extensions@4.2.0:", when="@0.1.6:", type=("build", "run"))
    depends_on("py-dm-tree@0.1.5:", type=("build", "run"))
    depends_on("py-jax@0.4.6:", when="@0.1.7:", type=("build", "run"))
    depends_on("py-jax@0.1.55:", when="@:0.1.6", type=("build", "run"))
