...
class PyCinemasci(PythonPackage):
    ...
    depends_on("py-matplotlib", when="@1.7.0:", type=("build", "run"))
    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-pyyaml", when="@1.7.0:", type=("build", "run"))
    depends_on("py-scikit-image", when="@1.7.0:", type=("build", "run"))
    depends_on("py-scipy", when="@1.7.0:", type=("build", "run"))
