...
class PyCleo(PythonPackage):
    ...
    version("0.8.1", sha256="3d0e22d30117851b45970b6c14aca4ab0b18b1b53c8af57bed13208147e4069f", preferred=True)

    depends_on("python@2.7,3.4:3", type=("build", "run"))
    depends_on("python@3.7:3", when="@1.0.0a5:", type=("build", "run"))
    depends_on("py-poetry-core@1:", type="build")
    depends_on("py-poetry-core@1", when="@1.0.0a5:", type="build")
    depends_on("py-clikit@0.6.0:0.6", type=("build", "run"))
    depends_on("py-pylev@1.3:1", when="@1.0.0a5:", type=("build", "run"))
    depends_on("py-crashtest@0.3.1:0.3", when="@1.0.0a5:", type=("build", "run"))
