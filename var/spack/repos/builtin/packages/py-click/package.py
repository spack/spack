...
class PyClick(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@8.1:")
    depends_on("py-setuptools", type="build")

    depends_on("py-importlib-metadata", type=("build", "run"), when="@8: ^python@:3.7")
    depends_on("py-colorama", type=("build", "run"), when="@8: platform=windows")
