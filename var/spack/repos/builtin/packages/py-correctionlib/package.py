...
class PyCorrectionlib(PythonPackage):
    ...
    depends_on("py-pandas", when="+convert", type=("build", "run"))
    depends_on("py-uproot@4.0.4:", when="+convert", type=("build", "run"))
    depends_on("py-requests", when="+convert", type=("build", "run"))
