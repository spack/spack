...
class PyCwlUpgrader(PythonPackage):
    ...
    depends_on("py-ruamel-yaml@0.16.0:0.17.21", type=("build", "run"), when="^python@3.10:")
    depends_on("py-ruamel-yaml@0.15.98:0.17.21", type=("build", "run"), when="^python@3.9:")
    depends_on("py-ruamel-yaml@0.15.78:0.17.21", type=("build", "run"), when="^python@3.8:")
