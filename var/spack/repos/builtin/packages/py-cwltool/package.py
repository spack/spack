...
class PyCwltool(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on(
            "py-setuptools",
            when="@:1.0.0,1.0.20170713151519:1.0.20170721221557,1.0.20170803160545,"
            "1.0.20170817131858,1.0.20171107133715:1.0.20171227212058,"
            "1.0.20180116213856,1.0.20180224111654:",
        )
