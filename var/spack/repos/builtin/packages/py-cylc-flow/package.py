...
class PyCylcFlow(PythonPackage):
    ...
    depends_on("py-aiofiles@0.7", when="@:8.1", type=("build", "run"))
    ...
    depends_on("py-pyzmq@22:", when="@8.2:", type=("build", "run"))
    depends_on("py-pyzmq@22", when="@:8.1", type=("build", "run"))
    depends_on("py-importlib-metadata", when="^python@:3.7", type=("build", "run"))
    depends_on("py-urwid@2", type=("build", "run"))
    depends_on("py-rx", type=("build", "run"))
    depends_on("py-promise", type=("build", "run"))
    depends_on("py-tomli@2:", when="^python@:3.10", type=("build", "run"))
