...
class PyCython(PythonPackage):
    ...
    import_modules = [
        'Cython', 'pyximport', 'Cython.Distutils', 'Cython.Runtime',
        'Cython.Tempita', 'Cython.Debugger', 'Cython.Plex', 'Cython.Build',
        'Cython.Compiler', 'Cython.Utility',
    ]
    ...
    def test(self):
        # Seems to be a bug in the testing code:
        # https://github.com/cython/cython/issues/2957
