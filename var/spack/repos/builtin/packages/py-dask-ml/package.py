...
class PyDaskMl(PythonPackage):
    ...
    depends_on('py-black', type=('build', 'run'), when='+docs')
    depends_on('py-coverage', type=('build', 'run'), when='+docs')
    depends_on('py-flake8', type=('build', 'run'), when='+docs')
    ...
    depends_on('py-isort', type=('build', 'run'), when='+docs')
    depends_on('py-mypy', type=('build', 'run'), when='+docs')
    ...
    depends_on('py-psutil', type=('build', 'run'), when='+docs')
    depends_on('py-pytest', type=('build', 'run'), when='+docs')
    depends_on('py-pytest-cov', type=('build', 'run'), when='+docs')
    depends_on('py-pytest-mock', type=('build', 'run'), when='+docs')
    depends_on('py-sortedcontainers', type=('build', 'run'), when='+docs')
    depends_on('py-sparse', type=('build', 'run'), when='+docs')
    ...
    depends_on('py-toolz', type=('build', 'run'), when='+docs')
