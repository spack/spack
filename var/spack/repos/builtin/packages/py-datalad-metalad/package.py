...
class PyDataladMetalad(PythonPackage):
    ...
    depends_on("py-six", type=("build", "run"), when="@0.3.1:")
    depends_on("py-datalad@0.18:", type=("build", "run"), when="@0.4.11:")
    depends_on("py-datalad@0.15.6:", type=("build", "run"), when="@0.3:")
    depends_on("py-datalad@0.12.3:", type=("build", "run"))
    depends_on("py-datalad-metadata-model@0.3.10:", type=("build", "run"), when="@0.4.12:")
    depends_on("py-datalad-metadata-model@0.3.5:0.3", type=("build", "run"), when="@:0.4.9")
    depends_on("py-datalad-deprecated", type=("build", "run"), when="@0.4.17:")
    depends_on("py-pytest", type=("build", "run"), when="@0.4.11:")
    depends_on("py-pyyaml", type=("build", "run"), when="@0.3.1:")
