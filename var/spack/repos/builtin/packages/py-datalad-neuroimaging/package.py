...
class PyDataladNeuroimaging(PythonPackage):
    ...
    depends_on("py-setuptools@43:", type="build", when="@0.3.2:")
    depends_on("py-setuptools", type="build")

    depends_on("py-datalad@0.16.7:", type=("build", "run"), when="@0.3.2:")
    depends_on("py-datalad@0.12:", type=("build", "run"))
    depends_on("py-datalad-deprecated@0.2.7:", type=("build", "run"), when="@0.3.3:")
    depends_on("py-pydicom", type=("build", "run"))
    depends_on("py-pybids@0.15.1:", type=("build", "run"), when="@0.3.2:")
    depends_on("py-pybids@0.9.2:", type=("build", "run"))
    depends_on("py-nibabel", type=("build", "run"))
    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-datalad-metalad@0.4.5:", type=("build", "run"), when="@0.3.2:")
