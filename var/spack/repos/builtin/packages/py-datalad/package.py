...
class PyDatalad(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on(
            "py-appdirs",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,"
            "0.14.6:0.14.7,0.15.1:0.15+full",
        )
        depends_on(
            "py-appdirs",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,"
            "0.14.6:0.14.7,0.15.1:0.15",
        )
        ...
        depends_on(
            "py-beautifulsoup4",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+tests",
        )
        depends_on(
            "py-beautifulsoup4",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+full",
        )
        depends_on(
            "py-boto",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
        ...
        depends_on(
            "py-colorama",
            when="@0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,0.15.1:0.15,"
            "0.17.10:+full platform=windows",
        )
        depends_on(
            "py-colorama",
            when="@0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,0.15.1:0.15,"
            "0.17.10: platform=windows",
        )
        depends_on(
            "py-distro",
            when="@0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7," "0.15.1:0.15,0.17.10:+full",
        )
        depends_on(
            "py-distro", when="@0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7," "0.15.1:0.15,0.17.10:"
        )
        depends_on(
            "py-duecredit",
            when="@0.12.0-rc3:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+duecredit",
        )
        depends_on(
            "py-duecredit",
            when="@0.10:0.10.0-rc4,0.12.0-rc3:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+full",
        )
        ...
        depends_on(
            "py-exifread",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:0.17+metadata-extra",
        )
        depends_on(
            "py-exifread",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:0.17+full",
        )
        ...
        depends_on(
            "py-jsmin",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7+full",
        )
        depends_on(
            "py-jsmin", when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7"
        )
        ...
        depends_on(
            "py-keyring@8:",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,0.15.1:0.15",
        )
        depends_on(
            "py-keyrings-alt",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
        ...
        depends_on(
            "py-mutagen@1.36:",
            when="@0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,0.15.1:0.15,"
            "0.17.10:0.17+metadata-extra",
        )
        depends_on(
            "py-mutagen@1.36:",
            when="@0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,0.15.1:0.15,"
        ...
        depends_on(
            "py-python-dateutil",
            when="@0.10.0-rc3:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+misc",
        )
        depends_on(
            "py-python-dateutil",
        ...
        depends_on(
            "py-requests-ftp",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:+downloaders-extra",
        )
        depends_on(
            "py-simplejson",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
        ...
        depends_on(
            "py-simplejson",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:0.17",
        )
        depends_on(
            "py-tqdm",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:0.18+full",
        )
        depends_on(
            "py-tqdm",
            when="@0.10:0.10.0-rc4,0.10.1,0.12:0.12.0-rc5,0.12.0:0.12.3,0.14.6:0.14.7,"
            "0.15.1:0.15,0.17.10:0.18",
        )
