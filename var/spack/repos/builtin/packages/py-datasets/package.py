...
class PyDatasets(PythonPackage):
    ...
    depends_on("py-pyarrow@1:3+parquet", when="@:1.8.0", type=("build", "run"))
    depends_on("py-pyarrow@6:+parquet", when="@2.8.0:", type=("build", "run"))
    depends_on("py-dill@:0.3.6", type=("build", "run"))
    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-requests@2.19:", type=("build", "run"))
    depends_on("py-tqdm@4.27:4.49", when="@:1.8.0", type=("build", "run"))
    depends_on("py-tqdm@4.62.1:", when="@2.8.0:", type=("build", "run"))
    depends_on("py-xxhash", type=("build", "run"))
    depends_on("py-multiprocess", type=("build", "run"))
    depends_on("py-importlib-metadata", when="^python@:3.7", type=("build", "run"))
    depends_on("py-huggingface-hub@:0.0", when="@:1.8.0", type=("build", "run"))
    depends_on("py-huggingface-hub@0.2:0", when="@2.8.0:", type=("build", "run"))
    depends_on("py-packaging", type=("build", "run"))
    depends_on("py-aiohttp", when="@2.8.0:", type=("build", "run"))
    depends_on("py-responses@:0.18", when="@2.8.0:", type=("build", "run"))
    depends_on("py-pyyaml@5.1:", when="@2.8.0:", type=("build", "run"))

    with when("@:1.8.0"):
        depends_on("py-fsspec", when="^python@3.8:", type=("build", "run"))
        depends_on("py-fsspec@:0.8.0", when="^python@:3.7", type=("build", "run"))
    depends_on("py-fsspec@2021.11.1:+http", when="@2.8.0:", type=("build", "run"))
