...
class PyDateparser(PythonPackage):
    ...
    depends_on("py-umalqurra", when="+calendars", type=("build", "run"))
    depends_on("py-ruamel-yaml", when="+calendars", type=("build", "run"))
    depends_on("py-convertdate", when="+calendars", type=("build", "run"))
    depends_on("py-jdatetime", when="+calendars", type=("build", "run"))
