...
class PyDevito(PythonPackage):
    ...
    depends_on('py-sympy@1.7:1.11', type=('build', 'run'))
    depends_on('py-scipy', type=('build', 'run'))
    depends_on('py-flake8@2.1.0:', type=('build', 'run'))
    depends_on('py-nbval', type=('build', 'run'))
    depends_on('py-cached-property', type=('build', 'run'))
    depends_on('py-psutil@5.1.0:5.9.9' type=('build', 'run'))
    ...
    depends_on('py-click@:8.9.9' type=('build', 'run'))
    ...
    depends_on('py-distributed@2022.8:' type=('build', 'run'))
    depends_on('py-pytest@3.6:7.9' type=('build', 'run'))
