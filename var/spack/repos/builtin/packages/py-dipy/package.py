...
class PyDipy(PythonPackage):
    ...
    depends_on("python@:3.9", when="@:1.4", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-cython@0.29:", type=("build"))
    depends_on("py-cython@0.29.24:", when="@1.7:", type=("build"))
    depends_on("py-numpy@1.12.0:", type=("build", "run"))
    depends_on("py-numpy@1.14.5:", when="@1.7:", type=("build", "run"))
    depends_on("py-scipy@1.0:", type=("build", "run"))
    depends_on("py-scipy@1.1:", when="@1.7:", type=("build", "run"))
    depends_on("py-nibabel@3.0.0:", type=("build", "run"))
    depends_on("py-h5py@2.5.0:", type=("build", "run"))
    depends_on("py-h5py@2.8.0:", when="@1.7:", type=("build", "run"))
