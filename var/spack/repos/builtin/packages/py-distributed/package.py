...
class PyDistributed(PythonPackage):
    ...
    depends_on("py-msgpack@1.0.0:", when="@2023.4.1:", type=("build", "run"))
    depends_on("py-packaging@20.0:", when="@2022.2.1:", type=("build", "run"))
    depends_on("py-psutil@5.0:", type=("build", "run"))
    depends_on("py-psutil@5.7.0:", when="@2023.4.1:", type=("build", "run"))
    ...
    depends_on("py-toolz@0.10.0:", when="@2022.10.2:", type=("build", "run"))
    depends_on("py-tornado@5:", when="^python@:3.7", type=("build", "run"))
    depends_on("py-tornado@6.0.3:", when="^python@3.8:", type=("build", "run"))
    depends_on("py-tornado@6.0.3:6.1", when="@2022.10.2:", type=("build", "run"))
    depends_on("py-zict@0.1.3:", type=("build", "run"))
    depends_on("py-zict@2.2.0:", when="@2023.4.1:", type=("build", "run"))
