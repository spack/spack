...
class PyDocker(PythonPackage):
    ...
    depends_on("py-setuptools@45:", type="build", when="@6:")
    depends_on("py-setuptools-scm+toml@6.2:", type="build", when="@6:")
    depends_on("py-six@1.4.0:", type=("build", "run"), when="@4.2.1")
    depends_on("py-websocket-client@0.32.0:", type=("build", "run"))
    depends_on("py-requests@2.14.2:2.17,2.18.1:", type=("build", "run"))
    depends_on("py-requests@2.26.0:", type=("build", "run"), when="@6:")
    depends_on("py-packaging@14.0:", type=("build", "run"), when="@6:")
    depends_on("py-urllib3@1.26.0:", type=("build", "run"), when="@6:")

    depends_on("py-paramiko@2.4.3:", type=("build", "run"), when="@6:+ssh")
    depends_on("py-paramiko@2.4.2:", type=("build", "run"), when="+ssh")
