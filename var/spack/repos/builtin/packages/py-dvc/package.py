...
class PyDvc(PythonPackage):
    ...
    depends_on("py-dulwich@0.20.14:", when="@:1.11.10", type=("build", "run"))
    depends_on("py-dulwich@0.20.21:", when="@2.1.0:", type=("build", "run"))
    depends_on("py-pygit2@1.5.0:", when="@2.1.0:", type=("build", "run"))
    ...
    depends_on("py-psutil@5.8.0:", when="@2.1.0:", type=("build", "run"))
    ...
    depends_on("py-shtab@1.3.2:1", when="@:1.11.10", type=("build", "run"))
    depends_on("py-shtab@1.3.4:1", when="@2.1.0:", type=("build", "run"))
    depends_on("py-rich@3.0.5:", when="@:1.11.10", type=("build", "run"))
    depends_on("py-rich@10.0.0:", when="@2.1.0:", type=("build", "run"))
    ...
    depends_on("py-fsspec@0.9.0", when="@2.1.0:", type=("build", "run"))
    depends_on("py-diskcache@5.2.1:", when="@2.1.0:", type=("build", "run"))
