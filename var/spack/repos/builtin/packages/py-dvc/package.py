...
class PyDvc(PythonPackage):
    ...
    depends_on("py-networkx@2.1:2.4", type=("build", "run"), when="@:1.11.6")
    depends_on("py-networkx@2.1:", type=("build", "run"), when="@1.11.7:")
    ...
    depends_on("py-paramiko@2.7.0:+invoke", type=("build", "run"), when="+ssh")
    depends_on("py-boto3@1.9.201:", type=("build", "run"), when="+s3")
