...
class PyFenicsBasix(PythonPackage):
    ...
    depends_on("fenics-basix@0.3.0", type=("build", "run"), when="@0.3.0", deprecated=True)
    depends_on("fenics-basix@0.2.0", type=("build", "run"), when="@0.2.0", deprecated=True)
    depends_on("fenics-basix@0.1.0", type=("build", "run"), when="@0.1.0", deprecated=True)
