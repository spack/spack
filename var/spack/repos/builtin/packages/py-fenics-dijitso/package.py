...
class PyFenicsDijitso(PythonPackage):
    ...
    url = (
        "https://bitbucket.org/fenics-project/dijitso/downloads/dijitso-2019.1.0.tar.gz"
    )
    ...
    version(
        "2017.2.0",
        sha256="05a893d17f8a50067d303b232e41592dce2840d6499677ad8b457ba58a679b58",
    )
    version(
        "2017.1.0",
    ...
    version(
        "2016.2.0",
        sha256="1bfa0ac0d47dae75bbde8fabb1145d3caa2e6c28a1e4097ad5550a91a8a205e4",
    )
