...
class PyFlake8(PythonPackage):
    ...
    version('3.3.0', '11d7fc1b13740beb61b0265cf79354c5')
    ...
    depends_on('py-pyflakes@1.5.0:1.5.999', when='@3.3.0', type=('build', 'run'))
    ...
    depends_on('py-pycodestyle@2.0.0:2.3.999', when='@3.3.0', type=('build', 'run'))
    ...
    # mccabe >= 0.6.0, < 0.7.0
    depends_on('py-mccabe@0.6.0:0.6.999', when='@3.3.0', type=('build', 'run'))
    # mccabe >= 0.5.0, < 0.6.0
