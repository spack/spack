...
class PyFlask(PythonPackage):
    ...
    depends_on("py-werkzeug@2.3.3:", type=("build", "run"), when="@2.3.2:")
    depends_on("py-werkzeug@2.2.2:", type=("build", "run"), when="@2.2.2:")
    depends_on("py-werkzeug@2:", type=("build", "run"), when="@2:")
    depends_on("py-werkzeug@0.15:", type=("build", "run"))
    depends_on("py-jinja2@3.1.2:", type=("build", "run"), when="@3:")
    depends_on("py-jinja2@3:", type=("build", "run"), when="@2:")
    depends_on("py-jinja2@2.10.1:", type=("build", "run"))
    depends_on("py-itsdangerous@2.1.2:", type=("build", "run"), when="@3:")
    depends_on("py-itsdangerous@2:", type=("build", "run"), when="@2:")
    depends_on("py-itsdangerous@0.24:", type=("build", "run"))
    depends_on("py-click@8.1.3:", type=("build", "run"), when="@3:")
    depends_on("py-click@8:", type=("build", "run"), when="@2.1:")
    depends_on("py-click@7.1.2:", type=("build", "run"), when="@2:")
    depends_on("py-click@5.1:", type=("build", "run"))
    depends_on("py-blinker@1.6.2:", type=("build", "run"), when="@2.3:")
    depends_on("py-importlib-metadata@3.6:", type=("build", "run"), when="@2.1: ^python@:3.9")
