...
class PyFlit(PythonPackage):
    ...
    depends_on("py-flit-core@3.9.0:3", type=("build", "run"), when="@3.9.0:3")
    depends_on("py-flit-core@3.8.0:3", type=("build", "run"), when="@3.8.0:3.8")
    depends_on("py-flit-core@3.7.1:3", type=("build", "run"), when="@3.7.1:3.7")
    depends_on("py-flit-core@3.6.0:3", type=("build", "run"), when="@3.6.0:3.6")
    depends_on("py-flit-core@3.3.0:3", type=("build", "run"), when="@3.3.0:3.3")
    depends_on("py-requests", type=("build", "run"))
    depends_on("py-docutils", type=("build", "run"))
    depends_on("py-tomli", type=("build", "run"), when="@3.4:3.7")
    depends_on("py-tomli-w", type=("build", "run"), when="@3.4:")
    depends_on("py-toml", type=("build", "run"), when="@3.3.0:3.3")
