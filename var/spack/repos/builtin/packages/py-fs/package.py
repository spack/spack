...
class PyFs(PythonPackage):
    ...
    # Generated by creating a venv with setuptools==59 and running setup.py
    # Notice: binary patch, since some files have CRLF line endings and
    # patch doesn't like patching CRLF files with LF patch
    patch('2to3.patch', level=0, when='@0.5.4 ^python@3:')
