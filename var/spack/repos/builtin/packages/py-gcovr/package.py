...
class PyGcovr(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@5.1:")
    depends_on("python@3.6:", type=("build", "run"), when="@5.0")
    depends_on("python@2.7:2,3.5:", type=("build", "run"), when="@:4")
    depends_on("py-setuptools", type=("build", "run"))

    depends_on("py-jinja2", type=("build", "run"))
    depends_on("py-lxml", type=("build", "run"))
    depends_on("py-pygments", type=("build", "run"), when="@5:")
