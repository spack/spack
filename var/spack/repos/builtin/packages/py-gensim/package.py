...
class PyGensim(PythonPackage):
    ...
    version(
        "3.8.0",
        sha256="ec5de7ff2bfa8692fa96a846bb5aae52f267fc322fbbe303c1f042d258af5766",
    )
    ...
    depends_on(
        "py-smart-open@1.7.0:1.10", when="@3.8.0^python@:2", type=("build", "run")
    )
    depends_on("py-smart-open@1.7.0:", when="@3.8.0^python@3:", type=("build", "run"))
    depends_on(
        "py-smart-open@1.8.1:1.10", when="@3.8.1:^python@:2", type=("build", "run")
    )
