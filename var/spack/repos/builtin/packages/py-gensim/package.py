...
class PyGensim(PythonPackage):
    ...
    depends_on("python@3.8:", when="@4.3.1:", type=("build", "run"))
    depends_on("py-setuptools", type="build")

    depends_on("py-cython", when="@4.3.1:", type=("build", "run"))

    depends_on("py-numpy@1.11.3:", type=("build", "run"))
    depends_on("py-numpy@1.18.5:", when="@4.3.1:", type=("build", "run"))

    depends_on("py-scipy@0.18.1:", type=("build", "run"))
    depends_on("py-scipy@1.7.0:", when="@4.3.1:", type=("build", "run"))

    depends_on("py-six@1.5.0:", when="@:3.8.3", type=("build", "run"))
