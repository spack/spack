...
class PyGeopandas(PythonPackage):
    ...
    depends_on("python@3.5:", when="@0.7:", type=("build", "run"))
    depends_on("python@3.6:", when="@0.9:", type=("build", "run"))
    depends_on("python@3.7:", when="@0.10:", type=("build", "run"))
    depends_on("python@3.8:", when="@0.11:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-pandas@0.23.0:", when="@0.6:", type=("build", "run"))
    depends_on("py-pandas@0.24.0:", when="@0.9:", type=("build", "run"))
    depends_on("py-pandas@0.25.0:", when="@0.10:", type=("build", "run"))
    depends_on("py-pandas@1.0.0:", when="@0.11:", type=("build", "run"))
    depends_on("py-shapely@:1", type=("build", "run"))
    depends_on("py-shapely@1.6:1", when="@0.9:0.10", type=("build", "run"))
    depends_on("py-shapely@1.7:1", when="@0.11:", type=("build", "run"))
    depends_on("py-fiona", type=("build", "run"))
    depends_on("py-fiona@1.8:", when="@0.9:", type=("build", "run"))
    depends_on("py-pyproj", type=("build", "run"))
    depends_on("py-pyproj@2.2.0:", when="@0.7:", type=("build", "run"))
    depends_on("py-pyproj@2.6.1.post1:", when="@0.11:", type=("build", "run"))
    depends_on("py-packaging", when="@0.11:", type=("build", "run"))
