...
class PyGevent(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@23.7.0:")
    depends_on("python@:3.10", type=("build", "run"), when="@:21.12")

    depends_on("py-setuptools@40.8:", type=("build", "run"), when="@20.5.1:")
    depends_on("py-setuptools@40.8:", type="build", when="@1.5:")
    depends_on("py-setuptools@24.2:", type="build", when="@:1.4")
    depends_on("py-cython@3:", type="build", when="@20.5.1:")
    depends_on("py-cython@0.29.14:", type="build", when="@1.5:")
    depends_on("py-cffi@1.12.3:", type=("build", "run"))
    depends_on("py-greenlet@3:", type=("build", "run"), when="@23.7: ^python@3.12:")
    depends_on("py-greenlet@2:", type=("build", "run"), when="@22.10.2: ^python@:3.11")
    depends_on("py-greenlet@1.1:1", type=("build", "run"), when="@21.8:21.12.0")
    depends_on("py-greenlet@0.4.17:1", type=("build", "run"), when="@20.12:21.1.2")
    depends_on("py-greenlet@0.4.14:", type=("build", "run"))
    depends_on("py-zope-event", type=("build", "run"), when="@20.5.1:")
    depends_on("py-zope-interface", type=("build", "run"), when="@20.5.1:")
