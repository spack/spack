...
class PyGitpython(PythonPackage):
    ...
    version(
        "3.1.22",
        sha256="e1589f27c3cd1f33b22db1df194201b5abca6b4cc5450f13f9c371e099c1b24f",
    )
    version(
        "3.1.20",
    ...
    version(
        "3.1.4",
        sha256="fa98ce1f05805d59bbc3adb16c0780e5ca43b5ea9422feecf1cd0949a61d947e",
    )
    version(
        "3.1.3",
    ...
    version(
        "0.3.6",
        sha256="e6599fcb939cb9b25a015a429702db39de10f2b493655ed5669c49c37707d233",
    )
    ...
    depends_on(
        "py-typing-extensions@3.7.4.0:",
        type=("build", "run"),
        when="@3.1.16: ^python@:3.7",
    )
    depends_on(
        "py-typing-extensions@3.7.4.3:",
        type=("build", "run"),
        when="@3.1.19: ^python@:3.10",
    )
