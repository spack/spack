...
class PyGluoncv(PythonPackage):
    ...
    depends_on("py-yacs", type=("build", "run"), when="@0.8:")
    depends_on("py-pandas", type=("build", "run"), when="@0.9:")
    depends_on("py-pyyaml", type=("build", "run"), when="@0.9:")
    depends_on("py-autocfg", type=("build", "run"), when="@0.9:")
