...
class PyGpaw(PythonPackage):
    ...
    depends_on("python@2.6:", when="@:1.3.0", type=("build", "run"))
    depends_on("python@3.5:", when="@19.8.1:", type=("build", "run"))
    depends_on("python@3.6:", when="@20.10.0:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-ase@3.13.0:", when="@1.3.0", type=("build", "run"))
    depends_on("py-ase@3.18.0:", when="@19.8.1", type=("build", "run"))
    depends_on("py-ase@3.19.0:", when="@20.1.0", type=("build", "run"))
    depends_on("py-ase@3.20.1:", when="@20.10.0", type=("build", "run"))
    depends_on("py-ase@3.21.0:", when="@21.1.0", type=("build", "run"))
