...
class PyGpytorch(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@1.9:")
    depends_on("python@3.7:", type=("build", "run"), when="@1.7:")
    depends_on("python@3.6:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools-scm", type="build", when="@1.9:")
    depends_on("py-torch@1.11:", type=("build", "run"), when="@1.9:")
    depends_on("py-torch@1.10:", type=("build", "run"), when="@1.7:")
    depends_on("py-torch@1.9:", type=("build", "run"), when="@1.6:")
    depends_on("py-torch@1.8.1:", type=("build", "run"), when="@1.5:")
    depends_on("py-torch@1.7:", type=("build", "run"), when="@1.3:")
    depends_on("py-torch@1.6:", type=("build", "run"), when="@1.2:")
    depends_on("py-torch@1.5:", type=("build", "run"))
    depends_on("py-scikit-learn", type=("build", "run"), when="@1.2:")
    depends_on("py-linear-operator@0.1.1:", type=("build", "run"), when="@1.9:")
    depends_on("py-linear-operator@0.2.0:", type=("build", "run"), when="@1.9.1:")
    depends_on("py-linear-operator@0.4.0:", type=("build", "run"), when="@1.10:")
    depends_on("py-numpy", type=("build", "run"), when="@1.7:1.8")
    depends_on("py-scipy", type=("build", "run"), when="@1.2:1.8")
