...
class PyGraphqlCore(PythonPackage):
    ...
    depends_on("py-six@1.10.0:", when="@2.3.2", type=("build", "run"))
    depends_on("py-promise@2.3:2", when="@2.3.2", type=("build", "run"))
    depends_on("py-rx@1.6:1", when="@2.3.2", type=("build", "run"))
