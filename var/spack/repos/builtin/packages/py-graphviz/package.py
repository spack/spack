...
class PyGraphviz(PythonPackage):
    ...
    depends_on("python@2.7:2.8,3.5:", when="@0.11.0:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-tox@3.0:", when="+dev", type=("build", "run"))
    depends_on("py-flake8", when="+dev", type=("build", "run"))
    depends_on("py-pep8-naming", when="+dev", type=("build", "run"))
    depends_on("py-wheel", when="+dev", type=("build", "run"))
    depends_on("py-twine", when="+dev", type=("build", "run"))
    depends_on("py-sphinx@1.7:", when="+docs", type=("build", "run"))
