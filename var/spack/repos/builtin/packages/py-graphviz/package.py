...
class PyGraphviz(PythonPackage):
    ...
    variant('test', default=False, description='test mode')
    ...
    depends_on('py-mock@2:', type=('build', 'run'), when='+test')
    depends_on('py-pytest@3.4:', type=('build', 'run'), when='+test')
    depends_on('py-pytest-mock@1.8:', type=('build', 'run'), when='+test')
