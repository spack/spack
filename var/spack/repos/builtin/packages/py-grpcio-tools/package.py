...
class PyGrpcioTools(PythonPackage):
    ...
    version("1.60.1", sha256="da08224ab8675c6d464b988bd8ca02cccd2bf0275bceefe8f6219bfd4a4f5e85")
    ...
    with default_args(type=("build", "run")):
        depends_on("py-protobuf@4.21.6:4", when="@1.49.0:")
        depends_on("py-protobuf@3.12.0:3", when="@1.48.1:1.48")
        depends_on("py-protobuf@3.5.0.post1:3", when="@:1.47")

        depends_on("py-grpcio@1.62.2:", when="@1.62.2:")
        depends_on("py-grpcio@1.60.1:", when="@1.60.1:")
        depends_on("py-grpcio@1.56.2:", when="@1.56.2:")
        depends_on("py-grpcio@1.48.1:", when="@1.48.1:")
        depends_on("py-grpcio@1.42.0:", when="@1.42.0:")
        depends_on("py-grpcio@1.39.0:", when="@1.39.0:1.41")
    depends_on("openssl")
    depends_on("zlib-api")
    depends_on("c-ares")
