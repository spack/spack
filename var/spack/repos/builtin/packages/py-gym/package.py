...
class PyGym(PythonPackage):
    ...
    depends_on("py-scipy", when="@0.18.0", type=("build", "run"))
    depends_on("py-numpy@1.10.4:", when="@0.18.0", type=("build", "run"))
    depends_on("py-numpy@1.18.0:", when="@0.19.0", type=("build", "run"))
    depends_on("py-pyglet@1.4.0:1.5.0", when="@0.18.0", type=("build", "run"))
    depends_on("pil@:7.2.0", when="@0.18.0", type=("build", "run"))
