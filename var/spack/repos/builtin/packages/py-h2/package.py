...
class PyH2(PythonPackage):
    ...
    depends_on("python@3.6.1:", when="@4.0.0:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-hyperframe@5.2:5", when="@3.2.0", type=("build", "run"))
    depends_on("py-hyperframe@6.0:6", when="@4.0.0:", type=("build", "run"))
    depends_on("py-hpack@3.0:3", when="@3.2.0", type=("build", "run"))
    depends_on("py-hpack@4.0:4", when="@4.0.0:", type=("build", "run"))
