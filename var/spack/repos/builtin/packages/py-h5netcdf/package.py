...
class PyH5netcdf(PythonPackage):
    ...
    local or remote HDF5 files directly via h5py or h5pyd, without relying on
    the Unidata netCDF library."""

    homepage = "https://github.com/h5netcdf/h5netcdf"
    url      = "https://pypi.io/packages/source/h/h5netcdf/h5netcdf-0.10.0.tar.gz"
