...
class PyH5py(PythonPackage):
    ...
    depends_on(
        "py-numpy@1.14.5:", type=("build", "run"), when="@3.0.0:^python@3.7.0:3.7"
    )
    depends_on(
        "py-numpy@1.17.5:", type=("build", "run"), when="@3.0.0:^python@3.8.0:3.8"
    )
    ...
    depends_on(
        "py-mpi4py@3.0.0:",
        when="@3.0.0:3.2+mpi^python@3.0.0:3.7",
        type=("build", "run"),
    )
    depends_on(
        "py-mpi4py@3.0.2:", when="@3.3.0:+mpi^python@3.0.0:3.7", type=("build", "run")
    )
    depends_on(
