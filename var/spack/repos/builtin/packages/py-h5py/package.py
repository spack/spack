...
class PyH5py(PythonPackage):
    ...
    depends_on("python@3.6:", when="@3:3.1", type=("build", "run"))
    ...
    depends_on("py-numpy@1.7:", when="@:2", type=("build", "run"))
    depends_on("py-numpy@1.14.5:", when="@3:", type=("build", "run"))
    depends_on("py-numpy@1.17.5:", when="@3:3.5 ^python@3.8.0:3.8", type=("build", "run"))
    depends_on("py-numpy@1.19.3:", when="@3:3.5 ^python@3.9.0:", type=("build", "run"))
