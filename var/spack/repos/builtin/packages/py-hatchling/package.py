...
class PyHatchling(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@1.18:")
    depends_on("py-editables@0.3:", type=("build", "run"))
    depends_on("py-importlib-metadata", type=("build", "run"), when="^python@:3.7")
    depends_on("py-packaging@21.3:", type=("build", "run"))
    depends_on("py-pathspec@0.10.1:", type=("build", "run"), when="@1.9:")
    ...
    depends_on("py-trove-classifiers", type=("build", "run"), when="@1.14:")
