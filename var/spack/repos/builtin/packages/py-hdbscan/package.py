...
class PyHdbscan(PythonPackage):
    ...
    depends_on("py-numpy@1.20:", when="@0.8.29:", type=("build", "run"))
    depends_on("py-scipy@0.9:", type=("build", "run"))
    depends_on("py-scipy@1.0:", when="@0.8.29:", type=("build", "run"))
    depends_on("py-scikit-learn@0.17:", type=("build", "run"))
    depends_on("py-scikit-learn@0.20:", when="@0.8.29:", type=("build", "run"))
    depends_on("py-joblib", type=("build", "run"))
    depends_on("py-joblib@1.0:", when="@0.8.29:", type=("build", "run"))
