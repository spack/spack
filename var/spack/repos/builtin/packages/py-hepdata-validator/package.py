...
class PyHepdataValidator(PythonPackage):
    ...
    depends_on("python@3.6:", type=("build", "run"), when="@0.3.3:")
    depends_on("py-setuptools", type="build")
    depends_on("py-click", type=("build", "run"), when="@0.3.3:")
    depends_on("py-jsonschema", type=("build", "run"))
    depends_on("py-packaging", type=("build", "run"), when="@0.3.3:")
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-pyyaml@5.4.1:", type=("build", "run"), when="@0.3.3:")
