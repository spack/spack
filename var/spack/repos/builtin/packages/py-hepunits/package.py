...
class PyHepunits(PythonPackage):
    ...
    depends_on("python@3.6:", type=("build", "run"), when="@2.2:")
    depends_on("python@3.7:", type=("build", "run"), when="@2.3:")
    depends_on("py-setuptools", type="build", when="@:2.2")
    depends_on("py-setuptools-scm +toml", type="build", when="@:2.2")
    depends_on("py-hatchling", type="build", when="@2.3:")
    depends_on("py-hatch-vcs", type="build", when="@2.3:")
    depends_on("py-toml", type="build", when="@:2.1.1")
