...
class PyHorovod(PythonPackage, CudaPackage):
    ...
    depends_on("py-six", when="@:0.19", type=("build", "run"))
    depends_on("py-packaging", when="@0.26:", type=("build", "run"))

    # Framework dependencies
    depends_on("py-tensorflow@1.1.0:", when="frameworks=tensorflow", type=("build", "link", "run"))
    depends_on(
        "py-tensorflow@1.15:", when="frameworks=tensorflow @0.20:", type=("build", "link", "run")
    )
    depends_on("py-tensorflow-estimator", when="frameworks=tensorflow", type=("build", "run"))
    depends_on("py-keras@2.0.8,2.1.2:", when="frameworks=keras", type=("build", "run"))
    depends_on("py-torch@0.4.0:", when="frameworks=pytorch", type=("build", "link", "run"))
    depends_on("py-torch@1.2:", when="frameworks=pytorch @0.20:", type=("build", "link", "run"))
    depends_on("py-torch@1.5:", when="frameworks=pytorch @0.25:", type=("build", "link", "run"))
    depends_on("py-torchvision", when="frameworks=pytorch @:0.19.1", type=("build", "run"))
    depends_on("py-cffi@1.4.0:", when="frameworks=pytorch", type=("build", "run"))
    depends_on("py-pytorch-lightning", when="frameworks=pytorch @0.22:0.23", type=("build", "run"))
    depends_on(
        "py-pytorch-lightning@1.3.8", when="frameworks=pytorch @0.24", type=("build", "run")
    )
    depends_on(
        "py-pytorch-lightning@1.3.8:1.5.9", when="frameworks=pytorch @0.25:", type=("build", "run")
    )
    depends_on("mxnet@1.4.1:+python", when="frameworks=mxnet", type=("build", "link", "run"))
    depends_on("py-h5py@:2", when="frameworks=spark @:0.23", type=("build", "run"))
    depends_on("py-numpy", when="frameworks=spark", type=("build", "run"))
    depends_on("py-petastorm@0.8.2", when="frameworks=spark @:0.19.1", type=("build", "run"))
    depends_on(
        "py-petastorm@0.9.0:", when="frameworks=spark @0.19.2:0.21.0", type=("build", "run")
    )
    depends_on("py-petastorm@0.9.8:", when="frameworks=spark @0.21.1:", type=("build", "run"))
    depends_on("py-petastorm@0.11:", when="frameworks=spark @0.22:", type=("build", "run"))
    depends_on("py-petastorm@0.12:", when="frameworks=spark @0.26:", type=("build", "run"))
    depends_on("py-pyarrow@0.15.0:10", when="frameworks=spark", type=("build", "run"))
    depends_on("py-pyspark@2.3.2:", when="frameworks=spark ^python@:3.7", type=("build", "run"))
    depends_on("py-pyspark@3.0.0:", when="frameworks=spark ^python@3.8:", type=("build", "run"))
    depends_on("py-fsspec", when="frameworks=spark @0.22.1:0.24.1", type=("build", "run"))
    depends_on("py-fsspec@2021.07:", when="frameworks=spark @0.24.2:", type=("build", "run"))
    depends_on("py-ray", when="frameworks=ray", type=("build", "run"))
    depends_on("py-aioredis@:1", when="frameworks=ray @0.23:", type=("build", "run"))
    depends_on("py-google-api-core@:2.8", when="frameworks=ray @0.26:", type=("build", "run"))
