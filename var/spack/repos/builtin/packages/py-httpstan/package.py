...
class PyHttpstan(PythonPackage):
    ...
    depends_on("python@3.8:3", when="@4.7:", type=("build", "run"))
    depends_on("python@3.7:3", when="@:4.6", type=("build", "run"))
    ...
    depends_on("py-numpy@1.19:1", when="@4.7:", type=("build", "run"))
    depends_on("py-numpy@1.16:1", when="@:4.6", type=("build", "run"))
