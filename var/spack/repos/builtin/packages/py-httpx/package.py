...
class PyHttpx(PythonPackage):
    ...
    depends_on("py-hatchling", type="build", when="@0.23:")
    depends_on("py-hatch-fancy-pypi-readme", type="build", when="@0.23:")
    depends_on("py-certifi", type=("build", "run"))
    depends_on("py-httpcore@0.15:0.16", type=("build", "run"), when="@0.23:")
    ...
    depends_on("py-setuptools", type="build", when="@:0.22")
