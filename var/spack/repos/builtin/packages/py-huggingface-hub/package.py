...
class PyHuggingfaceHub(PythonPackage):
    ...
    depends_on("py-pyyaml@5.1:", type=("build", "run"), when="@0.10:")
    depends_on("py-typing-extensions@3.7.4.3:", type=("build", "run"), when="@0.10:")
    depends_on("py-typing-extensions", type=("build", "run"), when="@0.0.10:")
    depends_on("py-importlib-metadata", type=("build", "run"), when="^python@:3.7")
    depends_on("py-packaging@20.9:", type=("build", "run"), when="@0.10:")

    depends_on("py-inquirerpy@0.3.4", type=("build", "run"), when="@0.14:+cli")
