...
class PyHyperopt(PythonPackage):
    ...
    depends_on("py-pyspark", type=("build", "run"), when="+spark")
    depends_on("py-pymongo", type=("build", "run"), when="+mongo")
    depends_on("py-scikit-learn", type=("build", "run"), when="+atpe")
    depends_on("py-lightgbm", type=("build", "run"), when="+atpe")
