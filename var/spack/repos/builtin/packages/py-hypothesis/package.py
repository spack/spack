...
class PyHypothesis(PythonPackage):
    ...
    depends_on("py-attrs@19.2.0:", type=("build", "run"), when="@4.38.2:")
    depends_on("py-attrs@16.0.0:", type=("build", "run"), when="@3.44.22:")
    depends_on("py-attrs", type=("build", "run"), when="@3.28.0:")
