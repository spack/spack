...
class PyIdna(PythonPackage):
    ...
    depends_on("python@2.7:2,3.4:", type=("build", "run"), when="@2.8:2")
    depends_on("python@2.6:", type=("build", "run"), when="@:2.7")
    depends_on("py-flit-core@3.2:3", type="build", when="@3.4:")
    depends_on("py-setuptools", type=("build", "link"), when="@:3.3")
