...
class PyInferenceSchema(PythonPackage):
    ...
    depends_on("py-numpy@1.13.0:", type=("build", "run"), when="+numpy")
    depends_on("py-pandas@0.20.2:", type=("build", "run"), when="+pandas")
    depends_on("py-pyspark@2.3.2", type=("build", "run"), when="+pyspark")
