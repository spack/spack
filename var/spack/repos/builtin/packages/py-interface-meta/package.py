...
class PyInterfaceMeta(PythonPackage):
    ...
    depends_on("python@3.7:3", type=("build", "run"), when="@1.3:")
    depends_on("python@3.4:", type=("build", "run"))
    depends_on("py-poetry-core@1:", type="build", when="@1.3:")
    depends_on("py-poetry-dynamic-versioning", type="build", when="@1.3:")
    depends_on("py-setuptools", type="build", when="@:1.2")
    depends_on("py-setupmeta", type="build", when="@:1.2")
