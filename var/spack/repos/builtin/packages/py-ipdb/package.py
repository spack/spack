...
class PyIpdb(PythonPackage):
    ...
    depends_on("py-toml@0.10.2:", type=("build", "run"), when="@:0.13.9")

    depends_on("py-ipython@7.31.1:", type=("build", "run"), when="@0.13.10:")
    depends_on("py-tomli", type=("build", "run"), when="@0.13.10: ^python@:3.10")
