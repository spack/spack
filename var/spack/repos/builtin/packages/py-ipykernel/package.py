...
class PyIpykernel(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@6.22:")
    depends_on("py-hatchling@1.4:", type="build", when="@6.13.1:")

    depends_on("py-debugpy@1.6.5:", type=("build", "run"), when="@6.22:")
    depends_on("py-debugpy@1:", type=("build", "run"), when="@6.11:")
    depends_on("py-debugpy@1.0:1", type=("build", "run"), when="@6:6.10")
    depends_on("py-ipython@7.23.1:", type=("build", "run"), when="@6.5.1:")
    depends_on("py-ipython@7.23.1:7", type=("build", "run"), when="@6.0.0:6.5.0")
    depends_on("py-ipython@5.0:", type=("build", "run"), when="@5")
    depends_on("py-ipython@4.0:", type=("build", "run"), when="@:4")
    depends_on("py-comm@0.1.1:", type=("build", "run"), when="@6.22:")
    depends_on("py-traitlets@5.4:", type=("build", "run"), when="@6.22:")
    depends_on("py-traitlets@5.1:", type=("build", "run"), when="@6.11:")
    depends_on("py-traitlets@5.1.0:5", type=("build", "run"), when="@6.5:6.10")
    depends_on("py-traitlets@4.1.0:5", type=("build", "run"), when="@6.0:6.4")
    depends_on("py-traitlets@4.1.0:", type=("build", "run"))
    depends_on("py-jupyter-client@6.1.12:", type=("build", "run"), when="@6.11:")
    depends_on("py-jupyter-client@:7", type=("build", "run"), when="@6.2:6.10")
    depends_on("py-jupyter-client@:6", type=("build", "run"), when="@6.0.2:6.1")
    depends_on("py-jupyter-client", type=("build", "run"))
    depends_on("py-jupyter-core@4.12:", type=("build", "run"), when="@6.22:")
    depends_on("py-nest-asyncio", type=("build", "run"), when="@6.6.1:")
    depends_on("py-tornado@6.1:", type=("build", "run"), when="@6.11:")
    depends_on("py-tornado@5:6", type=("build", "run"), when="@6.10")
    depends_on("py-tornado@4.2:6", type=("build", "run"), when="@6:6.9")
    depends_on("py-tornado@4.2:", type=("build", "run"), when="@5")
    depends_on("py-tornado@4:", type=("build", "run"), when="@:4")
    depends_on("py-matplotlib-inline@0.1:", type=("build", "run"), when="@6.11:")
    depends_on("py-matplotlib-inline@0.1.0:0.1", type=("build", "run"), when="@6:6.10")
    depends_on("py-appnope", type=("build", "run"), when="@5.1.3: platform=darwin")
    depends_on("py-pyzmq@20:", type=("build", "run"), when="@6.22:")
    depends_on("py-pyzmq@17:", type=("build", "run"), when="@6.15:")
    depends_on("py-psutil", type=("build", "run"), when="@6.9.2:")
    depends_on("py-packaging", type=("build", "run"), when="@6.12:")

    conflicts("^py-jupyter-core@5.0")

    # Historical dependencies
    depends_on("py-setuptools", type="build", when="@5:6.13.0")
    depends_on("py-jupyter-core@4.2:", type="build", when="@5:6.13.0")
    depends_on("py-ipython-genutils", type=("build", "run"), when="@6.3.1:6.4")
    depends_on("py-ipython-genutils", type=("build", "run"), when="@5.5.6")
    depends_on("py-importlib-metadata@:4", type=("build", "run"), when="@6.1:6.6 ^python@:3.7")
    depends_on("py-importlib-metadata@:3", type=("build", "run"), when="@6.0.0:6.0 ^python@:3.7")
    depends_on("py-argcomplete@1.12.3:", type=("build", "run"), when="@6.1:6.6 ^python@:3.7")
