...
class PyIpyparallel(PythonPackage):
    ...
    depends_on("python@3.6:", when="@7.1:", type=("build", "run"))
    ...
    depends_on("py-pyzmq@18:", when="@7.1:", type=("build", "run"))
    ...
    depends_on("py-tornado@5.1:", when="@7.1:", type=("build", "run"))
    depends_on("py-tornado@4:", type=("build", "run"))
    depends_on("py-psutil", when="@7.1:", type=("build", "run"))
    depends_on("py-python-dateutil@2.1:", type=("build", "run"))
    depends_on("py-tqdm", when="@7.1:", type=("build", "run"))
