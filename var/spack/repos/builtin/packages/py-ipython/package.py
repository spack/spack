...
class PyIpython(PythonPackage):
    ...
    depends_on("python@3.9:", type=("build", "run"), when="@8.13.1:")
    depends_on("python@3.8:", type=("build", "run"), when="@8:")
    depends_on("py-setuptools@51:", type="build", when="@8:")
    depends_on("py-setuptools@18.5:", type="run", when="@:7")
    ...
    depends_on("py-matplotlib-inline", type=("build", "run"), when="@7.23:")
    ...
    depends_on("py-pexpect", type=("build", "run"), when="platform=linux")
    depends_on("py-pexpect", type=("build", "run"), when="platform=darwin")
    depends_on("py-pexpect", type=("build", "run"), when="platform=cray")
    depends_on("py-pickleshare", type=("build", "run"))
    depends_on("py-prompt-toolkit@3.0.30:3.0.36,3.0.38:3.0", type=("build", "run"), when="@8.11:")
    depends_on("py-prompt-toolkit@3.0.2:3.0", type=("build", "run"), when="@8.5:")
    depends_on("py-prompt-toolkit@2.0.0:2,3.0.2:3.0", type=("build", "run"), when="@7.26:")
    depends_on("py-prompt-toolkit@3.0.2:3.0", type=("build", "run"), when="@7.18:7.25")
    depends_on("py-prompt-toolkit@2.0.0:2.0", type=("build", "run"), when="@7.5.0")
    depends_on("py-prompt-toolkit@2.0.0:2", type=("build", "run"), when="@7.0.0:7.5.0")
    depends_on("py-prompt-toolkit@1.0.4:1", type=("build", "run"), when="@:7.0.0")
    depends_on("py-prompt-toolkit@1.0.3:1", type=("build", "run"), when="@:7.0.0")
    depends_on("py-pygments@2.4:", type=("build", "run"), when="@8.1:")
    depends_on("py-pygments", type=("build", "run"))
    depends_on("py-stack-data", type=("build", "run"), when="@8:")
    depends_on("py-traitlets@5:", type=("build", "run"), when="@8:")
    depends_on("py-traitlets@4.2:", type=("build", "run"))
    depends_on("py-traitlets", type=("build", "run"))
    depends_on("py-typing-extensions", type=("build", "run"), when="@8.12: ^python@:3.9")

    # Historical dependencies
    depends_on("py-black", type=("build", "run"), when="@8.0")
