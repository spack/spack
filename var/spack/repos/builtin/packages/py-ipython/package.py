...
class PyIpython(PythonPackage):
    ...
    depends_on('py-expect@4.4:', type=('build', 'run'), when='@7.18: platform=linux')
    depends_on('py-expect@4.4:', type=('build', 'run'), when='@7.18: platform=darwin')
    depends_on('py-expect@4.4:', type=('build', 'run'), when='@7.18: platform=cray')
