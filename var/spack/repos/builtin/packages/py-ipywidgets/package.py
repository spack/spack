...
class PyIpywidgets(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@8.0.2:")
    # pip silently replaces distutils with setuptools
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools@40.8.0:", type="build", when="@8.0.2:")
    depends_on("py-ipython@4:", type=("build", "run"))
    depends_on("py-ipython@6.1.0:", type=("build", "run"), when="@8.0.2:")
    ...
    depends_on("py-widgetsnbextension@3.6", type=("build", "run"), when="@7.7:7")
    depends_on("py-widgetsnbextension@4.0:4", type=("build", "run"), when="@8.0.2:")
    depends_on("py-jupyterlab-widgets@1.0.0:", type=("build", "run"), when="@:7")
    depends_on("py-jupyterlab-widgets@3.0:3", type=("build", "run"), when="@8.0.2:")
    depends_on("py-ipython-genutils@0.2.0:0.2", type=("build", "run"), when="@7.6.4:7")
    depends_on("py-nbformat@4.2.0:", type=("build", "run"), when="@6:7")
