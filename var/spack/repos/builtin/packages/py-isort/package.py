...
class PyIsort(PythonPackage):
    ...
    depends_on('python@2.6:2.7.999,3.3:', when='@4.2.15:')
    depends_on('python@2.7:2.7.999,3.4:', when='@4.3.0:')
    depends_on('py-futures', when='@4.3.0: ^python@2.7:2.7.999,:3.1')
    depends_on('py-backports-functools-lru-cache', when='@4.3.10: ^python@:3.2')
