...
class PyJsonschema(PythonPackage):
    ...
    depends_on("py-hatch-vcs", type="build", when="@4.10:")
    depends_on("py-hatch-fancy-pypi-readme", type="build", when="@4.11:")

    depends_on("py-attrs@17.4:", type=("build", "run"), when="@3:")
    depends_on("py-pyrsistent@0.14:", type=("build", "run"), when="@3:")
    depends_on("py-importlib-metadata", type=("build", "run"), when="@3.1.1: ^python@:3.7")
    depends_on("py-typing-extensions", type=("build", "run"), when="@4.3: ^python@:3.7")
    depends_on("py-importlib-resources@1.4:", type=("build", "run"), when="@4.2.1: ^python@:3.8")
    depends_on("py-importlib-resources", type=("build", "run"), when="@4.2.0 ^python@:3.8")
    depends_on("py-pkgutil-resolve-name@1.3.10:", when="@4.10.0: ^python@:3.8")

    # Historical dependencies
    depends_on("py-setuptools@40.6.0:", type="build", when="@4:4.4")
    ...
    depends_on("py-setuptools-scm+toml@3.4:", type="build", when="@4.4.0")
    depends_on("py-setuptools-scm", type="build", when="@3")
    depends_on("py-six@1.11:", type=("build", "run"), when="@3")

    conflicts("^py-pyrsistent@0.17.0:0.17.2")

    with when("+format-nongpl"):
        depends_on("py-fqdn", type=("build", "run"), when="@4:")
        depends_on("py-idna", type=("build", "run"))
        depends_on("py-isoduration", type=("build", "run"), when="@4:")
        ...
        depends_on("py-uri-template", type=("build", "run"), when="@4:")
        depends_on("py-webcolors@1.11:", type=("build", "run"), when="@4:")
