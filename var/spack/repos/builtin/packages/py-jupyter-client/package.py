...
class PyJupyterClient(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@8:")
    depends_on("py-hatchling@1.5:", type="build", when="@8:")
    depends_on("py-hatchling@0.25:", type="build", when="@7.3.5:")

    depends_on("py-importlib-metadata@4.8.3:", type=("build", "run"), when="@8: ^python@:3.9")
    depends_on("py-jupyter-core@4.12:", type=("build", "run"), when="@8:")
    depends_on("py-jupyter-core@4.9.2:", type=("build", "run"), when="@7.3.5:")
    depends_on("py-jupyter-core@4.6.0:", type=("build", "run"), when="@6:")
    depends_on("py-jupyter-core", type=("build", "run"))
    depends_on("py-python-dateutil@2.8.2:", type=("build", "run"), when="@7.3.5:")
    depends_on("py-python-dateutil@2.1:", type=("build", "run"), when="@5:")
    depends_on("py-pyzmq@23:", type=("build", "run"), when="@7.3.5:")
    depends_on("py-pyzmq@13:", type=("build", "run"))
    depends_on("py-tornado@6.2:", type=("build", "run"), when="@7.3.5:")
    depends_on("py-tornado@4.1:", type=("build", "run"), when="@5:")
    depends_on("py-traitlets@5.3:", type=("build", "run"), when="@8:")
    depends_on("py-traitlets", type=("build", "run"))

    conflicts("^py-jupyter-core@5.0")

    # Historical dependencies
    depends_on("py-setuptools", type=("build", "run"), when="@5:7.3.4")
    depends_on("py-entrypoints", type=("build", "run"), when="@7")
    depends_on("py-nest-asyncio@1.5.4:", type=("build", "run"), when="@7.3.5")
    depends_on("py-nest-asyncio@1.5:", type=("build", "run"), when="@6.1.13:7.1.2")
