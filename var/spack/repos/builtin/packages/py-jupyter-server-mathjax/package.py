...
class PyJupyterServerMathjax(PythonPackage):
    ...
    depends_on("py-jupyter-packaging@0.10:1", type="build", when="@0.2.6:")
    depends_on("py-jupyter-server@1.1:1", type=("build", "run"), when="@0.2.3")
    depends_on("py-jupyter-server@1.1:", type=("build", "run"), when="@0.2.6:")
