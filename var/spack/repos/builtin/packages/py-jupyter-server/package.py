...
class PyJupyterServer(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@2:")
    depends_on("py-hatchling@1.11:", type="build", when="@2:")
    # under [tool.hatch.build.hooks.jupyter-builder] in pyproject.toml
    depends_on("py-hatch-jupyter-builder@0.8.1:", type="build", when="@2:")

    with when("@:1"):
        depends_on("py-jupyter-packaging@0.9:0", type="build", when="@1.6.2:")
        depends_on("py-pre-commit", type="build", when="@1.16:")
        depends_on("py-setuptools", type="build")

    depends_on("py-anyio@3.1.0:", type=("build", "run"), when="@2.2.1:")
    depends_on("py-anyio@3.1.0:3", type=("build", "run"), when="@:2.2.0")
    depends_on("py-argon2-cffi", type=("build", "run"))
    depends_on("py-jinja2", type=("build", "run"))
    depends_on("py-jupyter-client@7.4.4:", type=("build", "run"), when="@2:")
    depends_on("py-jupyter-client@6.1.12:", type=("build", "run"), when="@1.16:")
    depends_on("py-jupyter-client@6.1.1:", type=("build", "run"))
    depends_on("py-jupyter-core@4.12:4,5.1:", type=("build", "run"), when="@1.23.5:")
    depends_on("py-jupyter-core@4.7:", type=("build", "run"), when="@1.16:")
    depends_on("py-jupyter-core@4.6:", type=("build", "run"))
    depends_on("py-jupyter-server-terminals", type=("build", "run"), when="@2:")
    depends_on("py-nbconvert@6.4.4:", type=("build", "run"), when="@1.16:")
    depends_on("py-nbconvert", type=("build", "run"))
    depends_on("py-nbformat@5.3:", type=("build", "run"), when="@2:")
    depends_on("py-nbformat@5.2:", type=("build", "run"), when="@1.15:")
    depends_on("py-nbformat", type=("build", "run"))
    depends_on("py-packaging", type=("build", "run"), when="@1.13.2:")
    ...
    depends_on("py-pyzmq@24:", type=("build", "run"), when="@2:")
    depends_on("py-pyzmq@17:", type=("build", "run"))
    depends_on("py-send2trash", type=("build", "run"))
    depends_on("py-terminado@0.8.3:", type=("build", "run"))
    depends_on("py-tornado@6.2:", type=("build", "run"), when="@2:")
    depends_on("py-tornado@6.1:", type=("build", "run"))
    depends_on("py-traitlets@5.6:", type=("build", "run"), when="@2.0.1:")
    depends_on("py-traitlets@5.1:", type=("build", "run"), when="@1.16:")
    depends_on("py-traitlets@5:", type=("build", "run"), when="@1.13.3:")
    depends_on("py-traitlets@4.2.1:", type=("build", "run"))
    depends_on("py-websocket-client", type=("build", "run"))
    depends_on("py-jupyter-events@0.6:", type=("build", "run"), when="@2.6:")
    depends_on("py-overrides", type=("build", "run"), when="@2.6:")

    # old
    depends_on("py-ipython-genutils", type=("build", "run"), when="@:1.15")
