...
class PyJupyterhub(PythonPackage):
    ...
    depends_on("py-certipy@0.1.2:", type=("build", "run"), when="@1.0.0:")
    depends_on("py-entrypoints", type=("build", "run"), when="@1.0.0:")
    ...
    depends_on("py-oauthlib@3.0:", type=("build", "run"), when="@1.0.0:")
    ...
    depends_on("py-python-oauth2@1.0:", type=("build", "run"), when="@:0.9.4")
