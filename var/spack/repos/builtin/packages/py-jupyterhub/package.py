...
class PyJupyterhub(PythonPackage):
    ...
    depends_on("py-alembic@1.4:", when="@1.4.1:", type=("build", "run"))
    depends_on("py-alembic", type=("build", "run"))
    depends_on("py-async-generator@1.9:", when="@1.4.1:", type=("build", "run"))
    ...
    depends_on("py-jinja2@2.11.0:", when="@1.4.1:", type=("build", "run"))
    depends_on("py-jinja2", type=("build", "run"))
    depends_on("py-jupyter-telemetry@0.1.0:", when="@1.4.1:", type=("build", "run"))
    depends_on("py-mako", when="@:1.4.1", type=("build", "run"))
    depends_on("py-notebook", when="@:1.4.1", type=("build", "run"))
    depends_on("py-oauthlib@3.0:", when="@1.0.0:", type=("build", "run"))
    depends_on("py-pamela", type=("build", "run"))
    depends_on("py-prometheus-client@0.4.0:", when="@1.4.1:", type=("build", "run"))
    ...
    depends_on("py-tornado@5.1:", when="@1.4.1:", type=("build", "run"))
    depends_on("py-tornado@5.0:", type=("build", "run"))
    depends_on("py-traitlets@4.3.2:", type=("build", "run"))
    depends_on("python@3.6:", when="@1.4.1:", type=("build", "run"))
