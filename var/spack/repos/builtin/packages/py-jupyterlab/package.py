...
class PyJupyterlab(PythonPackage):
    ...
    depends_on("py-hatchling@1.5:", type=("build", "run"), when="@4:")
    # under [tool.hatch.build.hooks.jupyter-builder] in pyproject.toml
    depends_on("py-hatch-jupyter-builder@0.3.2:", type=("build", "run"), when="@4:")

    depends_on("py-async-lru@1:", type=("build", "run"), when="@4:")
    depends_on("py-importlib-metadata@4.8.3:", type=("build", "run"), when="@4: ^python@:3.9")
    depends_on("py-importlib-resources@1.4:", type=("build", "run"), when="@4: ^python@:3.8")
    depends_on("py-ipykernel", type=("build", "run"), when="@4:")
    depends_on("py-jinja2@3.0.3", type=("build", "run"), when="@4:")
    depends_on("py-jupyter-core", type=("build", "run"), when="@3:")
    depends_on("py-jupyter-lsp@2:", type=("build", "run"), when="@4:")
    depends_on("py-jupyter-server@2.4:2", type=("build", "run"), when="@4:")
    depends_on("py-jupyterlab-server@2.19:2", type=("build", "run"), when="@4:")
    depends_on("py-notebook-shim@0.2:", type=("build", "run"), when="@4:")
    depends_on("py-packaging", type=("build", "run"), when="@3:")
    depends_on("py-traitlets", type=("build", "run"), when="@4:")
    depends_on("py-tornado@6.2:", type=("build", "run"), when="@4:")
    depends_on("py-tomli", type=("build", "run"), when="@3.4.7: ^python@:3.10")

    with when("@:3"):
        depends_on("py-setuptools", type=("build", "run"), when="@:3")
        depends_on("py-jupyter-packaging@0.9:1", type="build", when="@3.4.8")
        depends_on("py-jupyter-packaging@0.9:0", type="build", when="@3.0.15:3.4.2")
        depends_on("py-jupyter-packaging@0.7.3:0.7", type=("build", "run"), when="@3.0.0:3.0.14")
        depends_on("py-pre-commit", type="build", when="@3.4:3.4.3")

        depends_on("py-ipython", type=("build", "run"), when="@3")
        depends_on("py-tornado@6.1:", type=("build", "run"), when="@3:")
        depends_on("py-jupyterlab-server@2.10:2", type=("build", "run"), when="@3.3:")
        depends_on("py-jupyterlab-server@2.3:2", type=("build", "run"), when="@3.0.9:3.2")
        depends_on("py-jupyterlab-server@2.0:2", type=("build", "run"), when="@3.0.0:3.0.8")
        depends_on("py-jupyter-server@1.16:1", type=("build", "run"), when="@3.4:")
        depends_on("py-jupyter-server@1.4:1", type=("build", "run"), when="@3.0.9:3.3")
        depends_on("py-jupyter-server@1.2:1", type=("build", "run"), when="@3.0.3:3.0.8")
        depends_on("py-jupyter-server@1.1:1", type=("build", "run"), when="@3.0.0:3.0.2")
        depends_on("py-nbclassic", type=("build", "run"), when="@3.4.4:")
        depends_on("py-nbclassic@0.2.0:0", type=("build", "run"), when="@3:3.4.3")
        depends_on("py-notebook@:6", type=("build", "run"), when="@3.4.8:")
