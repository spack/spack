...
class PyKiwisolver(PythonPackage):
    ...
    depends_on("py-setuptools@61.2:", type="build", when="@1.4.4:")
    depends_on("py-setuptools-scm@3.4.3:+toml", type="build", when="@1.4.4:")
    depends_on("py-cppy@1.1.0:", type="build", when="@1.2.0:")
    depends_on("py-cppy@1.2.0:", type="build", when="@1.4.4:")
    depends_on("py-typing-extensions", type=("build", "run"), when="@1.4.4: ^python@:3.7")
