...
class PyKombu(PythonPackage):
    ...
    depends_on("py-setuptools@:59", type="build", when="@4.6:5.2")

    depends_on("py-amqp@2.5.2:2.5", type=("build", "run"), when="@:4.6.6")
    depends_on("py-amqp@2.6.0:2.6", type=("build", "run"), when="@4.6.7:4")
    depends_on("py-amqp@5.0.0:5", type=("build", "run"), when="@5.0.0:5.0.2")
    depends_on("py-amqp@5.0.9:5.0", type=("build", "run"), when="@5.2.3")
    depends_on("py-vine", type=("build", "run"), when="@5.1.0:")
    ...
    depends_on("py-redis@3.4.1:3,4.0.2:", type=("build", "run"), when="+redis")
