...
class PyLabours(PythonPackage):
    ...
    depends_on('py-scipy@0.19.0:1.2.999', type=('build', 'run'))
    ...
    depends_on('py-hdbscan', type=('build', 'run'))
    depends_on('py-seriate', type=('build', 'run'))
    depends_on('py-fastdtw', type=('build', 'run'))
    depends_on('py-lifelines', type=('build', 'run'))
