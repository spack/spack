...
class PyLazyObjectProxy(PythonPackage):
    ...
    depends_on("py-setuptools-scm@3.3.1:", when="@1.4.0:", type="build")
    depends_on("py-setuptools-scm@3.3.1:5", when="@1.6.0:1.6", type="build")
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools@30.3.0:", when="@1.6.0:", type="build")
