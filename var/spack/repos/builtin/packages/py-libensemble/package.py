...
class PyLibensemble(PythonPackage):
    ...
    depends_on("py-numpy@1.21:", type=("build", "run"), when="@1:")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-psutil@5.9.4:", type=("build", "run"), when="@1:")
    depends_on("py-psutil", type=("build", "run"), when="@0.7.1:")
    depends_on("py-setuptools", type="build", when="@0.10.2:")
    depends_on("py-setuptools", type=("build", "run"), when="@:0.10.1")
    depends_on("py-pydantic@:1", type=("build", "run"), when="@0.10:")
    depends_on("py-tomli@1.2.1:", type=("build", "run"), when="@1:")
    depends_on("py-tomli", type=("build", "run"), when="@0.10:")
    depends_on("py-pyyaml@6.0:", type=("build", "run"), when="@1:")
