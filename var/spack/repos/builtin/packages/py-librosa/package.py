...
class PyLibrosa(PythonPackage):
    ...
    depends_on("py-numpy@1.17.0:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-scipy@1.0.0:", type=("build", "run"))
    depends_on("py-scipy@1.2.0:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-scikit-learn@0.14.0:0.18,0.19.1:", type=("build", "run"))
    depends_on("py-scikit-learn@0.19.1:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-joblib@0.12:", type=("build", "run"))
    depends_on("py-joblib@0.14:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-decorator@3.0.0:", type=("build", "run"))
    depends_on("py-decorator@4.0.10:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-six@1.3:", when="@0.7.2", type=("build", "run"))
    depends_on("py-resampy@0.2.2:", type=("build", "run"))
    depends_on("py-numba@0.43.0:", type=("build", "run"))
    depends_on("py-numba@0.45.1:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-soundfile@0.9.0:", type=("build", "run"))
    depends_on("py-soundfile@0.10.2:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-pooch@1:", when="@0.9.1:", type=("build", "run"))
    depends_on("py-packaging@20:", when="@0.9.1:", type=("build", "run"))
