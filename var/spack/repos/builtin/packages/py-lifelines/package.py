...
class PyLifelines(PythonPackage):
    ...
    *events* might refer to deaths, disease remission,
    ...
    depends_on("py-numpy", when="@0.9.4", type=("build", "run"))
    depends_on("py-scipy", when="@0.9.4", type=("build", "run"))
    depends_on("py-pandas@0.18.0:", when="@0.9.4", type=("build", "run"))
    depends_on("python@3.6:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-pandas@0.23.0:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-scipy@1.2.0:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-numpy@1.14:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-pandas@0.23.0:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-matplotlib@3.0:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-autograd@1.3:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-autograd-gamma@0.3:", when="@0.25.5:", type=("build", "run"))
    depends_on("py-patsy@0.5.0:", when="@0.25.5:", type=("build", "run"))
