...
class PyLightly(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on("py-hydra-core@1.0.0:", when="@0.1:")
        depends_on("py-lightly-utils", when="@1.1.16:")
        depends_on("py-numpy@1.18.1:", when="@0.1:")
        depends_on("py-pydantic@1.10.5:1", when="@1.4.8:")
        depends_on("py-python-dateutil@2.5.3:", when="@1.1:")
        depends_on("py-pytorch-lightning@1.0.4:", when="@1.1:1.1.7,1.1.9:1.2.25,1.2.28:")
        depends_on("py-requests@2.23:", when="@0.1:")
        depends_on("py-setuptools@21:65.5", when="@1.2.36:1.4.1")
        depends_on("py-setuptools@21:", when="@1.1:1.2.35,1.4.8,1.4.15:1.4.25")
        depends_on("py-six@1.10:", when="@1.1:")
        depends_on("py-torch", when="@1.4.2:")
        depends_on("py-torchvision", when="@0.1:")
