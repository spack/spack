...
class PyLmfit(PythonPackage):
    ...
    depends_on("python@2.7:2.8,3.5:", when="@0.9.15", type=("build", "run"))

    depends_on("py-asteval@0.9.16:", when="@0.9.15:", type=("build", "run"))

    depends_on("py-numpy@1.5:", when="@0.9.5:", type=("build", "run"))
    depends_on("py-numpy@1.16:", when="@0.9.15:", type=("build", "run"))

    depends_on("py-scipy@0.14:", when="@0.9.5", type=("build", "run"))
    depends_on("py-scipy@1.2:", when="@0.9.15:", type=("build", "run"))

    depends_on("py-setuptools", type="build")
    depends_on("py-six@1.11:", when="@0.9.15", type=("build", "run"))
    depends_on("py-uncertainties@3.0.1:", when="@0.9.15:", type=("build", "run"))
