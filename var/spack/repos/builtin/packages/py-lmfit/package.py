...
class PyLmfit(PythonPackage):
    ...
    depends_on('py-numpy@1.5:',  type=('build', 'run'), when='@0.9.5:0.9.6')
    ...
    depends_on('py-six@1.11:',  type='build', when='@0.9.15: ^python@2.7:2.8')
    depends_on('py-uncertainties@3.0.1:',  type='build', when='@0.9.15:')
