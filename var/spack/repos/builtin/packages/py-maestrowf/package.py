...
class PyMaestrowf(PythonPackage):
    ...
    url      = "https://github.com/LLNL/maestrowf/archive/v1.1.8.tar.gz"
    ...
    version('1.1.7dev0',   sha256='526fea2b3659375fd931ca4c3077175436b3148ef1f0f07063162b87cacada61')

    # pypi releases
    version('1.1.8', sha256='d47e4f3f52a2df4c64805c988d1fa882867f20306566f1422d184d51baeb5e1a', preferred=True)
    version('1.1.7', sha256='48db99d2629db160858843e63bd4e67834d4fe3abc356435e56ab6ea199fb520')
    ...
    depends_on('py-chainmap',     type=('build', 'run'), when='@1.1.7: ^python@2.7:3.3')
