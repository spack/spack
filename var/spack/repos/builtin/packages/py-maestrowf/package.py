...
class PyMaestrowf(PythonPackage):
    ...
    depends_on("python@3.6:", when="@1.1.9:", type=("build", "run"))
    depends_on("py-setuptools", when="@:1.1.8", type=("build"))
    depends_on("py-poetry-core@1.0.8:", when="@1.1.9:", type=("build"))
    depends_on("py-coloredlogs", when="@1.1.7:", type=("build", "run"))
    depends_on("py-dill", when="@1.1.7:", type=("build", "run"))
    depends_on("py-filelock", when="@1.1.0:", type=("build", "run"))
    depends_on("py-jsonschema@3.2.0:", when="@1.1.7:", type=("build", "run"))
    depends_on("py-pyyaml@4.2:", type=("build", "run"))
    depends_on("py-rich", when="@1.1.9:", type=("build", "run"))
    depends_on("py-six", type=("build", "run"))
    depends_on("py-tabulate", when="@1.1.0:", type=("build", "run"))
