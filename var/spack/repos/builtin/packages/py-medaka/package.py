...
class PyMedaka(PythonPackage):
    ...
    depends_on("py-parasail", type=("build", "run"), when="target=x86_64:")
    depends_on("py-parasail", type=("build", "run"), when="target=ppc64le:")
    depends_on("py-pysam@0.16.0.1:", type=("build", "run"))
    depends_on("py-pyspoa@0.0.3:", type=("build", "run"), when="target=x86_64:")
    depends_on("py-pyspoa@0.0.3:", type=("build", "run"), when="target=ppc64le:")
