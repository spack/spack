...
class PyMelissaCore(PythonPackage):
    ...
    depends_on("py-mpi4py@3.1.3:", type="run", when="@develop,joss")
    depends_on("py-mpi4py@3.1.3", type="run", when="@sc23")
    depends_on("py-numpy@1.21:", type="run")
    depends_on("py-jsonschema@4.5:", type="run")
    depends_on("py-python-rapidjson@1.8:", type="run", when="@develop,joss")
    depends_on("py-python-rapidjson@1.9:", type="run", when="@sc23")
