...
class PyMerlin(PythonPackage):
    ...
    depends_on("py-celery@5.0.3:+redis+sqlalchemy", type=("build", "run"), when="@1.7.6:")
    depends_on("py-celery@5.0.0:+redis+sqlalchemy", type=("build", "run"), when="@1.7.5")
    depends_on("py-celery@4.4.5:+redis+sqlalchemy", type=("build", "run"), when="@1.6.2:1.7.4")
    depends_on("py-celery@4.3.0:+redis+sqlalchemy", type=("build", "run"), when="@:1.5.2")
    depends_on("py-celery@4.3.0:+redis", type=("build", "run"), when="@1.4.1:1.5.1")
    ...
    depends_on("py-celery@:4", type=("build", "run"), when="@:1.7.4")
    depends_on("py-coloredlogs", type=("build", "run"))
    depends_on("py-cryptography", type=("build", "run"))
    depends_on("py-importlib-metadata@:4", type=("build", "run"), when="@1.10: ^python@3.7")
    depends_on("py-maestrowf@1.1.9:", type=("build", "run"), when="@1.9.0:")
    depends_on("py-maestrowf@1.1.7dev0", type=("build", "run"), when="@1.2.0:1.8")
    depends_on("py-maestrowf@1.1.6:", type=("build", "run"), when="@:1.1")
    ...
    depends_on("py-redis@4.3.4:", type=("build", "run"), when="@1.9.0:")
