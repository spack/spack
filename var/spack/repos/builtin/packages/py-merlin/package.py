...
class PyMerlin(PythonPackage):
    ...
    depends_on("py-celery@4.3.0:+redis+sqlalchemy", type=("build", "run"))
    depends_on("py-celery@5.0.3:", when="@1.7.6:", type=("build", "run"))
    depends_on("py-celery@5.0.0:", when="@1.7.5", type=("build", "run"))
    depends_on("py-celery@4.4.5:", when="@1.6.2:", type=("build", "run"))
