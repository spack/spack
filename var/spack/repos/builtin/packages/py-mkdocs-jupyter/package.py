...
class PyMkdocsJupyter(PythonPackage):
    ...
    depends_on("py-jupytext@1.13.8:1", when="@0.21.0:", type=("build", "run"))
    depends_on("py-jupytext@1.11.02:1", when="@:0.20", type=("build", "run"))
    depends_on("py-mkdocs@1.2.3:1", type=("build", "run"))
    depends_on("py-mkdocs-material@8.0:8", type=("build", "run"))
    depends_on("py-pygments@2.12.0:2", when="@0.21.0:", type=("build", "run"))
