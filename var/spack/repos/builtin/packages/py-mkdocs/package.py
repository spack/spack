...
class PyMkdocs(PythonPackage):
    ...
    depends_on("python@3.7:", when="@1.4.2:", type=("build", "run"))
    depends_on("py-setuptools", when="@:1.3", type="build")
    depends_on("py-hatchling", when="@1.4.2:", type="build")
    ...
    depends_on("py-importlib-metadata@4.3:", when="@1.3.1", type=("build", "run"))
    depends_on("py-importlib-metadata@4.3:", when="@1.4.2: ^python@:3.9", type=("build", "run"))
    depends_on("py-typing-extensions@3.10:", when="@1.4.2: ^python@:3.7", type=("build", "run"))
