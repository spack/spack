...
class PyMlflow(PythonPackage):
    ...
    variant(
        "skinny",
        default=False,
        description="Lightweight MLflow package without SQL storage, server, UI, "
        "or data science dependencies.",
    )
    ...
    depends_on("py-databricks-cli@0.8.7:", type=("build", "run"))
    depends_on("py-entrypoints", type=("build", "run"))
    depends_on("py-gitpython@2.1.0:", type=("build", "run"))
    ...
    depends_on("py-docker@4.0.0:6", type=("build", "run"), when="~skinny")
    depends_on("py-flask@:2", type=("build", "run"), when="~skinny")
    depends_on("py-numpy@:1", type=("build", "run"), when="~skinny")
    depends_on("py-scipy@:1", type=("build", "run"), when="~skinny")
    depends_on("py-pandas@:1", type=("build", "run"), when="~skinny")
    ...
    for platform in ["linux", "darwin", "cray"]:
        depends_on("py-gunicorn@:20", type=("build", "run"), when=f"~skinny platform={platform}")
    depends_on("py-waitress@:2", type=("build", "run"), when="platform=windows ~skinny")
    ...
    depends_on("py-markdown@3.3:3", type=("build", "run"), when="~skinny")
    for platform in ["linux", "darwin", "cray"]:
        depends_on("py-jinja2@2.11:3", type=("build", "run"), when=f"~skinny platform={platform}")
    depends_on("py-jinja2@3.0:3", type=("build", "run"), when="platform=windows ~skinny")
    depends_on("py-matplotlib@:3", type=("build", "run"), when="~skinny")
    depends_on("py-prometheus-flask-exporter", type=("build", "run"), when="~skinny")
