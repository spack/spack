...
class PyMorphValidator(PythonPackage):
    ...
    depends_on('py-pandas@0.25:1.2.99', type='run')
    ...
    depends_on('py-morph-tool@2.5.1:2.8.99', type='run', when='@:0.2.99')
    depends_on('py-neurom@3.0:3.999', type='run', when='@0.3.0:')
    depends_on('py-neurom@2.0:2.99', type='run', when='@:0.2.99')
    depends_on('py-bluepy@2.3.0:2.99', type='run')
