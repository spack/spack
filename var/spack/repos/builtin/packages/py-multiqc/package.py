...
class PyMultiqc(PythonPackage):
    ...
    depends_on("py-matplotlib@2.1.1:", when="@1.13:", type=("build", "run"))
    depends_on("py-matplotlib@2.1.1:2", when="@1.7", type=("build", "run"))
    depends_on("py-matplotlib@:2.1.0", when="@1.5", type=("build", "run"))
    depends_on("py-matplotlib", when="@:1.3", type=("build", "run"))
    depends_on("py-networkx@2.5.1:", when="@1.13:", type=("build", "run"))
    depends_on("py-networkx@:1", when="@1.3", type=("build", "run"))
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-click", type=("build", "run"))
    depends_on("py-coloredlogs", when="@1.13:", type=("build", "run"))
    depends_on("py-future@0.14.1:", type=("build", "run"))
    depends_on("py-jinja2@3.0.0:", when="@1.14:", type=("build", "run"))
    depends_on("py-jinja2@2.9:", when="@:1.13", type=("build", "run"))
    depends_on("py-lzstring", type=("build", "run"))
    depends_on("py-markdown", when="@1.3:", type=("build", "run"))
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-pyyaml@4:", when="@1.13:", type=("build", "run"))
    depends_on("py-requests", when="@1.3:", type=("build", "run"))
    depends_on("py-rich@10:", when="@1.13:", type=("build", "run"))
    depends_on("py-rich-click", when="@1.13:", type=("build", "run"))
    depends_on("py-simplejson", type=("build", "run"))
    depends_on("py-spectra@0.0.10:", when="@1.5:", type=("build", "run"))
