...
class PyMypy(PythonPackage):
    ...
    # pyproject.toml
    depends_on("py-setuptools@40.6.2:", type=("build", "run"), when="@0.790:")
    depends_on("py-setuptools", type=("build", "run"))
    depends_on("py-wheel@0.30:", type="build", when="@0.790:")
    depends_on("py-typing-extensions@3.10:", type=("build", "run"), when="@0.930:")
    depends_on("py-typing-extensions@3.7.4:", type=("build", "run"), when="@0.700:")
    depends_on("py-mypy-extensions@1:", type=("build", "run"), when="@1.1:")
    depends_on("py-mypy-extensions@0.4.3:", type=("build", "run"), when="@0.930:1.0")
    depends_on("py-mypy-extensions@0.4.3:0.4", type=("build", "run"), when="@0.700:0.929")
    depends_on("py-mypy-extensions@0.4.0:0.4", type=("build", "run"), when="@:0.699")
    depends_on("py-typed-ast@1.4.0:1", type=("build", "run"), when="@0.920: ^python@:3.7")
    depends_on("py-typed-ast@1.4.0:1.4", type=("build", "run"), when="@0.900:0.910 ^python@:3.7")
    depends_on("py-typed-ast@1.4.0:1.4", type=("build", "run"), when="@0.700:0.899")
    depends_on("py-typed-ast@1.3.1:1.3", type=("build", "run"), when="@:0.699")
    depends_on("py-tomli@1.1:", type=("build", "run"), when="@0.950: ^python@:3.10")
    depends_on("py-tomli@1.1:", type=("build", "run"), when="@0.930:0.949")
    depends_on("py-tomli@1.1:2", type=("build", "run"), when="@0.920:0.929")
    depends_on("py-types-psutil", type="build", when="@0.981:")
    depends_on("py-types-setuptools", type="build", when="@0.981:")
    depends_on("py-types-typed-ast@1.5.8:1.5", type="build", when="@0.981:")

    # setup.py
    depends_on("python@3.7:", type=("build", "run"), when="@0.981:")

    # Historical dependencies
    depends_on("py-toml", type=("build", "run"), when="@0.900:0.910")
