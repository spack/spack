...
class PyNbclient(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@0.5.13:")
    depends_on("python@3.6.1:", type=("build", "run"), when="@0.5.5:")
    depends_on("py-setuptools", type="build", when="@:0.7.0")
    depends_on("py-hatchling@1.10:", type="build", when="@0.7.1:")

    depends_on("py-jupyter-client@6.1.12:", type=("build", "run"), when="@0.7.1:")
    depends_on("py-jupyter-client@6.1.5:", type=("build", "run"))
    depends_on("py-jupyter-core@4.12:4,5.1:", type=("build", "run"), when="@0.7.1:")
    depends_on("py-nbformat@5.1:", type=("build", "run"), when="@0.7.1:")
    depends_on("py-nbformat@5.0:", type=("build", "run"))
    depends_on("py-traitlets@5.4:", type=("build", "run"), when="@0.8:")
    depends_on("py-traitlets@5.3:", type=("build", "run"), when="@0.7.1:")
    depends_on("py-traitlets@5.2.2:", type=("build", "run"), when="@0.6:")
    depends_on("py-traitlets@5:", type=("build", "run"), when="@0.5.13:")
    depends_on("py-traitlets@4.2:", type=("build", "run"))

    # Historical dependencies
    depends_on("py-async-generator", type=("build", "run"), when="@0.5.0")
    depends_on("py-nest-asyncio", type=("build", "run"), when="@:0.7.0")
