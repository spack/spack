...
class PyNbconvert(PythonPackage):
    ...
    depends_on("py-hatchling@0.25:", type="build", when="@7:")
    ...
    depends_on("py-importlib-metadata@3.6:", type=("build", "run"), when="@7: ^python@:3.9")
    ...
    depends_on("py-mistune@2.0.3:2", type=("build", "run"), when="@7:")
    depends_on("py-mistune@0.8.1:1", type=("build", "run"), when="@:6")
    ...
    depends_on("py-setuptools", type=("build", "run"), when="@5:6")
    depends_on("py-setuptools@60:", type=("build", "run"), when="@6.5:6")
    depends_on("py-entrypoints", type=("build", "run"), when="@:6")
    depends_on("py-entrypoints@0.2.2:", type=("build", "run"), when="@5:6")
    depends_on("py-testpath", type=("build", "run"), when="@5:6.4")
    depends_on("py-lxml", type=("build", "run"), when="@6.5.1:7.0")
