...
class PyNbmake(PythonPackage):
    ...
    depends_on("py-pytest@6.1.0:", type=("build", "run"), when="@1.2.1:")
    depends_on("py-pytest@6.1.0:6", type=("build", "run"), when="@0.10:1.2.0")
    depends_on("py-pytest@6.1.2:6", type=("build", "run"), when="@:0.9")
    depends_on("python@3.7.0:3", type=("build", "run"), when="@1.3:")
    depends_on("python@3.6.1:3", type=("build", "run"), when="@:1.2")
    depends_on("py-nbclient@0.6.6:0.6", type=("build", "run"), when="@1.3.1:")
    depends_on("py-nbclient@0.5.13:0.5", type=("build", "run"), when="@1.3.0")
    depends_on("py-nbclient@0.5.5:0.5", type=("build", "run"), when="@1.2")
    depends_on("py-nbclient@0.3:0", type=("build", "run"), when="@:1.1")
    depends_on("py-nbformat@5.0.8:5", type=("build", "run"))
    depends_on("py-pygments@2.7.3:2", type=("build", "run"))
    depends_on("py-ipykernel@5.4.0:", type=("build", "run"), when="@0.7:")
    depends_on("py-ipykernel@5.4.0:5", type=("build", "run"), when="@0.5")

    # Historical dependencies
    depends_on("py-pydantic@1.7.2:1", type=("build", "run"), when="@:1.4.1")
