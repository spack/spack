...
class PyNeo(PythonPackage):
    ...
    # maintainers = ['acc1', 'acc2']

    version('0.10.2', sha256='2d4218b0826daeea880e155227060029ec38a00238ceb5f097138d9467c6399b')
    version('0.10.1', sha256='444ff15278ddcf9e3577820e878cf6b9f4220ce145bf1013c8f30536cf60939b')
    ...
    depends_on('py-numpy@1.3.0:', when='@0.3.3', type=('build', 'run'))
    depends_on('py-numpy@1.13.0:', when='@0.9.0', type=('build', 'run'))
    depends_on('py-numpy@1.16.1:', when='@0.10.0:', type=('build', 'run'))
    depends_on('py-quantities@0.9.0:', when='@0.3.3:', type=('build', 'run'))
