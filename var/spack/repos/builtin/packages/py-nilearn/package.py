...
class PyNilearn(PythonPackage):
    ...
    depends_on("py-hatchling", type="build", when="@0.10.1:")
    depends_on("py-hatch-vcs", type="build", when="@0.10.1:")
    depends_on("py-setuptools", type="build", when="@:0.10.0")

    variant("plotting", default=False, description="Enable plotting functionalities")

    depends_on("py-joblib@1:", type=("build", "run"), when="@0.10:")
    depends_on("py-joblib@0.15:", type=("build", "run"), when="@0.9.1:")
    depends_on("py-joblib@0.12:", type=("build", "run"), when="@0.7:")
    depends_on("py-joblib@0.11:", type=("build", "run"), when="@0.6:")
    depends_on("py-lxml", type=("build", "run"), when="@0.9.1:")
    depends_on("py-nibabel@3.2:", type=("build", "run"), when="@0.10:")
    depends_on("py-nibabel@3:", type=("build", "run"), when="@0.9.1:")
    depends_on("py-nibabel@2.5:", type=("build", "run"), when="@0.8:")
    depends_on("py-nibabel@2.0.2:", type=("build", "run"))
    depends_on("py-numpy@1.19:", type=("build", "run"), when="@0.10:")
    depends_on("py-numpy@1.18:", type=("build", "run"), when="@0.9.1:")
    depends_on("py-numpy@1.16:", type=("build", "run"), when="@0.8:")
    depends_on("py-numpy@1.11:", type=("build", "run"), when="@0.5:")
    depends_on("py-numpy@1.6.1:", type=("build", "run"))
    depends_on("py-pandas@1.1.5:", type=("build", "run"), when="@0.10:")
    depends_on("py-pandas@1:", type=("build", "run"), when="@0.9.1:")
    depends_on("py-pandas@0.24.0:", type=("build", "run"), when="@0.8:")
    depends_on("py-pandas@0.18.0:", type=("build", "run"), when="@0.7:")
    depends_on("py-requests@2.25:", type=("build", "run"), when="@0.10:")
    depends_on("py-requests@2:", type=("build", "run"), when="@0.7:")
    depends_on("py-scikit-learn@1:", type=("build", "run"), when="@0.10:")
    depends_on("py-scikit-learn@0.22:", type=("build", "run"), when="@0.9.1:")
    ...
    depends_on("py-scikit-learn@0.19:0.23", type=("build", "run"), when="@0.6.0:0.6")
    # older py-nilearn versions use import sklearn.external.joblib which was
    # deprecated in py-scikit-learn@0.23:
    depends_on("py-scikit-learn@0.15:0.22", type=("build", "run"), when="@:0.5")
    depends_on("py-scipy@1.6:", type=("build", "run"), when="@0.10:")
    depends_on("py-scipy@1.5:", type=("build", "run"), when="@0.9.1:")
    depends_on("py-scipy@1.2:", type=("build", "run"), when="@0.8:")
    depends_on("py-scipy@0.19:", type=("build", "run"), when="@0.6:")
    depends_on("py-scipy@0.17:", type=("build", "run"), when="@0.5:")
    depends_on("py-scipy@0.14:", type=("build", "run"))
    depends_on("py-packaging", type=("build", "run"), when="@0.10.1:")

    depends_on("py-matplotlib@3.3:", type=("build", "run"), when="@0.10: +plotting")
    depends_on("py-matplotlib@3:", type=("build", "run"), when="@0.9.1: +plotting")
    depends_on("py-matplotlib@2:", type=("build", "run"), when="@0.6: +plotting")
    # older py-nilearn versions use matplotlib.cm.revcmap which was deprecated
    # in py-matplotlib@3.4:
    depends_on("py-matplotlib@1.5.1:3.3", type=("build", "run"), when="@:0.5 +plotting")
    depends_on("py-matplotlib@1.1.1:3.3", type=("build", "run"), when="@0.4.2 +plotting")
