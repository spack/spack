...
class PyNipype(PythonPackage):
    ...
    depends_on("py-pydotplus", type=("build", "run"), when="@:1.5")
    depends_on("py-python-dateutil@2.2:", type=("build", "run"))
    depends_on("py-rdflib@5:", type=("build", "run"), when="@1.5:")
    depends_on("py-scipy@0.14:", type=("build", "run"))
    depends_on("py-simplejson@3.8:", type=("build", "run"))
    depends_on("py-traits@4.6:4,5.1:6.3", type=("build", "run"), when="@1.8.4:")
    depends_on("py-traits@4.6:4,5.1:", type=("build", "run"), when="@:1.8.3")
    depends_on("py-filelock@3:", type=("build", "run"))
    depends_on("py-etelemetry@0.2:", type=("build", "run"), when="@1.5:")
    depends_on("py-etelemetry", type=("build", "run"))
    depends_on("py-looseversion", type=("build", "run"), when="@1.8.1:")
