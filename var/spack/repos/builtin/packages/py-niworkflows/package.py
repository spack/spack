...
class PyNiworkflows(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@1.3.3:")
    depends_on("python@3.6:", type=("build", "run"), when="@1.2:")
    depends_on("python@3.5:", type=("build", "run"))
    depends_on("py-setuptools@38.4.1:", type="build", when="@1.2.3:")
    depends_on("py-setuptools@30.4.0:", type="build")
    depends_on("py-attrs", type=("build", "run"), when="@1.1.4:")
    depends_on("py-jinja2", type=("build", "run"))
    depends_on("py-matplotlib@2.2.0:", type=("build", "run"))
    depends_on("py-nibabel@3.0.1:", type=("build", "run"), when="@1.1.6:")
    depends_on("py-nibabel@2.4.1:", type=("build", "run"))
    depends_on("py-nilearn@0.2.6:0.4,0.5.2:", type=("build", "run"))
    depends_on("py-nipype@1.5.1:", type=("build", "run"), when="@1.3:")
    depends_on("py-nipype@1.3.1:", type=("build", "run"))
    depends_on("py-nitransforms@20:20.1", type=("build", "run"), when="@1.2:")
    depends_on("py-numpy", type=("build", "run"), when="@1.3.3:")
    depends_on("py-packaging", type=("build", "run"))
    depends_on("py-pandas", type=("build", "run"))
    depends_on("py-pybids@0.11.1:", type=("build", "run"), when="@1.3:")
    depends_on("py-pybids@0.9.4:", type=("build", "run"))
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-scikit-image", type=("build", "run"))
    depends_on("py-scikit-learn", type=("build", "run"), when="@:1.3")
    depends_on("py-scipy", type=("build", "run"))
    depends_on("py-seaborn", type=("build", "run"))
    depends_on("py-svgutils@0.3.4:", type=("build", "run"), when="@1.4:")
    depends_on("py-svgutils@0.3.1", type=("build", "run"), when="@1.3.5")
    depends_on("py-svgutils", type=("build", "run"))
    depends_on("py-transforms3d", type=("build", "run"))
    depends_on("py-templateflow@0.6:", type=("build", "run"), when="@1.3:")
    depends_on("py-templateflow@0.4.1:0.4", type=("build", "run"), when="@:1.0")
