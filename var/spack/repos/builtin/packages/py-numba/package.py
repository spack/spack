...
class PyNumba(PythonPackage):
    ...
    depends_on("python@3.8:3.11", type=("build", "run"), when="@0.57")
    depends_on("python@3.7:3.10", type=("build", "run"), when="@0.55:0.56")
    ...
    depends_on("py-numpy@1.21:1.24", type=("build", "run"), when="@0.57:")
    depends_on("py-numpy@1.18:1.23", type=("build", "run"), when="@0.56.1:0.56.4")
    depends_on("py-numpy@1.18:1.22", type=("build", "run"), when="@0.55.2:0.56.0")
    ...
    depends_on("py-llvmlite@0.40", type=("build", "run"), when="@0.57")
    ...
    depends_on("py-importlib-metadata", type=("build", "run"), when="@0.56:^python@:3.8")
