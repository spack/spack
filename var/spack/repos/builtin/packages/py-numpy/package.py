...
class PyNumpy(PythonPackage):
    ...
    depends_on("python@3.9:3.12", type=("build", "link", "run"), when="@1.26:")
    depends_on("python@3.9:3.11", type=("build", "link", "run"), when="@1.25")
    depends_on("python@3.8:3.11", type=("build", "link", "run"), when="@1.23.2:1.24")
    depends_on("python@3.8:3.10", type=("build", "link", "run"), when="@1.22:1.23.1")
    depends_on("python@:3.10", type=("build", "link", "run"), when="@1.21.2:1.21")
    depends_on("python@:3.9", type=("build", "link", "run"), when="@1.19.3:1.21.1")
    depends_on("python@:3.8", type=("build", "link", "run"), when="@1.17.3:1.19.2")
    depends_on("python@:3.7", type=("build", "link", "run"), when="@1.14.5:1.17.2")

    depends_on("py-cython@0.29.34:3", type="build", when="@1.26:")
    depends_on("py-cython@0.29.34:2", type="build", when="@1.25")
    depends_on("py-cython@0.29.30:2", type="build", when="@1.22.4:1.24")
    depends_on("py-cython@0.29.24:2", type="build", when="@1.21.2:1.22.3")
    depends_on("py-cython@0.29.21:2", type="build", when="@1.19.1:1.21.1")
    depends_on("py-cython@0.29.14:2", type="build", when="@1.18.1:1.19.0")
    depends_on("py-cython@0.29.13:2", type="build", when="@1.18.0")
    depends_on("py-pyproject-metadata@0.7.1:", type="build", when="@1.26:")
    depends_on("py-tomli@1:", type="build", when="@1.26: ^python@:3.10")
    depends_on("py-setuptools@60:", type="build", when="@1.26: ^python@3.12:")
    # https://github.com/spack/spack/pull/32078
    depends_on("py-setuptools@:63", type=("build", "run"), when="@:1.25")
    depends_on("py-setuptools@:59", type=("build", "run"), when="@:1.22.1")
    depends_on("py-colorama", type="build", when="@1.26: platform=windows")

    # Required to use --config-settings
    depends_on("py-pip@23.1:", type="build", when="@1.26:")
    # meson is vendored, ninja and pkgconfig are not
    depends_on("ninja@1.8.2:", type="build", when="@1.26:")
    depends_on("pkgconfig", type="build", when="@1.26:")
    depends_on("blas")
    depends_on("lapack")
    ...
    depends_on("py-hypothesis", type="test", when="@1.19:")
    depends_on("py-typing-extensions@4.2:", type="test", when="@1.23:")
