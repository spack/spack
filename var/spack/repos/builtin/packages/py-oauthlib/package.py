...
class PyOauthlib(PythonPackage):
    ...
    depends_on("py-pyjwt@1.0.0:", when="+extras", type=("build", "run"))
    depends_on("py-pyjwt@2.0.0:2", when="+extras @3.1.1:", type=("build", "run"))
    depends_on("py-pyjwt@2.0.0:2", when="+signedtoken @3.2.1:", type=("build", "run"))
    depends_on("py-blinker", when="+extras", type=("build", "run"))
    depends_on("py-blinker", when="+signals", type=("build", "run"))
    depends_on("py-blinker@1.4:", when="+extras @3.1.1:", type=("build", "run"))
    depends_on("py-blinker@1.4:", when="+signals @3.2.1:", type=("build", "run"))
    depends_on("py-cryptography", when="+extras", type=("build", "run"))
    depends_on("py-cryptography@3.0.0:3", when="+extras @3.1.1", type=("build", "run"))
    depends_on("py-cryptography@3.0.0:", when="+rsa @3.2.1:", type=("build", "run"))
    depends_on("py-cryptography@3.0.0:", when="+signedtoken @3.2.1:", type=("build", "run"))
    depends_on("python@2.7:2.8,3.4:", type=("build", "run"))
    depends_on("python@3.6:", when="@3.1.1:", type=("build", "run"))
