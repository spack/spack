...
class PyOnnx(PythonPackage):
    ...
    depends_on("protobuf@3.20.2:", when="@1.13.0:")
    depends_on("py-protobuf@3.20.2:", type=("build", "run"), when="@1.13.0:")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-numpy@1.16.6:", type=("build", "run"), when="@1.8.1:")
    depends_on("py-numpy@1.21.5:", type=("build", "run"), when="@1.13:")
    depends_on("py-numpy@1.23.2:", type=("build", "run"), when="@1.13: ^python@3.11:")
