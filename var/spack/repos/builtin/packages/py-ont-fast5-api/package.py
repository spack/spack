...
class PyOntFast5Api(PythonPackage):
    ...
    depends_on("py-h5py@2.10:", when="@4.0.1:", type=("build", "run"))
    depends_on("py-numpy@1.8.1:", type=("build", "run"))
    depends_on("py-numpy@1.16:", when="@3.2.0:", type=("build", "run"))
    depends_on("py-packaging", when="@3.0.2:", type=("build", "run"))
    depends_on("py-progressbar33@2.3.1:", when="@1.0.1:", type=("build", "run"))
