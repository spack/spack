...
class PyOpenpmdValidator(PythonPackage):
    ...
    url = (
        "https://github.com/openPMD/openPMD-validator/archive/refs/tags/1.1.0.2.tar.gz"
    )
    ...
    version(
        "1.1.0.2",
        sha256="b30be7957c2e1e7de67d81fad64492c3a1ecd25db231293d896da116a71ecca5",
    )
    version(
        "1.1.0.1",
        sha256="93031f50ddeb747ebd6aabca249aa6bf0491d570de56746d7a98d6453427f191",
    )
    version(
        "1.0.0.2",
