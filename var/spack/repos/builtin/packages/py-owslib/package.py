...
class PyOwslib(PythonPackage):
    ...
    depends_on("python@3.6:", type=("build", "run"), when="@0.19.2:")
    depends_on("python@3.5:", type=("build", "run"), when="@0.19.1:")
    ...
    depends_on("py-pyproj@2:", type=("build", "run"), when="@0.19.2:")
    depends_on("py-pyyaml", type=("build", "run"), when="@0.19.2:")
