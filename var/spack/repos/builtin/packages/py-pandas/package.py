...
class PyPandas(PythonPackage):
    ...
    depends_on("python@3.9:3.12", type=("build", "run"), when="@2.1.1:")
    depends_on("python@3.9:3.11", type=("build", "run"), when="@2.1.0")
    depends_on("python@3.8:3.11", type=("build", "run"), when="@1.5:2.0")
    depends_on("python@3.8:3.10", type=("build", "run"), when="@1.4")
    depends_on("python@:3.10", type=("build", "run"), when="@1.3.3:1.3")
    depends_on("python@:3.9", type=("build", "run"), when="@1.1.3:1.3.2")
    depends_on("python@:3.8", type=("build", "run"), when="@0.25.2:1.1.2")
    depends_on("python@:3.7", type=("build", "run"), when="@:0.25.1")

    # pyproject.toml
    depends_on("py-meson-python@0.13.1", type="build", when="@2.1:")
    depends_on("meson@1.2.1", type="build", when="@2.1.1:")
    depends_on("meson@1.0.1", type="build", when="@2.1.0")
    ...
    depends_on("py-numpy@1.22.4:2", type=("build", "run"), when="@2.1.2:")
    depends_on("py-numpy@1.22.4:", type=("build", "run"), when="@2.1:")
    ...
    depends_on("py-numexpr@2.8.0:", type=("build", "run"), when="@2.1:")
    ...
    depends_on("py-bottleneck@1.3.4:", type=("build", "run"), when="@2.1:")
    ...
    depends_on("py-numba@0.55.2:", type=("build", "run"), when="@2.1:")
    depends_on("py-numba@0.53.1:", type=("build", "run"), when="@2.0:")
    ...
    depends_on("py-setuptools@61:", type="build", when="@2.0")
    depends_on("py-setuptools@51:", type="build", when="@1.3.2:1")
    depends_on("py-setuptools@38.6:", type="build", when="@1.3.0:1.3.1")
    depends_on("py-setuptools@24.2:", type="build", when="@:1.2")
