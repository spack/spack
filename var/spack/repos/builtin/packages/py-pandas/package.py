...
class PyPandas(PythonPackage):
    ...
    depends_on("py-odfpy@1.4.1:", when="@2.0: +excel", type=("run"))
    depends_on("py-openpyxl@3.0.10:", when="@2.1: +excel", type=("run"))
    depends_on("py-openpyxl@3.0.7:", when="@1.5: +excel", type=("run"))
    depends_on("py-openpyxl@3.0.3:", when="@1.4: +excel", type=("run"))
    depends_on("py-pyxlsb@1.0.9:", when="@2.1: +excel", type=("run"))
    depends_on("py-pyxlsb@1.0.8:", when="@1.5: +excel", type=("run"))
    depends_on("py-pyxlsb@1.0.6:", when="@1.4: +excel", type=("run"))
    depends_on("py-xlrd@2.0.1:", when="@1.4: +excel", type=("run"))
    depends_on("py-xlwt@1.3.0:", when="@1.4:1.5 +excel", type=("run"))
    depends_on("py-xlsxwriter@3.0.3:", when="@2.1: +excel", type=("run"))
    depends_on("py-xlsxwriter@1.4.3:", when="@1.5: +excel", type=("run"))
    depends_on("py-xlsxwriter@1.2.2:", when="@1.4: +excel", type=("run"))
