...
class PyParsl(PythonPackage):
    ...
    depends_on("python@3.8:", when="@2023.08.21:", type=("build", "run"))
    depends_on("python@3.6:", when="@:1.2", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-pyzmq@17.1.2:", type=("build", "run"))
    depends_on("py-typeguard@2.10:2", when="@2023.08.21:", type=("build", "run"))
    depends_on("py-typeguard@2.10:", when="@:1.2", type=("build", "run"))
    depends_on("py-typing-extensions@4.6:4", when="@2023.08.21:", type=("build", "run"))
    depends_on("py-typing-extensions", when="@:1.2", type=("build", "run"))
    depends_on("py-six", when="@2023.08.21:", type=("build", "run"))
    ...
    depends_on("py-setproctitle", when="@2023.08.21:", type=("build", "run"))

    with when("+monitoring"):
        depends_on("py-sqlalchemy@1.4:1", when="@2023.08.21:", type=("build", "run"))
        depends_on("py-sqlalchemy@1.3", when="@:1.2", type=("build", "run"))
        conflicts("^py-sqlalchemy@1.3.4", when="@:1.2")
        depends_on("py-sqlalchemy-utils", when="@:1.2", type=("build", "run"))
        depends_on("py-pydot", type=("build", "run"))
        depends_on("py-networkx@2.5.0:2.5", when="@2023.08.21:", type=("build", "run"))
        depends_on("py-networkx", when="@:1.2", type=("build", "run"))
        depends_on("py-flask@1.0.2:", type=("build", "run"))
        depends_on("py-flask-sqlalchemy", type=("build", "run"))
        depends_on("py-pandas@:1", when="@2023.08.21:", type=("build", "run"))
