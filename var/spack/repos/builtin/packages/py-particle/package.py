...
class PyParticle(PythonPackage):
    ...
    depends_on("python@2.7:2.8,3.5:", type=("build", "run"), when="@:0.19")
    depends_on("python@3.6:", type=("build", "run"), when="@0.20:")
    depends_on("python@3.7:", type=("build", "run"), when="@0.21:")
    depends_on("py-setuptools", type="build", when="@:0.20")
    depends_on("py-setuptools-scm@3.4:+toml", type="build", when="@:0.20")
    depends_on("py-hatchling", type="build", when="@0.21:")
    depends_on("py-hatch-vcs", type="build", when="@0.21:")
    depends_on("py-importlib-resources@2:", type=("build", "run"), when="@0.16: ^python@:3.8")
    depends_on("py-typing-extensions", type=("build", "run"), when="@0.16: ^python@:3.7")
    depends_on("py-deprecated", type=("build", "run"), when="@0.22.0:")

    depends_on("py-attrs@19.2.0:", type=("build", "run"))
    depends_on("py-hepunits@1.2.0:", type=("build", "run"), when="@:0.12")
    depends_on("py-hepunits@2.0.0:", type=("build", "run"), when="@0.13:")
