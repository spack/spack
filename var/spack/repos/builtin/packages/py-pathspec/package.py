...
class PyPathspec(PythonPackage):
    ...
    depends_on("py-flit-core@3.2:3", type="build", when="@0.11:")
    depends_on("py-setuptools@40.8:", type="build", when="@0.10")
    depends_on("py-setuptools@39.2:", type="build", when="@0.9")
    depends_on("py-setuptools", type="build", when="@:0.10")
