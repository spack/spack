...
class PyPetastorm(PythonPackage):
    ...
    depends_on("py-pyarrow@0.12.0:", when="@:0.8.2", type=("build", "run"))
    depends_on("py-pyarrow@0.17.1:", when="@0.9.8:", type=("build", "run"))
    depends_on("py-six@1.5.0:", type=("build", "run"))
    depends_on("py-fsspec", when="@0.11.4:", type=("build", "run"))
