...
class PyPint(PythonPackage):
    ...
    depends_on("python@3.9:", type=("build", "run"), when="@0.22:")
    depends_on("python@3.8:", type=("build", "run"), when="@0.19:0.21")
    depends_on("py-typing-extensions", type=("build", "run"), when="@0.22:")
    depends_on("py-setuptools@61:", type="build", when="@0.21:")
    depends_on("py-setuptools@41:", type="build", when="@0.16:0.20")
    depends_on("py-setuptools@41:", type=("build", "run"), when="@0.11:0.15")
    depends_on("py-setuptools", type=("build", "run"), when="@:0.10")
    depends_on("py-setuptools-scm@3.4.3:+toml", type="build", when="@0.11:")
    depends_on("py-setuptools-scm", type="build", when="@0.10")
