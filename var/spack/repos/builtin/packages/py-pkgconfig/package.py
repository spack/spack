...
class PyPkgconfig(PythonPackage):
    ...
    depends_on("python@3.3:", type=("build", "run"), when="@1.5.5:")
    depends_on("python@2.7,3.3:", type=("build", "run"), when="@1.5:")
    depends_on("python@2.6:2.7,3.3:", type=("build", "run"), when="@1.4:")
    depends_on("py-poetry-core@1:", type="build", when="@1.5.2:")
    depends_on("py-poetry@0.12:", type="build", when="@1.5.0:1.5.1")
    depends_on("py-setuptools", type="build", when="@:1.4")
