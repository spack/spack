...
class PyPoetryCore(PythonPackage):
    ...
    depends_on("python@3.7:3", type=("build", "run"), when="@1.1.0:")
    depends_on("python@:3", type=("build", "run"))
    depends_on("py-importlib-metadata@1.7:", type=("build", "run"), when="@1.1: ^python@:3.7")
    depends_on("py-importlib-metadata@1.7:1", type=("build", "run"), when="@:1.0 ^python@:3.7")
