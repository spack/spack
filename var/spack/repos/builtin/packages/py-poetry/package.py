...
class PyPoetry(PythonPackage):
    ...
    depends_on("py-cleo@2.0.0:2", when="@1.6.1", type=("build", "run"))
    depends_on("py-clikit@0.6.2:0.6", when="@:1.1", type=("build", "run"))
    depends_on("py-crashtest@0.3.0:0.3", when="@:1.2", type=("build", "run"))
    depends_on("py-crashtest@0.4.1:0", when="@1.6.1", type=("build", "run"))
    ...
    depends_on("py-xattr@0.10.0:0", when="platform=darwin @1.6.1", type=("build", "run"))
    ...
    depends_on("py-dulwich@0.21.2:0", when="@1.6.1", type=("build", "run"))
    depends_on("py-build@0.10.0:0", when="@1.6.1", type=("build", "run"))
    depends_on("py-installer@0.7.0:0", when="@1.6.1", type=("build", "run"))
