...
class PyPoetry(PythonPackage):
    ...
    version("1.7.0", sha256="796e2866f35cb57af36280a890f5a5b3f9ef1a2dcf780b945b02be2e82895391")
    ...
    depends_on("py-poetry-core@1.8.1", when="@1.7.0:", type=("build", "run"))
    ...
    depends_on("py-poetry-plugin-export@1.6.0:1", when="@1.7.0:", type=("build", "run"))
    depends_on("py-build@1.0.3:1", when="@1.7:", type=("build", "run"))
    depends_on(
    ...
    depends_on(
        "py-cachecontrol@0.13.1:0.13+filecache", when="@1.7: ^python@3.6:3", type=("build", "run")
    )
    depends_on("py-cachy@0.3.0:0.3", type=("build", "run"), when="@:1.2")
    depends_on("py-cleo@0.8.1:0.8", when="@:1.1", type=("build", "run"))
    depends_on("py-cleo@1", type=("build", "run"), when="@1.2")
    depends_on("py-cleo@2.1.0", type=("build", "run"), when="@1.7:")
    depends_on("py-clikit@0.6.2:0.6", when="@:1.1", type=("build", "run"))
    depends_on("py-crashtest@0.4.1:0.4", when="@1.7.0: ^python@3.6:3", type=("build", "run"))
    depends_on("py-crashtest@0.3.0:0.3", when="@:1.2 ^python@3.6:3", type=("build", "run"))
    ...
    depends_on("py-jsonschema@4.10.0:4", when="@:1.6", type=("build", "run"))
    depends_on("py-fastjsonschema@2.18.0:2", when="@1.7:", type=("build", "run"))
    ...
    depends_on("py-keyring@24.0.0:24", when="@1.7.0:", type=("build", "run"))
    depends_on("py-installer@0.7.0:0.7", when="@1.7.0:", type=("build", "run"))
    depends_on("py-packaging@20.4:20", when="@:1.1", type=("build", "run"))
    depends_on("py-packaging@20.4:", when="@1.2:", type=("build", "run"))
    depends_on("py-packaging@20.5:", when="@1.7.0:", type=("build", "run"))
    ...
    depends_on("py-pkginfo@1.9.4:1", when="@1.7.0:", type=("build", "run"))
    depends_on("py-platformdirs@3.0.0:3", when="@1.5:", type=("build", "run"))
    depends_on("py-platformdirs@2.5.2:2", when="@1.2", type=("build", "run"))
    depends_on("py-requests@2.18:2", type=("build", "run"))
    depends_on("py-requests@2.26:2", when="@1.7.0:", type=("build", "run"))
    depends_on("py-requests-toolbelt@0.9.1:0.9", type=("build", "run"))
    depends_on("py-requests-toolbelt@0.9.1:1", when="@1.7.0:", type=("build", "run"))
    depends_on("py-shellingham@1.1:1", when="@:1.1", type=("build", "run"))
    depends_on("py-shellingham@1.5:1", when="@1.2:", type=("build", "run"))
    depends_on("py-tomli@2.0.1:2", when="@:1.7 ^python@:3.10", type=("build", "run"))
    ...
    depends_on("py-virtualenv@20.23.0:", when="@1.7.0:", type=("build", "run"))
    depends_on("py-trove-classifiers@2022.5.19:", when="@1.7.0:", type=("build", "run"))
    depends_on("py-xattr@0.9.7:0.9", when="platform=darwin @1.2:")
    depends_on("py-xattr@0.10.0:0.10", when="platform=darwin @1.7.0:")
    depends_on("py-urllib3@1.26.0:1", when="@1.2:1")
    depends_on("py-dulwich@0.20.44:0.20", when="@1.2.0")
    depends_on("py-dulwich@0.20.46:0.20", when="@1.2.1")
    depends_on("py-dulwich@0.21.2:0.21", when="@1.7.0:")
