...
class PyPooch(PythonPackage):
    ...
    depends_on("py-setuptools@45:", type="build", when="@1.6:")
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools-scm+toml@6.2:", type="build", when="@1.6:")
    depends_on("py-setuptools-scm", type="build", when="@1.4:")

    depends_on("py-platformdirs@2.5:", type=("build", "run"), when="@1.7:")
    depends_on("py-packaging@20:", type=("build", "run"), when="@1.6:")
    depends_on("py-packaging", type=("build", "run"))
    depends_on("py-requests@2.19:", type=("build", "run"), when="@1.6:")
    depends_on("py-requests", type=("build", "run"))

    # Historical dependencies
    depends_on("py-appdirs", type=("build", "run"), when="@:1.5")
