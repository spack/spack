...
class PyPreCommit(PythonPackage):
    ...
    depends_on("py-pyyaml@5.1:", type=("build", "run"), when="@2.1:")
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-virtualenv@20.10:", type=("build", "run"), when="@2.21:")
    depends_on("py-virtualenv@20.0.8:", type=("build", "run"), when="@2.4:")
    depends_on("py-virtualenv@15.2:", type=("build", "run"))

    # Historical dependencies
    depends_on("py-toml", type=("build", "run"), when="@:2.20")
