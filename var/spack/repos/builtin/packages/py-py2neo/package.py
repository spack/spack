...
class PyPy2neo(PythonPackage):
    ...
    depends_on("py-certifi", when="@4.3.0:", type=("build", "run"))
    depends_on("py-click@7.0", when="@4.3.0:", type=("build", "run"))
    depends_on("py-colorama", when="@4.3.0:", type=("build", "run"))
    depends_on("py-neobolt@1.7.12:1.7", when="@4.3.0:", type=("build", "run"))
    depends_on("py-neotime@1.7.4:1.7", when="@4.3.0:", type=("build", "run"))
    depends_on("py-prompt-toolkit@2.0.7:2.0", when="@4.3.0:", type=("build", "run"))
    depends_on("py-pygments@2.3.1:2.3", when="@4.3.0:", type=("build", "run"))
    depends_on("py-pytz", when="@4.3.0:", type=("build", "run"))
    depends_on("py-urllib3@1.23:1.24", when="@4.3.0:", type=("build", "run"))
