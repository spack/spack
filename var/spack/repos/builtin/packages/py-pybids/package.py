...
class PyPybids(PythonPackage):
    ...
    depends_on("py-setuptools", type="build", when="@0.15.6:")
    depends_on("py-setuptools@30.3:60,61.0.1:", type="build", when="@:0.15.5")
    depends_on("py-versioneer+toml", type="build", when="@0.15.6:")

    depends_on("py-numpy@1.19:", type=("build", "run"), when="@0.16:")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-scipy@1.5:", type=("build", "run"), when="@0.16:")
    depends_on("py-scipy", type=("build", "run"))
    depends_on("py-nibabel@3:", type=("build", "run"), when="@0.16:")
    depends_on("py-nibabel@2.1:", type=("build", "run"))
    depends_on("py-pandas@0.25.2:", type=("build", "run"), when="@0.16:")
    depends_on("py-pandas@0.23:", type=("build", "run"))
    depends_on("py-formulaic@0.2.4:0.5", type=("build", "run"), when="@0.15.6:")
    depends_on("py-formulaic@0.2.4:0.3", type=("build", "run"), when="@0.15.1:0.15.5")
    depends_on("py-formulaic@0.2.4:0.2", type=("build", "run"), when="@0.14:0.15.0")
    depends_on("py-sqlalchemy@1.3.16:", type=("build", "run"), when="@0.16:")
    depends_on("py-sqlalchemy@:1.3", type=("build", "run"), when="@0.12.4:")
    depends_on("py-sqlalchemy", type=("build", "run"))
    depends_on("py-bids-validator@1.11:", type=("build", "run"), when="@0.16:")
    depends_on("py-bids-validator", type=("build", "run"))
    depends_on("py-num2words@0.5.5:", type=("build", "run"), when="@0.16:")
    depends_on("py-num2words", type=("build", "run"))
    depends_on("py-click@8:", type=("build", "run"), when="@0.15.2:")
    depends_on("py-click", type=("build", "run"), when="@0.12.1:")

    # Historical dependencies
    depends_on("py-patsy", type=("build", "run"), when="@:0.13")
