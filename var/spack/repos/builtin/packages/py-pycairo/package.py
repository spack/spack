...
class PyPycairo(PythonPackage):
    ...
    depends_on("python@3.8:", type=("build", "run"), when="@1.23:")
    depends_on("python@3.6:3", type=("build", "run"), when="@1.20:1.22")
    depends_on("python@2.7:2.8,3.4:3.7", type=("build", "run"), when="@1.18.1:1.19")
