...
class PyPygdal(PythonPackage):
    ...
    depends_on("gdal@3.3.2", when="@3.3.2.10", type=("build", "link", "run"))
    depends_on("gdal@3.3.0", when="@3.3.0.10", type=("build", "link", "run"))
    depends_on("gdal@3.0.4", when="@3.0.4.6", type=("build", "link", "run"))
    depends_on("gdal@3.0.1", when="@3.0.1.5", type=("build", "link", "run"))
    depends_on("gdal@2.4.2", when="@2.4.2.5", type=("build", "link", "run"))
    depends_on("gdal@2.4.1", when="@2.4.1.6", type=("build", "link", "run"))
    depends_on("gdal@2.4.0", when="@2.4.0.6", type=("build", "link", "run"))
