...
class PyPygit2(PythonPackage):
    ...
    depends_on("libgit2@1.5", when="@1.11")
    depends_on("libgit2@1.1", when="@1.4")
    depends_on("libgit2@1.0", when="@1.2:1.3")
    depends_on("libgit2@:1.0", when="@1.1")
    depends_on("libgit2@:0.28", when="@:1.0")
    depends_on("libgit2@:0.27", when="@:0.27")
