...
class PyPygit2(PythonPackage):
    ...
    depends_on("libgit2@1.6.0:1.6", when="@1.12.0:1.12")
    depends_on("libgit2@1.5.0:1.5", when="@1.11.0:1.11")
    depends_on("libgit2@1.1.0:1.1", when="@1.4.0:1.6")
    ...
    depends_on("python@3.8:", when="@1.11.1")
    depends_on("python@3.7:", when="@1.4.0:1.6.0")
    depends_on("python@:3.8", when="@1.2:1.3")
    depends_on("python@:3.8", when="@1.0:1.1")
    depends_on("python@3.7", when="@0.28:0")
    depends_on("py-six", type=("build", "run"), when="@:0.28.2")
    depends_on("py-cffi@1.9.1:", when="@1.11.1:", type=("build", "run"))
    depends_on("py-cffi@1.4.0:", when="@:1.6.0", type=("build", "run"))
