...
class PyPylint(PythonPackage):
    ...
    depends_on("python@3.4:", type=("build", "run"), when="@2:2.7")
    depends_on("python@3.6:", type=("build", "run"), when="@2.8.2:")
    depends_on("python@3.6.2:", type=("build", "run"), when="@2.13.5:")
    depends_on("python@3.7.2:", type=("build", "run"), when="@2.14.0:")
    depends_on("py-setuptools-scm", type="build", when="@2.8.2")
    depends_on("py-setuptools@17.1:", type="build")
    depends_on("py-setuptools@62.6:62", type="build", when="@2.15.0:")
    depends_on("py-wheel@0.37.1:0.37", type="build", when="@2.15.0:")
    depends_on("py-dill@0.2:", type=("build", "run"), when="@2.13.5:2.15")
    depends_on("py-dill@0.2:", type=("build", "run"), when="@2.16:  ^python@:3.10")
    depends_on("py-dill@0.3.6:", type=("build", "run"), when="@2.16.0: ^python@3.11:")
    ...
    depends_on("py-astroid@2.12.4:2.13", type=("build", "run"), when="@2.15")
    depends_on("py-astroid@2.14.2:2.15", type=("build", "run"), when="@2.16:")
    depends_on("py-isort@4.2.5:", type=("build", "run"))
    depends_on("py-isort@4.2.5:4", type=("build", "run"), when="@2.3.1:2.5")
    depends_on("py-isort@4.2.5:5", type=("build", "run"), when="@2.6:")
    depends_on("py-mccabe", type=("build", "run"))
    depends_on("py-mccabe@0.6.0:0.6", type=("build", "run"), when="@2.3.1:2.11")
    depends_on("py-mccabe@0.6.0:0.7", type=("build", "run"), when="@2.13:")
    depends_on("py-tomli@1.1.0:", type=("build", "run"), when="@2.13.5: ^python@:3.10")
    depends_on("py-tomlkit@0.10.1:", type=("build", "run"), when="@2.14.0:")
    depends_on("py-colorama@0.4.5:", type=("build", "run"), when="platform=windows")
