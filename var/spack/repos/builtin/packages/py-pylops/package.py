...
class PyPylops(PythonPackage):
    ...
    depends_on("py-llvmlite", type=("build", "run"), when="+advanced")
    depends_on("py-numba", type=("build", "run"), when="+advanced")
    depends_on("py-pyfftw", type=("build", "run"), when="+advanced")
    depends_on("py-pywavelets", type=("build", "run"), when="+advanced")
    depends_on("py-scikit-fmm", type=("build", "run"), when="+advanced")
    depends_on("py-spgl1", type=("build", "run"), when="+advanced")
