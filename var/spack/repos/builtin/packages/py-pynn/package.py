...
class PyPynn(PythonPackage):
    ...
    depends_on("py-jinja2@2.7:", when="@:0.9", type=("build", "run"))
    depends_on("py-docutils@0.10:", when="@:0.9", type=("build", "run"))
    ...
    depends_on("py-quantities@0.12.1:", when="@0.10.0:", type=("build", "run"))

    depends_on("py-lazyarray@0.2.9:", type=("build", "run"))
    depends_on("py-lazyarray@0.5.0:", when="@0.10.0:", type=("build", "run"))

    depends_on("py-neo@0.3:0.4.1", when="@:0.8.3", type=("build", "run"))
    depends_on("py-neo@0.5.0:", when="@0.9.0:", type=("build", "run"))
    depends_on("py-neo@0.10.0:", when="@0.10.0:", type=("build", "run"))
