...
class PyPysam(PythonPackage):
    ...
    depends_on("py-setuptools@59.0:", type="build", when="@0.21:")
    depends_on("py-setuptools", type="build")
    depends_on("py-cython@0.29.30:2", type="build", when="@0.21:")
    depends_on("py-cython@0.29.12:2", type="build", when="@0.18:")
    depends_on("py-cython@0.21:2", type="build", when="@0.14:")
