...
class PyPyspark(PythonPackage):
    ...
    version("3.5.0", sha256="d41a9b76bd2aca370a6100d075c029e22ba44c5940927877e9435a3a9c566558")
    ...
    depends_on("py-py4j@0.10.9.7", when="@3.4:", type=("build", "run"))
    depends_on("py-py4j@0.10.9.5", when="@3.3", type=("build", "run"))
    depends_on("py-py4j@0.10.9.3", when="@3.2", type=("build", "run"))
