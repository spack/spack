...
class PyPyspark(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@3.3.0:")
    depends_on("python@3.6:", type=("build", "run"), when="@3:3.2.3")
    depends_on("python@2.7:3.7", type=("build", "run"), when="@:2")
    depends_on("python@2.7:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-py4j@0.10.9.5", type=("build", "run"), when="@3.3.0:")
    depends_on("py-py4j@0.10.9.3", type=("build", "run"), when="@3.2.1")
    depends_on("py-py4j@0.10.9", type=("build", "run"), when="@3.0.1:3.1.3")
    depends_on("py-py4j@0.10.7", type=("build", "run"), when="@2.3.2:2.4.4")
    depends_on("py-py4j@0.10.6", type=("build", "run"), when="@2.3.0")
