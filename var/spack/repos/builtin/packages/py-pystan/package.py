...
class PyPystan(PythonPackage):
    ...
    depends_on("python@3.8:3", when="@3.4.0:", type=("build", "run"))
    depends_on("py-aiohttp@3.6:3", when="@3.4.0:", type=("build", "run"))
    depends_on("py-httpstan@4.8", when="@3.5.0:", type=("build", "run"))
    depends_on("py-httpstan@4.7", when="@3.4", type=("build", "run"))
    depends_on("py-pysimdjson@3.2:3", when="@3.4.0:", type=("build", "run"))
    depends_on("py-numpy@1.19:1", when="@3.4.0:", type=("build", "run"))
    depends_on("py-numpy@1.7:", when="@2.19.0.0:", type=("build", "run"))
    depends_on("py-clikit@0.6", when="@3.4.0:", type=("build", "run"))
    depends_on("py-cython@0.22:0.23.2,0.25.2:", when="@:2.19.1.1", type=("build", "run"))
