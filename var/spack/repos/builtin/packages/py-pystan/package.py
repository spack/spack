...
class PyPystan(PythonPackage):
    ...
    depends_on('python@3.8:3.9',    type=('build', 'run'), when='@3.4.0:')
    depends_on('py-aiohttp@3.6:',   type=('build', 'run'), when='@3.4.0:')
    depends_on('py-httpstan@4.8:',  type=('build', 'run'), when='@3.5.0:')
    depends_on('py-httpstan@4.7',   type=('build', 'run'), when='@3.4.0:')
    depends_on('py-pysimdjson@3.2', type=('build', 'run'), when='@3.4.0:')
    depends_on('py-numpy@1.19:',    type=('build', 'run'), when='@3.4.0:')
    depends_on('py-numpy@1.7:',     type=('build', 'run'), when='@2.19.0.0:')
    depends_on('py-clikit@0.6',     type=('build', 'run'), when='@3.4.0:')
    depends_on('py-cython@0.22:0.23.2,0.25.2:',
                type=('build', 'run'), when='@:2.19.1.1')
