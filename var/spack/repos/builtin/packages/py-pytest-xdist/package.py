...
class PyPytestXdist(PythonPackage):
    ...
    depends_on("py-setuptools@45.0:", when="@3.2.0:", type="build")
    depends_on("py-setuptools", when="@:1.30.0", type="build")
    depends_on("py-setuptools-scm@6.2.3: +toml", when="@3.2.0:", type="build")
    depends_on("py-execnet@1.1:", type=("build", "run"))
    depends_on("py-pytest@6.2.0:", when="@3.2.0:", type=("build", "run"))
    depends_on("py-pytest@4.4.0:", when="@1.28.0:1.30.0", type=("build", "run"))
    depends_on("py-pytest@3.6.0:", when="@1.25.0:1.27.0", type=("build", "run"))
    depends_on("py-pytest@3.0.0:", when="@1.18.0:1.24.0", type=("build", "run"))
    depends_on("py-pytest@2.7.0:", when="@1.16.0:1.17.0", type=("build", "run"))
    depends_on("py-pytest-forked", when="@1.19.0:1", type=("build", "run"))
    depends_on("py-six", when="@1.23.0:1", type=("build", "run"))
