...
class PyPythran(PythonPackage):
    ...
    depends_on("py-gast@0.5:0.5.3", type=("build", "run"), when="@0.9.12:")
    depends_on("py-gast@0.4", type=("build", "run"), when="@0.9.7:0.9.11")
    depends_on("py-gast@0.3.3:0.3", type=("build", "run"), when="@0.9.6")
    depends_on("py-gast@0.3:", type=("build", "run"), when="@0.9.4:0.9.5")
    depends_on("py-gast", type=("build", "run"), when="@:0.9.3")
    depends_on("py-numpy", type=("build", "run"))
    depends_on("py-beniget@0.4", type=("build", "run"), when="@0.9.12:")
    depends_on("py-beniget@0.3", type=("build", "run"), when="@0.9.7:0.9.11")
    depends_on("py-beniget@0.2.1:0.2", type=("build", "run"), when="@0.9.6")
    depends_on("py-beniget@0.2:", type=("build", "run"), when="@0.9.4:0.9.5")
    depends_on("py-beniget", type=("build", "run"), when="@:0.9.3")
    depends_on("llvm-openmp", type=("build", "run"), when="%apple-clang")

    # Historical dependencies
    depends_on("py-pytest-runner", type="build", when="@:0.9")
    depends_on("py-networkx@2:", type=("build", "run"), when="@:0.9.11")
    depends_on("py-decorator", type=("build", "run"), when="@:0.9.11")
    depends_on("py-six", type=("build", "run"), when="@:0.9.11")
