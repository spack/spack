...
class PyPytools(PythonPackage):
    ...
    depends_on("py-appdirs@1.4.0:", type=("build", "run"), when="@:2021.2.9")
    depends_on("py-platformdirs@2.2.0:", type=("build", "run"), when="@2022.1.12:")
    depends_on("py-six@1.8.0:", type=("build", "run"), when="@:2019.1.1")
    depends_on("py-numpy@1.6.0:", type=("build", "run"), when="@:2021.2.9")
    depends_on("py-numpy@1.6.0:", type=("build", "run"), when="@2022.1.12: +numpy")
    depends_on("py-typing-extensions@4.0:", type=("build", "run"), when="@2021.2.9: ^python@:3.10")
    depends_on("python@2.6:2.8,3.4:", type=("build", "run"))
    depends_on("python@3.6:3", type=("build", "run"), when="@2021.2.9:2022.1.12")
    depends_on("python@3.8:3", type=("build", "run"), when="@2022.1.14:")
