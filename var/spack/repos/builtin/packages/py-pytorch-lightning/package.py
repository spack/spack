...
class PyPytorchLightning(PythonPackage):
    ...
    depends_on("py-numpy@1.17.2:", type=("build", "run"), when="@1.3:")
    depends_on("py-numpy@1.16.6:", type=("build", "run"), when="@:1.2")
    depends_on("py-torch@1.11:", type=("build", "run"), when="@2:")
    depends_on("py-torch@1.10:", type=("build", "run"), when="@1.9:")
    depends_on("py-torch@1.9:", type=("build", "run"), when="@1.7:")
    depends_on("py-torch@1.8:", type=("build", "run"), when="@1.6:")
    depends_on("py-torch@1.6:", type=("build", "run"), when="@1.4:1.5")
    depends_on("py-torch@1.4:", type=("build", "run"), when="@:1.3")
    depends_on("py-tqdm@4.57.0:", type=("build", "run"), when="@1.6.3:")
    depends_on("py-tqdm@4.41.0:", type=("build", "run"), when="@:1.6.2")
    depends_on("py-pyyaml@5.4:", type=("build", "run"), when="@1.6:")
    depends_on("py-pyyaml@5.1:", type=("build", "run"), when="@1.4:1.5")
    depends_on("py-pyyaml@5.1:5.4.1", type=("build", "run"), when="@1.3")
    depends_on("py-pyyaml@5.1:5.3,5.5:", type=("build", "run"), when="@:1.2")
    depends_on("py-fsspec@2021.06.1:+http", type=("build", "run"), when="@1.8:")
    depends_on("py-fsspec@2021.05.0:2021.05,2021.06.1:+http", type=("build", "run"), when="@1.3:")
    depends_on("py-fsspec@0.8.1:+http", type=("build", "run"), when="@:1.2")
    depends_on("py-torchmetrics@0.7:", type=("build", "run"), when="@1.7:")
    depends_on("py-torchmetrics@0.4.1:", type=("build", "run"), when="@1.5:")
    depends_on("py-torchmetrics@0.4.0:", type=("build", "run"), when="@1.4")
    depends_on("py-torchmetrics@0.2.0:", type=("build", "run"), when="@1.3")
    depends_on("py-torchmetrics@0.2.0", type=("build", "run"), when="@:1.2")
    depends_on("py-packaging@17.1:", type=("build", "run"), when="@1.9:")
    depends_on("py-packaging@17.0:", type=("build", "run"), when="@1.3:")
    depends_on("py-packaging", type=("build", "run"), when="@:1.2")
    depends_on("py-typing-extensions@4.0.0:", type=("build", "run"), when="@1.6:")
    depends_on("py-typing-extensions", type=("build", "run"), when="@1.4:1.5")
    depends_on("py-lightning-utilities@0.7:", type=("build", "run"), when="@2:")
    depends_on("py-lightning-utilities@0.6.0.post0:", type=("build", "run"), when="@1.9.1:")
    depends_on("py-lightning-utilities@0.4.2:", type=("build", "run"), when="@1.9.0")
    depends_on("py-lightning-utilities@0.3,0.4.1:", type=("build", "run"), when="@1.8.4:1.8")
    depends_on("py-lightning-utilities@0.3:", type=("build", "run"), when="@1.8.0:1.8.3")

    # Historical dependencies
    depends_on("py-lightning-lite@1.8.0", type=("build", "run"), when="@1.8.0")
    depends_on("py-future@0.17.1:", type=("build", "run"), when="@:1.5")
    depends_on("pil@:8.2,8.3.1:", type=("build", "run"), when="@1.3")
    depends_on("py-protobuf@:3.20.1", type="build", when="@1.6.4:1.6")
    depends_on("py-pydeprecate@0.3.1:", type=("build", "run"), when="@1.6.4:1.7")
    depends_on("py-pydeprecate@0.3.1:0.3", type=("build", "run"), when="@1.6:1.6.3")
    depends_on("py-pydeprecate@0.3.1", type=("build", "run"), when="@1.4:1.5")
    depends_on("py-pydeprecate@0.3.0", type=("build", "run"), when="@1.3")
    depends_on("py-tensorboardx@2.2:", type=("build", "run"), when="@1.8.3:1.8")
    depends_on("py-tensorboard@2.9.1:", type=("build", "run"), when="@1.7:1.8.2")
    depends_on("py-tensorboard@2.2.0:", type=("build", "run"), when="@1.5:1.6")
    depends_on("py-tensorboard@2.2.0:2.4,2.5.1:", type=("build", "run"), when="@:1.4")
