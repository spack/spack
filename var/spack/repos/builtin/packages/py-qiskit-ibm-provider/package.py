...
class PyQiskitIbmProvider(PythonPackage):
    ...
    depends_on("py-qiskit-terra@0.23.0:",       type=("build", "run"))
    ...
    with when("+visualization"):
        conflicts("py-traitlets@5.0.5")
        depends_on("py-matplotlib@2.1:",            type=("build", "run"))
        depends_on("py-ipywidgets@:8.0.0",          type=("build", "run"))
        ...
        depends_on("py-ipython@5.1.0:",             type=("build", "run"))
