...
class PyQuantities(PythonPackage):
    ...
    depends_on("python@2.7.0:2.7,3.4:3.7", when="@0.12.3", type=("build", "run"))
    depends_on("python@2.7.0:2.7,3.4:3.8", when="@0.12.4:0.12.5", type=("build", "run"))
    depends_on("python@3.7:3.10", when="@0.13:", type=("build", "run"))

    # pip silently replaces distutils with setuptools
    depends_on("py-setuptools", type="build")

    depends_on("py-numpy@1.8.2:1.16", when="@0.12.3", type=("build", "run"))
    depends_on("py-numpy@1.8.2:1.17", when="@0.12.4:0.12", type=("build", "run"))
    depends_on("py-numpy@1.16:", when="@0.13.0:", type=("build", "run"))
