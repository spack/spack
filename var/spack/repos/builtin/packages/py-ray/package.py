...
class PyRay(PythonPackage):
    ...
    depends_on("python@3.6:3.10", type=("build", "run"), when="@2.0.1")
    depends_on("python@3.6:3.8", type=("build", "run"), when="@0.8.7")
    depends_on("bazel@4.2.2", type="build", when="@2.0.1")
    depends_on("bazel@3.2.0", type="build", when="@0.8.7")
    depends_on("npm", type="build")
    depends_on("py-setuptools", type="build")
    depends_on("py-cython@0.29.26:", type="build", when="@2.0.1")
    depends_on("py-cython@0.29.14:", type="build", when="@0.8.7")
    depends_on("py-attrs", type=("build", "run"), when="@2.0.1")
    depends_on("py-click@7:8.0.4", type=("build", "run"), when="@2.0.1")
    depends_on("py-click@7.0:", type=("build", "run"), when="@0.8.7")
    depends_on("py-filelock", type=("build", "run"))
    depends_on("py-grpcio@1.32:1.43.0", type=("build", "run"), when="@2.0.1 ^python@:3.9")
    depends_on("py-grpcio@1.42:1.43.0", type=("build", "run"), when="@2.0.1 ^python@3.10:")
    depends_on("py-grpcio@1.28.1:", type=("build", "run"), when="@0.8.7")
    depends_on("py-jsonschema", type=("build", "run"))
    depends_on("py-msgpack@1", type=("build", "run"))
    depends_on("py-numpy@1.16:", type=("build", "run"), when="^python@:3.8")
    depends_on("py-numpy@1.19.3:", type=("build", "run"), when="^python@3.9:")
    depends_on("py-protobuf@3.15.3:3", type=("build", "run"), when="@2.0.1")
    depends_on("py-protobuf@3.8.0:", type=("build", "run"), when="@0.8.7")
    depends_on("py-pyyaml", type=("build", "run"))
    depends_on("py-frozenlist", type=("build", "run"), when="@2.0.1")
    depends_on("py-requests", type=("build", "run"))
    depends_on("py-typing-extensions", type=("build", "run"), when="@2.0.1 ^python@:3.7")
    depends_on("py-virtualenv", type=("build", "run"), when="@2.0.1")
    ...
    with when("@0.8.7"):
        ...
        depends_on("py-pickle5", type=("build", "run"), when="^python@:3.8.1")
