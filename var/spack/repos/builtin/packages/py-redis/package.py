...
class PyRedis(PythonPackage):
    ...
    version(
        ...
        url="https://pypi.org/packages/bb/f1/a384c5582d9a28e4a02eb1a2c279668053dd09aafeb08d2bd4dd323fc466/redis-5.0.3-py3-none-any.whl",
    )
    version(
        "4.5.1",
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-async-timeout@4.0.3:", when="@5.0.3:5.0 ^python@:3.10")
