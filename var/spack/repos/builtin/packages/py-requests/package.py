...
class PyRequests(PythonPackage):
    ...
    depends_on("python@3.7:", type=("build", "run"), when="@2.28:")
    depends_on("py-setuptools", type="build")

    depends_on("py-charset-normalizer@2:3", type=("build", "run"), when="@2.28.2:")
    depends_on("py-charset-normalizer@2", type=("build", "run"), when="@2.26:2.28.1")
    depends_on("py-idna@2.5:3", type=("build", "run"), when="@2.26:")
    depends_on("py-idna@2.5:2", type=("build", "run"), when="@2.23:2.25")
    depends_on("py-idna@2.5:2.8", type=("build", "run"), when="@2.16:2.22")
    depends_on("py-urllib3@1.21.1:2", type=("build", "run"), when="@2.30:")
    depends_on("py-urllib3@1.21.1:1.26", type=("build", "run"), when="@2.25:2.29")
    depends_on("py-urllib3@1.21.1:1.24,1.25.2:1.25", type=("build", "run"), when="@2.16:2.24")
    depends_on("py-certifi@2017.4.17:", type=("build", "run"), when="@2.16:")
