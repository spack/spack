...
class PyResultsfile(PythonPackage):
    ...
    url = (
        "https://gitlab.com/scemama/resultsFile/-/archive/v1.0/resultsFile-v1.0.tar.gz"
    )
    ...
    version(
        "2.0", sha256="2a34208254e4bea155695690437f6a59bf5f7b0ddb421d6c1a2d377510f018f7"
    )
    version(
        "1.0",
        sha256="e029054b2727131da9684fa2ec9fb8b6a3225dc7f648216a9390267b2d5d60c3",
        deprecated=True,
    )
