...
class PySalib(PythonPackage):
    ...
    depends_on("py-numpy@1.16.5:", type=("build", "run"), when="@:1.4.4")
    depends_on("py-numpy@1.20.3:", type=("build", "run"), when="@1.4.6:")
    depends_on("py-scipy@1.5.2:", type=("build", "run"), when="@:1.4.4")
    depends_on("py-scipy@1.7.3:", type=("build", "run"), when="@1.4.6:1.4.8")
    ...
    depends_on("py-pandas@1.1.2:", type=("build", "run"), when="@:1.4.8")
    depends_on("py-pandas@2.0:", type=("build", "run"), when="@1.5.0:")
    depends_on("py-pathos@0.2.5:", type=("build", "run"), when="@:1.4.8")
    depends_on("py-pathos@0.3.2:", type=("build", "run"), when="@:1.5.0")
