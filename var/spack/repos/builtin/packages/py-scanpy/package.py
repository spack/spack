...
class PyScanpy(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        depends_on(
            "py-joblib",
            when="@:0.2.4,0.2.9:0.2.9.0,0.4:0.4.0,0.4.2:0,1.1-alpha1,1.3.8:1.4.0,"
            "1.4.4,1.4.5.post2:1.4.5,1.5:",
        )
        ...
        depends_on(
            "py-seaborn",
            when="@:0.2.4,0.2.9:0.2.9.0,0.4:0.4.0,0.4.2:0,1.1-alpha1,1.3.8:1.4.0,"
            "1.4.4,1.4.5.post2:1.4.5,1.5:1.9.5",
        )
        ...
        depends_on(
            "py-tqdm", when="@:0.2.4,0.2.9:0.2.9.0,0.4:0.4.0,0.4.2,1.4.4,1.4.5.post2:1.4.5,1.5:"
        )
