...
class PyScikitLearn(PythonPackage):
    ...
    depends_on("python@3.8:3.12", type=("build", "run"), when="@1.3.1:")
    depends_on("python@3.8:3.11", type=("build", "run"), when="@1.1.3:1.3.0")
    depends_on("python@3.8:3.10", type=("build", "run"), when="@1.1.0:1.1.2")
    depends_on("python@:3.10", type=("build", "run"), when="@1.0.2")
    depends_on("python@:3.9", type=("build", "run"), when="@0.24:1.0.1")
    depends_on("python@:3.8", type=("build", "run"), when="@0.22:0.23")
    depends_on("python@:3.7", type=("build", "run"), when="@:0.21")

    # pyproject.toml
    depends_on("py-setuptools", type="build")
    depends_on("py-setuptools@:59", type="build", when="@:1.2.1")
    depends_on("py-cython@0.29.33:2", type="build", when="@1.3:")
    depends_on("py-cython@0.29.24:2", type="build", when="@1.0.2:")
    depends_on("py-cython@0.28.5:2", type="build", when="@0.21:")
    depends_on("py-cython@0.23:2", type="build")

    # sklearn/_min_dependencies.py
    depends_on("py-numpy@1.17.3:", type=("build", "run"), when="@1.1:")
    depends_on("py-numpy@1.14.6:", type=("build", "run"), when="@1.0:")
    depends_on("py-numpy@1.13.3:", type=("build", "run"), when="@0.23:")
    depends_on("py-numpy@1.11.0:", type=("build", "run"), when="@0.21:")
    depends_on("py-numpy@1.8.2:", type=("build", "run"), when="@0.20")
    depends_on("py-numpy@1.6.1:", type=("build", "run"), when="@:0.19")
    depends_on("py-scipy@1.5:", type=("build", "run"), when="@1.3:")
    depends_on("py-scipy@1.3.2:", type=("build", "run"), when="@1.1:")
    depends_on("py-scipy@1.1.0:", type=("build", "run"), when="@1.0:")
    depends_on("py-scipy@0.19.1:", type=("build", "run"), when="@0.23:")
    depends_on("py-scipy@0.17.0:", type=("build", "run"), when="@0.21:")
    depends_on("py-scipy@0.13.3:", type=("build", "run"), when="@0.20")
    depends_on("py-scipy@0.9:", type=("build", "run"), when="@:0.19")
    depends_on("py-joblib@1.1.1:", type=("build", "run"), when="@1.2:")
    depends_on("py-joblib@1:", type=("build", "run"), when="@1.1:")
    depends_on("py-joblib@0.11:", type=("build", "run"))
    depends_on("py-threadpoolctl@2.0.0:", type=("build", "run"), when="@0.23:")
