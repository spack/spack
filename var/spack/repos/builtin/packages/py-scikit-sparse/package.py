...
class PyScikitSparse(PythonPackage):
    ...
    depends_on("python@3.6:3.11", type=("build", "link", "run"), when="@0.4.12")
    depends_on("python@3.6:3.11", type=("build", "link", "run"), when="@0.4.11")
    depends_on("python@3.6:3.10", type=("build", "link", "run"), when="@0.4.8")
    depends_on("py-setuptools@40.8:", type="build")
    depends_on("py-cython@0.22:", type="build", when="@0.4.12")
    depends_on("py-cython@0.22:0.29", type="build", when="@:0.4.11")
