...
class PyScipy(PythonPackage):
    ...
    depends_on("py-meson-python@0.15", when="@1.12:", type="build")
    ...
    depends_on("py-cython@0.29.35:3.0", when="@1.12:", type="build")
    depends_on("py-cython@0.29.35:2", when="@1.11", type="build")
    depends_on("py-cython@0.29.32:2", when="@1.9.2:1.10", type="build")
    depends_on("py-cython@0.29.21:2", when="@1.9.0:1.9.1", type="build")
    depends_on("py-cython@0.29.18:2", when="@1.7:1.8", type="build")
    depends_on("py-pybind11@2.10.4:2.11", when="@1.12:", type=("build", "link"))
    depends_on("py-pybind11@2.10.4:2.11.0", when="@1.11.3:1.11", type=("build", "link"))
    ...
    depends_on("py-pythran@0.15", when="@1.12:", type="build")
    ...
    depends_on("py-numpy@1.22.4:1.28", when="@1.12:", type=("build", "link", "run"))
    ...
    depends_on("py-pooch", type="test")
    depends_on("py-hypothesis@6.30:", type="test")
