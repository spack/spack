...
class PyScipy(PythonPackage):
    ...
    depends_on("python@3.9:3.12", type=("build", "link", "run"), when="@1.11:")
    depends_on("python@3.8:3.11", type=("build", "link", "run"), when="@1.9.2:1.10")
    depends_on("python@3.8:3.10", type=("build", "link", "run"), when="@1.8:1.9.1")
    depends_on("python@:3.10", type=("build", "link", "run"), when="@1.7.2:1.7")
    depends_on("python@:3.9", type=("build", "link", "run"), when="@1.5.4:1.7.1")
    depends_on("python@:3.8", type=("build", "link", "run"), when="@1.3.2:1.5.3")
    depends_on("python@:3.7", type=("build", "link", "run"), when="@1.1:1.3.1")

    depends_on("py-meson-python@0.12.1:", type="build", when="@1.11:")
    depends_on("py-meson-python@0.11:", type="build", when="@1.10:")
    depends_on("py-meson-python@0.9:", type="build", when="@1.9.2:")
    depends_on("py-meson-python@0.8.1:", type="build", when="@1.9.1:")
    depends_on("py-meson-python@0.7:", type="build", when="@1.9:")
    depends_on("meson", type="build", when="@1.9.0:1.9.1")
    depends_on("py-cython@0.29.35:2", type="build", when="@1.11:")
    depends_on("py-cython@0.29.32:2", type="build", when="@1.9.2:")
    depends_on("py-cython@0.29.21:2", type="build", when="@1.9:")
    depends_on("py-cython@0.29.18:2", type="build", when="@1.7:")
    depends_on("py-pybind11@2.10.4:2.11.0", type=("build", "link"), when="@1.11.3:")
    depends_on("py-pybind11@2.10.4:2.10", type=("build", "link"), when="@1.11.0:1.11.2")
    depends_on("py-pybind11@2.10.1", type=("build", "link"), when="@1.10")
    depends_on("py-pybind11@2.4.3:2.10", type=("build", "link"), when="@1.9.1:1.9")
    depends_on("py-pybind11@2.4.3:2.9", type=("build", "link"), when="@1.9.0")
    depends_on("py-pybind11@2.4.3:2.8", type=("build", "link"), when="@1.8")
    depends_on("py-pybind11@2.4.3:2.7", type=("build", "link"), when="@1.7.2:1.7")
    depends_on("py-pybind11@2.4.3:2.6", type=("build", "link"), when="@1.6.2:1.7.1")
    depends_on("py-pybind11@2.4.3:", type=("build", "link"), when="@1.5:1.6.1")
    depends_on("py-pybind11@2.4.0:", type=("build", "link"), when="@1.4.1:1.4")
    depends_on("py-pybind11@2.2.4:", type=("build", "link"), when="@1.4.0")
    depends_on("py-pythran@0.12:", type="build", when="@1.10:")
    depends_on("py-pythran@0.10:", type="build", when="@1.8")
    depends_on("py-pythran@0.9.12:", type="build", when="@1.7.2:")
    depends_on("py-pythran@0.9.11:", type="build", when="@1.7:")
    depends_on("py-wheel@:0.40", type="build", when="@1.11.0:1.11.2")
    depends_on("py-wheel@:0.38", type="build", when="@1.10")
    depends_on("py-wheel@:0.37", type="build", when="@:1.9")
    depends_on("pkgconfig", type="build", when="@1.9:")
    depends_on("py-setuptools", type="build", when="@:1.8")
    depends_on("py-setuptools@:59", type="build", when="@1.8")
    depends_on("py-setuptools@:57", type="build", when="@1.7")
    depends_on("py-setuptools@:51.0.0", type="build", when="@1.6")
    depends_on("py-numpy@1.21.6:1.27", type=("build", "link", "run"), when="@1.11:")
    depends_on("py-numpy@1.19.5:1.26", type=("build", "link", "run"), when="@1.10")
    depends_on("py-numpy@1.18.5:1.25", type=("build", "link", "run"), when="@1.9")
    depends_on("py-numpy@1.17.3:1.24", type=("build", "link", "run"), when="@1.8")
    depends_on("py-numpy@1.16.5:1.22", type=("build", "link", "run"), when="@1.6:1.7")
    depends_on("py-numpy@1.14.5:1.21", type=("build", "link", "run"), when="@1.5")
    depends_on("py-numpy@1.13.3:1.21", type=("build", "link", "run"), when="@1.3:1.4")
    depends_on("py-numpy@1.8.2:1.20", type=("build", "link", "run"), when="@:1.2")
    depends_on("py-pytest", type="test")

    # Required to use --config-settings
    depends_on("py-pip@23.1:", type="build", when="@1.9:")
