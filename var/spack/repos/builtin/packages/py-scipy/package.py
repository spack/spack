...
class PyScipy(PythonPackage):
    ...
    depends_on("py-cython@0.29.35:", when="@1.12:", type="build")
    ...
    depends_on("py-pybind11@2.10.4:", when="@1.11:", type=("build", "link"))
    depends_on("py-pybind11@2.10.1:", when="@1.10:", type=("build", "link"))
    depends_on("py-pybind11@2.4.3:", when="@1.5:", type=("build", "link"))
