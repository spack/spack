...
class PySecretstorage(PythonPackage):
    ...
    depends_on("python@3.6:", type=("build", "run"), when="@3.3:")
    depends_on("python@3.5:", type=("build", "run"), when="@3.0:3.2")
    depends_on("py-setuptools@30.3:", type="build", when="@3:")
    depends_on("py-setuptools", type="build")
    depends_on("py-cryptography@2.0:", type=("build", "run"), when="@3.2:")
    depends_on("py-cryptography", type=("build", "run"), when="@:3.1")
    depends_on("py-jeepney@0.6:", type=("build", "run"), when="@3.3:")
    depends_on("py-jeepney@0.4.2:", type=("build", "run"), when="@3.0:3.2")
