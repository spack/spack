...
class PySegmentationModelsPytorch(PythonPackage):
    ...
    depends_on("py-efficientnet-pytorch@0.7.1", type=("build", "run"), when="@0.3:")
    depends_on("py-efficientnet-pytorch@0.6.3", type=("build", "run"), when="@:0.2")
    depends_on("py-timm@0.9.2", type=("build", "run"), when="@0.3.3")
    depends_on("py-timm@0.6.12", type=("build", "run"), when="@0.3.2")
    depends_on("py-timm@0.4.12", type=("build", "run"), when="@:0.3.1")
    depends_on("py-tqdm", type=("build", "run"), when="@0.3:")
    depends_on("pil", type=("build", "run"), when="@0.3:")
