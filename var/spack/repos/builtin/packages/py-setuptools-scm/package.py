...
class PySetuptoolsScm(PythonPackage):
    ...
    depends_on("py-packaging@20.0:", type=("build", "run"), when="@6.3:")
    ...
    depends_on("py-toml", type=("build", "run"), when="+toml @:6.1.0")
    depends_on("py-tomli@1:", type=("build", "run"), when="+toml @6.1.0:")
    depends_on("py-tomli@1:", type=("build", "run"), when="@7.0")
    depends_on("py-tomli@1:", type=("build", "run"), when="@7.1: ^python@:3.10")
    depends_on("py-typing-extensions", type=("build", "run"), when="@7:")
    depends_on("py-importlib-metadata", type=("build", "run"), when="@7: ^python@:3.7")
