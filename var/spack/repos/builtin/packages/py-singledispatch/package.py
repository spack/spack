...
class PySingledispatch(PythonPackage):
    ...
    depends_on('py-setuptools@42:', type='build', when='@3.7.0')
    depends_on('py-setuptools-scm@3.4.1: +toml', type='build', when='@3.7.0')
    depends_on('py-six', type=('build', 'run'), when='@:3.6')
