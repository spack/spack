...
class PySpacy(PythonPackage):
    ...
    depends_on("python@2.7:2.8,3.4:", when="@2.2.4:2.2", type=("build", "run"))
    depends_on("python@2.7:2.8,3.5:", when="@2.3.0:", type=("build", "run"))
    ...
    depends_on("py-thinc@7.4.0", when="@2.2.4:2.2", type=("build", "run"))
    depends_on("py-thinc@7.4.1", when="@2.3.0:", type=("build", "run"))
    depends_on("py-thinc@7.4.1:7.4", when="@2.3.7:", type=("build", "run"))
    depends_on("py-blis@0.4.0:0.4", type=("build", "run"))
    depends_on("py-blis@0.4.0:0.7", when="@2.3.7:", type=("build", "run"))
