...
class PySphinx(PythonPackage):
    ...
    depends_on("py-flit-core@3.7:", type="build", when="@5.2:")

    depends_on("python@3.9:", type=("build", "run"), when="@7.2:")
    depends_on("python@3.8:", type=("build", "run"), when="@6:")

    depends_on("py-sphinxcontrib-applehelp", type=("build", "run"), when="@2:")
    depends_on("py-sphinxcontrib-devhelp", type=("build", "run"), when="@2:")
    depends_on("py-sphinxcontrib-jsmath", type=("build", "run"), when="@2:")
    depends_on("py-sphinxcontrib-htmlhelp@2:", type=("build", "run"), when="@4.1.1:")
    depends_on("py-sphinxcontrib-htmlhelp", type=("build", "run"), when="@2:")
    depends_on("py-sphinxcontrib-serializinghtml@1.1.9:", type=("build", "run"), when="@7.2.3:")
    depends_on("py-sphinxcontrib-serializinghtml@1.1.5:", type=("build", "run"), when="@4.1.1:")
    depends_on("py-sphinxcontrib-serializinghtml", type=("build", "run"), when="@2:")
    depends_on("py-sphinxcontrib-qthelp", type=("build", "run"), when="@2:")
    depends_on("py-jinja2@3:", type=("build", "run"), when="@5.2:")
    depends_on("py-jinja2@2.3:2", type=("build", "run"), when="@:4.0.1")
    depends_on("py-jinja2@2.3:", type=("build", "run"))
    depends_on("py-pygments@2.14:", type=("build", "run"), when="@7.2:")
    depends_on("py-pygments@2.13:", type=("build", "run"), when="@6.0.1:")
    depends_on("py-pygments@2.12:", type=("build", "run"), when="@5.2:")
    depends_on("py-pygments@2:", type=("build", "run"))
    depends_on("py-docutils@0.18.1:0.20", type=("build", "run"), when="@7.0.1:")
    depends_on("py-docutils@0.18.1:0.19", type=("build", "run"), when="@6.2:7.0.0")
    depends_on("py-docutils@0.18:0.19", type=("build", "run"), when="@6.0:6.1")
    depends_on("py-docutils@0.14:0.19", type=("build", "run"), when="@5.1:5")
    depends_on("py-docutils@0.14:0.18", type=("build", "run"), when="@5.0")
    depends_on("py-docutils@0.14:0.17", type=("build", "run"), when="@4")
    depends_on("py-docutils@0.12:0.16", type=("build", "run"), when="@:3")
    depends_on("py-snowballstemmer@2:", type=("build", "run"), when="@5.2:")
    depends_on("py-snowballstemmer@1.1:", type=("build", "run"))
    depends_on("py-babel@2.9:", type=("build", "run"), when="@5.2:")
    depends_on("py-babel@1.3:", type=("build", "run"))
    depends_on("py-alabaster@0.7", type=("build", "run"))
    depends_on("py-imagesize@1.3:", type=("build", "run"), when="@5.2:")
    depends_on("py-imagesize", type=("build", "run"), when="@1.4:")
    depends_on("py-requests@2.25:", type=("build", "run"), when="@6:")
    depends_on("py-requests@2.5:", type=("build", "run"), when="@2:")
    depends_on("py-requests@2.4:", type=("build", "run"), when="@1.5.2:")
    depends_on("py-packaging@21:", type=("build", "run"), when="@5.2:")
    depends_on("py-packaging", type=("build", "run"), when="@1.7:")
    depends_on("py-importlib-metadata@4.8:", type=("build", "run"), when="@5.2: ^python@:3.9")
    depends_on("py-importlib-metadata@4.4:", type=("build", "run"), when="@4.4: ^python@:3.9")
    depends_on("py-colorama@0.4.5:", type=("build", "run"), when="@5.2: platform=windows")
    depends_on("py-colorama@0.3.5:", type=("build", "run"), when="platform=windows")

    # Historical dependencies
    depends_on("py-setuptools", type="build", when="@4.4:5.1")
    depends_on("py-setuptools", type=("build", "run"), when="@:4.3")
    depends_on("py-sphinxcontrib-websupport", type=("build", "run"), when="@1.6:1")
    depends_on("py-six@1.5:", type=("build", "run"), when="@:1")
    depends_on("py-sphinx-rtd-theme@0.1:", type=("build", "run"), when="@:1.3")
