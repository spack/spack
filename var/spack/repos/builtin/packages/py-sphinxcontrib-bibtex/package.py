...
class PySphinxcontribBibtex(PythonPackage):
    ...
    depends_on("python@3.5:", when="@1:", type=("build", "run"))
    depends_on("python@3.6:", when="@2:", type=("build", "run"))
    depends_on("py-setuptools", type="build")
    depends_on("py-latexcodec@0.3.0:", when="@:0.3.6", type=("build", "run"))
    depends_on("py-pybtex@0.17:", when="@:1", type=("build", "run"))
    depends_on("py-pybtex@0.20:", when="@2:2.3", type=("build", "run"))
    depends_on("py-pybtex@0.24:", when="@2.4:", type=("build", "run"))
    depends_on("py-pybtex-docutils@0.2.0:", when="@:1", type=("build", "run"))
    depends_on("py-pybtex-docutils@0.2.2:", when="@2:", type=("build", "run"))
    depends_on("py-pybtex-docutils@1.0.0:", when="@2.2:", type=("build", "run"))
    depends_on("py-six@1.4.1:", when="@0.3.5", type=("build", "run"))
    depends_on("py-sphinx@1.0:", when="@:1", type=("build", "run"))
    depends_on("py-sphinx@2.0:", when="@2.0.0:", type=("build", "run"))
    depends_on("py-sphinx@2.1:", when="@2.1.3:", type=("build", "run"))
    depends_on("py-oset@0.1.3:", when="@:2.0.0", type=("build", "run"))
    depends_on("py-docutils@0.8:", when="@2.1.0:", type=("build", "run"))
