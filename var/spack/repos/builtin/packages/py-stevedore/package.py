...
class PyStevedore(PythonPackage):
    ...
    depends_on("python@3.6:", when="@3.5.0:", type=("build", "run"))
    depends_on("python@3.8:", when="@4.0.0:", type=("build", "run"))

    depends_on("py-setuptools", type="build")

    depends_on("py-six@1.10.0:", when="@:3.4", type=("build", "run"))
    depends_on("py-pbr@2.0.0:2.1.0", when="@:3.4", type=("build", "run"))
    depends_on("py-pbr@2.0.0:", when="@3.5.0:", type=("build", "run"))
