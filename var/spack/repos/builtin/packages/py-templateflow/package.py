...
class PyTemplateflow(PythonPackage):
    ...
    depends_on("python@3.6:", type=("build", "run"), when="@0.5:")
    depends_on("python@3.5:", type=("build", "run"))
    depends_on("py-setuptools@40.9:", type="build", when="@0.7.1:")
    depends_on("py-setuptools@30.3:", type="build")
    depends_on("py-setuptools-scm+toml@3.4:", type="build", when="@0.6:")
    depends_on("py-wheel", type="build", when="@0.7.1")
    depends_on("py-pybids@0.12.1:", type=("build", "run"), when="@0.6.3:")
