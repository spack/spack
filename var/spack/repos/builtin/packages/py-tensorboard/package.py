...
class PyTensorboard(PythonPackage):
    ...
    depends_on("python@3.9:", when="@2.14:", type=("build", "run"))
    depends_on("python@3.8:", when="@2.12:", type=("build", "run"))
    depends_on("py-absl-py@0.4:", type=("build", "run"))
    depends_on("py-grpcio@1.48.2:", when="@2.12:", type=("build", "run"))
    depends_on("py-grpcio@1.24.3:", when="@2.3:", type=("build", "run"))
    depends_on("py-grpcio@1.23.3:", when="@2.2", type=("build", "run"))
    depends_on("py-google-auth@1.6.3:2", when="@2.7:", type=("build", "run"))
    depends_on("py-google-auth@1.6.3:1", when="@:2.6", type=("build", "run"))
    depends_on("py-google-auth-oauthlib@0.5:1.0", when="@2.13:", type=("build", "run"))
    depends_on("py-google-auth-oauthlib@0.4.1:0.4", when="@:2.12", type=("build", "run"))
    depends_on("py-markdown@2.6.8:", type=("build", "run"))
    depends_on("py-numpy@1.12.0:", type=("build", "run"))
    depends_on("py-protobuf@3.19.6:", when="@2.12:", type=("build", "run"))
    depends_on("py-protobuf@3.9.2:3", when="@2.11", type=("build", "run"))
    depends_on("py-protobuf@3.9.2:3.19", when="@2.9:2.10", type=("build", "run"))
    depends_on("py-protobuf@3.6.0:3.19", when="@:2.8", type=("build", "run"))
    depends_on("py-requests@2.21.0:2", type=("build", "run"))
    depends_on("py-setuptools@41.0.0:", type=("build", "run"))
    depends_on("py-six@1.10.0:", when="@:2.4,2.14:", type=("build", "run"))
    depends_on("py-tensorboard-data-server@0.7", when="@2.12:", type=("build", "run"))
    depends_on("py-tensorboard-data-server@0.6", when="@2.5:2.11", type=("build", "run"))
