...
class PyTensorflow(Package, CudaPackage):
    ...
    depends_on('bazel@3.1.0:',        type='build', when='@2.6:')
    depends_on('bazel@3.1.0:3.99.0',  type='build', when='@2.3:2.5')
    ...
    depends_on('py-clang@5.0.0:5.0', type=('build', 'run'), when='@2.6:')
    ...
    depends_on('py-h5py@3.1.0:3.1', type=('build', 'run'), when='@2.5:+mpi')
    depends_on('py-h5py~mpi@3.1.0:3.1', type=('build', 'run'), when='@2.5:~mpi')
    depends_on('py-h5py@2.10.0:2.10', type=('build', 'run'), when='@2.2:2.4.999+mpi')
    depends_on('py-h5py~mpi@2.10.0:2.10', type=('build', 'run'), when='@2.2:2.4.999~mpi')
    ...
    depends_on('py-six@1.12.0:', type=('build', 'run'), when='@2.7:')
