...
class PyTensorflow(Package, CudaPackage, ROCmPackage, PythonExtension):
    ...
    version("2.16.0-rocm-enhanced", git="https://github.com/ROCm/tensorflow-upstream.git", branch="r2.16-rocm-enhanced")
    ...
    version("2.14.0-rocm-enhanced", git="https://github.com/ROCm/tensorflow-upstream.git", branch="r2.14-rocm-enhanced-nohipblaslt-build")
    ...
    conflicts(
        "+rocm",
        when="@:2.7.4-a,2.7.4.0:2.11.0-a,2.11.0.0:2.14.0-a,2.14.0.0:2.16.0-a,2.16.0.0:"
    )
