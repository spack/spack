...
class PyTensorflow(Package, CudaPackage, ROCmPackage, PythonExtension):
    ...
    depends_on("python@3.9:3.11", type=("build", "run"), when="@2.14:")
    depends_on("python@3.8:3.11", type=("build", "run"), when="@2.12:2.13")
    depends_on("python@:3.10", type=("build", "run"), when="@2.8:2.11")
    depends_on("python@:3.9", type=("build", "run"), when="@2.5:2.7")
    depends_on("python@:3.8", type=("build", "run"), when="@2.2:2.4")
    ...
    depends_on("coreutils", type="build", when="@2.13: platform=darwin")
