...
class PyTensorflow(Package, CudaPackage, ROCmPackage, PythonExtension):
    ...
    conflicts("~rocm", when="@2.7.4-rocm-enhanced,2.11.0-rocm-enhanced,2.14.0-rocm-enhanced")
    conflicts("+rocm", when="@:2.7.4-a,2.7.4.0:2.11.0-a,2.11.0.0:2.14.0-a,2.14.0.0:")
