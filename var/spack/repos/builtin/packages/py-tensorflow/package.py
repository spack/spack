...
class PyTensorflow(Package, CudaPackage, ROCmPackage, PythonExtension):
    ...
    # See .bazelversion
    depends_on("bazel@6.1.0", when="@2.14:", type="build")
    depends_on("bazel@5.3.0", when="@2.11:2.13", type="build")
    depends_on("bazel@5.1.1", when="@2.10", type="build")
    # See _TF_MIN_BAZEL_VERSION and _TF_MAX_BAZEL_VERSION in configure.py
    depends_on("bazel@4.2.2:5.99.0", when="@2.9", type="build")
    depends_on("bazel@4.2.1:4.99.0", when="@2.8", type="build")
    depends_on("bazel@3.7.2:4.99.0", when="@2.7", type="build")
    depends_on("bazel@3.7.2:3.99.0", when="@2.5:2.6", type="build")
    depends_on("bazel@3.1.0:3.99.0", when="@2.3:2.4", type="build")
    depends_on("bazel@2.0.0", when="@2.2", type="build")
    depends_on("bazel@0.27.1:0.29.1", when="@2.1", type="build")
    depends_on("bazel@0.24.1:0.26.1", when="@1.15:2.0", type="build")
    # See call to check_bazel_version in configure.py
    depends_on("bazel@0.24.1:0.25.2", when="@1.14", type="build")
    depends_on("bazel@0.19.0:0.21.0", when="@1.13", type="build")
    depends_on("bazel@0.24.1:0.25.0", when="@1.12.1", type="build")
    depends_on("bazel@0.15.0", when="@1.10:1.12.0,1.12.2:1.12.3", type="build")
    depends_on("bazel@0.10.0", when="@1.7:1.9", type="build")
    # See call to check_version in tensorflow/workspace.bzl
    depends_on("bazel@0.5.4", when="@1.4:1.6", type="build")
    # See MIN_BAZEL_VERSION in configure
    depends_on("bazel@0.4.5", when="@1.2:1.3", type="build")
    # See call to check_version in WORKSPACE
    depends_on("bazel@0.4.2", when="@1.0:1.1", type="build")
    ...
    depends_on("py-absl-py@1:", when="@2.9:", type=("build", "run"))
    depends_on("py-absl-py@0.4:", when="@2.7:2.8", type=("build", "run"))
    depends_on("py-absl-py@0.10:0", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-absl-py@0.7:", when="@1.12.1,1.14:2.3", type=("build", "run"))
    depends_on("py-absl-py@0.1.6:", when="@1.5:1.12.0,1.12.2:1.13.2", type=("build", "run"))
    depends_on("py-astunparse@1.6:", when="@2.7:", type=("build", "run"))
    depends_on("py-astunparse@1.6.3:1.6", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-astunparse@1.6.3", when="@2.2:2.3", type=("build", "run"))
    depends_on("py-flatbuffers@23.5.26:", when="@2.14:", type=("build", "run"))
    depends_on("py-flatbuffers@23.1.21:", when="@2.13", type=("build", "run"))
    depends_on("py-flatbuffers@2:", when="@2.10:2.12", type=("build", "run"))
    depends_on("py-flatbuffers@1.12:1", when="@2.9", type=("build", "run"))
    depends_on("py-flatbuffers@1.12:", when="@2.8", type=("build", "run"))
    depends_on("py-flatbuffers@1.12:2", when="@2.7", type=("build", "run"))
    depends_on("py-flatbuffers@1.12", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-gast@0.2.1:0.4,0.5.3:", when="@2.14:", type=("build", "run"))
    depends_on("py-gast@0.2.1:0.4.0", when="@2.9:2.13", type=("build", "run"))
    depends_on("py-gast@0.2.1:", when="@2.8", type=("build", "run"))
    depends_on("py-gast@0.2.1:0.4", when="@2.7", type=("build", "run"))
    depends_on("py-gast@0.4.0", when="@2.5:2.6", type=("build", "run"))
    depends_on("py-gast@0.3.3", when="@2.2:2.4", type=("build", "run"))
    depends_on("py-gast@0.2.2", when="@1.15:2.1", type=("build", "run"))
    depends_on("py-gast@0.2:", when="@1.6:1.14", type=("build", "run"))
    depends_on("py-google-pasta@0.1.1:", when="@2.7:", type=("build", "run"))
    depends_on("py-google-pasta@0.2:0", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-google-pasta@0.1.8:", when="@2.2:2.3", type=("build", "run"))
    depends_on("py-google-pasta@0.1.6:", when="@1.14:2.1", type=("build", "run"))
    depends_on("py-google-pasta@0.1.2:", when="@1.12.1", type=("build", "run"))
    depends_on("py-h5py@2.9:", when="@2.7:", type=("build", "run"))
    depends_on("py-h5py@3.1", when="@2.5:2.6", type=("build", "run"))
    depends_on("py-h5py@2.10", when="@2.2:2.4", type=("build", "run"))
    depends_on("py-h5py@:2.10.0", when="@1.15.5,2.0.4,2.1.3:2.1", type=("build", "run"))
    # propagate the mpi variant setting for h5py/hdf5 to avoid unexpected crashes
    depends_on("py-h5py+mpi", when="@1.15.5,2.0.4,2.1.3:+mpi", type=("build", "run"))
    depends_on("py-h5py~mpi", when="@1.15.5,2.0.4,2.1.3:~mpi", type=("build", "run"))
    depends_on("hdf5+mpi", when="@1.15.5,2.0.4,2.1.3:+mpi", type="build")
    depends_on("hdf5~mpi", when="@1.15.5,2.0.4,2.1.3:~mpi", type="build")
    depends_on("py-libclang@13:", when="@2.9:", type=("build", "run"))
    depends_on("py-libclang@9.0.1:", when="@2.7:2.8", type=("build", "run"))
    depends_on("py-ml-dtypes@0.2.0", when="@2.14:", type=("build", "run"))
    depends_on("py-numpy@1.23.5:", when="@2.14:", type=("build", "run"))
    depends_on("py-numpy@1.22:1.24.3", when="@2.13:", type=("build", "run"))
    depends_on("py-numpy@1.22:1.23", when="@2.12", type=("build", "run"))
    depends_on("py-numpy@1.20:", when="@2.8:2.11", type=("build", "run"))
    depends_on("py-numpy@1.14.5:", when="@2.7", type=("build", "run"))
    depends_on("py-numpy@1.19.2:1.19", when="@2.4:2.6", type=("build", "run"))
    # https://github.com/tensorflow/tensorflow/issues/40688
    depends_on("py-numpy@1.16.0:1.18", when="@1.13.2,1.15:2.3", type=("build", "run"))
    depends_on("py-numpy@1.14.5:1.18", when="@1.12.1,1.14", type=("build", "run"))
    depends_on(
        "py-numpy@1.13.3:1.18", when="@1.6:1.9,1.11:1.12.0,1.12.2:1.13.1", type=("build", "run")
    )
    depends_on("py-numpy@1.13.3:1.14.5", when="@1.10", type=("build", "run"))
    depends_on("py-numpy@1.12.1:1.14.5", when="@1.4:1.5", type=("build", "run"))
    depends_on("py-numpy@1.11.0:1.14.5", when="@:1.3", type=("build", "run"))
    depends_on("py-opt-einsum@2.3.2:", when="@1.15:2.3,2.7:", type=("build", "run"))
    depends_on("py-opt-einsum@3.3", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-packaging", when="@2.9:", type=("build", "run"))
    depends_on("py-protobuf@3.20.3:4.20,4.21.6:4", when="@2.12:", type=("build", "run"))
    depends_on("py-protobuf@3.9.2:", when="@2.3:2.11", type=("build", "run"))
    depends_on("py-protobuf@3.8.0:", when="@2.1:2.2", type=("build", "run"))
    depends_on("py-protobuf@3.6.1:", when="@1.12:2.0", type=("build", "run"))
    depends_on("py-protobuf@3.6.0:", when="@1.10:1.11", type=("build", "run"))
    depends_on("py-protobuf@3.4.0:", when="@1.5:1.9", type=("build", "run"))
    depends_on("py-protobuf@3.3.0:", when="@1.3:1.4", type=("build", "run"))
    depends_on("py-protobuf@3.2.0:", when="@1.1:1.2", type=("build", "run"))
    depends_on("py-protobuf@3.1.0:", when="@:1.0", type=("build", "run"))
    # https://github.com/protocolbuffers/protobuf/issues/10051
    # https://github.com/tensorflow/tensorflow/issues/56266
    depends_on("py-protobuf@:3.19", when="@:2.11", type=("build", "run"))
    # Must be matching versions of py-protobuf and protobuf
    conflicts("^py-protobuf~cpp")
    depends_on("py-setuptools", type=("build", "run"))
    depends_on("py-six@1.12:", when="@2.1:2.3,2.7:", type=("build", "run"))
    depends_on("py-six@1.15", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-six@1.10:", when="@:2.0", type=("build", "run"))
    depends_on("py-termcolor@1.1:", when="@1.6:2.3,2.7:", type=("build", "run"))
    depends_on("py-termcolor@1.1", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-typing-extensions@3.6.6:", when="@2.7:2.12,2.14:", type=("build", "run"))
    depends_on("py-typing-extensions@3.6.6:4.5", when="@2.13", type=("build", "run"))
    depends_on("py-typing-extensions@3.7.4:3.7", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-wrapt@1.11:1.14", when="@2.12,2.14:", type=("build", "run"))
    depends_on("py-wrapt@1.11:", when="@2.7:2.11,2.13", type=("build", "run"))
    depends_on("py-wrapt@1.12.1:1.12", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-wrapt@1.11.1:", when="@1.12.1,1.14:2.3", type=("build", "run"))
    ...
    if sys.byteorder == "little":
        ...
        depends_on("py-grpcio@1.24.3:1", when="@2.7:", type=("build", "run"))
        depends_on("py-grpcio@1.37.0:1", when="@2.6", type=("build", "run"))
        depends_on("py-grpcio@1.34", when="@2.5", type=("build", "run"))
        depends_on("py-grpcio@1.32", when="@2.4", type=("build", "run"))
        depends_on("py-grpcio@1.8.6:", when="@1.6:2.3", type=("build", "run"))
    ...
    depends_on("py-astor@0.6:", when="@1.6:2.1", type=("build", "run"))
    depends_on("py-backports-weakref@1.0rc1", when="@1.2", type=("build", "run"))
    depends_on("py-jax@0.3.15:", when="@2.12", type=("build", "run"))
    depends_on("py-keras-applications@1.0.8:", when="@1.15:2.1", type=("build", "run"))
    depends_on("py-keras-applications@1.0.6:", when="@1.12:1.14", type=("build", "run"))
    depends_on("py-keras-applications@1.0.5:", when="@1.11", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.1.1:", when="@2.7:2.10", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.1.2:1.1", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.1.1:1.1", when="@2.3", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.1:", when="@2.1.0,2.2", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.1.0", when="@2.1.1:2.1", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.0.5:", when="@1.12:2.0", type=("build", "run"))
    depends_on("py-keras-preprocessing@1.0.3:", when="@1.11", type=("build", "run"))
    depends_on("py-scipy@1.4.1", when="@2.1.0:2.1.1,2.2.0,2.3.0", type=("build", "run"))
    depends_on("py-wheel@0.32:0", when="@2.7", type=("build", "run"))
    depends_on("py-wheel@0.35:0", when="@2.4:2.6", type=("build", "run"))
    depends_on("py-wheel@0.26:", when="@:2.3", type=("build", "run"))
