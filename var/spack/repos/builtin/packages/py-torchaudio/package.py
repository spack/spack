...
class PyTorchaudio(PythonPackage):
    ...
    depends_on("python@3.7:3.10", when="@0.12:", type=("build", "run"))
    depends_on("python@3.7:3.9", when="@0.11", type=("build", "run"))
    depends_on("python@3.6:3.9", when="@0.7.2:0.10", type=("build", "run"))
    depends_on("python@3.6:3.8", when="@0.6:0.7.0", type=("build", "run"))
    depends_on("python@3.5:3.8", when="@0.5", type=("build", "run"))
    depends_on("python@2.7,3.5:3.8", when="@0.4", type=("build", "run"))
    ...
    depends_on("py-torch@1.12.1", when="@0.12.1", type=("build", "run"))
    depends_on("py-torch@1.12.0", when="@0.12.0", type=("build", "run"))
    depends_on("py-torch@1.11.0", when="@0.11.0", type=("build", "run"))
    depends_on("py-torch@1.10.2", when="@0.10.2", type=("build", "run"))
    depends_on("py-torch@1.10.1", when="@0.10.1", type=("build", "run"))
    depends_on("py-torch@1.10.0", when="@0.10.0", type=("build", "run"))
    depends_on("py-torch@1.9.1", when="@0.9.1", type=("build", "run"))
    depends_on("py-torch@1.9.0", when="@0.9.0", type=("build", "run"))
    depends_on("py-torch@1.8.2", when="@0.8.2", type=("build", "run"))
    depends_on("py-torch@1.8.1", when="@0.8.1", type=("build", "run"))
    depends_on("py-torch@1.8.0", when="@0.8.0", type=("build", "run"))
    depends_on("py-torch@1.7.1", when="@0.7.2", type=("build", "run"))
    depends_on("py-torch@1.7.0", when="@0.7.0", type=("build", "run"))
    depends_on("py-torch@1.6.0", when="@0.6.0", type=("build", "run"))
    depends_on("py-torch@1.5.1", when="@0.5.1", type=("build", "run"))
    depends_on("py-torch@1.5.0", when="@0.5.0", type=("build", "run"))
    depends_on("py-torch@1.4.1", when="@0.4.0", type=("build", "run"))
