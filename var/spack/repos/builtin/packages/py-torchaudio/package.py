...
class PyTorchaudio(PythonPackage):
    ...
    depends_on("python@:3.10", type=("build", "link", "run"), when="@0.12:0")
    depends_on("python@:3.9", type=("build", "link", "run"), when="@0.7.2:0.11")
    depends_on("python@:3.8", type=("build", "link", "run"), when="@:0.7.0")

    # CMakelists.txt
    depends_on("cmake@3.18:", type="build", when="@0.10:")
    depends_on("cmake@3.5:", type="build", when="@0.8:")
    depends_on("ninja", type="build", when="@0.8:")

    # setup.py
    depends_on("py-setuptools", type="build")
    depends_on("py-pybind11", type=("build", "link"), when="@0.12:")
    depends_on("pkgconfig", type="build")
    depends_on("sox")

    depends_on("py-torch@main", type=("build", "link", "run"), when="@main")
    depends_on("py-torch@2.1.0", type=("build", "link", "run"), when="@2.1.0")
    depends_on("py-torch@2.0.1", type=("build", "link", "run"), when="@2.0.2")
    depends_on("py-torch@2.0.0", type=("build", "link", "run"), when="@2.0.1")
    depends_on("py-torch@1.13.1", type=("build", "link", "run"), when="@0.13.1")
    depends_on("py-torch@1.13.0", type=("build", "link", "run"), when="@0.13.0")
    depends_on("py-torch@1.12.1", type=("build", "link", "run"), when="@0.12.1")
    depends_on("py-torch@1.12.0", type=("build", "link", "run"), when="@0.12.0")
    depends_on("py-torch@1.11.0", type=("build", "link", "run"), when="@0.11.0")
    depends_on("py-torch@1.10.2", type=("build", "link", "run"), when="@0.10.2")
    depends_on("py-torch@1.10.1", type=("build", "link", "run"), when="@0.10.1")
    depends_on("py-torch@1.10.0", type=("build", "link", "run"), when="@0.10.0")
    depends_on("py-torch@1.9.1", type=("build", "link", "run"), when="@0.9.1")
    depends_on("py-torch@1.9.0", type=("build", "link", "run"), when="@0.9.0")
    depends_on("py-torch@1.8.2", type=("build", "link", "run"), when="@0.8.2")
    depends_on("py-torch@1.8.1", type=("build", "link", "run"), when="@0.8.1")
    depends_on("py-torch@1.8.0", type=("build", "link", "run"), when="@0.8.0")
    depends_on("py-torch@1.7.1", type=("build", "link", "run"), when="@0.7.2")
    depends_on("py-torch@1.7.0", type=("build", "link", "run"), when="@0.7.0")
    depends_on("py-torch@1.6.0", type=("build", "link", "run"), when="@0.6.0")
    depends_on("py-torch@1.5.1", type=("build", "link", "run"), when="@0.5.1")
    depends_on("py-torch@1.5.0", type=("build", "link", "run"), when="@0.5.0")
    depends_on("py-torch@1.4.1", type=("build", "link", "run"), when="@0.4.0")
