...
class PyTorchgeo(PythonPackage):
    ...
    depends_on("py-setuptools@61:", type="build", when="@0.5:")
    depends_on("py-setuptools@42:", type="build")
    depends_on("py-einops@0.3:", type=("build", "run"))
    depends_on("py-fiona@1.8.19:", type=("build", "run"), when="@0.5:")
    depends_on("py-fiona@1.8:", type=("build", "run"), when="@0.3:")
    depends_on("py-fiona@1.5:", type=("build", "run"))
    # Only part of lightning[pytorch-extra] we actually require.
    depends_on("py-jsonargparse@4.18:+signatures", type=("build", "run"), when="@0.5:")
    depends_on("py-kornia@0.6.9:", type=("build", "run"), when="@0.5:")
    depends_on("py-kornia@0.6.5:", type=("build", "run"), when="@0.4.1:")
    # https://github.com/microsoft/torchgeo/pull/1123
    depends_on("py-kornia@0.6.5:0.6.9", type=("build", "run"), when="@0.4.0")
    depends_on("py-kornia@0.6.4:0.6.9", type=("build", "run"), when="@0.3")
    depends_on("py-kornia@0.5.11:0.6.9", type=("build", "run"), when="@0.2")
    depends_on("py-kornia@0.5.4:0.6.9", type=("build", "run"), when="@0.1")
    depends_on("py-lightly@1.4.4:", type=("build", "run"), when="@0.5:")
    depends_on("py-lightning@2:", type=("build", "run"), when="@0.5:")
    depends_on("py-lightning@1.8:", type=("build", "run"), when="@0.4.1:")
    depends_on("py-matplotlib@3.3.3:", type=("build", "run"), when="@0.5:")
    depends_on("py-matplotlib@3.3:", type=("build", "run"))
    depends_on("py-numpy@1.19.3:", type=("build", "run"), when="@0.5:")
    depends_on("py-numpy@1.17.2:", type=("build", "run"))
    depends_on("py-pandas@1.1.3:", type=("build", "run"), when="@0.5:")
    depends_on("pil@8:", type=("build", "run"), when="@0.5:")
    ...
    depends_on("py-pyproj@3:", type=("build", "run"), when="@0.5:")
    depends_on("py-pyproj@2.2:", type=("build", "run"))
    depends_on("py-rasterio@1.2:", type=("build", "run"), when="@0.5:")
    depends_on("py-rasterio@1.0.20:", type=("build", "run"), when="@0.3:")
    depends_on("py-rasterio@1.0.16:", type=("build", "run"))
    depends_on("py-rtree@1:", type=("build", "run"), when="@0.3:")
    depends_on("py-rtree@0.9.4:", type=("build", "run"), when="@0.2.1:")
    depends_on("py-rtree@0.5:", type=("build", "run"))
    depends_on("py-segmentation-models-pytorch@0.2:", type=("build", "run"))
    depends_on("py-shapely@1.7.1:", type=("build", "run"), when="@0.5:")
    depends_on("py-shapely@1.3:", type=("build", "run"))
    depends_on("py-timm@0.4.12:", type=("build", "run"))
    depends_on("py-torch@1.12:", type=("build", "run"), when="@0.4:")
    depends_on("py-torch@1.9:", type=("build", "run"), when="@0.2:")
    depends_on("py-torch@1.7:", type=("build", "run"))
    depends_on("py-torchmetrics@0.10:", type=("build", "run"), when="@0.4:")
    depends_on("py-torchmetrics@0.7:", type=("build", "run"))
    depends_on("py-torchvision@0.13:", type=("build", "run"), when="@0.4:")
    depends_on("py-torchvision@0.10:", type=("build", "run"), when="@0.2:")
    ...
    with when("+datasets"):
        ...
        depends_on("gdal+openjpeg", type="run", when="@0.3.1:")
        ...
        depends_on("py-h5py@3:", type="run", when="@0.5:")
        depends_on("py-h5py@2.6:", type="run")
        depends_on("py-laspy@2:", type="run", when="@0.2:")
        depends_on("opencv@4.4.0.46:", type="run", when="@0.5:")
        ...
        depends_on("py-pycocotools@2.0.5:", type="run", when="@0.5:")
        depends_on("py-pycocotools@2:", type="run")
        depends_on("py-pyvista@0.34.2:", type="run", when="@0.5:")
        depends_on("py-pyvista@0.20:", type="run", when="@0.4:")
        depends_on("py-radiant-mlhub@0.3:", type="run", when="@0.4.1:")
        depends_on("py-radiant-mlhub@0.2.1:0.4", type="run", when="@:0.4.0")
        depends_on("py-rarfile@4:", type="run", when="@0.5:")
        depends_on("py-rarfile@3:", type="run")
        depends_on("py-scikit-image@0.18:", type="run", when="@0.4:")
        depends_on("py-scipy@1.6.2:", type="run", when="@0.4:")
        depends_on("py-scipy@1.2:", type="run", when="@0.3:")
        depends_on("py-scipy@0.9:", type="run")
        depends_on("py-zipfile-deflate64@0.2:", type="run", when="@0.2.1:")
    ...
    with when("+style"):
        depends_on("py-black@21.8:+jupyter", type="run", when="@0.3:")
        ...
        depends_on("py-pyupgrade@2.8:", type="run", when="@0.5:")
        depends_on("py-pyupgrade@1.24:", type="run", when="@0.3:")

    with when("+tests"):
        depends_on("py-mypy@0.900:", type="run")
        depends_on("py-nbmake@1.3.3:", type="run", when="@0.4.1:")
        depends_on("py-nbmake@0.1:", type="run", when="@0.3.1:")
        depends_on("py-nbmake@0.1:1.1", type="run", when="@:0.3.0")
        depends_on("py-pytest@6.2:", type="run", when="@0.5:")
        depends_on("py-pytest@6.1.2:", type="run")
        depends_on("py-pytest-cov@2.4:", type="run")

    # Historical dependencies
    depends_on("py-omegaconf@2.1:", type=("build", "run"), when="@:0.4.0")
    depends_on("py-packaging@17:", type=("build", "run"), when="@0.3")
    depends_on("py-pytorch-lightning@1.5.1:", type=("build", "run"), when="@0.3.1:0.4.0")
    # https://github.com/microsoft/torchgeo/pull/697
    depends_on("py-pytorch-lightning@1.5.1:1.8", type=("build", "run"), when="@0.3.0")
    depends_on("py-pytorch-lightning@1.3:1.8", type=("build", "run"), when="@:0.2")
    depends_on("py-scikit-learn@0.21:", type=("build", "run"), when="@0.3:0.4")
    depends_on("py-scikit-learn@0.18:", type=("build", "run"), when="@:0.2")
    depends_on("open3d@0.11.2:+python", type="run", when="@0.2:0.3+datasets")
    # https://github.com/microsoft/torchgeo/pull/1537
    depends_on("py-pandas@0.23.2:2.0", type="run", when="@0.3:0.4+datasets")
    depends_on("py-pandas@0.19.1:2.0", type="run", when="@0.2+datasets")
    depends_on("py-omegaconf@2.1:", type="run", when="@0.4.1+tests")
    depends_on("py-tensorboard@2.9.1:", type="run", when="@0.4.1+tests")
