...
class PyTorchmetrics(PythonPackage):
    ...
    with default_args(type="run"):
        ...
        # depends_on("py-dython@:0.7.4", when="@1.2.1:1.3.0.0")
        # depends_on("py-fairlearn", when="@1.2.1:1.3.0.0")
        # depends_on("py-fast-bss-eval@0.1:", when="@1.2.1:1.3.0.0")
        # depends_on("py-faster-coco-eval@1.3.3:", when="@1.2.1:1.3.0.0")
        # depends_on("py-huggingface-hub@:0.20", when="@1.3:1.3.0.0")
        # depends_on("py-huggingface-hub@:0.19", when="@1.2.1:1.2")
        # depends_on("py-jiwer@2.3:", when="@1.2.1:1.3.0.0")
        # depends_on("py-kornia@0.6.7:", when="@1.2.1:1.3.0.0")
        # depends_on("py-lpips", when="@1.2.1:1.3.0.0")
        # depends_on("py-mir-eval@0.6:", when="@1.2.1:1.3.0.0")
        # depends_on("py-monai@1.3.0:", when="@1.3:1.3.0.0")
        # depends_on("py-netcal@1.1:", when="@1.2.1:1.3.0.0")
        # depends_on("py-numpy@:1.24", when="@1.2.1:1.3.0.0")
        # depends_on("py-pandas@1.4.0:", when="@1.2.1:1.3.0.0")
        # depends_on("py-pandas@1.0.1:", when="@1.2.1:1.3.0.0")
        # depends_on("py-pytorch-msssim@1:", when="@1.2.1:1.3.0.0")
        # depends_on("py-rouge-score@0.1.1:", when="@1.2.1:1.3.0.0")
        # depends_on("py-sacrebleu@2.3:", when="@1.3:1.3.0.0")
        # depends_on("py-sacrebleu@2:", when="@1.2.1:1.2")
        # depends_on("py-scikit-image@0.19.0:", when="@1.2.1:1.3.0.0")
        # depends_on("py-scipy@1.0.1:", when="@1.2.1:1.3.0.0")
