...
class PyTorchvision(PythonPackage):
    ...
    depends_on("python@3.8:3.11", type=("build", "link", "run"), when="@0.15:")
    depends_on("python@:3.10", type=("build", "link", "run"), when="@0.12:0.14")
    depends_on("python@:3.9", type=("build", "link", "run"), when="@0.8.2:0.11")
    depends_on("python@:3.8", type=("build", "link", "run"), when="@0.5:0.8.1")
    depends_on("python@:3.7", type=("build", "link", "run"), when="@:0.4")

    # https://github.com/pytorch/vision#installation
    depends_on("py-torch@main", type=("build", "link", "run"), when="@main")
    depends_on("py-torch@2.1.0", type=("build", "link", "run"), when="@0.16.0")
    depends_on("py-torch@2.0.1", type=("build", "link", "run"), when="@0.15.2")
    depends_on("py-torch@2.0.0", type=("build", "link", "run"), when="@0.15.1")
    depends_on("py-torch@1.13.1", type=("build", "link", "run"), when="@0.14.1")
    depends_on("py-torch@1.13.0", type=("build", "link", "run"), when="@0.14.0")
    depends_on("py-torch@1.12.1", type=("build", "link", "run"), when="@0.13.1")
    depends_on("py-torch@1.12.0", type=("build", "link", "run"), when="@0.13.0")
    depends_on("py-torch@1.11.0", type=("build", "link", "run"), when="@0.12.0")
    depends_on("py-torch@1.10.2", type=("build", "link", "run"), when="@0.11.3")
    depends_on("py-torch@1.10.1", type=("build", "link", "run"), when="@0.11.2")
    depends_on("py-torch@1.10.0", type=("build", "link", "run"), when="@0.11.1")
    depends_on("py-torch@1.10.0", type=("build", "link", "run"), when="@0.11.0")
    depends_on("py-torch@1.9.1", type=("build", "link", "run"), when="@0.10.1")
    depends_on("py-torch@1.9.0", type=("build", "link", "run"), when="@0.10.0")
    depends_on("py-torch@1.8.2", type=("build", "link", "run"), when="@0.9.2")
    depends_on("py-torch@1.8.1", type=("build", "link", "run"), when="@0.9.1")
    depends_on("py-torch@1.8.0", type=("build", "link", "run"), when="@0.9.0")
    depends_on("py-torch@1.7.1", type=("build", "link", "run"), when="@0.8.2")
    depends_on("py-torch@1.7.0", type=("build", "link", "run"), when="@0.8.1")
    depends_on("py-torch@1.7.0", type=("build", "link", "run"), when="@0.8.0")
    depends_on("py-torch@1.6.0", type=("build", "link", "run"), when="@0.7.0")
    depends_on("py-torch@1.5.1", type=("build", "link", "run"), when="@0.6.1")
    depends_on("py-torch@1.5.0", type=("build", "link", "run"), when="@0.6.0")
    depends_on("py-torch@1.4.1", type=("build", "link", "run"), when="@0.5.0")
    depends_on("py-torch@1.3.1", type=("build", "link", "run"), when="@0.4.2")
    depends_on("py-torch@1.3.0", type=("build", "link", "run"), when="@0.4.1")
    depends_on("py-torch@1.2.0", type=("build", "link", "run"), when="@0.4.0")
    depends_on("py-torch@1.1.0", type=("build", "link", "run"), when="@0.3.0")
    depends_on("py-torch@:1.0.1", type=("build", "link", "run"), when="@0.2.2")
    ...
    depends_on("py-requests", type=("build", "run"), when="@0.12:")
    depends_on("pil@5.3:", type=("build", "run"), when="@0.10:")
    ...
    depends_on("py-typing-extensions", type=("build", "run"), when="@0.12:0.14")
    depends_on("py-six", type=("build", "run"), when="@:0.5")
