...
class PyTraitlets(PythonPackage):
    ...
    depends_on("py-hatchling@1.5:", type="build", when="@5.5:")
    depends_on("py-hatchling@0.25:", type="build", when="@5.2.1.post0:")
    depends_on("py-setuptools@40.8:", type="build", when="@:5.2.1.a")
    depends_on("py-ipython-genutils", type=("build", "run"), when="@:5.0")
    depends_on("py-six", type=("build", "run"), when="@:4")
    depends_on("py-decorator", type=("build", "run"), when="@:4")
