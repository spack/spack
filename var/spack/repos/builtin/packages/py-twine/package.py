...
class PyTwine(PythonPackage):
    ...
    depends_on("py-setuptools@45:", type="build", when="@3.4.1:")
    depends_on("py-setuptools@0.7.0:", type="build")
    depends_on("py-setuptools-scm+toml@6:", type="build", when="@3.4.2:")

    depends_on("py-pkginfo@1.8.1:", type=("build", "run"), when="@3.7:")
    depends_on("py-pkginfo@1.4.2:", type=("build", "run"))
    depends_on("py-readme-renderer@35:", type=("build", "run"), when="@4.0.1:")
    ...
    depends_on("py-urllib3@1.26:", type=("build", "run"), when="@3.8:")
    depends_on("py-importlib-metadata@3.6:", type=("build", "run"), when="@3.4:")
    depends_on("py-keyring@15.1:", type=("build", "run"), when="@3:")
    depends_on("py-rfc3986@1.4:", type=("build", "run"), when="@3.2:")
    depends_on("py-rich@12:", type=("build", "run"), when="@4:")

    # Historical Dependencies
    depends_on("py-tqdm@4.14:", type=("build", "run"), when="@:3")
