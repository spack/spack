...
class PyVirtualenv(PythonPackage):
    ...
    version(
        "13.0.1",
        sha256="36c2cfae0f9c6462264bb19c478fc6bab3478cf0575f1027452e975a1ed84dbd",
    )
    version(
        "1.11.6",
    ...
    depends_on(
        "py-backports-entry-points-selectable @1.0.4:",
        type=("build", "run"),
        when="@20.10.0:",
    )
    ...
    depends_on(
        "py-importlib-metadata@0.12:",
        type=("build", "run"),
        when="@20.10.0: ^python@:3.7",
    )
    depends_on(
        "py-importlib-resources@1:",
        type=("build", "run"),
        when="@20.10.0: ^python@:3.6",
    )
