...
class PyWandb(PythonPackage):
    ...
    with when("@0.13.0:"):
        depends_on("py-grpcio@1.46.3:", type="build")
        depends_on("py-grpcio-tools@1.46.3:", type="build")
        depends_on("py-twine", type="build")
        depends_on("py-pathtools", type=("build", "run"))
        depends_on("py-setproctitle", type=("build", "run"))
        depends_on("py-appdirs@1.4.3:", type=("build", "run"))
        depends_on("py-protobuf@3.12.0:4", type=("build", "run"), when="^python@:3.8 platform=linux")
        depends_on("py-protobuf@3.15.0:4", type=("build", "run"), when="^python@3.9 platform=linux")
        depends_on("py-protobuf@3.19.0:4", type=("build", "run"), when="^python@3.10: platform=linux")
