...
class PyWarpx(PythonPackage):
    ...
    depends_on("python@3.8:", when="@23.09:", type=("build", "run"))
    depends_on("py-numpy@1.15.0:1", type=("build", "run"))
    depends_on("py-mpi4py@2.1.0:", when="+mpi", type=("build", "run"))
    depends_on("py-periodictable@1.5:1", type=("build", "run"))
    depends_on("py-picmistandard@0.25.0", when="@23.07:", type=("build", "run"))
    depends_on("py-picmistandard@0.24.0", when="@23.06", type=("build", "run"))
    depends_on("py-picmistandard@0.23.2", when="@23.04:23.05", type=("build", "run"))
    depends_on("py-picmistandard@0.0.22", when="@22.12:23.03", type=("build", "run"))
    depends_on("py-picmistandard@0.0.20", when="@22.10:22.11", type=("build", "run"))
    depends_on("py-picmistandard@0.0.19", when="@22.02:22.09", type=("build", "run"))
    depends_on("py-picmistandard@0.0.18", when="@22.01", type=("build", "run"))
    ...
    depends_on("warpx +lib ~mpi +shared", when="~mpi", type=("build", "link"))
    depends_on("warpx +lib +mpi +shared", when="+mpi", type=("build", "link"))
