...
class PyYt(PythonPackage):
    ...
    depends_on("py-cmyt@0.2.2:", type=('build', 'run'), when="@4.0.0:")
    depends_on("py-more-itertools@8.4.0:", type=('build', 'run'), when="@4.0.0:")
    depends_on("py-numpy@1.13.3:", type=('build', 'run'), when="@4.0.0:")
    depends_on("py-pyparsing", type=('build', 'run'), when="@4.0.0:")
    depends_on("py-toml", type=('build', 'run'), when="@4.0.0:4.0.2")
    depends_on("py-tomli@1.2.3:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-tomli-w@0.4.0:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-tqdm@3.4.0:", type=('build', 'run'), when="@4.0.0:")
    depends_on("py-unyt@2.8.0:", type=('build', 'run'), when="@4.0.0:")
