...
class PyYt(PythonPackage):
    ...
    depends_on("py-cmyt@0.2.2:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-matplotlib@1.5.3:", type=('build', 'run'))
    depends_on("py-matplotlib@:3.2.2", type=('build', 'run'), when="@:3.6.0")
    depends_on("py-matplotlib@2.1.0:", type=('build', 'run'), when="@4.0.3:")
    # conflicts_with("py-matplotlib@3.4.2", when="@4.0.3:")
    depends_on("py-more-itertools@8.4:", when="@4.0.3:")
    depends_on("py-numpy@1.10.4:", type=('build', 'run'))
    depends_on("py-numpy@1.13.3:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-setuptools@19.6:", type=('build', 'run'))
    depends_on("py-tomli@1.2.3:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-tomli-w@0.4.0:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-tqdm@3.4.0:", type=('build', 'run'), when="@4.0.3:")
    depends_on("py-unyt@2.8.0:", type=('build', 'run'), when="@4.0.3:")
    depends_on("python@2.7.0:2.7,3.5:", type=('build', 'run'))
    depends_on("py-cython@0.24:", type=('build'))
    depends_on("py-wheel@0.36.2", type=('build'), when="@4.0.3:")
    depends_on("py-h5py@3.1.0:4.0.0", type=('build', 'run'), when="+h5py")
