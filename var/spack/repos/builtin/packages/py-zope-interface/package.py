...
class PyZopeInterface(PythonPackage):
    ...
    depends_on("python@2.7:2.8,3.4:", when="@4.5.0", type=("build", "run"))
    depends_on("python@2.7:2.8,3.5:", when="@5.1.0:", type=("build", "run"))

    depends_on("py-setuptools", type=("build", "run"))
    depends_on("py-setuptools@:45", when="@4.5.0", type=("build", "run"))
