...
class AutotoolsBuilder(RunAfter, BuildEnvironment, autotools.AutotoolsBuilder):
    ...
    def configure_args(self):
        ...
        config_args.extend(self.with_or_without("pydebug", variant="debug"))
        ...
        config_args.extend(self.with_or_without("system-expat", variant="pyexpat"))

        config_args.extend(self.with_or_without("system-ffi", variant="ctypes"))
