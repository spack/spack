# Copyright 2019 University of Colorado Boulder See the top-level
...
class Qemu(AutotoolsPackage):
    ...
    version('4.1.1',      sha256='ed6fdbbdd272611446ff8036991e9b9f04a2ab2e3ffa9e79f3bab0eb9a95a1d2', preferred=True)
