...
class QuantumEspresso(Package):
    ...
    conflicts('+epw', when='@:5.9', msg='EPW only available from version 6.0.0 and on')
    ...
    conflicts('+epw', when='openmpi@2.0.0:2.9.9', msg='OpenMPI version incompatible with EPW')
