...
class RAdsplit(RPackage):
    ...
    depends_on('r-annotationdbi', when='@1.46.0:', type=('build', 'run'))
    depends_on('r-biobase@1.5.12:', when='@1.46.0:', type=('build', 'run'))
    depends_on('r-cluster@1.9.1:', when='@1.46.0:', type=('build', 'run'))
    depends_on('r-go-db@1.8.1:', when='@1.46.0:', type=('build', 'run'))
    depends_on('r-kegg-db@1.8.1:', when='@1.46.0:', type=('build', 'run'))
    depends_on('r-multtest@1.6.0:', when='@1.46.0:', type=('build', 'run'))
    depends_on('r@2.1.0:', when='@1.46.0:', type=('build', 'run'))
