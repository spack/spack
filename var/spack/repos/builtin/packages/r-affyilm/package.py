...
class RAffyilm(RPackage):
    ...
    depends_on('r-affxparser@1.16.0:', when='@1.28.0:', type=('build', 'run'))
    depends_on('r-affy', when='@1.28.0:', type=('build', 'run'))
    depends_on('r-biobase', when='@1.28.0:', type=('build', 'run'))
    depends_on('r-gcrma', when='@1.28.0:', type=('build', 'run'))
    depends_on('r@2.10.0:', when='@1.28.0:', type=('build', 'run'))
