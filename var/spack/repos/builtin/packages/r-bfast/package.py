...
class RBfast(RPackage):
    ...
    depends_on("r@3.0.0:", when="@1.6.1:", type=("build", "run"))
    depends_on("r-strucchangercpp", when="@1.6.1:", type=("build", "run"))
    depends_on("r-zoo", type=("build", "run"))
    depends_on("r-forecast", type=("build", "run"))
    depends_on("r-rcpp@0.12.7:", when="@1.6.1:", type=("build", "run"))
    depends_on("r-rdpack@0.7:", when="@1.6.1:", type=("build", "run"))

    depends_on("r-strucchange", when="@:1.5.7", type=("build", "run"))
    depends_on("r-sp", when="@:1.5.7", type=("build", "run"))
    depends_on("r-raster", when="@:1.5.7", type=("build", "run"))
