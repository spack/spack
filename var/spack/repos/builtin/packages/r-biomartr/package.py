...
class RBiomartr(RPackage):
    ...
    depends_on("r@3.1.1:", when="@1.0.2:", type=("build", "run"))
    ...
    depends_on("r-readr@0.2.2:", when="@0.9.2:", type=("build", "run"))
    depends_on("r-readr@1.4.0:", when="@1.0.2:", type=("build", "run"))
    ...
    depends_on("r-withr", when="@1.0.2:", type=("build", "run"))
    depends_on("r-fs", type=("build", "run"))
    depends_on("r-fs@1.3.1:", when="@0.9.2", type=("build", "run"))
