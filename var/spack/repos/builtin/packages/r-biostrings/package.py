...
class RBiostrings(RPackage):
    ...
    depends_on("r@4.0.0:", when="@2.62.0:", type=("build", "run"))
    # Older versions do not build with r@4.2:
    depends_on("r@:4.1", when="@:2.62.0", type=("build", "run"))
    depends_on("r-biocgenerics@0.15.6:", type=("build", "run"))
    depends_on("r-biocgenerics@0.31.5:", when="@2.58.0:", type=("build", "run"))
    depends_on("r-biocgenerics@0.37.0:", when="@2.62.0:", type=("build", "run"))
    ...
    depends_on("r-iranges@2.30.1:", when="@2.64.1:", type=("build", "run"))
    depends_on("r-iranges@2.31.2:", when="@2.66.0:", type=("build", "run"))
    ...
    depends_on("r-xvector@0.37.1:", when="@2.66.0:", type=("build", "run"))
    depends_on("r-genomeinfodb", when="@2.62.0:", type=("build", "run"))
