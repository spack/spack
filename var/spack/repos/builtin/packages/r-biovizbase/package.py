...
class RBiovizbase(RPackage):
    ...
    depends_on('r-biostrings@2.33.11:', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-dichromat', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-ensembldb@1.99.13:', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-genomeinfodb@1.5.14:', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-genomicalignments@1.1.16:', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-genomicfeatures@1.21.19:', when='@1.24.0:', type=('build', 'run'))
    ...
    depends_on('r-scales', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-summarizedexperiment', when='@1.24.0:', type=('build', 'run'))
    depends_on('r-variantannotation@1.11.4:', when='@1.24.0:', type=('build', 'run'))
