...
class RBlavaan(RPackage):
    ...
    depends_on("r-lavaan@0.6-7:", when="@0.3-18:", type=("build", "run"))
    depends_on("r-lavaan@0.6-10:", when="@0.4-1:", type=("build", "run"))
    depends_on("r-lavaan@0.6-14:", when="@0.4-7:", type=("build", "run"))
    ...
    depends_on("r-mcmcpack", when="@:0.4-1", type=("build", "run"))
