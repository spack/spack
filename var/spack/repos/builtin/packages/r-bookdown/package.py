...
class RBookdown(RPackage):
    ...
    depends_on("r@3.5.0:", when="@0.33:", type=("build", "run"))

    depends_on("r+X", type=("build", "run"))
    depends_on("r-htmltools@0.3.6:", type=("build", "run"))
    depends_on("r-knitr@1.22:", type=("build", "run"))
    depends_on("r-knitr@1.31:", when="@0.24:", type=("build", "run"))
    depends_on("r-knitr@1.38:", when="@0.29:", type=("build", "run"))
    depends_on("r-rmarkdown@1.12:", type=("build", "run"))
    depends_on("r-rmarkdown@2.4:", when="@0.21:", type=("build", "run"))
    depends_on("r-rmarkdown@2.9:", when="@0.24:", type=("build", "run"))
    depends_on("r-rmarkdown@2.13:", when="@0.26:", type=("build", "run"))
    depends_on("r-rmarkdown@2.14:", when="@0.29:", type=("build", "run"))
    depends_on("r-jquerylib", when="@0.24:", type=("build", "run"))
    depends_on("r-xfun@0.6:", type=("build", "run"))
    depends_on("r-xfun@0.13:", when="@0.21:", type=("build", "run"))
    depends_on("r-xfun@0.22:", when="@0.24:", type=("build", "run"))
    depends_on("r-xfun@0.29:", when="@0.26:", type=("build", "run"))
