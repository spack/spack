...
class RBoot(RPackage):
    ...
    version(
        "1.3-28",
        sha256="9f7158fd2714659f590c3955651893dc24bd8f39196bc5a4cc35b0b031744a32",
    )
    version(
        "1.3-25",
        sha256="464835fcb453072346ce49e4ae318e04c9dba682349be49db616623b6088fbbe",
    )
    version(
        "1.3-23",
        sha256="79236a5a770dc8bf5ce25d9aa303c5dc0574d94aa043fd00b8b4c8ccc877357f",
    )
    version(
        "1.3-22",
        sha256="cf1f0cb1e0a7a36dcb6ae038f5d0211a0e7a009c149bc9d21acb9c58c38b4dfc",
    )
    version(
        "1.3-20",
