...
class RBslib(RPackage):
    ...
    depends_on("r-htmltools@0.5.4:", when="@0.4.2:", type=("build", "run"))
    depends_on("r-jsonlite", type=("build", "run"))
    depends_on("r-sass@0.4.0:", type=("build", "run"))
    depends_on("r-jquerylib@0.1.3:", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-memoise", when="@0.4.0:", type=("build", "run"))
    depends_on("r-memoise@2.0.1:", when="@0.4.1:", type=("build", "run"))
    depends_on("r-mime", when="@0.4.2:", type=("build", "run"))
    depends_on("r-base64enc", when="@0.4.2:", type=("build", "run"))
    depends_on("r-cachem", when="@0.4.0:", type=("build", "run"))
