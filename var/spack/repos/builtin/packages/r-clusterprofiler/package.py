...
class RClusterprofiler(RPackage):
    ...
    depends_on("r@3.5.0:", when="@4.2.2:", type=("build", "run"))
    ...
    depends_on("r-dose@3.23.2:", when="@4.6.0:", type=("build", "run"))
    ...
    depends_on("r-gson@0.0.7:", when="@4.6.0:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-plyr", type=("build", "run"))
    depends_on("r-qvalue", type=("build", "run"))
    depends_on("r-rlang", when="@3.18.0:", type=("build", "run"))
    depends_on("r-tidyr", type=("build", "run"))
    depends_on("r-yulab-utils", when="@4.2.2:", type=("build", "run"))

    depends_on("r-ggplot2", when="@:3.12.0", type=("build", "run"))
    depends_on("r-rvcheck", when="@:3.18.0", type=("build", "run"))
