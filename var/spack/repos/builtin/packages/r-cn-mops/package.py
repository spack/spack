...
class RCnMops(RPackage):
    ...
    homepage = "https://www.bioconductor.org/packages/cn.mops/"
    url      = "https://www.bioconductor.org/packages/release/bioc/src/contrib/cn.mops_1.26.0.tar.gz"

    version('1.26.0', 'e95b8477a957fcf5547ffb936cbeda39')
