...
class RCner(RPackage):
    ...
    depends_on('r-dbi@0.6:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-genomeinfodb@1.1.3:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-genomicalignments@1.1.9:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-genomicranges@1.23.16:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-ggplot2@2.1.0:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-go-db@3.3.0:', when='@1.12.1:', type=('build', 'run'))
    ...
    depends_on('r-rsqlite@0.11.4:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-rtracklayer@1.25.5:', when='@1.12.1:', type=('build', 'run'))
    depends_on('r-s4vectors@0.13.13:', when='@1.12.1:', type=('build', 'run'))
