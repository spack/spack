...
class RComplexheatmap(RPackage):
    ...
    depends_on("r-circlize@0.4.14:", when="@2.12.0:", type=("build", "run"))
    ...
    depends_on("r-foreach", when="@2.10.0:", type=("build", "run"))
    depends_on("r-doparallel", when="@2.10.0:", type=("build", "run"))
    depends_on("r-codetools", when="@2.12.0:", type=("build", "run"))
