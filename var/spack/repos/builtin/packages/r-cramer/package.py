...
class RCramer(RPackage):
    ...
    url      = "https://cran.r-project.org/src/contrib/cramer_0.9-1.tar.gz"
    list_url = "https://cran.r-project.org/src/contrib/Archive/cramer"

    version('0.9-1', 'b5f6f0291d8bd0748aca5e1e957b6f37')
