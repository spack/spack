...
class RDbplyr(RPackage):
    ...
    depends_on("r-cli@3.3.0:", when="@2.2.1:", type=("build", "run"))
    depends_on("r-cli@3.4.1:", when="@2.3.2:", type=("build", "run"))
    ...
    depends_on("r-dplyr@1.0.9:", when="@2.2.1:", type=("build", "run"))
    depends_on("r-dplyr@1.1.0:", when="@2.3.2:", type=("build", "run"))
    ...
    depends_on("r-lifecycle@1.0.3:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-magrittr", when="@2.0.0:", type=("build", "run"))
    depends_on("r-pillar@1.5.0:", when="@2.2.1:", type=("build", "run"))
    depends_on("r-purrr@0.2.5:", type=("build", "run"))
    depends_on("r-purrr@1.0.1:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-r6@2.2.2:", type=("build", "run"))
    depends_on("r-rlang@0.2.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@2.2.1:", type=("build", "run"))
    depends_on("r-rlang@1.0.6:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-tibble@1.4.2:", type=("build", "run"))
    depends_on("r-tidyr@1.3.0:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-tidyselect@0.2.4:", type=("build", "run"))
    depends_on("r-tidyselect@1.2.0:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-vctrs", when="@2.1:", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@2.2.1:", type=("build", "run"))
    depends_on("r-vctrs@0.5.0:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-withr", when="@2.0.0:", type=("build", "run"))
    depends_on("r-ellipsis", when="@2.1.1", type=("build", "run"))
    depends_on("r-assertthat", when="@:2.2.1", type=("build", "run"))
