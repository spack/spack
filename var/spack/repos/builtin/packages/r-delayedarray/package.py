...
class RDelayedarray(RPackage):
    ...
    depends_on("r@4.0.0:", when="@0.20.0:", type=("build", "run"))
    ...
    depends_on("r-biocgenerics@0.37.0:", when="@0.20.1:", type=("build", "run"))
    depends_on("r-biocgenerics@0.43.4:", when="@0.24.0:", type=("build", "run"))
