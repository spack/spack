...
class RDelayedmatrixstats(RPackage):
    ...
    depends_on("r-matrixgenerics@1.5.3:", when="@1.16.0:", type=("build", "run"))
    ...
    depends_on("r-delayedarray@0.17.6:", when="@1.16.0:", type=("build", "run"))
    ...
    depends_on("r-matrixstats@0.60.0:", when="@1.16.0:", type=("build", "run"))
    depends_on("r-sparsematrixstats", when="@1.12.2:", type=("build", "run"))
    depends_on("r-matrix", type=("build", "run"))
    depends_on("r-matrix@1.5-0:", when="@1.18.1:", type=("build", "run"))
    depends_on("r-s4vectors", type=("build", "run"))
    depends_on("r-s4vectors@0.17.5:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-iranges", type=("build", "run"))
    depends_on("r-iranges@2.25.10:", when="@1.16.0:", type=("build", "run"))

    depends_on("r-hdf5array@1.7.10:", when="@1.4.0:1.12.3", type=("build", "run"))
    depends_on("r-hdf5array@1.17.2:", when="@1.12.2:1.12.3", type=("build", "run"))
    depends_on("r-biocparallel", when="@1.4.0:1.12.3", type=("build", "run"))
