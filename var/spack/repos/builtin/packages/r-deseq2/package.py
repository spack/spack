...
class RDeseq2(RPackage):
    ...
    depends_on("r-matrixstats", when="@1.40.0:", type=("build", "run"))
    depends_on("r-locfit", type=("build", "run"))
    depends_on("r-ggplot2", type=("build", "run"))
    depends_on("r-rcpp@0.11.0:", type=("build", "run"))
    depends_on("r-rcpparmadillo", type=("build", "run"))

    depends_on("r-hmisc", when="@:1.30.0", type=("build", "run"))
    depends_on("r-genefilter", when="@:1.38.0", type=("build", "run"))
    depends_on("r-geneplotter", when="@:1.38.0", type=("build", "run"))
