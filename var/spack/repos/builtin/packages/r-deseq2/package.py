...
class RDeseq2(RPackage):
    ...
    depends_on('r-genefilter', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-geneplotter', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-genomicranges', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-ggplot2', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-hmisc', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-iranges', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-locfit', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-rcpp@0.11.0:', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-rcpparmadillo', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-s4vectors@0.9.25:', when='@1.16.1:', type=('build', 'run'))
    depends_on('r-summarizedexperiment@1.1.6:', when='@1.16.1:', type=('build', 'run'))
