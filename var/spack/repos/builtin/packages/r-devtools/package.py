...
class RDevtools(RPackage):
    ...
    depends_on('r-usethis@1.6.0:', when='@2.0.0:', type=('build', 'run'))
    ...
    depends_on('r-remotes@2.1.1:', when='@2.0.0:', type=('build', 'run'))
    depends_on('r-rlang@0.4.5:', when='@2.0.0', type=('build', 'run'))
    depends_on('r-roxygen2@7.1.0:', when='@2.0.0:', type=('build', 'run'))
