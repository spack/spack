...
class RDevtools(RPackage):
    ...
    depends_on("r-urlchecker@1.0.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-profvis@0.3.7:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-pkgdown@2.0.6:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-miniui@0.1.1.1:", when="@2.4.4:", type=("build", "run"))
    ...
    depends_on("r-usethis@2.0.1:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-usethis@2.1.6:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-cli", when="@2.0.0:", type=("build", "run"))
    depends_on("r-cli@2.0.2:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-cli@3.0.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-cli@3.3.0:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-desc@1.2.0:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-desc@1.3.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-desc@1.4.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-ellipsis@0.3.0:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-ellipsis@0.3.1:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-ellipsis@0.3.2:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-fs@1.5.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-fs@1.5.2:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-memoise@1.0.0:", type=("build", "run"))
    depends_on("r-memoise@1.1.0:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-memoise@2.0.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-memoise@2.0.1:", when="@2.4.4:", type=("build", "run"))
    ...
    depends_on("r-pkgbuild@1.2.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-pkgbuild@1.3.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-pkgload@1.0.2:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-pkgload@1.1.0:", when="@2.0.2:", type=("build", "run"))
    depends_on("r-pkgload@1.2.1:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-pkgload@1.3.0:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-rcmdcheck@1.3.3:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-rcmdcheck@1.4.0:", when="@2.4.4:", type=("build", "run"))
    ...
    depends_on("r-remotes@2.3.0:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-remotes@2.4.2:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-rlang@0.4.5:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-rlang@0.4.7:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-rlang@0.4.10:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-rlang@1.0.4:", when="@2.4.4:", type=("build", "run"))
    ...
    depends_on("r-roxygen2@7.2.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-rversions@2.0.1:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-rversions@2.0.2:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-rversions@2.1.1:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-sessioninfo@1.1.1:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-sessioninfo@1.2.2:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-testthat@2.1.1:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-testthat@2.3.2:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-testthat@3.0.2:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-testthat@3.1.4:", when="@2.4.4:", type=("build", "run"))
    depends_on("r-testthat@3.1.5:", when="@2.4.5:", type=("build", "run"))
    depends_on("r-withr", type=("build", "run"))
    depends_on("r-withr@2.1.2:", when="@2.3.0:", type=("build", "run"))
    depends_on("r-withr@2.2.0:", when="@2.3.2:", type=("build", "run"))
    depends_on("r-withr@2.4.1:", when="@2.4.3:", type=("build", "run"))
    depends_on("r-withr@2.5.0:", when="@2.4.4:", type=("build", "run"))
    ...
    depends_on("r-whisker", when="@:1.12.0", type=("build", "run"))
    depends_on("r-dt@0.13:", when="@:2.3.0", type=("build", "run"))
    depends_on("r-dt@0.15:", when="@2.3.2", type=("build", "run"))
    depends_on("r-jsonlite", when="@:2.3.2", type=("build", "run"))
    ...
    depends_on("r-callr@3.4.3:", when="@2.3.0:2.4.3", type=("build", "run"))
    depends_on("r-callr@3.4.4:", when="@2.3.2:2.4.3", type=("build", "run"))
    depends_on("r-callr@3.6.0:", when="@2.4.3:2.4.3", type=("build", "run"))
    depends_on("r-covr@3.5.0:", when="@2.3.0:2.3.2", type=("build", "run"))
    depends_on("r-covr@3.5.1:", when="@2.3.2", type=("build", "run"))
    depends_on("r-httr@1.4.1:", when="@2.3.0:2.4.3", type=("build", "run"))
    depends_on("r-httr@1.4.2:", when="@2.3.2:2.4.3", type=("build", "run"))
    depends_on("r-rstudioapi@0.7.0:", type=("build", "run"))
    depends_on("r-rstudioapi@0.11:", when="@2.3.0:2.4.3", type=("build", "run"))
    depends_on("r-rstudioapi@0.13:", when="@2.4.3", type=("build", "run"))
