...
class RDismo(RPackage):
    ...
    depends_on("r@4.0.0:", when="@1.3-5:", type=("build", "run"))
    depends_on("r@3.6.3:", when="@1.3-9:", type=("build", "run"))
    depends_on("r-raster@2.5-2:", type=("build", "run"))
    depends_on("r-raster@3.5-2:", when="@1.3-5:", type=("build", "run"))
    depends_on("r-raster@3.5-21:", when="@1.3-9:", type=("build", "run"))
    depends_on("r-sp@1.2-0:", type=("build", "run"))
    depends_on("r-sp@1.4-5:", when="@1.3-5:", type=("build", "run"))
    depends_on("r-terra@1.5-34:", when="@1.3-9:", type=("build", "run"))
    depends_on("r-rcpp", when="@1.3-9:", type=("build", "run"))
