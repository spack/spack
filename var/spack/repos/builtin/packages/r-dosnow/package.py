...
class RDosnow(RPackage):
    ...
    url      = "https://cran.r-project.org/src/contrib/doSNOW_1.0.14.tar.gz"
    list_url = "https://cran.r-project.org/src/contrib/Archive/doSNOW"

    version('1.0.14', 'd7f904e79968d85dcc89958b1dbd2a7e')
