...
class RDplyr(RPackage):
    ...
    depends_on("r@3.4.0:", when="@1.0.9:", type=("build", "run"))
    depends_on("r@3.5.0:", when="@1.1.2:", type=("build", "run"))
    ...
    depends_on("r-lifecycle@1.0.1:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-cli@3.4.0:", when="@1.1.2:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.2:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-rlang@1.1.0:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-tibble@2.0.0:", type=("build", "run"))
    depends_on("r-tibble@2.1.3:", when="@1.0.3:", type=("build", "run"))
    depends_on("r-tibble@3.2.0:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-tidyselect@0.2.5:", type=("build", "run"))
    depends_on("r-tidyselect@1.1.0:", when="@1.0.3:", type=("build", "run"))
    depends_on("r-tidyselect@1.1.1:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-tidyselect@1.2.0:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-vctrs@0.3.5:", when="@1.0.3:", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-vctrs@0.6.0:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-pillar@1.5.1:", when="@1.0.6:", type=("build", "run"))
    depends_on("r-pillar@1.9.0:", when="@1.1.2:", type=("build", "run"))
    ...
    depends_on("r-ellipsis", when="@1.0.3:1.0.9", type=("build", "run"))
