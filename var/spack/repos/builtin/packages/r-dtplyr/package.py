...
class RDtplyr(RPackage):
    ...
    depends_on("r-cli@3.4.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-data-table@1.12.4:", type=("build", "run"))
    depends_on("r-data-table@1.13.0:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-dplyr@1.0.3:", type=("build", "run"))
    depends_on("r-dplyr@1.1.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-lifecycle", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-rlang@1.0.4:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-tibble", type=("build", "run"))
    depends_on("r-tidyselect", type=("build", "run"))
    depends_on("r-tidyselect@1.2.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-vctrs", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-crayon", when="@:1.2.2", type=("build", "run"))
    depends_on("r-ellipsis", when="@:1.2.2", type=("build", "run"))
