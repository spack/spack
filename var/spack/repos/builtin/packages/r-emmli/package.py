...
class REmmli(RPackage):
    ...
    homepage = "https://cran.r-project.org/package=EMMLi"
    url      = "https://cran.r-project.org/src/contrib/EMMLi_0.0.3.tar.gz"
    list_url = "https://cran.r-project.org/src/contrib/Archive/EMMLi"
