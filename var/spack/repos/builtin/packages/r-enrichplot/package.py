...
class REnrichplot(RPackage):
    ...
    depends_on("r-aplot", when="@1.14.1:", type=("build", "run"))
    depends_on("r-aplot@0.1.4:", when="@1.18.0:", type=("build", "run"))
    depends_on("r-dose@3.5.1:", type=("build", "run"))
    depends_on("r-dose@3.13.1:", when="@1.8.1:", type=("build", "run"))
    depends_on("r-dose@3.16.0:", when="@1.12.3:", type=("build", "run"))
    depends_on("r-ggnewscale", when="@1.18.0:", type=("build", "run"))
    ...
    depends_on("r-rlang", when="@1.18.0:", type=("build", "run"))
    ...
    depends_on("r-ggtree", when="@1.14.1:", type=("build", "run"))
    depends_on("r-yulab-utils@0.0.4:", when="@1.14.1:", type=("build", "run"))
    ...
    depends_on("r-cowplot", when="@:1.16.1", type=("build", "run"))
