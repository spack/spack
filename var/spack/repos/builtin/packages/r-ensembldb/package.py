...
class REnsembldb(RPackage):
    ...
    depends_on('r-annotationhub', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-biobase', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-biocgenerics@0.15.10:', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-biostrings', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-curl', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-dbi', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-genomeinfodb', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-genomicfeatures@1.23.18:', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-genomicranges@1.23.21:', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-iranges', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-protgenerics', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-rsamtools', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-rsqlite@1.1:', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-rtracklayer', when='@2.0.4:', type=('build', 'run'))
    depends_on('r-s4vectors', when='@2.0.4:', type=('build', 'run'))
