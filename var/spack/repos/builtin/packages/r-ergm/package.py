...
class RErgm(RPackage):
    ...
    depends_on("r@3.5:", when="@4.1.2:", type=("build", "run"))
    depends_on("r@4.0:", when="@4.2.1:", type=("build", "run"))
    depends_on("r@4.1:", when="@4.4.0:", type=("build", "run"))
    depends_on("r-network@1.15:", type=("build", "run"))
    depends_on("r-network@1.17:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-network@1.17.0:", when="@4.2.3:", type=("build", "run"))
    depends_on("r-network@1.18.0:", when="@4.4.0:", type=("build", "run"))
    depends_on("r-robustbase@0.93-5:", type=("build", "run"))
    depends_on("r-robustbase@0.93-7:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-coda@0.19-2:", type=("build", "run"))
    depends_on("r-coda@0.19-4:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-trust@0.1.7:", type=("build", "run"))
    depends_on("r-trust@0.1.8:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-matrix@1.2-17:", type=("build", "run"))
    depends_on("r-matrix@1.3.2:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-lpsolveapi@5.5.2.0.17.7:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-mass@7.3-51.4:", type=("build", "run"))
    depends_on("r-mass@7.3.53.1:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-statnet-common@4.3.0:", type=("build", "run"))
    depends_on("r-statnet-common@4.4.0:", when="@3.11.0:", type=("build", "run"))
    depends_on("r-statnet-common@4.5.0:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-statnet-common@4.6.0:", when="@4.2.1:", type=("build", "run"))
    depends_on("r-statnet-common@4.7.0:", when="@4.3.1:", type=("build", "run"))
    depends_on("r-statnet-common@4.8.0:", when="@4.4.0:", type=("build", "run"))
    depends_on("r-rle", when="@3.11.0:", type=("build", "run"))
    depends_on("r-rle@0.9.2:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-purrr@0.3.2:", when="@3.10.0:", type=("build", "run"))
    depends_on("r-purrr@0.3.4:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-rlang@0.3.4:", when="@3.10.0:", type=("build", "run"))
    depends_on("r-rlang@0.4.10:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-memoise@2.0.0:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-tibble@2.1.1:", when="@3.10.0:", type=("build", "run"))
    depends_on("r-tibble@3.1.0:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-magrittr@2.0.1:", when="@4.2.1:", type=("build", "run"))
    depends_on("r-rdpack@2.4:", when="@4.4.0:", type=("build", "run"))
    depends_on("r-knitr", when="@4.2.1:", type=("build", "run"))
    depends_on("r-stringr", when="@4.2.1:", type=("build", "run"))

    depends_on("r-dplyr@0.8.0.1:", when="@3.10.0:3.10.4", type=("build", "run"))
    depends_on("r-lpsolve@5.6.13:", when="@:3.11.0", type=("build", "run"))
    depends_on("r-digest", when="@4.2.1:4.2.2", type=("build", "run"))
