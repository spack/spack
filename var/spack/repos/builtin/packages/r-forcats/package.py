...
class RForcats(RPackage):
    ...
    depends_on("r@3.4:", when="@0.5.2:", type=("build", "run"))
    depends_on("r-cli", when="@0.5.2:", type=("build", "run"))
    depends_on("r-cli@3.4.0:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-lifecycle", when="@0.5.2:", type=("build", "run"))
    depends_on("r-glue", when="@0.5.2:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-rlang", when="@0.4.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@0.5.2:", type=("build", "run"))
    depends_on("r-tibble", type=("build", "run"))
    depends_on("r-ellipsis", when="@0.4.0:0.5.2", type=("build", "run"))
    depends_on("r-withr", when="@0.5.2:0.5.2", type=("build", "run"))
