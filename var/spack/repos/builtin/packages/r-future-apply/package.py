...
class RFutureApply(RPackage):
    ...
    depends_on("r-future@1.21.0:", when="@1.8.1:", type=("build", "run"))
    depends_on("r-future@1.22.1:", when="@1.9.0:", type=("build", "run"))
    depends_on("r-future@1.27.0:", when="@1.9.1:", type=("build", "run"))
    depends_on("r-future@1.28.0:", when="@1.10.0:", type=("build", "run"))
    depends_on("r-globals@0.12.4:", type=("build", "run"))
    depends_on("r-globals@0.12.5:", when="@1.7.0:", type=("build", "run"))
    depends_on("r-globals@0.14.0:", when="@1.8.1:", type=("build", "run"))
    depends_on("r-globals@0.16.1:", when="@1.9.1:", type=("build", "run"))
