...
class RFuture(RPackage):
    ...
    depends_on("r-globals@0.15.0:", when="@1.26.1:", type=("build", "run"))
    depends_on("r-globals@0.16.0:", when="@1.28.0:", type=("build", "run"))
    depends_on("r-globals@0.16.1:", when="@1.29.0:", type=("build", "run"))
    ...
    depends_on("r-parallelly@1.30.0:", when="@1.24.0:", type=("build", "run"))
    depends_on("r-parallelly@1.32.1:", when="@1.28.0:", type=("build", "run"))
    depends_on("r-parallelly@1.34.0:", when="@1.32.0:", type=("build", "run"))
