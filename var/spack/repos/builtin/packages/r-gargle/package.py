...
class RGargle(RPackage):
    ...
    depends_on("r-cli@3.0.1:", when="@1.4.0:", type=("build", "run"))
    depends_on("r-fs@1.3.1:", type=("build", "run"))
    depends_on("r-glue@1.3.0:", type=("build", "run"))
    depends_on("r-httr@1.4.0:", type=("build", "run"))
    depends_on("r-httr@1.4.5:", when="@1.4.0:", type=("build", "run"))
    depends_on("r-jsonlite", type=("build", "run"))
    depends_on("r-openssl", when="@1.4.0:", type=("build", "run"))
    depends_on("r-lifecycle", when="@1.4.0:", type=("build", "run"))
    depends_on("r-rappdirs", type=("build", "run"))
    depends_on("r-rlang@0.4.9:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@1.2.1:", type=("build", "run"))
    depends_on("r-rlang@1.1.0:", when="@1.4.0:", type=("build", "run"))
    depends_on("r-withr", type=("build", "run"))
    depends_on("r-rstudioapi", when="@:1.2.1", type=("build", "run"))
