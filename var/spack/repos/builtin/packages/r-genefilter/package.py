...
class RGenefilter(RPackage):
    ...
    depends_on("r-matrixgenerics@1.11.1:", when="@1.82.0:", type=("build", "run"))
    depends_on("r-annotationdbi", type=("build", "run"))
    depends_on("r-annotate", type=("build", "run"))
    depends_on("r-biobase", type=("build", "run"))
    depends_on("r-survival", type=("build", "run"))
    depends_on("r-s4vectors@0.9.42:", when="@:1.66.0", type=("build", "run"))
    depends_on("r-biocgenerics", when="@1.78.0:1.80.0", type=("build", "run"))
    depends_on("r-biocgenerics@0.31.2:", when="@1.68.0:1.80.0", type=("build", "run"))
