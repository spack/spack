...
class RGenelendatabase(RPackage):
    ...
    depends_on('r-genomicfeatures@1.3.15:', when='@1.12.0:', type=('build', 'run'))
    depends_on('r@2.11.0:', when='@1.12.0:', type=('build', 'run'))
    depends_on('r-rtracklayer', when='@1.12.0:', type=('build', 'run'))
