...
class RGenomicalignments(RPackage):
    ...
    depends_on('r@3.6.0:3.6.9', when='@1.20.1', type=('build', 'run'))
    ...
    depends_on('r-biocgenerics@0.15.3:', when='@1.12.2:', type=('build', 'run'))
    depends_on('r-biocparallel', when='@1.12.2:', type=('build', 'run'))
    depends_on('r-biostrings@2.37.1:', when='@1.12.2:', type=('build', 'run'))
    ...
    depends_on('r-rsamtools@1.21.4:', when='@1.12.2:', type=('build', 'run'))
    depends_on('r-s4vectors@0.13.13:', when='@1.12.2:', type=('build', 'run'))
    depends_on('r-summarizedexperiment@1.5.3:', when='@1.12.2:', type=('build', 'run'))
