...
class RGenomicfeatures(RPackage):
    ...
    depends_on("r@3.5.0:", when="@1.48.3:", type=("build", "run"))
    ...
    depends_on("r-genomeinfodb@1.34.1:", when="@1.50.2:", type=("build", "run"))
    depends_on("r-genomeinfodb@1.35.8:", when="@1.52.0:", type=("build", "run"))
