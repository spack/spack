...
class RGenomicfeatures(RPackage):
    ...
    depends_on('r-biomart@2.17.1:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-biostrings@2.23.3:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-dbi', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-genomeinfodb@1.11.4:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-genomicranges@1.27.6:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-iranges@2.9.19:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-rcurl', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-rsqlite@2.0:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-rtracklayer@1.29.24:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-s4vectors@0.9.47:', when='@1.28.5:', type=('build', 'run'))
    depends_on('r-xvector', when='@1.28.5:', type=('build', 'run'))
