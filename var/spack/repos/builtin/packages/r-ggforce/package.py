...
class RGgforce(RPackage):
    ...
    depends_on("r-ggplot2@3.3.6:", when="@0.4.1:", type=("build", "run"))
    ...
    depends_on("r-systemfonts", when="@0.4.1:", type=("build", "run"))
    depends_on("r-vctrs", when="@0.4.1:", type=("build", "run"))
    depends_on("r-cli", when="@0.4.1:", type=("build", "run"))
    depends_on("r-lifecycle", when="@0.4.1:", type=("build", "run"))
