...
class RGgplot2(RPackage):
    ...
    depends_on("r-cli", when="@3.4.0:", type=("build", "run"))
    ...
    depends_on("r-lifecycle@1.0.1:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-lifecycle@unknown:", when="@3.4.2:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.0:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-rlang@1.1.0:", when="@3.4.2:", type=("build", "run"))
    depends_on("r-scales@0.5.0:", type=("build", "run"))
    depends_on("r-scales@1.2.0:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-tibble", type=("build", "run"))
    depends_on("r-vctrs@0.5.0:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-withr@2.0.0:", when="@3.0.0:", type=("build", "run"))
    depends_on("r-withr@2.5.0:", when="@3.4.0:", type=("build", "run"))
    ...
    depends_on("r-digest", when="@:3.3.6", type=("build", "run"))
