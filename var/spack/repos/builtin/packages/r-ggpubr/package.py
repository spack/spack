...
class RGgpubr(RPackage):
    ...
    depends_on("r-ggplot2@3.4.0:", when="@0.6.0:", type=("build", "run"))
    depends_on("r-ggrepel", type=("build", "run"))
    depends_on("r-ggrepel@0.9.2:", when="@0.6.0:", type=("build", "run"))
    depends_on("r-ggsci", type=("build", "run"))
    depends_on("r-tidyr", when="@0.2:", type=("build", "run"))
    depends_on("r-tidyr@1.3.0:", when="@0.6.0:", type=("build", "run"))
    ...
    depends_on("r-cowplot@1.1.1:", when="@0.6.0:", type=("build", "run"))
    ...
    depends_on("r-rlang@0.4.6:", when="@0.6.0:", type=("build", "run"))
    depends_on("r-rstatix@0.6.0:", when="@0.4.0:", type=("build", "run"))
    depends_on("r-rstatix@0.7.2:", when="@0.6.0:", type=("build", "run"))
