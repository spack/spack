...
class RGgtree(RPackage):
    ...
    depends_on("r-aplot", when="@3.4.0:", type=("build", "run"))
    depends_on("r-dplyr", type=("build", "run"))
    depends_on("r-ggplot2@3.0.0:", type=("build", "run"))
    depends_on("r-ggplot2@3.4.0:", when="@3.6.2:", type=("build", "run"))
    depends_on("r-ggplot2@UNKNOWN:", when="@3.8.0:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-purrr", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-ggfun", type=("build", "run"))
    depends_on("r-ggfun@0.0.6:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-ggfun@0.0.9:", when="@3.8.0:", type=("build", "run"))
    depends_on("r-yulab-utils", type=("build", "run"))
    depends_on("r-tidyr", type=("build", "run"))
    depends_on("r-tidytree@0.2.6:", type=("build", "run"))
    depends_on("r-tidytree@0.3.9:", when="@3.4.0:", type=("build", "run"))
    depends_on("r-treeio@1.8.0:", type=("build", "run"))
    depends_on("r-scales", type=("build", "run"))
    depends_on("r-cli", when="@3.6.2:", type=("build", "run"))
