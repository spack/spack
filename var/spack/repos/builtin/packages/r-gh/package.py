...
class RGh(RPackage):
    ...
    depends_on("r@3.4:", when="@1.3.1:", type=("build", "run"))

    depends_on("r-cli", when="@1.1.0:", type=("build", "run"))
    depends_on("r-cli@2.0.1:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-cli@3.0.1:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-gitcreds", when="@1.2.0:", type=("build", "run"))
    depends_on("r-httr2", when="@1.4.0:", type=("build", "run"))
    depends_on("r-ini", type=("build", "run"))
    depends_on("r-jsonlite", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@1.4.0:", type=("build", "run"))
    depends_on("r-httr@1.2:", when="@1.1.0:1.3.1", type=("build", "run"))
