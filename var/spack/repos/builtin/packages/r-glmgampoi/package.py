...
class RGlmgampoi(RPackage):
    ...
    depends_on("r-matrixgenerics", when="@1.10.0:", type=("build", "run"))
    depends_on("r-delayedarray", type=("build", "run"))
    depends_on("r-hdf5array", type=("build", "run"))
    depends_on("r-summarizedexperiment", type=("build", "run"))
    depends_on("r-singlecellexperiment", when="@1.10.0:", type=("build", "run"))
    depends_on("r-biocgenerics", type=("build", "run"))
    depends_on("r-rlang", when="@1.10.0:", type=("build", "run"))
    depends_on("r-vctrs", when="@1.12.0:", type=("build", "run"))
