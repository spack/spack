...
class RGoogledrive(RPackage):
    ...
    depends_on("r@3.5:", when="@2.1.0:", type=("build", "run"))
    depends_on("r-cli@3.0.0:", type=("build", "run"))
    depends_on("r-gargle@1.2.0:", type=("build", "run"))
    depends_on("r-gargle@1.3.0:", when="@2.1.0:", type=("build", "run"))
    ...
    depends_on("r-purrr@1.0.1:", when="@2.1.0:", type=("build", "run"))
    depends_on("r-rlang@0.4.9:", type=("build", "run"))
    depends_on("r-rlang@1.0.2:", when="@2.1.0:", type=("build", "run"))
