...
class RGooglesheets4(RPackage):
    ...
    depends_on("r@3.5:", when="@1.1.0:", type=("build", "run"))
    ...
    depends_on("r-gargle@1.2.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-gargle@1.3.0:", when="@1.1.0:", type=("build", "run"))
    depends_on("r-glue@1.3.0:", type=("build", "run"))
    depends_on("r-googledrive@2.0.0:", type=("build", "run"))
    depends_on("r-googledrive@2.1.0:", when="@1.1.0:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.2:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-tibble@2.1.1:", type=("build", "run"))
    depends_on("r-vctrs@0.2.3:", type=("build", "run"))
    depends_on("r-withr", when="@1.1.0:", type=("build", "run"))
