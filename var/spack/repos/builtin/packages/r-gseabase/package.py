...
class RGseabase(RPackage):
    ...
    depends_on('r@3.4.0:3.4.9', when='@1.40.1', type=('build', 'run'))
    depends_on('r@3.4.0:3.4.9', when='@1.38.2', type=('build', 'run'))

    depends_on('r-annotate@1.45.3:', when='@1.38.2:', type=('build', 'run'))
    depends_on('r-annotationdbi', when='@1.38.2:', type=('build', 'run'))
    depends_on('r-biobase@2.17.8:', when='@1.38.2:', type=('build', 'run'))
    depends_on('r-biocgenerics@0.13.8:', when='@1.38.2:', type=('build', 'run'))
    depends_on('r-graph@1.37.2:', when='@1.38.2:', type=('build', 'run'))
    depends_on('r-xml', when='@1.38.2:', type=('build', 'run'))
