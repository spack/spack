...
class RGstat(RPackage):
    ...
    depends_on("r-stars", when="@2.1-0:", type=("build", "run"))
    depends_on("r-sftime", when="@2.1-0:", type=("build", "run"))
    depends_on("r-sf@0.7-2:", when="@2.1-0:", type=("build", "run"))
    depends_on("r-spacetime@1.0-0:", type=("build", "run"))
    depends_on("r-spacetime@1.2-8:", when="@2.1-0:", type=("build", "run"))
