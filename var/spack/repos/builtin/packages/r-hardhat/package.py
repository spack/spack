...
class RHardhat(RPackage):
    ...
    depends_on("r@3.5.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-cli@3.6.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-glue@1.6.2:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-rlang@0.4.2:", type=("build", "run"))
    depends_on("r-rlang@1.0.2:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.3:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-rlang@1.1.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-tibble", type=("build", "run"))
    depends_on("r-tibble@3.1.7:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-tibble@3.2.1:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-vctrs@0.3.0:", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-vctrs@0.6.0:", when="@1.3.0:", type=("build", "run"))
