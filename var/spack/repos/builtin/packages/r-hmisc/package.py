...
class RHmisc(RPackage):
    ...
    depends_on("r-knitr", when="@5.0-1:", type=("build", "run"))
    depends_on("r-rmarkdown", when="@5.0-1:", type=("build", "run"))
    depends_on("r-colorspace", when="@5.0-1:", type=("build", "run"))

    depends_on("r-acepack", when="@:4.4-0", type=("build", "run"))
    depends_on("r-lattice", when="@:4.7-1", type=("build", "run"))
    depends_on("r-latticeextra", when="@:4.7-1", type=("build", "run"))
    depends_on("r-survival@2.40-1:", when="@:4.7-1", type=("build", "run"))
    depends_on("r-survival@3.1-6:", when="@4.4:4.7-1", type=("build", "run"))
