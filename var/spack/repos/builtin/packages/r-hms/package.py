...
class RHms(RPackage):
    ...
    depends_on("r-rlang@1.0.2:", when="@1.1.3:", type=("build", "run"))
    ...
    depends_on("r-ellipsis", when="@1.0.0:1.1.2", type=("build", "run"))
    depends_on("r-ellipsis@0.3.2", when="@1.1:1.1.2", type=("build", "run"))
    depends_on("r-ellipsis@0.3.2:", when="@1.1.2:1.1.2", type=("build", "run"))
