...
class RIranges(RPackage):
    ...
    version('2.18.1', commit='b1cab4e341bb7e4e5cff4ab958a9bb83a06c8ec2')
    ...
    depends_on('r@3.6.0:3.6.9', when='@2.18.1', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@2.16.0', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@2.14.12', type=('build', 'run'))
    depends_on('r@3.4.0:3.4.9', when='@2.12.0', type=('build', 'run'))
    depends_on('r@3.4.0:3.4.9', when='@2.10.5', type=('build', 'run'))

    depends_on('r-biocgenerics@0.21.1:', when='@2.10.5:', type=('build', 'run'))
    depends_on('r-s4vectors@0.13.17:', when='@2.10.5:', type=('build', 'run'))
    ...
    depends_on('r-s4vectors@0.21.9:', when='@2.18.1:', type=('build', 'run'))
