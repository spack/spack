...
class RIranges(RPackage):
    ...
    depends_on("r-biocgenerics@0.39.2:", when="@2.28.0:", type=("build", "run"))
    ...
    depends_on("r-s4vectors@0.29.19:", when="@2.28.0:", type=("build", "run"))
    depends_on("r-s4vectors@0.33.3:", when="@2.30.0:", type=("build", "run"))
