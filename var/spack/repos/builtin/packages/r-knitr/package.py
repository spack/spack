...
class RKnitr(RPackage):
    ...
    depends_on("r@3.3.0:", when="@1.39:", type=("build", "run"))

    depends_on("r-evaluate@0.10:", type=("build", "run"))
    depends_on("r-evaluate@0.15:", when="@1.39:", type=("build", "run"))
    ...
    depends_on("r-xfun@0.27:", when="@1.37:", type=("build", "run"))
    depends_on("r-xfun@0.29:", when="@1.39:", type=("build", "run"))
    depends_on("r-xfun@0.34:", when="@1.42:", type=("build", "run"))
    ...
    depends_on("r-markdown", when="@:1.33", type=("build", "run"))
    depends_on("r-stringr@0.6:", when="@:1.40", type=("build", "run"))
