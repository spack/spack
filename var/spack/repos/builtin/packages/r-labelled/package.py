...
class RLabelled(RPackage):
    ...
    depends_on("r@3.0:", when="@2.9.0:", type=("build", "run"))
    depends_on("r-haven@2.3.1:", type=("build", "run"))
    depends_on("r-haven@2.4.1:", when="@2.9.0:", type=("build", "run"))
    depends_on("r-dplyr", type=("build", "run"))
    depends_on("r-dplyr@1.0.0:", when="@2.9.0:", type=("build", "run"))
    depends_on("r-lifecycle", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-vctrs", type=("build", "run"))
    depends_on("r-stringr", when="@2.9.0:", type=("build", "run"))
    depends_on("r-tidyr", type=("build", "run"))

    depends_on("r-pillar", when="@:2.7.0", type=("build", "run"))
