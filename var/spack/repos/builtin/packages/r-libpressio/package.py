...
class RLibpressio(RPackage):
    ...
    depends_on("libpressio@0.65.0:", when="@1.2:1.5", type=("build", "link", "run"))
    depends_on("libpressio@0.88.0:", when="@1.6:", type=("build", "link", "run"))
    depends_on("pkgconfig", type=("build"))
    depends_on("libpressio-tools@0.1.4:", when="+third_party", type=("build", "link", "run"))
