...
class RMatrixstats(RPackage):
    ...
    version(
        "0.61.0",
        sha256="dbd3c0ec59b1ae62ff9b4c2c90c4687cbd680d1796f6fdd672319458d4d2fd9a",
    )
    version(
        "0.58.0",
        sha256="8367b4b98cd24b6e40022cb2b11e907aa0bcf5ee5b2f89fefb186f53661f4b49",
    )
    version(
        "0.57.0",
        sha256="f9681887cd3b121762c83f55f189cae26cb8443efce91fcd212ac714fde9f343",
    )
    version(
        "0.55.0",
