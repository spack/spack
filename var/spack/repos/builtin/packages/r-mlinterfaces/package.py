...
class RMlinterfaces(RPackage):
    ...
    version('1.64.0', commit='38d5c087321280ff14beb9576c4fd4bec6246bc4')
    ...
    depends_on('r@3.6.0:3.6.9', when='@1.64.0', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@1.62.1', type=('build', 'run'))
