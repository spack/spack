...
class RMsnbase(RPackage):
    ...
    depends_on("r-mzr@2.29.3:", when="@2.22.0:", type=("build", "run"))
    depends_on("r-s4vectors", type=("build", "run"))
    depends_on("r-protgenerics@1.5.1:", type=("build", "run"))
    depends_on("r-protgenerics@1.19.3:", when="@2.16.1:", type=("build", "run"))
    depends_on("r-protgenerics@1.25.1:", when="@2.20.4:", type=("build", "run"))
    depends_on("r-protgenerics@1.27.2:", when="@2.22.0:", type=("build", "run"))
    depends_on("r-protgenerics@1.29.1:", when="@2.24.0:", type=("build", "run"))
    depends_on("r-mscoreutils", when="@2.20.4:", type=("build", "run"))
    ...
    depends_on("r-preprocesscore", when="@:2.16.1", type=("build", "run"))
