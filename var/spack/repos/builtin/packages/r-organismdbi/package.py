...
class ROrganismdbi(RPackage):
    ...
    depends_on('r-biocinstaller', when='@1.18.1:', type=('build', 'run'))
    depends_on('r-dbi', when='@1.18.1:', type=('build', 'run'))
    depends_on('r-genomicfeatures@1.23.31:', when='@1.18.1:', type=('build', 'run'))
