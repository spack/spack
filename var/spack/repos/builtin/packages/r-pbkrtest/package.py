...
class RPbkrtest(RPackage):
    ...
    depends_on("r@4.1.0:", when="@0.5.2:", type=("build", "run"))
    depends_on("r-lme4@1.1-10:", type=("build", "run"))
    depends_on("r-lme4@1.1.31:", when="@0.5.2:", type=("build", "run"))
    ...
    depends_on("r-knitr", when="@0.5-0.1:0.5.1", type=("build", "run"))
    depends_on("r-magrittr", when="@0.5-0.1:0.5.1", type=("build", "run"))
