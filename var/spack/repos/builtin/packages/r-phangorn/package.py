...
class RPhangorn(RPackage):
    ...
    depends_on("r@4.1.0:", when="@2.8.1:", type=("build", "run"))
    depends_on("r-digest", when="@2.10.0:", type=("build", "run"))
    depends_on("r-ape@5.0:", type=("build", "run"))
    depends_on("r-ape@5.5:", when="@2.8.1:", type=("build", "run"))
    depends_on("r-ape@5.6:", when="@2.10.0:", type=("build", "run"))
    depends_on("r-fastmatch", type=("build", "run"))
    depends_on("r-generics", when="@2.10.0:", type=("build", "run"))
    depends_on("r-igraph@1.0:", type=("build", "run"))
    depends_on("r-matrix", type=("build", "run"))
    depends_on("r-quadprog", type=("build", "run"))
    depends_on("r-rcpp", type=("build", "run"))

    depends_on("r-rcpp@0.12.0:", when="@:2.5.5", type=("build", "run"))
    depends_on("r-magrittr", when="@:2.5.5", type=("build", "run"))
