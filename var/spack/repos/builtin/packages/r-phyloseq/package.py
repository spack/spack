...
class RPhyloseq(RPackage):
    ...
    depends_on('r-ade4@1.7.4:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-ape@3.4:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-biobase', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-biocgenerics@0.18.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-biomformat@1.0.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-biostrings@2.40.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-cluster@2.0.4:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-data-table@1.9.6:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-foreach@1.4.3:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-ggplot2@2.1.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-igraph@1.0.1:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-multtest@2.28.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-plyr@1.8.3:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r@3.3.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-reshape2@1.4.1:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-scales@0.4.0:', when='@1.20.0:', type=('build', 'run'))
    depends_on('r-vegan@2.3.5:', when='@1.20.0:', type=('build', 'run'))
