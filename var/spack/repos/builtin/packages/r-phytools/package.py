...
class RPhytools(RPackage):
    ...
    depends_on("r-ape@5.7:", when="@1.5-1:", type=("build", "run"))
    depends_on("r-maps", type=("build", "run"))
    depends_on("r-clustergeneration", type=("build", "run"))
    depends_on("r-coda", type=("build", "run"))
    depends_on("r-combinat", type=("build", "run"))
    depends_on("r-doparallel", when="@1.5-1:", type=("build", "run"))
    depends_on("r-expm", type=("build", "run"))
    depends_on("r-foreach", when="@1.5-1:", type=("build", "run"))
    depends_on("r-mass", type=("build", "run"))
    depends_on("r-mnormt", type=("build", "run"))
    depends_on("r-nlme", type=("build", "run"))
    depends_on("r-numderiv", type=("build", "run"))
    depends_on("r-optimparallel", when="@1.2-0:", type=("build", "run"))
    depends_on("r-phangorn@2.3.1:", type=("build", "run"))
    depends_on("r-plotrix", type=("build", "run"))
    depends_on("r-scatterplot3d", type=("build", "run"))

    depends_on("r-animation", when="@:0.6-99", type=("build", "run"))
    depends_on("r-gtools", when="@0.6-99:0.7-70", type=("build", "run"))
