...
class RPiggyback(RPackage):
    ...
    depends_on("r-gh", when="@0.0.7:", type=("build", "run"))
    depends_on("r-httr", when="@0.0.7:", type=("build", "run"))
    depends_on("r-jsonlite", when="@0.0.7:", type=("build", "run"))
    depends_on("r-git2r", when="@0.0.7:0.0.11", type=("build", "run"))
    depends_on("r-fs", when="@0.0.7:", type=("build", "run"))
    depends_on("r-usethis", when="@0.0.7:0.0.11", type=("build", "run"))
    depends_on("r-crayon", when="@0.0.7:0.1.1", type=("build", "run"))
    depends_on("r-clisymbols", when="@0.0.7:0.1.1", type=("build", "run"))
    depends_on("r-magrittr", when="@0.0.7:0.1.0", type=("build", "run"))
    depends_on("r-lubridate", when="@0.0.7:", type=("build", "run"))
    depends_on("r-memoise", when="@0.0.7:", type=("build", "run"))
    depends_on("r-cli", when="@0.1.2:", type=("build", "run"))
    depends_on("r-glue", when="@0.1.2:", type=("build", "run"))
