...
class RPillar(RPackage):
    ...
    depends_on("r-cli@2.3.0:", when="@1.7.0:", type=("build", "run"))
    depends_on("r-fansi", type=("build", "run"))
    depends_on("r-glue", when="@1.6.5:", type=("build", "run"))
    depends_on("r-lifecycle", when="@1.4.7:", type=("build", "run"))
    depends_on("r-rlang@0.3.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.2:", when="@1.8.1:", type=("build", "run"))
    ...
    depends_on("r-vctrs@0.5.0:", when="@1.9.0:", type=("build", "run"))

    depends_on("r-crayon@1.3.4:", when="@:1.7.0", type=("build", "run"))
    depends_on("r-ellipsis", when="@1.4.7:1.7.0", type=("build", "run"))
    depends_on("r-ellipsis@0.3.2", when="@1.6.1:1.7.0", type=("build", "run"))
