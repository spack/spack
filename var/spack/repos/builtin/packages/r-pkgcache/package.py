...
class RPkgcache(RPackage):
    ...
    depends_on("r@3.4:", when="@2.0.2:", type=("build", "run"))
    depends_on("r-callr@2.0.4.9000:", type=("build", "run"))
    depends_on("r-cli@2.0.0:", type=("build", "run"))
    depends_on("r-cli@3.2.0:", when="@2.0.1:", type=("build", "run"))
    ...
    depends_on("r-assertthat", when="@:1.3.0", type=("build", "run"))
    depends_on("r-digest", when="@:1.3.0", type=("build", "run"))
    depends_on("r-rlang", when="@:1.3.0", type=("build", "run"))
    depends_on("r-tibble", when="@:1.3.0", type=("build", "run"))
    depends_on("r-uuid", when="@:1.3.0", type=("build", "run"))
    depends_on("r-glue", when="@:2.0.2", type=("build", "run"))
