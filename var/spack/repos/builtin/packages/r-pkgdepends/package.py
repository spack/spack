...
class RPkgdepends(RPackage):
    ...
    depends_on("r@3.4:", when="@0.3.1:", type=("build", "run"))
    depends_on("r-callr@3.3.1:", type=("build", "run"))
    depends_on("r-cli@2.1.0:", type=("build", "run"))
    depends_on("r-cli@3.6.0:", when="@0.5.0:", type=("build", "run"))
    ...
    depends_on("r-pkgcache@2.0.0:", when="@0.3.1:", type=("build", "run"))
    depends_on("r-pkgcache@2.1.0:", when="@0.5.0:", type=("build", "run"))
    ...
    depends_on("r-zip@2.3.0:", when="@0.5.0:", type=("build", "run"))

    depends_on("r-rematch2", when="@:0.2.0", type=("build", "run"))
    depends_on("r-tibble", when="@:0.2.0", type=("build", "run"))
    depends_on("r-crayon", when="@:0.3.2", type=("build", "run"))
