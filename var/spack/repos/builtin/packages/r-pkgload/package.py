...
class RPkgload(RPackage):
    ...
    depends_on("r-cli@3.3.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-crayon", when="@1.1.0:", type=("build", "run"))
    depends_on("r-desc", type=("build", "run"))
    depends_on("r-glue", when="@1.3.0:", type=("build", "run"))
    depends_on("r-fs", when="@1.3.0:", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-rlang@1.0.3:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-rprojroot", type=("build", "run"))
    depends_on("r-withr", type=("build", "run"))
    depends_on("r-withr@2.4.3:", when="@1.3.0:", type=("build", "run"))

    depends_on("r-pkgbuild", when="@:1.1.0", type=("build", "run"))
    depends_on("r-rstudioapi", when="@:1.2.4", type=("build", "run"))
