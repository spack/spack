...
class RPosterior(RPackage):
    ...
    depends_on("r-rlang@1.0.6:", when="@1.4.1:", type=("build", "run"))
    depends_on("r-tibble@3.0.0:", type=("build", "run"))
    depends_on("r-tibble@3.1.0:", when="@1.4.1:", type=("build", "run"))
    depends_on("r-vctrs", type=("build", "run"))
    depends_on("r-vctrs@0.5.0:", when="@1.4.1:", type=("build", "run"))
