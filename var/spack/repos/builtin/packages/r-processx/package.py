...
class RProcessx(RPackage):
    ...
    version(
        "3.5.2",
        sha256="ed6f2d1047461c6061e6ed58fb6de65a289b56009867892abad76c6bba46fc2b",
    )
    version(
        "3.4.5",
        sha256="e368103aa6a6894bfa8e78b12a25598464bcd2c19a8b6334f24ee397db13bb14",
    )
    version(
        "3.4.1",
    ...
    version(
        "3.3.1",
        sha256="6123dbdf9f3bb6e5e8678980fb4587dcefb56d2190adf2ef494d7cd199720bae",
    )
    version(
        "3.2.0",
    ...
    version(
        "3.0.3",
        sha256="53781dba3c538605a02e28b3b577e7de79e2064bfc502025f7ec0e5945e302bf",
    )
    version(
        "2.0.0.1",
    ...
    version(
        "2.0.0",
        sha256="8325b56a60a276909228756281523cda9256bc754c5f3ca03b41c5c17cc398ad",
    )
