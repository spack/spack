...
class RPscbs(RPackage):
    ...
    depends_on("r-r-methodss3@1.8.1:", when="@0.66.0:", type=("build", "run"))
    depends_on("r-r-oo@1.22.1:", type=("build", "run"))
    depends_on("r-r-oo@1.24.0:", when="@0.66.0:", type=("build", "run"))
    depends_on("r-r-utils@2.8.0:", type=("build", "run"))
    depends_on("r-r-utils@2.11.0:", when="@0.66.0:", type=("build", "run"))
    depends_on("r-r-cache@0.13.0:", type=("build", "run"))
    depends_on("r-r-cache@0.15.0:", when="@0.66.0:", type=("build", "run"))
    depends_on("r-matrixstats@0.54.0:", type=("build", "run"))
    depends_on("r-matrixstats@0.61.0:", when="@0.66.0:", type=("build", "run"))
    ...
    depends_on("r-listenv@0.8.0:", when="@0.66.0:", type=("build", "run"))
    depends_on("r-future@1.12.0:", type=("build", "run"))
    depends_on("r-future@1.22.1:", when="@0.66.0:", type=("build", "run"))
