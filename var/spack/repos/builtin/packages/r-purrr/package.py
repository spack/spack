...
class RPurrr(RPackage):
    ...
    depends_on("r-vctrs@0.5.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-cli@3.4.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-magrittr@1.5:", type=("build", "run"))
    depends_on("r-magrittr@1.5.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-rlang@0.3.1:", type=("build", "run"))
    depends_on("r-rlang@0.4.10:", when="@1.0.1:", type=("build", "run"))
