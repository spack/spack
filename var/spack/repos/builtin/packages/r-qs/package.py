...
class RQs(RPackage):
    ...
    depends_on("r@3.0.2:", when="@0.25.2:", type=("build", "run"))
    depends_on("r-rcpp", type=("build", "run"))
    depends_on("r-rapiserialize", type=("build", "run"))
    depends_on("r-rapiserialize@0.1.1:", when="@0.25.4:", type=("build", "run"))
    depends_on("r-stringfish@0.14.1:", type=("build", "run"))
    depends_on("r-stringfish@0.15.1:", when="@0.25.2:", type=("build", "run"))
    depends_on("zstd")
