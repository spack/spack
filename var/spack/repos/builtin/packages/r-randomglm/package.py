...
class RRandomglm(RPackage):
    ...
    depends_on("r@4.0.0:", when="@1.10-1:", type=("build", "run"))
    depends_on("r-mass", type=("build", "run"))
    depends_on("r-foreach", type=("build", "run"))
    depends_on("r-doparallel", type=("build", "run"))
    depends_on("r-hmisc", when="@1.10-1:", type=("build", "run"))
    depends_on("r-geometry", when="@1.10-1:", type=("build", "run"))
    depends_on("r-survival", when="@1.10-1:", type=("build", "run"))
    depends_on("r-matrixstats", when="@1.10-1:", type=("build", "run"))
