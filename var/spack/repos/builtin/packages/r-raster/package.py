...
class RRaster(RPackage):
    ...
    depends_on("r-sp@1.4-5:", when="@3.5-11:", type=("build", "run"))
    depends_on("r-rcpp", type=("build", "run"))
    depends_on("r-terra@1.4-11:", when="@3.5-11:", type=("build", "run"))
    depends_on("r-terra@1.5-12:", when="@3.5-15:", type=("build", "run"))
    depends_on("r-terra@1.6-16:", when="@3.6-3:", type=("build", "run"))
    depends_on("r-terra@1.6-41:", when="@3.6-20:", type=("build", "run"))
