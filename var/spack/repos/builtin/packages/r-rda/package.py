...
class RRda(RPackage):
    ...
    # Marking all versions as deprecated because the checksum no longer
    # matches and no current R packages use it.
    version("1.0.2-2.1",
    ...
    version("1.0.2-2",
            ...
            deprecated=True)
    version("1.0.2-1",
            sha256="e5b96610ec9e82f12efe5dbb9a3ec9ecba9aaddfad1d6ab3f8c37d15fc2b42b7",
            deprecated=True)
