...
class RReadr(RPackage):
    ...
    depends_on("r@3.4:", when="@2.1.3:", type=("build", "run"))
    depends_on("r@3.5:", when="@2.1.4:", type=("build", "run"))
    depends_on("r-cli", when="@1.4.0:", type=("build", "run"))
    depends_on("r-cli@3.0.0:", when="@2.1.2:", type=("build", "run"))
    depends_on("r-cli@3.2.0:", when="@2.1.3:", type=("build", "run"))
    ...
    depends_on("r-vroom@1.5.6:", when="@2.1.1:", type=("build", "run"))
    depends_on("r-vroom@1.6.0:", when="@2.1.3:", type=("build", "run"))
