...
class RRecipes(RPackage):
    ...
    depends_on("r-dplyr@1.1.0:", when="@1.0.6:", type=("build", "run"))
    depends_on("r-cli", when="@1.0.1:", type=("build", "run"))
    depends_on("r-clock@0.6.1:", when="@1.0.6:", type=("build", "run"))
    depends_on("r-ellipsis", when="@0.1.17:", type=("build", "run"))
    depends_on("r-generics", type=("build", "run"))
    depends_on("r-generics@0.1.0:", when="@0.1.15:", type=("build", "run"))
    depends_on("r-generics@0.1.0.9000:", when="@0.2.0:", type=("build", "run"))
    depends_on("r-generics@0.1.2:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-gower", type=("build", "run"))
    depends_on("r-hardhat@0.1.6.9001:", when="@0.2.0:", type=("build", "run"))
    depends_on("r-hardhat@1.2.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-hardhat@1.3.0:", when="@1.0.6:", type=("build", "run"))
    depends_on("r-ipred", type=("build", "run"))
    depends_on("r-ipred@0.9-12:", when="@0.1.17:", type=("build", "run"))
    depends_on("r-lifecycle", when="@0.1.15:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.0.2:", type=("build", "run"))
    depends_on("r-lubridate", type=("build", "run"))
    depends_on("r-lubridate@1.8.0:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-matrix", type=("build", "run"))
    depends_on("r-purrr@0.2.3:", type=("build", "run"))
    depends_on("r-purrr@1.0.0:", when="@1.0.6:", type=("build", "run"))
    depends_on("r-rlang@0.4.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.3:", when="@1.0.1:", type=("build", "run"))
    ...
    depends_on("r-tidyselect@1.1.2:", when="@1.0.1:", type=("build", "run"))
    depends_on("r-tidyselect@1.2.0:", when="@1.0.2:", type=("build", "run"))
    depends_on("r-timedate", type=("build", "run"))
    depends_on("r-vctrs", when="@0.1.17:", type=("build", "run"))
    depends_on("r-vctrs@0.5.0:", when="@1.0.6:", type=("build", "run"))
