...
class RReprex(RPackage):
    ...
    depends_on("r-cli@3.2.0:", when="@2.0.2:", type=("build", "run"))
    ...
    depends_on("r-lifecycle", when="@2.0.2:", type=("build", "run"))
    depends_on("r-rlang", when="@0.2.0:", type=("build", "run"))
    depends_on("r-rlang@0.4.0:", when="@1:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@2.0.2:", type=("build", "run"))
