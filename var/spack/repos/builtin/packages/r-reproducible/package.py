...
class RReproducible(RPackage):
    ...
    depends_on("r@3.6:", when="@1.2.8:", type=("build", "run"))
    depends_on("r@4.0:", when="@1.2.10:", type=("build", "run"))
    depends_on("r-data-table@1.10.4:", type=("build", "run"))
    depends_on("r-dbi", type=("build", "run"))
    depends_on("r-digest", type=("build", "run"))
    depends_on("r-fpcompare", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-lobstr", when="@1.2.10:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-raster", type=("build", "run"))
    depends_on("r-raster@3.5-15:", when="@1.2.10:", type=("build", "run"))
    depends_on("r-rsqlite", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-sp@1.4-2:", type=("build", "run"))
    depends_on("unrar", type=("build", "run"))

    depends_on("r-gdalutilities", when="@1.2.8", type=("build", "run"))
    depends_on("r-require", when="@:1.2.10", type=("build", "run"))
