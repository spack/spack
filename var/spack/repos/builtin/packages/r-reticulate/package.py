...
class RReticulate(RPackage):
    ...
    depends_on("r-rcpptoml", when="@1.23:", type=("build", "run", "link"))
    depends_on("r-here", when="@1.23:", type=("build", "run", "link"))
    depends_on("r-jsonlite", type=("build", "run"))
    depends_on("r-png", when="@1.23:", type=("build", "run", "link"))
    depends_on("r-rappdirs", when="@1.15:", type=("build", "run"))
    depends_on("r-withr", when="@1.23:", type=("build", "run", "link"))
