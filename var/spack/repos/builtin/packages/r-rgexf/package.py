...
class RRgexf(RPackage):
    ...
    url      = "https://cran.r-project.org/src/contrib/rgexf_0.15.3.tar.gz"
    list_url = "https://cran.r-project.org/src/contrib/Archive/rgexf"

    version('0.15.3', '3e696b1228e222cc8fa3e15e5da0212f')
