...
class RRmarkdown(RPackage):
    ...
    depends_on("r-bslib@0.2.5.1:", when="@2.14:", type=("build", "run"))
    depends_on("r-evaluate@0.13:", type=("build", "run"))
    depends_on("r-fontawesome@0.5.0:", when="@2.21:", type=("build", "run"))
    depends_on("r-htmltools@0.3.5:", type=("build", "run"))
    depends_on("r-htmltools@0.5.1:", when="@2.16:", type=("build", "run"))
    ...
    depends_on("r-xfun@0.30:", when="@2.14:", type=("build", "run"))
    depends_on("r-xfun@0.36:", when="@2.21:", type=("build", "run"))
