...
class RRms(RPackage):
    ...
    version(
        "6.1-0",
        sha256="b89ec3b9211a093bfe83a2a8107989b5ce3b7b7c323b88a5d887d99753289f52",
    )
    version(
        "5.1-4",
        sha256="38f5844c4944a95b2adebea6bb1d163111270b8662399ea0349c45c0758076a6",
    )
    version(
        "5.1-3.1",
    ...
    version(
        "5.1-3",
        sha256="5fc7120d8a93b4aa9727d82eac368c5c47ff70f467ae2b012afac688235089eb",
    )
    version(
        "5.1-2",
        sha256="f1cfeef466ac436105756679353a3468027d97a600e3be755b819aef30ed9207",
    )
    version(
        "5.1-1",
