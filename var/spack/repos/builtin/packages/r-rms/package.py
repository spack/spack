...
class RRms(RPackage):
    ...
    depends_on("r-hmisc@4.7-0:", when="@6.3-0:", type=("build", "run"))
    depends_on("r-hmisc@4.8-0:", when="@6.6-0:", type=("build", "run"))
    ...
    depends_on("r-knitr", when="@6.6-0:", type=("build", "run"))
    depends_on("r-kableextra", when="@6.6-0:", type=("build", "run"))
    depends_on("r-colorspace", when="@6.6-0:", type=("build", "run"))
    depends_on("r-lattice", when="@:6.3-0", type=("build", "run"))
