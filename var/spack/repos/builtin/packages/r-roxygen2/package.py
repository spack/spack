...
class RRoxygen2(RPackage):
    ...
    depends_on("r@3.3:", when="@7.1.2:", type=("build", "run"))
    depends_on("r-brew", type=("build", "run"))
    depends_on("r-cli@3.3.0:", when="@7.2.0:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.0:", when="@7.2.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.6:", when="@7.2.3:", type=("build", "run"))
    depends_on("r-stringi", type=("build", "run"))
    depends_on("r-stringr@1.0.0:", type=("build", "run"))
    depends_on("r-withr", when="@7.2.0:", type=("build", "run"))
    depends_on("r-xml2", type=("build", "run"))
    depends_on("r-cpp11", when="@7.1.2:", type=("build", "run"))

    depends_on("r-rcpp@0.11.0:", when="@:7.1.1", type=("build", "run"))
    depends_on("r-digest", when="@:7.2.1", type=("build", "run"))
