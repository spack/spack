...
class RRsqlite(RPackage):
    ...
    depends_on("r-dbi@1.1.0:", when="@2.2.10:", type=("build", "run"))
    depends_on("r-memoise", type=("build", "run"))
    depends_on("r-pkgconfig", type=("build", "run"))
    depends_on("r-plogr@0.2.0:", type=("build", "run"))
    depends_on("r-cpp11@0.4.0:", when="@2.3.1:", type=("build", "run"))

    depends_on("r-bh", when="@:2.2.2", type=("build", "run"))
    depends_on("r-rcpp@0.12.7:", when="@:2.2.18", type=("build", "run"))
    depends_on("r-rcpp@1.0.7:", when="@2.2.9:2.2.18", type=("build", "run"))
