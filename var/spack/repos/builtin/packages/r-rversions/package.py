...
class RRversions(RPackage):
    ...
    version(
        "2.0.2",
        sha256="3523f4b7393365341d429500b01ba3a224056e89d134635b81dfb4918ba2173e",
    )
    version(
        "2.0.1",
        sha256="51ec1f64e7d628e88d716a020d5d521eba71d472e3c9ae7b694428ef6dd786c5",
    )
    version(
        "2.0.0",
        sha256="b50c321d9e973284ae6b1d0c89bd46a40f5174de51fb28e3c77cd12ef34f6f56",
    )
    version(
        "1.1.0",
    ...
    version(
        "1.0.2",
        sha256="c8ec8e24524cc42893e445e01e1a65d15889d28959877cd6b3c5e5f08221b176",
    )
    version(
        "1.0.1",
        sha256="9099d37d2f6cc1cab0cd0fdddfb9657c7bd3651226810b496e2808f458c80ae3",
    )
    version(
        "1.0.0",
        sha256="ce1e5368ff1d15665ca2db700521a96cf44f0e78daaab68aabbdaf7ed7393b4d",
    )
