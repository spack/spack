...
class RRvest(RPackage):
    ...
    depends_on("r-cli", when="@1.0.3:", type=("build", "run"))
    depends_on("r-glue", when="@1.0.3:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.0:", when="@1.0.3:", type=("build", "run"))
    ...
    depends_on("r-withr", when="@1.0.3:", type=("build", "run"))
