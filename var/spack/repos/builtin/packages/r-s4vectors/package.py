...
class RS4vectors(RPackage):
    ...
    version('0.22.0', commit='0787f5b3c915841621d5cac622ad878bf93c219a')
    ...
    depends_on('r@3.6.0:3.6.9', when='@0.22.0', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@0.20.1', type=('build', 'run'))
    ...
    depends_on('r-biocgenerics@0.21.1:', when='@0.14.7:', type=('build', 'run'))
