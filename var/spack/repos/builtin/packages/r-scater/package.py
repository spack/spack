...
class RScater(RPackage):
    ...
    depends_on('r-data-table', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-dplyr', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-edger', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-ggbeeswarm', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-ggplot2', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-limma', when='@1.4.0:', type=('build', 'run'))
    ...
    depends_on('r-shiny', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-shinydashboard', when='@1.4.0:', type=('build', 'run'))
    depends_on('r-tximport', when='@1.4.0:', type=('build', 'run'))
