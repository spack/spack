...
class RScater(RPackage):
    ...
    depends_on("r-rtsne", when="@1.22.0:", type=("build", "run"))
    depends_on("r-rcolorbrewer", when="@1.22.0:", type=("build", "run"))
    depends_on("r-rcppml", when="@1.24.0:", type=("build", "run"))
    depends_on("r-ggrastr", when="@1.26.0:", type=("build", "run"))
    depends_on("r-pheatmap", when="@1.26.0:", type=("build", "run"))
    depends_on("r-uwot", when="@1.26.0:", type=("build", "run"))
    depends_on("r-ggrepel", when="@1.22.0:", type=("build", "run"))
    depends_on("r-densvis", when="@1.28.0:", type=("build", "run"))
    ...
    depends_on("r-gridextra", when="@1.18.3:1.26.0", type=("build", "run"))
