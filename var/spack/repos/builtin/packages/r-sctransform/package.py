...
class RSctransform(RPackage):
    ...
    depends_on("r@3.5.0:", when="@0.3.3:", type=("build", "run"))
    depends_on("r-dplyr", when="@0.3.3:", type=("build", "run"))
    depends_on("r-magrittr", when="@0.3.3:", type=("build", "run"))
    depends_on("r-mass", type=("build", "run"))
    depends_on("r-matrix", type=("build", "run"))
    depends_on("r-matrix@1.5-0:", when="@0.3.5:", type=("build", "run"))
    depends_on("r-future-apply", type=("build", "run"))
    depends_on("r-future", type=("build", "run"))
    depends_on("r-ggplot2", type=("build", "run"))
    depends_on("r-reshape2", type=("build", "run"))
    depends_on("r-rlang", when="@0.3.3:", type=("build", "run"))
