...
class RSeuratobject(RPackage):
    ...
    depends_on("r-future", when="@4.1.0:", type=("build", "run"))
    depends_on("r-future-apply", when="@4.1.0:", type=("build", "run"))
    depends_on("r-matrix@1.3-3:", type=("build", "run"))
    depends_on("r-matrix@1.5-0:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-progressr", when="@4.1.0:", type=("build", "run"))
    depends_on("r-rcpp@1.0.5:", type=("build", "run"))
    depends_on("r-sp", when="@4.1.0:", type=("build", "run"))
    depends_on("r-sp@1.5-0:", when="@4.1.2:", type=("build", "run"))
    depends_on("r-rlang@0.4.7:", type=("build", "run"))
    depends_on("r-rcppeigen", type=("build", "run"))

    depends_on("r-rgeos", when="@4.1.0:4.1.2", type=("build", "run"))
