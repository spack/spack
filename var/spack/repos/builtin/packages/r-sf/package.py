...
class RSf(RPackage):
    ...
    depends_on("r-s2@1.0.7:", when="@1.0-5:", type=("build", "run"))
    depends_on("r-s2@1.1.0:", when="@1.0-9:", type=("build", "run"))
    depends_on("r-units", type=("build", "run"))
    depends_on("r-units@0.6-0:", when="@1.0-5:", type=("build", "run"))
    depends_on("r-units@0.7-0:", when="@1.0-8:", type=("build", "run"))
