...
class RShiny(RPackage):
    ...
    depends_on("r-fontawesome@0.2.1:", when="@1.7.1:", type=("build", "run"))
    depends_on("r-fontawesome@0.4.0:", when="@1.7.3:", type=("build", "run"))
    depends_on("r-htmltools@0.3.6:", type=("build", "run"))
    depends_on("r-htmltools@0.4.0.9003:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-htmltools@0.5.2:", when="@1.7.1:", type=("build", "run"))
    depends_on("r-htmltools@0.5.4:", when="@1.7.4:", type=("build", "run"))
    ...
    depends_on("r-rlang@0.4.10:", when="@1.7.1:", type=("build", "run"))
    depends_on("r-fastmap@1.0.0:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-fastmap@1.1.0:", when="@1.7.1:", type=("build", "run"))
    ...
    depends_on("r-bslib@0.3.0:", when="@1.7.1:", type=("build", "run"))
    depends_on("r-cachem", when="@1.7.1:", type=("build", "run"))
    depends_on("r-ellipsis", when="@1.7.1:", type=("build", "run"))
    depends_on("r-lifecycle@0.2.0:", when="@1.7.1:", type=("build", "run"))

    depends_on("r-digest", when="@:1.5.0", type=("build", "run"))
