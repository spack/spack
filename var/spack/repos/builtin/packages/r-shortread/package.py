...
class RShortread(RPackage):
    ...
    depends_on('r-biostrings@2.37.1:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-genomeinfodb@1.1.19:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-genomicalignments@1.5.4:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-genomicranges@1.21.6:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-hwriter', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-iranges@2.3.7:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-lattice', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-latticeextra', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-rsamtools@1.21.4:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-s4vectors@0.13.8:', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-xvector', when='@1.34.2:', type=('build', 'run'))
    depends_on('r-zlibbioc', when='@1.34.2:', type=('build', 'run'))
