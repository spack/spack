...
class RSmoof(RPackage):
    ...
    depends_on("r-mco", when="@:1.6.0.2", type=("build", "run"))
    depends_on("r-plot3d", when="@:1.6.0.2", type=("build", "run"))
    depends_on("r-plotly", when="@:1.6.0.2", type=("build", "run"))
    depends_on("r-rcolorbrewer", when="@:1.6.0.2", type=("build", "run"))
    depends_on("r-rjsonio", when="@:1.6.0.2", type=("build", "run"))
