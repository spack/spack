...
class RSomaticsignatures(RPackage):
    ...
    depends_on('r-genomicranges', when='@2.12.1:', type=('build', 'run'))
    depends_on('r-ggbio', when='@2.12.1:', type=('build', 'run'))
    depends_on('r-ggplot2', when='@2.12.1:', type=('build', 'run'))
    depends_on('r-iranges', when='@2.12.1:', type=('build', 'run'))
