...
class RSpadesCore(RPackage):
    ...
    depends_on("r@4.0:", when="@1.0.10:", type=("build", "run"))
    depends_on("r-quickplot@0.1.4:", type=("build", "run"))
    depends_on("r-reproducible@1.2.1.9007:", type=("build", "run"))
    depends_on("r-reproducible@1.2.7:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-reproducible@1.2.9:", when="@1.1.0:", type=("build", "run"))
    depends_on("r-crayon", type=("build", "run"))
    depends_on("r-data-table@1.10.4:", type=("build", "run"))
    depends_on("r-data-table@1.11.0:", when="@1.0.9:", type=("build", "run"))
    depends_on("r-fastdigest", type=("build", "run"))
    depends_on("r-igraph@1.0.1:", type=("build", "run"))
    depends_on("r-lobstr", when="@1.1.0:", type=("build", "run"))
