...
class RSpadesTools(RPackage):
    ...
    depends_on("r@3.6:", when="@0.3.9:", type=("build", "run"))
    depends_on("r@4.0:", when="@0.3.10:", type=("build", "run"))
    ...
    depends_on("r-require", when="@0.3.10:", type=("build", "run"))
    depends_on("r-rgeos", type=("build", "run"))
    depends_on("r-sp@1.2-4:", type=("build", "run"))

    depends_on("r-reproducible@0.2.0:", when="@:0.3.6", type=("build", "run"))
    depends_on("r-reproducible@1.2.7:", when="@0.3.9", type=("build", "run"))
