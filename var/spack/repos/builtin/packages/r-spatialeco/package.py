...
class RSpatialeco(RPackage):
    ...
    depends_on("r@4.0:", when="@1.3-7:", type=("build", "run"))
    depends_on("r-sf", type=("build", "run"))
    depends_on("r-spatstat-explore", when="@2.0-0:", type=("build", "run"))
    depends_on("r-terra", when="@2.0-0:", type=("build", "run"))
    depends_on("r-spatstat-geom", when="@1.3-7:", type=("build", "run"))
    depends_on("r-spatstat-geom@3.0-3:", when="@2.0-0:", type=("build", "run"))
    ...
    depends_on("r-ks", when="@2.0-0:", type=("build", "run"))
    ...
    depends_on("r-spatstat", when="@:1.3-5", type=("build", "run"))
    depends_on("r-raster", when="@:1.3-7", type=("build", "run"))
    depends_on("r-rgeos", when="@:1.3-7", type=("build", "run"))
    depends_on("r-sp", when="@:1.3-7", type=("build", "run"))
    depends_on("r-spatstat-core", when="@1.3-7:1.3-7", type=("build", "run"))
