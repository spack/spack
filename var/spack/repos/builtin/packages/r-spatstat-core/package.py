...
class RSpatstatCore(RPackage):
    ...
    depends_on("r-spatstat-geom@2.4-0:", when="@2.4-4:", type=("build", "run"))
    depends_on("r-spatstat-random@2.2-0:", when="@2.4-4:", type=("build", "run"))
    depends_on("r-nlme", type=("build", "run"))
    depends_on("r-rpart", type=("build", "run"))
    depends_on("r-spatstat-utils@2.2-0:", type=("build", "run"))
    depends_on("r-spatstat-utils@2.3.1:", when="@2.4-4:", type=("build", "run"))
