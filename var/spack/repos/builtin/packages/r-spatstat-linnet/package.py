...
class RSpatstatLinnet(RPackage):
    ...
    depends_on("r-spatstat-model@3.2-1:", when="@3.1-0:", type=("build", "run"))
    depends_on("r-spatstat-explore@3.0-6:", when="@3.1-0:", type=("build", "run"))
    depends_on("r-spatstat-data@2.1-0:", type=("build", "run"))
    depends_on("r-spatstat-data@3.0:", when="@3.1-0:", type=("build", "run"))
    depends_on("r-spatstat-geom@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-geom@3.0-6:", when="@3.1-0:", type=("build", "run"))
    depends_on("r-spatstat-random@2.2-0:", when="@2.3-2:", type=("build", "run"))
    depends_on("r-spatstat-random@3.1-3:", when="@3.1-0:", type=("build", "run"))
    ...
    depends_on("r-spatstat-sparse@3.0:", when="@3.1-0:", type=("build", "run"))
    depends_on("r-spatstat-core@2.3-2:", when="@2.3-2:2.3-2", type=("build", "run"))
