...
class RSpatstatRandom(RPackage):
    ...
    depends_on("r-spatstat-data@2.2-0.003:", when="@3.0-1:", type=("build", "run"))
    depends_on("r-spatstat-data@3.0:", when="@3.1-4:", type=("build", "run"))
    depends_on("r-spatstat-geom@2.4-0:", type=("build", "run"))
    depends_on("r-spatstat-geom@2.4-0.023:", when="@3.0-1:", type=("build", "run"))
    depends_on("r-spatstat-geom@3.0-5:", when="@3.1-4:", type=("build", "run"))
    depends_on("r-spatstat-utils@2.2-0:", type=("build", "run"))
    depends_on("r-spatstat-utils@2.3-1.003:", when="@3.0-1:", type=("build", "run"))
    depends_on("r-spatstat-utils@3.0-2:", when="@3.1-4:", type=("build", "run"))
