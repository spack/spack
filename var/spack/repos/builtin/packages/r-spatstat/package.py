...
class RSpatstat(RPackage):
    ...
    depends_on("r@3.5.0:", when="@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-model@3.2-3:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-explore@3.1-0:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-data@1.4-2:", type=("build", "run"))
    depends_on("r-spatstat-data@2.1-0:", when="@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-data@2.1-2:", when="@2.3-4:", type=("build", "run"))
    depends_on("r-spatstat-data@3.0-1:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-geom@2.3-0:", when="@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-geom@2.4-0:", when="@2.3-4:", type=("build", "run"))
    depends_on("r-spatstat-geom@3.1-0:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-random@2.2-0:", when="@2.3-4:", type=("build", "run"))
    depends_on("r-spatstat-random@3.1-4:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-linnet@2.3-0:", when="@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-linnet@2.3-2:", when="@2.3-4:", type=("build", "run"))
    depends_on("r-spatstat-linnet@3.1-0:", when="@3.0-5:", type=("build", "run"))
    depends_on("r-spatstat-utils@1.17:", type=("build", "run"))
    depends_on("r-spatstat-utils@2.2-0:", when="@2.3-0:", type=("build", "run"))
    depends_on("r-spatstat-utils@2.3-0:", when="@2.3-4:", type=("build", "run"))
    depends_on("r-spatstat-utils@3.0-2:", when="@3.0-5:", type=("build", "run"))

    depends_on("r-rpart", when="@:1.64-1", type=("build", "run"))
    depends_on("r-nlme", when="@:1.64-1", type=("build", "run"))
    depends_on("r-mgcv", when="@:1.64-1", type=("build", "run"))
    depends_on("r-matrix", when="@:1.64-1", type=("build", "run"))
    depends_on("r-deldir@0.0-21:", when="@:1.64-1", type=("build", "run"))
    depends_on("r-abind", when="@:1.64-1", type=("build", "run"))
    depends_on("r-tensor", when="@:1.64-1", type=("build", "run"))
    depends_on("r-polyclip@1.10:", when="@:1.64-1", type=("build", "run"))
    depends_on("r-goftest@1.2-2:", when="@:1.64-1", type=("build", "run"))
    depends_on("r-spatstat-core@2.3-0:", when="@2.3-0:2.3-4", type=("build", "run"))
    depends_on("r-spatstat-core@2.4-1:", when="@2.3-4:2.3-4", type=("build", "run"))
