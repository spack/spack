...
class RSpdep(RPackage):
    ...
    depends_on("r-units", when="@1.2-1:", type=("build", "run"))
    depends_on("r-s2", when="@1.2-1:", type=("build", "run"))
    depends_on("r-e1071", when="@1.2-1:", type=("build", "run"))

    depends_on("r-matrix", when="@:1.1-5", type=("build", "run"))
    depends_on("r-learnbayes", when="@:1.1-5", type=("build", "run"))
    depends_on("r-mass", when="@:1.1-5", type=("build", "run"))
    depends_on("r-coda", when="@:1.1-5", type=("build", "run"))
    depends_on("r-expm", when="@:1.1-5", type=("build", "run"))
    depends_on("r-gmodels", when="@:1.1-5", type=("build", "run"))
    depends_on("r-nlme", when="@:1.1-5", type=("build", "run"))
