...
class RStringr(RPackage):
    ...
    depends_on("r@3.3:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-cli", when="@1.5.0:", type=("build", "run"))
    depends_on("r-stringi@1.1.7:", type=("build", "run"))
    depends_on("r-stringi@1.5.3:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-vctrs", when="@1.5.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@1.5.0:", type=("build", "run"))
    depends_on("r-glue@1.2.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-glue@1.6.1:", when="@1.5.0:", type=("build", "run"))
