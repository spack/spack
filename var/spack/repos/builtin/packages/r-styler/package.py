...
class RStyler(RPackage):
    ...
    depends_on("r@3.4.0:", when="@1.7.0:", type=("build", "run"))
    depends_on("r@3.5.0:", when="@1.8.0:", type=("build", "run"))
    depends_on("r-cli@1.1.0:", type=("build", "run"))
    depends_on("r-cli@3.1.1:", when="@1.7.0:", type=("build", "run"))
    depends_on("r-magrittr@1.0.1:", type=("build", "run"))
    depends_on("r-magrittr@2.0.0:", when="@1.6.2:", type=("build", "run"))
    depends_on("r-purrr@0.2.3:", type=("build", "run"))
    depends_on("r-r-cache@0.14.0:", type=("build", "run"))
    depends_on("r-r-cache@0.15.0:", when="@1.6.2:", type=("build", "run"))
    depends_on("r-rlang@0.1.1:", type=("build", "run"))
    depends_on("r-rprojroot@1.1:", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@1.8.0:", type=("build", "run"))
    depends_on("r-withr@1.0.0:", type=("build", "run"))
    depends_on("r-withr@2.3.0:", when="@1.8.1:", type=("build", "run"))

    depends_on("r-backports@1.1.0:", when="@:1.6.2", type=("build", "run"))
    depends_on("r-xfun@0.1:", when="@:1.6.2", type=("build", "run"))
    depends_on("r-glue", when="@1.6.2:1.7.0", type=("build", "run"))
    depends_on("r-rematch2@2.0.1:", when="@:1.7.0", type=("build", "run"))
    depends_on("r-tibble@1.4.2:", when="@:1.7.0", type=("build", "run"))
