...
class RSummarizedexperiment(RPackage):
    ...
    depends_on("r@4.0.0:", when="@1.24.0:", type=("build", "run"))
    ...
    depends_on("r-biocgenerics@0.37.0:", when="@1.24.0:", type=("build", "run"))
    ...
    depends_on("r-s4vectors@0.33.7:", when="@1.26.1:", type=("build", "run"))
