...
class RSurvival(RPackage):
    ...
    version(
        "3.2-7",
        sha256="5356cd73da7ecfda4042e8a8ae00d3531b106f7b39ca31a1843eadf288418a46",
    )
    version(
        "3.1-12",
        sha256="b62ed66eb646f3df13f7e9bf6571e3bfecae128c66491e174c8833cbef1bf21f",
    )
    version(
        "2.44-1.1",
    ...
    version(
        "2.44-1",
        sha256="82c44afa41fe4504295855f1da4a5940c3289dfd61bc664bf211bb67c051a909",
    )
    version(
        "2.41-3",
    ...
    version(
        "2.39-5",
        sha256="607170ebe36080d102e884cf13c3b29df01d6bb3b593258afffa67fee2a0ada7",
    )
