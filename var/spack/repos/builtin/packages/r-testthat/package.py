...
class RTestthat(RPackage):
    ...
    depends_on("r-cli@3.3.0:", when="@3.1.4:", type=("build", "run"))
    depends_on("r-cli@3.4.0:", when="@3.1.5:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.1:", when="@3.1.4:", type=("build", "run"))
    depends_on("r-waldo@0.2.1:", when="@3.0.1:", type=("build", "run"))
    depends_on("r-waldo@0.2.4:", when="@3.1.1:", type=("build", "run"))
    depends_on("r-waldo@0.4.0:", when="@3.1.4:", type=("build", "run"))
    depends_on("r-withr@2.0.0:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-withr@2.3.0:", when="@3.0.1:", type=("build", "run"))
    depends_on("r-withr@2.4.3:", when="@3.1.2:", type=("build", "run"))

    depends_on("r-crayon@1.3.4:", when="@:3.1.4", type=("build", "run"))
