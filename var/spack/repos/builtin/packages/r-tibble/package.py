...
class RTibble(RPackage):
    ...
    depends_on("r@3.4.0:", when="@3.2.1:", type=("build", "run"))
    ...
    depends_on("r-pillar@1.6.0:", when="@3.1.0:", type=("build", "run"))
    depends_on("r-pillar@1.6.2:", when="@3.1.4:", type=("build", "run"))
    depends_on("r-pillar@1.7.0:", when="@3.1.7:", type=("build", "run"))
    depends_on("r-pillar@1.8.1:", when="@3.2.1:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.1:", when="@3.1.7:", type=("build", "run"))
    depends_on("r-rlang@1.0.2:", when="@3.1.8:", type=("build", "run"))
    depends_on("r-vctrs@0.3.2:", when="@3.0.5:", type=("build", "run"))
    depends_on("r-vctrs@0.3.8:", when="@3.1.2:", type=("build", "run"))
    depends_on("r-vctrs@0.4.2:", when="@3.2.1:", type=("build", "run"))
    ...
    depends_on("r-ellipsis@0.2.0:", when="@3.0.5:3.1.7", type=("build", "run"))
    depends_on("r-ellipsis@0.3.2:", when="@3.1.2:3.1.7", type=("build", "run"))
