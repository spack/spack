...
class RTibble(RPackage):
    ...
    version(
        "3.1.5",
        sha256="da6387ba683a67cd7fc2a111f6b62468e480a8078bc1867d433a40c5460edbe7",
    )
    version(
        "3.0.5",
        sha256="1cc92d7bf5ecf8291718682fb7fcb96f6f87751f1ed101a7441cad5120195190",
    )
    version(
        "2.1.3",
    ...
    version(
        "2.0.1",
        sha256="7ab2cc295eecf00a5310993c99853cd6622ad468e7a60d004b8a73957a713d13",
    )
    version(
        "2.0.0",
        sha256="05ad2d62e949909548c4bb8ac596810321f11b330afa9717d0889dc35edd99ba",
    )
    version(
        "1.4.2",
    ...
    version(
        "1.4.1",
        sha256="32267fae1ca86abdd37c4683f9d2b1a47b8b65e1977ea3900aa197066c57aa29",
    )
    version(
        "1.3.4",
