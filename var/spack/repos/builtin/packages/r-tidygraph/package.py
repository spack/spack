...
class RTidygraph(RPackage):
    ...
    depends_on("r-igraph@1.3.0:", when="@1.2.3:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-r6", type=("build", "run"))
    depends_on("r-tidyr", type=("build", "run"))
    depends_on("r-pillar", type=("build", "run"))
    depends_on("r-cli", when="@1.2.1:", type=("build", "run"))
    depends_on("r-cpp11", when="@1.2.1:", type=("build", "run"))

    depends_on("r-rcpp", when="@:1.2.0", type=("build", "run"))
