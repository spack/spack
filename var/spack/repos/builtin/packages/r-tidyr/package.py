...
class RTidyr(RPackage):
    ...
    depends_on("r-dplyr@1.0.0:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-dplyr@1.0.10:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-lifecycle", when="@1.1.2:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-magrittr", type=("build", "run"))
    depends_on("r-stringr@1.5.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-purrr", type=("build", "run"))
    depends_on("r-purrr@1.0.1:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-rlang@1.0.4:", when="@1.3.0:", type=("build", "run"))
    ...
    depends_on("r-tidyselect@1.2.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-vctrs@0.3.0:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-vctrs@0.3.6:", when="@1.1.3:", type=("build", "run"))
    depends_on("r-vctrs@0.3.7:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-vctrs@0.5.2:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-cpp11@0.2.1:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-cpp11@0.2.6:", when="@1.1.3:", type=("build", "run"))
    depends_on("r-cpp11@0.4.0:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-cli@3.4.1:", when="@1.3.0:", type=("build", "run"))

    depends_on("r-stringi", when="@:0.8.3", type=("build", "run"))
    depends_on("r-rcpp", when="@:0.8.3", type=("build", "run"))
    depends_on("r-ellipsis@0.1.0:", when="@1.1.2:1.2.1", type=("build", "run"))
