...
class RTidyselect(RPackage):
    ...
    depends_on("r@3.4:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-glue@1.3.0:", type=("build", "run"))
    depends_on("r-withr", when="@1.2.0:", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-rlang@0.2.2:", type=("build", "run"))
    depends_on("r-rlang@0.4.6:", when="@1.1.0:", type=("build", "run"))
    depends_on("r-rlang@1.0.1:", when="@1.1.2:", type=("build", "run"))
    depends_on("r-rlang@1.0.4:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-vctrs@0.2.2:", when="@1.1.0:", type=("build", "run"))
    depends_on("r-vctrs@0.3.0:", when="@1.1.1:", type=("build", "run"))
    depends_on("r-vctrs@0.4.1:", when="@1.2.0:", type=("build", "run"))

    depends_on("r-rcpp@0.12.0:", when="@:0.2.5", type=("build", "run"))
    depends_on("r-cli@3.3.0:", when="@1.2.0:", type=("build", "run"))
    depends_on("r-ellipsis", when="@1.1.0:1.1.2", type=("build", "run"))

    depends_on("r-purrr", type=("build", "run"))
    depends_on("r-purrr@0.3.2:", when="@1.1.0:1.1.2", type=("build", "run"))
