...
class RTidyverse(RPackage):
    ...
    depends_on("r-conflicted@1.2.0:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-broom@0.7.10:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-broom@1.0.3:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-cli@3.1.0:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-cli@3.6.0:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-dbplyr@2.3.0:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-dplyr@1.0.7:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-dplyr@1.1.0:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-dtplyr@1.1.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-dtplyr@1.2.0:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-dtplyr@1.2.2:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-forcats@1.0.0:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-googledrive@1.0.1:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-googledrive@2.0.0:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-ragg@1.2.5:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-googlesheets4@0.3.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-googlesheets4@1.0.0:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-googlesheets4@1.0.1:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-ggplot2@2.2.1:", type=("build", "run"))
    depends_on("r-ggplot2@3.2.1:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-ggplot2@3.3.3:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-ggplot2@3.3.5:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-ggplot2@3.4.1:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-haven@2.4.3:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-haven@2.5.1:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-hms@1.1.1:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-hms@1.1.2:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-httr@1.4.4:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-jsonlite@1.8.4:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-lubridate@1.8.0:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-lubridate@1.9.2:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-magrittr@1.5:", type=("build", "run"))
    depends_on("r-magrittr@2.0.1:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-magrittr@2.0.3:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-modelr@0.1.10:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-pillar@1.4.2:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-pillar@1.6.0:", when="@1.3.1:", type=("build", "run"))
    depends_on("r-pillar@1.6.4:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-pillar@1.8.1:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-purrr@1.0.1:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-readr@2.1.1:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-readr@2.1.4:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-readxl@1.0.0:", type=("build", "run"))
    depends_on("r-readxl@1.3.1:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-readxl@1.4.2:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-reprex@2.0.1:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-reprex@2.0.2:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-rlang@0.4.12:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-rlang@1.0.6:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-rstudioapi@0.14:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-rvest@1.0.2:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-rvest@1.0.3:", when="@2.0.0:", type=("build", "run"))
    depends_on("r-stringr@1.2.0:", type=("build", "run"))
    depends_on("r-stringr@1.4.0:", when="@1.3.0:", type=("build", "run"))
    depends_on("r-stringr@1.5.0:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-tibble@3.1.6:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-tibble@3.1.8:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-tidyr@1.1.4:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-tidyr@1.3.0:", when="@2.0.0:", type=("build", "run"))
    ...
    depends_on("r-xml2@1.3.3:", when="@1.3.2:", type=("build", "run"))
    depends_on("r-crayon@1.4.1:", when="@1.3.1:1.3.2", type=("build", "run"))
    depends_on("r-crayon@1.4.2:", when="@1.3.2:1.3.2", type=("build", "run"))
