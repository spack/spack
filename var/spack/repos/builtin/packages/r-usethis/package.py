...
class RUsethis(RPackage):
    ...
    depends_on("r-gh@1.2.1:", when="@2.1.5:", type=("build", "run"))
    ...
    depends_on("r-lifecycle@1.0.0:", when="@2.1.5:", type=("build", "run"))
    depends_on("r-purrr", type=("build", "run"))
    depends_on("r-rappdirs", when="@2.0.0:", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-rlang@0.4.3:", when="@1.6.1:", type=("build", "run"))
    depends_on("r-rlang@0.4.10:", when="@2.1.5:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@2.1.6:", type=("build", "run"))
