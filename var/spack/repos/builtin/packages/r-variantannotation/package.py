...
class RVariantannotation(RPackage):
    ...
    depends_on('r-biostrings@2.33.5:', when='@1.22.3:', type=('build', 'run'))
    depends_on('r-bsgenome@1.37.6:', when='@1.22.3:', type=('build', 'run'))
    depends_on('r-dbi', when='@1.22.3:', type=('build', 'run'))
    depends_on('r-genomeinfodb@1.11.4:', when='@1.22.3:', type=('build', 'run'))
    ...
    depends_on('r-summarizedexperiment@1.5.3:', when='@1.22.3:', type=('build', 'run'))
    depends_on('r-xvector@0.5.6:', when='@1.22.3:', type=('build', 'run'))
    depends_on('r-zlibbioc', when='@1.22.3:', type=('build', 'run'))
