...
class RVariantannotation(RPackage):
    ...
    depends_on("r@4.0.0:", when="@1.40.0:", type=("build", "run"))
    depends_on("r-biocgenerics@0.15.3:", type=("build", "run"))
    depends_on("r-biocgenerics@0.37.0:", when="@1.40.0:", type=("build", "run"))
    ...
    depends_on("r-rhtslib@1.99.3:", when="@1.44.0:", type=("build", "run"))
