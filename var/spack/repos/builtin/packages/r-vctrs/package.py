...
class RVctrs(RPackage):
    ...
    depends_on("r-cli@3.2.0:", when="@0.4.1:", type=("build", "run"))
    depends_on("r-cli@3.4.0:", when="@0.5.0:", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-lifecycle@1.0.3:", when="@0.5.0:", type=("build", "run"))
    ...
    depends_on("r-rlang@1.0.0:", when="@0.4.1:", type=("build", "run"))
    depends_on("r-rlang@1.0.2:", when="@0.4.2:", type=("build", "run"))
    depends_on("r-rlang@1.0.6:", when="@0.5.0:", type=("build", "run"))
    depends_on("r-rlang@1.1.0:", when="@0.6.2:", type=("build", "run"))

    depends_on("r-digest", when="@:0.3.6", type=("build", "run"))
    depends_on("r-zeallot", when="@:0.2.0", type=("build", "run"))
    depends_on("r-ellipsis@0.2.0:", when="@:0.3.8", type=("build", "run"))
