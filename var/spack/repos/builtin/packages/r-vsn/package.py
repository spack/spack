...
class RVsn(RPackage):
    ...
    depends_on('r@3.6.0:3.6.9', when='@3.52.0', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@3.50.0', type=('build', 'run'))
    depends_on('r@3.5.0:3.5.9', when='@3.48.1', type=('build', 'run'))
    depends_on('r@3.4.0:3.4.9', when='@3.46.0', type=('build', 'run'))
    depends_on('r@3.4.0:3.4.9', when='@3.44.0', type=('build', 'run'))

    depends_on('r-affy', when='@3.44.0:', type=('build', 'run'))
    depends_on('r-biobase', when='@3.44.0:', type=('build', 'run'))
    depends_on('r-ggplot2', when='@3.44.0:', type=('build', 'run'))
    depends_on('r-hexbin', when='@3.44.0:', type=('build', 'run'))
    depends_on('r-lattice', when='@3.44.0:', type=('build', 'run'))
    depends_on('r-limma', when='@3.44.0:', type=('build', 'run'))
