...
class RWaldo(RPackage):
    ...
    depends_on("r-diffobj@0.3.4:", when="@0.3.1:", type=("build", "run"))
    depends_on("r-fansi", type=("build", "run"))
    depends_on("r-glue", type=("build", "run"))
    depends_on("r-rematch2", type=("build", "run"))
    depends_on("r-rlang", type=("build", "run"))
    depends_on("r-rlang@0.4.10:", when="@0.3.1:", type=("build", "run"))
    depends_on("r-rlang@1.0.0:", when="@0.4.0:", type=("build", "run"))
