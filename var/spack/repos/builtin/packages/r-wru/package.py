...
class RWru(RPackage):
    ...
    depends_on("r@3.2.0:", when="@0.0-1:", type=("build", "run"))
    depends_on("r@3.5.0:", when="@0.0-10:", type=("build", "run"))
    depends_on("r@4.1.0:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-devtools", when="@0.0-2:0.1-12", type=("build", "run"))
    depends_on("r-devtools@1.10.0:", when="@0.1-1:0.1-12", type=("build", "run"))
    depends_on("r-dplyr", when="@1.0.0:", type=("build", "run"))
    depends_on("r-future", when="@1.0.0:", type=("build", "run"))
    depends_on("r-furrr", when="@1.0.0:", type=("build", "run"))
    depends_on("r-purrr", when="@1.0.0:", type=("build", "run"))
    depends_on("r-rcpp", when="@1.0.0:", type=("build", "run"))
    depends_on("r-rcpparmadillo", when="@1.0.0:", type=("build", "run"))
    depends_on("r-piggyback", when="@1.0.0:", type=("build", "run"))
    depends_on("r-piggyback@0.1.4:", when="@1.0.0:", type=("build", "run"))
    depends_on("r-pl94171", when="@1.0.0:", type=("build", "run"))
