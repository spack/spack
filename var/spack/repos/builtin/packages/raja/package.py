...
class Raja(CachedCMakePackage, CudaPackage, ROCmPackage):
    ...
    patch(
        "https://github.com/LLNL/RAJA/commit/eca1124ee4af380d6613adc6012c307d1fd4176b.patch",
    ...
    with when("+rocm @0.12.0:"):
        ...
        for arch in ROCmPackage.amdgpu_targets:
            depends_on(
                "camp+rocm amdgpu_target={0}".format(arch),
    ...
    def initconfig_package_entries(self):
        ...
        if spec.satisfies("@0.14.0:"):
            entries.append(
                cmake_cache_option("RAJA_ENABLE_EXERCISES", "+exercises" in spec)
            )
        else:
