...
class Re2c(AutotoolsPackage):
    ...
    version(
        "2.2", sha256="0fc45e4130a8a555d68e230d1795de0216dfe99096b61b28e67c86dfd7d86bda"
    )
    version(
        "2.1.1",
    ...
    version(
        "2.1", sha256="8cba0d95c246c670de8f97f57def83a9c0f2113eaa6f7e4867a941f48f633540"
    )
    version(
        "2.0.3",
    ...
    version(
        "2.0", sha256="89a9d7ee14be10e3779ea7b2c8ea4a964afce6e76b8dbcd5479940681db46d20"
    )
    version(
        "1.3", sha256="f37f25ff760e90088e7d03d1232002c2c2672646d5844fdf8e0d51a5cd75a503"
    )
    version(
        "1.2.1",
