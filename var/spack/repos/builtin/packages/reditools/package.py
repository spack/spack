...
class Reditools(PythonPackage):
    ...
    # Nature Protocol
    depends_on("bcftools", when="+nature_protocol", type="run")
    depends_on("bedtools2", when="+nature_protocol", type="run")
    depends_on("bwa", when="+nature_protocol", type="run")
    depends_on("bzip2", when="+nature_protocol", type="run")
    depends_on("fastp", when="+nature_protocol", type="run")
    depends_on("fastqc", when="+nature_protocol", type="run")
    depends_on("git", when="+nature_protocol", type="run")
    depends_on("gmap-gsnap", when="+nature_protocol", type="run")
    depends_on("htslib", when="+nature_protocol", type="run")
    depends_on("libdeflate", when="+nature_protocol", type="run")
    depends_on("py-bx-python", when="+nature_protocol", type="run")
    depends_on("py-rseqc", when="+nature_protocol", type="run")
    depends_on("samtools", when="+nature_protocol", type="run")
    depends_on("star", when="+nature_protocol", type="run")
    depends_on("wget", when="+nature_protocol", type="run")
