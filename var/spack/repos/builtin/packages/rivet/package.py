...
class Rivet(AutotoolsPackage):
    ...
    patch('rivet-1.8.2.patch', when='@1.8.2')
    patch('rivet-1.9.0.patch', when='@1.9.0')
    patch('rivet-2.2.0.patch', when='@2.2.0')
    patch('rivet-2.2.1.patch', when='@2.2.1')
    patch('rivet-2.4.0.patch', when='@2.4.0')
    patch('rivet-2.4.2.patch', when='@2.4.2')
    patch('rivet-2.4.3.patch', when='@2.4.3')
    patch('rivet-2.5.1.patch', when='@2.5.1')
    patch('rivet-2.5.2.patch', when='@2.5.2')
    patch('rivet-2.5.3.patch', when='@2.5.3')
    patch('rivet-2.5.4.patch', when='@2.5.4')
    patch('rivet-2.6.0.patch', when='@2.6.0')
    patch('rivet-2.6.1.patch', when='@2.6.1')
    patch('rivet-2.6.2.patch', when='@2.6.2')
    patch('rivet-2.7.0.patch', when='@2.7.0')
    patch('rivet-3.0.0.patch', when='@3.0.0')
