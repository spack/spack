...
class Rstudio(CMakePackage):
    ...
    depends_on('r-base64enc', when='+notebook')
    depends_on('r-digest', when='+notebook')
    depends_on('r-evaluate', when='+notebook')
    depends_on('r-glue', when='+notebook')
    depends_on('r-highr', when='+notebook')
    depends_on('r-htmltools', when='+notebook')
    depends_on('r-jsonlite', when='+notebook')
    depends_on('r-knitr', when='+notebook')
    depends_on('r-magrittr', when='+notebook')
    depends_on('r-markdown', when='+notebook')
    depends_on('r-mime', when='+notebook')
    depends_on('r-rmarkdown', when='+notebook')
    depends_on('r-stringi', when='+notebook')
    depends_on('r-stringr', when='+notebook')
    depends_on('r-tinytex', when='+notebook')
    depends_on('r-xfun', when='+notebook')
    depends_on('r-yaml', when='+notebook')
