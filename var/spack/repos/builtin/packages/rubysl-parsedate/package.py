...
class RubyslParsedate(RubyPackage):
    """Ruby standard library for date parsing."""

    homepage = "https://rubygems.org/gems/rubysl-parsedate"
    url      = "https://rubygems.org/downloads/rubysl-parsedate-1.0.1.gem"
