...
# Important feature: a version of salome-medcoupling depand on a specific version of salome-med package
...
class SalomeMedcoupling(CMakePackage):
    ...
    def setup_run_environment(self, env):
        env.prepend_path('PYTHONPATH', join_path(self.prefix.lib, 'python{0}'.format(self.spec['python'].version.up_to(2)), 'site-packages'))
    ...
    def cmake_args(self):
        ...
        options.extend([
            ...
            '-DMEDCOUPLING_ENABLE_RENUMBER=ON',
