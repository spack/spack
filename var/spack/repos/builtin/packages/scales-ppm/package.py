...
class ScalesPpm(AutotoolsPackage):
    ...
    version(
        "1.0.8",
        sha256="34cde7ce210eee4755ec0228d3f2d61542e94522e7a4eefdc5472ed3772f32f7",
        url="https://www.dkrz.de/redmine/attachments/download/517/ppm-1.0.8.tar.gz",
    )
    version(
        "1.0.7",
        sha256="e37bfa8a68a975b6de40c757a75ad05d4ff3b70dc21de8876daa259dbe8065cb",
        url="https://www.dkrz.de/redmine/attachments/download/509/ppm-1.0.7.tar.gz",
    )
    version(
        "1.0.6",
        sha256="fa45d75d4225f726985128727fe65a075096e7308557dfa05ca8f0ce13ebbda4",
        url="https://www.dkrz.de/redmine/attachments/download/500/ppm-1.0.6.tar.gz",
    )
    ...
    conflicts(
        "~fortran",
        when="@:1.0.7",
        msg="Fortran interface can be disabled " "only starting version 1.0.8",
    )
