...
class Seacas(CMakePackage):
    ...
    # TPLs (alphabet order)
    variant("adios2", default=False, description="Enable ADIOS2. See https://github.com/ornladios/ADIOS2")
    variant("cgns", default=True, description="Enable CGNS.")
    variant("faodel", default=False, description="Enable Faodel. See https://github.com/sandialabs/faodel")
    variant("matio", default=True, description="Compile with matio (MatLab) support.  Enables exo2mat and mat2exo translators.")
    variant("metis", default=False, description="Compile with METIS and ParMETIS. Provides additional parallel decomposition options.")
    variant("pamgen", default=False, description="Compile with pamgen. Provides another ioss database option for internal generation of mesh models.")
    variant("x11", default=True, description="Compile with X11. Needed if building blot (visualizer) and fastq (2D mesh generation).")
    variant("zlib", default=False, description="Compile with zlib. Sometimes needed when building static libraries on some systems.")
    # ###################### Dependencies ##########################
