...
class SifdecodeSrc(Package):
    """Build system (sort of) for GALAHAD and other optimization packages."""

    homepage = "http://ccpforge.cse.rl.ac.uk/gf/project/sifdecode/wiki"

    # Galahad has no valid versions.
    # This must be built with "spack spconfig" in a local repo
    version('1.00000', svn='http://ccpforge.cse.rl.ac.uk/svn/cutest/sifdecode/trunk/', revision=286)
