...
class Silo(AutotoolsPackage):
    ...
    depends_on("m4", when="+shared", type="build")
    depends_on("autoconf", when="+shared", type="build")
    depends_on("autoconf-archive", when="+shared", type="build")
    depends_on("automake", when="+shared", type="build")
    depends_on("libtool", when="+shared", type="build")
