...
class Simdjson(CMakePackage):
    """
    simdjson is an extremely fast JSON library that can parse gigabytes of JSON per second
    by leveraging commonly available SIMD instructions and microparallel algorithms.
    """
