...
class Singularity(MakefilePackage):
    '''SingularityCE is the Community Edition of Singularity, an open source
       container platform designed to be simple, fast, and secure. For older
       versions of Singularity, before fork (pre 3.8) you should use singularity.
    ...
    depends_on('shadow', type='run')
    depends_on('cryptsetup', type=('build', 'run'))
