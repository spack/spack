...
class Strumpack(CMakePackage, CudaPackage, ROCmPackage):
    ...
    version(
        "6.1.0",
        sha256="219ec7360594172464aafa6ecac1fd161097db6fb9ee35af5c1ca61531f4f5c4",
    )
    version(
        "6.0.0",
        sha256="fcea150b68172d5a4ec2c02f9cce0b7305919b86871c9cf34a9f65b1567d58b7",
    )
    version(
        "5.1.1",
        sha256="6cf4eaae5beb9bd377f2abce9e4da9fd3e95bf086ae2f04554fad6dd561c28b9",
    )
    version(
        "5.0.0",
        sha256="bdfd1620ff7158d96055059be04ee49466ebaca8213a2fdab33e2d4571019a49",
    )
    version(
        "4.0.0",
        sha256="a3629f1f139865c74916f8f69318f53af6319e7f8ec54e85c16466fd7d256938",
    )
    version(
        "3.3.0",
        sha256="499fd3b58656b4b6495496920e5372895861ebf15328be8a7a9354e06c734bc7",
    )
    version(
        "3.2.0",
        sha256="34d93e1b2a3b8908ef89804b7e08c5a884cbbc0b2c9f139061627c0d2de282c1",
    )
    version(
        "3.1.1",
    ...
    for val in ROCmPackage.amdgpu_targets:
        depends_on(
            "slate amdgpu_target={0}".format(val), when="amdgpu_target={0}".format(val)
        )
