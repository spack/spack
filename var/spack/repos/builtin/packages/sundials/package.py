...
class Sundials(CMakePackage):
    ...
    version('develop', '1d4b538721b84ebc91ce7ad92d94beae',
            url='https://computation.llnl.gov/projects/sundials/download/sundials-4.0.0-dev.tar.gz')

    version('3.1.1', 'e63f4de0be5be97f750b30b0fa11ef34')
