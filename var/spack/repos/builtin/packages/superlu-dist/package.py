...
class SuperluDist(CMakePackage, CudaPackage, ROCmPackage):
    ...
    version(
        "7.1.1",
        sha256="558053b3d4a56eb661c4f04d4fcab6604018ce5db97115394c161b56c9c278ff",
    )
    version(
        "7.1.0",
        sha256="edbea877562be95fb22c7de1ff484f18685bec4baa8e4f703c414d3c035d4a66",
    )
    version(
        "6.4.0",
    ...
    version(
        "6.3.1",
        sha256="3787c2755acd6aadbb4d9029138c293a7570a2ed228806676edcc7e1d3f5a1d3",
    )
    version(
        "6.3.0",
        sha256="daf3264706caccae2b8fd5a572e40275f1e128fa235cb7c21ee2f8051c11af95",
    )
    version(
        "6.2.0",
        sha256="15ad1badd81b41e37941dd124d06d3b92e51c4f0ff532ad23fb09c4ebfe6eb9e",
    )
    version(
        "6.1.1",
        sha256="35d25cff592c724439870444ed45e1d1d15ca2c65f02ccd4b83a6d3c9d220bd1",
    )
    version(
        "6.1.0",
        sha256="92c6d1424dd830ee2d1e7396a418a5f6645160aea8472e558c4e4bfe006593c4",
    )
    version(
        "6.0.0",
        sha256="ff6cdfa0263d595708bbb6d11fb780915d8cfddab438db651e246ea292f37ee4",
    )
    version(
        "5.4.0",
        sha256="3ac238fe082106a2c4dbaf0c22af1ff1247308ffa8f053de9d78c3ec7dd0d801",
    )
    version(
        "5.3.0",
        sha256="49ed110bdef1e284a0181d6c7dd1fae3aa110cb45f67c6aa5cb791070304d670",
    )
    version(
        "5.2.2",
        sha256="65cfb9ace9a81f7affac4ad92b9571badf0f10155b3468531b0fffde3bd8e727",
    )
    version(
        "5.2.1",
        sha256="67cf3c46cbded4cee68e2a9d601c30ab13b08091c8cdad95b0a8e018b6d5d1f1",
    )
    version(
        "5.1.3",
        sha256="58e3dfdb4ae6f8e3f6f3d5ee5e851af59b967c4483cdb3b15ccd1dbdf38f44f9",
    )
    version(
        "5.1.2",
        sha256="e34865ad6696ee6a6d178b4a01c8e19103a7d241ba9de043603970d63b0ee1e2",
    )
    version(
        "5.1.0",
        sha256="73f292ab748b590b6dd7469e6986aeb95d279b8b8b3da511c695a396bdbc996c",
    )
    version(
        "5.0.0",
        sha256="78d1d6460ff16b3f71e4bcd7306397574d54d421249553ccc26567f00a10bfc6",
    )
    ...
    def cmake_args(self):
        ...
        if "+cuda" in spec:
            ...
            args.append(
                "-DTPL_CUDA_LIBRARIES=-L%s -lcublas -lcudart"
    ...
    def test(self):
        ...
        if "+cuda" in self.spec:
            cuda_lib_opts = ",-rpath,{0}".format(self.spec["cuda"].libs.directories[0])
