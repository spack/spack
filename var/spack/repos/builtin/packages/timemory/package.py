...
class Timemory(CMakePackage, PythonExtension):
    ...
    depends_on("py-cython", type=("build"), when="+python_hatchet")
    depends_on("py-cython", type=("build"), when="+python_line_profiler")
    depends_on("pil", type=("run"), when="+python+python_deps")
    depends_on("py-numpy", type=("run"), when="+python+python_deps")
    depends_on("py-hatchet", type=("run"), when="+python+python_deps")
    depends_on("py-matplotlib", type=("run"), when="+python+python_deps")
    depends_on("py-mpi4py", type=("run"), when="+python+mpi+python_deps")
    depends_on("py-pandas", type=("run"), when="+python_deps+python_hatchet")
    depends_on("py-pydot", type=("run"), when="+python_deps+python_hatchet")
    depends_on("py-pyyaml", type=("run"), when="+python_deps+python_hatchet")
    depends_on("py-multiprocess", type=("run"), when="+python_deps+python_hatchet")
