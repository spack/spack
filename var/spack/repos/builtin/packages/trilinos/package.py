...
class Trilinos(CMakePackage, CudaPackage, ROCmPackage):
    ...
    with when("@14.4: +kokkos"):
        ...
        depends_on("kokkos@=4.5.01", when="@=16.1.0")
        depends_on("kokkos@=4.3.01", when="@=16.0.0")
        depends_on("kokkos@=4.2.01", when="@15.1:15")
        depends_on("kokkos@=4.1.00", when="@14.4:15.0")
        depends_on("kokkos-kernels@=4.5.01", when="@master:")
        depends_on("kokkos-kernels@=4.5.01", when="@=16.1.0")
        depends_on("kokkos-kernels@=4.3.01", when="@=16.0.0")
