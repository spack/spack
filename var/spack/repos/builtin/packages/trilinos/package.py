...
class Trilinos(CMakePackage, CudaPackage, ROCmPackage):
    ...
    conflicts("+amesos", when="@15.0.0:+superlu")
    conflicts("+ifpack", when="@15.0.0:+superlu")
    ...
    depends_on("superlu@5.2.2 +pic", when="@15.0.0:+superlu")
    depends_on("superlu@4.3 +pic", when="@:14.4.0+superlu")
