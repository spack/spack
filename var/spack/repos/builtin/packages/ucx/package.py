...
class Ucx(AutotoolsPackage, CudaPackage):
    ...
    version(
        "1.11.2",
        sha256="deebf86a5344fc2bd9e55449f88c650c4514928592807c9bc6fe4190e516c6df",
    )
    version(
        "1.11.1",
        sha256="29338cad18858517f96b46ff83bdd259a5899e274792cebd269717c660aa86fd",
    )
    version(
        "1.11.0",
    ...
    version(
        "1.10.1",
        sha256="ae9a108af6842ca135e7ec9b6131469adf9f1e50f899349fafcc69a215368bc9",
    )
    version(
        "1.10.0",
        sha256="b885e24b1b94724c03cb213c355381e98df1e2d1fd7f633cf8055b6dd05db92d",
    )
    version("1.9-dev", branch="v1.9.x")
    version(
        "1.9.0",
        sha256="a7a2c8841dc0d5444088a4373dc9b9cc68dbffcd917c1eba92ca8ed8e5e635fb",
    )
    version(
        "1.8.1",
        sha256="a48820cb8d0761b5ccf3e7ba03a7c8c1dde6276017657178829e07ffc35b556a",
    )
    version(
        "1.8.0",
        sha256="e400f7aa5354971c8f5ac6b881dc2846143851df868088c37d432c076445628d",
    )
    version(
        "1.7.0",
        sha256="6ab81ee187bfd554fe7e549da93a11bfac420df87d99ee61ffab7bb19bdd3371",
    )
    version(
        "1.6.1",
        sha256="1425648aa03f5fa40e4bc5c4a5a83fe0292e2fe44f6054352fbebbf6d8f342a1",
    )
    version(
        "1.6.0",
        sha256="360e885dd7f706a19b673035a3477397d100a02eb618371697c7f3ee4e143e2c",
    )
    version(
        "1.5.2",
        sha256="1a333853069860e86ba69b8d071ccc9871209603790e2b673ec61f8086913fad",
    )
    version(
        "1.5.1",
    ...
    version(
        "1.3.1",
        sha256="e058c8ec830d2f50d9db1e3aaaee105cd2ad6c1e6df20ae58b9b4179de7a8992",
    )
    version(
        "1.3.0",
    ...
    version(
        "1.2.2",
        sha256="914d10fee8f970d4fb286079dd656cf8a260ec7d724d5f751b3109ed32a6da63",
    )
    version(
        "1.2.1",
    ...
    version(
        "1.2.0",
        sha256="1e1a62d6d0f89ce59e384b0b5b30b416b8fd8d7cedec4182a5319d0dfddf649c",
    )
    ...
    variant(
        "mlx5-dv", default=False, description="Compile with mlx5 Direct Verbs support"
    )
    variant(
        "ib-hw-tm", default=False, description="Compile with IB Tag Matching support"
    )
    variant("dm", default=False, description="Compile with Device Memory support")
    variant(
        "cm", default=False, description="Compile with IB Connection Manager support"
    )
    ...
    def configure_args(self):
        ...
        config_args.extend(self.with_or_without("java", activation_value="prefix"))
        config_args.extend(self.with_or_without("cuda", activation_value="prefix"))
        config_args.extend(self.with_or_without("gdrcopy", activation_value="prefix"))
        config_args.extend(self.with_or_without("knem", activation_value="prefix"))
        config_args.extend(self.with_or_without("xpmem", activation_value="prefix"))
