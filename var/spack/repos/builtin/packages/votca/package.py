...
class Votca(CMakePackage):
    ...
    depends_on("boost@1.71:+filesystem+system+regex+timer")
    depends_on("boost@1.71:1.84+filesystem+system+regex+timer", when="@2024")
    depends_on("boost@1.71:1.82+filesystem+system+regex+timer", when="@:2023")
