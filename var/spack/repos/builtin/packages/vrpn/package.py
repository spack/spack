...
class Vrpn(CMakePackage):
    """The Virtual-Reality Peripheral Network (VRPN) is
    a set of classes within a library and a set of servers
    ...
    version('07.34', sha256='2fd6b418901e0f575099aea293274f5a61703ae37b55a335fc15fd3fe2779f84')
