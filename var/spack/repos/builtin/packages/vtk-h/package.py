...
class VtkH(Package, CudaPackage):
    ...
    version(
        "0.7.1",
        sha256="f28f7e6fb0f854a2293265b67cbdfb350b42c13ac08ffffe9cd246f3fe9fb77a",
    )
    version(
        "0.7.0",
        sha256="1b3c15c1340c5f66edcc2962ffe2f0d86e155f45a4932cf9c407261c203fbc19",
    )
    version(
        "0.6.9",
        sha256="8111f59c3528f02cb3c5083c17a1737dff9472266b156732794612471f3393c7",
    )
    version(
        "0.6.8",
        sha256="0a37468ca65fdc12509b9fd53c74d5afb090630280e1161415d7377cad7d45f1",
    )
    version(
        "0.6.7",
        sha256="aff3ab94cf137fbc3019149363d5d8a39d052b02ecef42c6bf6d076e538af3f2",
    )
    version(
        "0.6.6",
        sha256="5fe8bae5f55dbeb3047a37499cc41f3b548e4d86f0058993069f1df57f7915a1",
    )
    version(
        "0.6.5",
        sha256="3e566ee06150edece8a61711d9347de216c1ae45f3b4585784b2252ee9ff2a9b",
    )
    version(
        "0.6.4",
        sha256="c1345679fa4110cba449a9e27d40774d53c1f0bbddd41e52f5eb395cec1ee2d0",
    )
    version(
        "0.6.3",
        sha256="388ad05110efac45df6ae0d565a7d16bd05ff83c95b8b2b8daa206360ab73eec",
    )
    version(
        "0.6.2",
        sha256="1623e943a5a034d474c04755be8f0f40b639183cd9b576b1289eeee687d4cf6d",
    )
    version(
        "0.6.1",
        sha256="ca30b5ff1a48fa247cd20b3f19452f7744eb744465e0b64205135aece42d274f",
    )
    version(
        "0.6.0",
        sha256="2fc054f88ae253fb1bfcae22a156bcced08eca963ba90384dcd5b5791e6dfbf4",
    )
    version(
        "0.5.8",
        sha256="203b337f4280a24a2b75722384f77e0e2f5965058b541efc153db76b7ab98133",
    )
    version(
        "0.5.7",
        sha256="e8c1925dc34ee6be17cec734121e43002e3c02b54ef8dac341b51a455b95e402",
    )
    version(
        "0.5.6",
        sha256="c78c0fa71a9687c2951a06d2112b52aa81fdcdcfbc9464d1578326d03fbb205e",
    )
    version(
        "0.5.4",
        sha256="92bf3741df7a15e36ff41a9a783f3b88eecc86e55cad1defba76f141baa2610b",
    )
    version(
        "0.5.3",
        sha256="0c4aae3bd2a5906738a6806de2b62ea2049ac8b40ebe7fc2ba25505272c2d359",
    )
    version(
        "0.5.2",
        sha256="db2e6250c0ece6381fc90540317ad7b5869dbcce0231ce9be125916a77bfdb25",
    )
    ...
    for _arch in CudaPackage.cuda_arch_values:
        depends_on(
            "vtk-m@:1.6+cuda~tbb+openmp cuda_arch={0}".format(_arch),
    ...
    def install(self, spec, prefix):
        with working_dir("spack-build", create=True):
            ...
            if "+mpi" in spec:
                ...
                cmake_args.extend(
                    [
                        "-DMPI_C_COMPILER={0}".format(mpicc),
    ...
    def create_host_config(self, spec, prefix, py_site_pkgs_dir=None):
        ...
        host_cfg_fname = "%s-%s-%s-vtkh.cmake" % (
            socket.gethostname(),
            sys_type,
            spec.compiler,
        )
