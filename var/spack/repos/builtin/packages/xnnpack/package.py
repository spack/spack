...
class Xnnpack(CMakePackage):
    ...
    version(
        "2021-02-22", commit="55d53a4e7079d38e90acd75dd9e4f9e781d2da35"
    )  # py-torch@1.8:1.9
    version(
        "2020-03-23", commit="1b354636b5942826547055252f3b359b54acff95"
    )  # py-torch@1.6:1.7
    version(
        "2020-02-24", commit="7493bfb9d412e59529bcbced6a902d44cfa8ea1c"
    )  # py-torch@1.5
    ...
    def cmake_args(self):
        ...
        return [
            self.define(
                "CLOG_SOURCE_DIR", join_path(self.stage.source_path, "deps", "clog")
            ),
            self.define(
                "CPUINFO_SOURCE_DIR",
            ...
            self.define(
                "FP16_SOURCE_DIR", join_path(self.stage.source_path, "deps", "fp16")
            ),
            self.define(
                "FXDIV_SOURCE_DIR", join_path(self.stage.source_path, "deps", "fxdiv")
            ),
            self.define(
            ...
            self.define(
                "PSIMD_SOURCE_DIR", join_path(self.stage.source_path, "deps", "psimd")
            ),
        ]
