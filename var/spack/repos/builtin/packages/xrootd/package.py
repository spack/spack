...
class Xrootd(CMakePackage):
    ...
    depends_on("bzip2")
    depends_on("cmake@2.6:", when="@3.1.0:", type="build")
    depends_on("cmake@3.16:", when="@5.6:", type="build")
    ...
    depends_on("py-setuptools", when="@:5.5 +python", type="build")
    depends_on("py-pip", when="@5.6: +python", type="build")
