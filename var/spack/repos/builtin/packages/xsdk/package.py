...
class Xsdk(Package):
    ...
    depends_on('mfem@3.3.2-rc5+mpi+hypre+superlu-dist+petsc+sundials+examples+miniapps', when='@0.3.0-rc1')
    depends_on('mfem@3.3.2-rc5+mpi+hypre+superlu-dist+petsc+sundials+examples+miniapps', when='@develop')
