...
class Ycsb(MavenPackage):
    ...
    for key in bindings:
        ...
        variant(
            variant_name,
            default=False,
            description="Build the %s binding" % key,
            when="@%s" % bindings[key],
        )
    ...
    def build(self, spec, prefix):
        ...
        if "+mangodb" in spec:
            ...
            jar_name = "target/mongodb-async-driver-" + mongodb_async_driver_version + ".jar"
        ...
        projects = ["site.ycsb:core", "site.ycsb:binding-parent", "site.ycsb:distribution"]
