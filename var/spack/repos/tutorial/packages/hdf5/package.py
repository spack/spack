...
class Hdf5(CMakePackage):
    ...
    conflicts(
        "api=v114", when="@1.6.0:1.12", msg="v114 is not compatible with this release"
    )
    conflicts(
        "api=v112", when="@1.6.0:1.10", msg="v112 is not compatible with this release"
    )
    conflicts(
        "api=v110", when="@1.6.0:1.8", msg="v110 is not compatible with this release"
    )
    conflicts(
